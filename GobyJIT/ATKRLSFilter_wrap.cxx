...
#define SWIGTYPE_p_ATK__RLSFilterT_DspFloatType_t swig_types[0]
#define SWIGTYPE_p_AmplifierProcessor swig_types[1]
#define SWIGTYPE_p_FilterProcessor swig_types[2]
#define SWIGTYPE_p_Filters__AudioTK__Adaptive__RLSFilter swig_types[3]
...
#define SWIG_name      "ATKRLSFilter"
#define SWIG_init      luaopen_ATKRLSFilter
#define SWIG_init_user luaopen_ATKRLSFilter_user

#define SWIG_LUACODE   luaopen_ATKRLSFilter_luacode
...
static int _wrap_RLSFilter_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Adaptive::RLSFilter *arg1 = (Filters::AudioTK::Adaptive::RLSFilter *) 0 ;
  ATK::RLSFilter< DspFloatType > *arg2 = (ATK::RLSFilter< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Adaptive::RLSFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Adaptive::RLSFilter::filter",1,"Filters::AudioTK::Adaptive::RLSFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::Adaptive::RLSFilter::filter",2,"ATK::RLSFilter< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Adaptive__RLSFilter,0))){
    SWIG_fail_ptr("RLSFilter_filter_set",1,SWIGTYPE_p_Filters__AudioTK__Adaptive__RLSFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__RLSFilterT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("RLSFilter_filter_set",2,SWIGTYPE_p_ATK__RLSFilterT_DspFloatType_t);
  }
...
static int _wrap_RLSFilter_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Adaptive::RLSFilter *arg1 = (Filters::AudioTK::Adaptive::RLSFilter *) 0 ;
  ATK::RLSFilter< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Adaptive::RLSFilter::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Adaptive::RLSFilter::filter",1,"Filters::AudioTK::Adaptive::RLSFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Adaptive__RLSFilter,0))){
    SWIG_fail_ptr("RLSFilter_filter_get",1,SWIGTYPE_p_Filters__AudioTK__Adaptive__RLSFilter);
  }
  
  result = (ATK::RLSFilter< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__RLSFilterT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_RLSFilter(lua_State* L) {
  int SWIG_arg = 0;
  size_t arg1 ;
  Filters::AudioTK::Adaptive::RLSFilter *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Adaptive::RLSFilter::RLSFilter",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Filters::AudioTK::Adaptive::RLSFilter::RLSFilter",1,"size_t");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative");
  arg1 = (size_t)lua_tonumber(L, 1);
  result = (Filters::AudioTK::Adaptive::RLSFilter *)new Filters::AudioTK::Adaptive::RLSFilter(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__Adaptive__RLSFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_RLSFilter_setPort(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Adaptive::RLSFilter *arg1 = (Filters::AudioTK::Adaptive::RLSFilter *) 0 ;
  int arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Filters::AudioTK::Adaptive::RLSFilter::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Adaptive::RLSFilter::setPort",1,"Filters::AudioTK::Adaptive::RLSFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AudioTK::Adaptive::RLSFilter::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AudioTK::Adaptive::RLSFilter::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Adaptive__RLSFilter,0))){
    SWIG_fail_ptr("RLSFilter_setPort",1,SWIGTYPE_p_Filters__AudioTK__Adaptive__RLSFilter);
  }
...
static void swig_delete_RLSFilter(void *obj) {
Filters::AudioTK::Adaptive::RLSFilter *arg1 = (Filters::AudioTK::Adaptive::RLSFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_RLSFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_RLSFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_RLSFilter_attributes[] = {
    { "filter", _wrap_RLSFilter_filter_get, _wrap_RLSFilter_filter_set },
    {0,0,0}
};
static swig_lua_method swig_RLSFilter_methods[]= {
    { "setPort", _wrap_RLSFilter_setPort},
    {0,0}
};
static swig_lua_method swig_RLSFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_RLSFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_RLSFilter_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_SIZE", Filters::AudioTK::Adaptive::RLSFilter::PORT_SIZE)},
    {SWIG_LUA_CONSTTAB_INT("PORT_MEMORY", Filters::AudioTK::Adaptive::RLSFilter::PORT_MEMORY)},
    {SWIG_LUA_CONSTTAB_INT("PORT_LEARNING", Filters::AudioTK::Adaptive::RLSFilter::PORT_LEARNING)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_RLSFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_RLSFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_RLSFilter_Sf_SwigStatic = {
    "RLSFilter",
    swig_RLSFilter_Sf_SwigStatic_methods,
    swig_RLSFilter_Sf_SwigStatic_attributes,
    swig_RLSFilter_Sf_SwigStatic_constants,
    swig_RLSFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_RLSFilter_bases[] = {0};
static const char *swig_RLSFilter_base_names[] = {0};
static swig_lua_class _wrap_class_RLSFilter = { "RLSFilter", "RLSFilter", &SWIGTYPE_p_Filters__AudioTK__Adaptive__RLSFilter,_proxy__wrap_new_RLSFilter, swig_delete_RLSFilter, swig_RLSFilter_methods, swig_RLSFilter_attributes, &swig_RLSFilter_Sf_SwigStatic, swig_RLSFilter_meta, swig_RLSFilter_bases, swig_RLSFilter_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("RLSFilter_PORT_SIZE", Filters::AudioTK::Adaptive::RLSFilter::PORT_SIZE)},
    {SWIG_LUA_CONSTTAB_INT("RLSFilter_PORT_MEMORY", Filters::AudioTK::Adaptive::RLSFilter::PORT_MEMORY)},
    {SWIG_LUA_CONSTTAB_INT("RLSFilter_PORT_LEARNING", Filters::AudioTK::Adaptive::RLSFilter::PORT_LEARNING)},
    {0,0,0,0,0,0}
};
...
static swig_type_info _swigt__p_ATK__RLSFilterT_DspFloatType_t = {"_p_ATK__RLSFilterT_DspFloatType_t", "ATK::RLSFilter< DspFloatType > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_Filters__AudioTK__Adaptive__RLSFilter = {"_p_Filters__AudioTK__Adaptive__RLSFilter", "Filters::AudioTK::Adaptive::RLSFilter *", 0, 0, (void*)&_wrap_class_RLSFilter, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ATK__RLSFilterT_DspFloatType_t,
  &_swigt__p_AmplifierProcessor,
  &_swigt__p_FilterProcessor,
  &_swigt__p_Filters__AudioTK__Adaptive__RLSFilter,
...
static swig_cast_info _swigc__p_ATK__RLSFilterT_DspFloatType_t[] = {  {&_swigt__p_ATK__RLSFilterT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_Filters__AudioTK__Adaptive__RLSFilter[] = {  {&_swigt__p_Filters__AudioTK__Adaptive__RLSFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ATK__RLSFilterT_DspFloatType_t,
  _swigc__p_AmplifierProcessor,
  _swigc__p_FilterProcessor,
  _swigc__p_Filters__AudioTK__Adaptive__RLSFilter,
