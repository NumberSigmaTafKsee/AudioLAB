...
#define SWIGTYPE_p_DSPFX__FxLadderFilter swig_types[1]
...
#define SWIGTYPE_p_LadderFilter swig_types[5]
...
#define SWIG_name      "FxDSPLadderFilter"
#define SWIG_init      luaopen_FxDSPLadderFilter
#define SWIG_init_user luaopen_FxDSPLadderFilter_user

#define SWIG_LUACODE   luaopen_FxDSPLadderFilter_luacode
...
static int _wrap_FxLadderFilter_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxLadderFilter *arg1 = (DSPFX::FxLadderFilter *) 0 ;
  LadderFilter *arg2 = (LadderFilter *) 0 ;
  
  SWIG_check_num_args("DSPFX::FxLadderFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxLadderFilter::filter",1,"DSPFX::FxLadderFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("DSPFX::FxLadderFilter::filter",2,"LadderFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxLadderFilter,0))){
    SWIG_fail_ptr("FxLadderFilter_filter_set",1,SWIGTYPE_p_DSPFX__FxLadderFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_LadderFilter,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("FxLadderFilter_filter_set",2,SWIGTYPE_p_LadderFilter);
  }
...
static int _wrap_FxLadderFilter_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxLadderFilter *arg1 = (DSPFX::FxLadderFilter *) 0 ;
  LadderFilter *result = 0 ;
  
  SWIG_check_num_args("DSPFX::FxLadderFilter::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxLadderFilter::filter",1,"DSPFX::FxLadderFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxLadderFilter,0))){
    SWIG_fail_ptr("FxLadderFilter_filter_get",1,SWIGTYPE_p_DSPFX__FxLadderFilter);
  }
  
  result = (LadderFilter *) ((arg1)->filter);
...
static int _wrap_new_FxLadderFilter(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  DSPFX::FxLadderFilter *result = 0 ;
  
  SWIG_check_num_args("DSPFX::FxLadderFilter::FxLadderFilter",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("DSPFX::FxLadderFilter::FxLadderFilter",1,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  result = (DSPFX::FxLadderFilter *)new DSPFX::FxLadderFilter(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_DSPFX__FxLadderFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_FxLadderFilter_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxLadderFilter *arg1 = (DSPFX::FxLadderFilter *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("DSPFX::FxLadderFilter::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxLadderFilter::ProcessBlock",1,"DSPFX::FxLadderFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxLadderFilter::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("DSPFX::FxLadderFilter::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("DSPFX::FxLadderFilter::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxLadderFilter,0))){
    SWIG_fail_ptr("FxLadderFilter_ProcessBlock",1,SWIGTYPE_p_DSPFX__FxLadderFilter);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxLadderFilter_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxLadderFilter_ProcessBlock",4,SWIGTYPE_p_float);
  }
...
static int _wrap_FxLadderFilter_setCutoff(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxLadderFilter *arg1 = (DSPFX::FxLadderFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("DSPFX::FxLadderFilter::setCutoff",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxLadderFilter::setCutoff",1,"DSPFX::FxLadderFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxLadderFilter::setCutoff",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxLadderFilter,0))){
    SWIG_fail_ptr("FxLadderFilter_setCutoff",1,SWIGTYPE_p_DSPFX__FxLadderFilter);
  }
...
static int _wrap_FxLadderFilter_setResonance(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxLadderFilter *arg1 = (DSPFX::FxLadderFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("DSPFX::FxLadderFilter::setResonance",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxLadderFilter::setResonance",1,"DSPFX::FxLadderFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxLadderFilter::setResonance",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxLadderFilter,0))){
    SWIG_fail_ptr("FxLadderFilter_setResonance",1,SWIGTYPE_p_DSPFX__FxLadderFilter);
  }
...
static int _wrap_FxLadderFilter_setTemperature(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxLadderFilter *arg1 = (DSPFX::FxLadderFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("DSPFX::FxLadderFilter::setTemperature",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxLadderFilter::setTemperature",1,"DSPFX::FxLadderFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxLadderFilter::setTemperature",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxLadderFilter,0))){
    SWIG_fail_ptr("FxLadderFilter_setTemperature",1,SWIGTYPE_p_DSPFX__FxLadderFilter);
  }
...
static int _wrap_FxLadderFilter_setPort(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxLadderFilter *arg1 = (DSPFX::FxLadderFilter *) 0 ;
  int arg2 ;
  double arg3 ;
  
  SWIG_check_num_args("DSPFX::FxLadderFilter::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxLadderFilter::setPort",1,"DSPFX::FxLadderFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxLadderFilter::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("DSPFX::FxLadderFilter::setPort",3,"double");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxLadderFilter,0))){
    SWIG_fail_ptr("FxLadderFilter_setPort",1,SWIGTYPE_p_DSPFX__FxLadderFilter);
  }
...
static void swig_delete_FxLadderFilter(void *obj) {
DSPFX::FxLadderFilter *arg1 = (DSPFX::FxLadderFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_FxLadderFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_FxLadderFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_FxLadderFilter_attributes[] = {
    { "filter", _wrap_FxLadderFilter_filter_get, _wrap_FxLadderFilter_filter_set },
    {0,0,0}
};
static swig_lua_method swig_FxLadderFilter_methods[]= {
    { "ProcessBlock", _wrap_FxLadderFilter_ProcessBlock},
    { "setCutoff", _wrap_FxLadderFilter_setCutoff},
    { "setResonance", _wrap_FxLadderFilter_setResonance},
    { "setTemperature", _wrap_FxLadderFilter_setTemperature},
    { "setPort", _wrap_FxLadderFilter_setPort},
    {0,0}
};
static swig_lua_method swig_FxLadderFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_FxLadderFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_FxLadderFilter_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_CUTOFF", DSPFX::FxLadderFilter::PORT_CUTOFF)},
    {SWIG_LUA_CONSTTAB_INT("PORT_RESONANCE", DSPFX::FxLadderFilter::PORT_RESONANCE)},
    {SWIG_LUA_CONSTTAB_INT("PORT_TEMP", DSPFX::FxLadderFilter::PORT_TEMP)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_FxLadderFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_FxLadderFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_FxLadderFilter_Sf_SwigStatic = {
    "FxLadderFilter",
    swig_FxLadderFilter_Sf_SwigStatic_methods,
    swig_FxLadderFilter_Sf_SwigStatic_attributes,
    swig_FxLadderFilter_Sf_SwigStatic_constants,
    swig_FxLadderFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_FxLadderFilter_bases[] = {0,0};
static const char *swig_FxLadderFilter_base_names[] = {"MonoFXProcessor *",0};
static swig_lua_class _wrap_class_FxLadderFilter = { "FxLadderFilter", "FxLadderFilter", &SWIGTYPE_p_DSPFX__FxLadderFilter,_proxy__wrap_new_FxLadderFilter, swig_delete_FxLadderFilter, swig_FxLadderFilter_methods, swig_FxLadderFilter_attributes, &swig_FxLadderFilter_Sf_SwigStatic, swig_FxLadderFilter_meta, swig_FxLadderFilter_bases, swig_FxLadderFilter_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("FxLadderFilter_PORT_CUTOFF", DSPFX::FxLadderFilter::PORT_CUTOFF)},
    {SWIG_LUA_CONSTTAB_INT("FxLadderFilter_PORT_RESONANCE", DSPFX::FxLadderFilter::PORT_RESONANCE)},
    {SWIG_LUA_CONSTTAB_INT("FxLadderFilter_PORT_TEMP", DSPFX::FxLadderFilter::PORT_TEMP)},
    {0,0,0,0,0,0}
};
...
static void *_p_DSPFX__FxLadderFilterTo_p_MonoFXProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoFXProcessor *)  ((DSPFX::FxLadderFilter *) x));
}
...
static void *_p_DSPFX__FxLadderFilterTo_p_MonoProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoProcessor *) (MonoFXProcessor *) ((DSPFX::FxLadderFilter *) x));
}
...
static void *_p_DSPFX__FxLadderFilterTo_p_SoundProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SoundProcessor *) (MonoProcessor *)(MonoFXProcessor *) ((DSPFX::FxLadderFilter *) x));
}
...
static swig_type_info _swigt__p_DSPFX__FxLadderFilter = {"_p_DSPFX__FxLadderFilter", "DSPFX::FxLadderFilter *", 0, 0, (void*)&_wrap_class_FxLadderFilter, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_DSPFX__FxLadderFilter,
...
static swig_cast_info _swigc__p_DSPFX__FxLadderFilter[] = {  {&_swigt__p_DSPFX__FxLadderFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_MonoFXProcessor[] = {  {&_swigt__p_DSPFX__FxLadderFilter, _p_DSPFX__FxLadderFilterTo_p_MonoFXProcessor, 0, 0},  {&_swigt__p_MonoFXProcessor, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_DSPFX__FxLadderFilter,
