...
#define SWIGTYPE_p_ATK__UniversalVariableDelayLineFilterT_DspFloatType_t swig_types[0]
#define SWIGTYPE_p_AmplifierProcessor swig_types[1]
#define SWIGTYPE_p_FilterProcessor swig_types[2]
#define SWIGTYPE_p_Filters__AudioTK__Delays__UVDLDelay swig_types[3]
...
#define SWIG_name      "ATKUniversalVariableDelayLine"
#define SWIG_init      luaopen_ATKUniversalVariableDelayLine
#define SWIG_init_user luaopen_ATKUniversalVariableDelayLine_user

#define SWIG_LUACODE   luaopen_ATKUniversalVariableDelayLine_luacode
...
static int _wrap_UVDLDelay_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Delays::UVDLDelay *arg1 = (Filters::AudioTK::Delays::UVDLDelay *) 0 ;
  ATK::UniversalVariableDelayLineFilter< DspFloatType > *arg2 = (ATK::UniversalVariableDelayLineFilter< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Delays::UVDLDelay::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Delays::UVDLDelay::filter",1,"Filters::AudioTK::Delays::UVDLDelay *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::Delays::UVDLDelay::filter",2,"ATK::UniversalVariableDelayLineFilter< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Delays__UVDLDelay,0))){
    SWIG_fail_ptr("UVDLDelay_filter_set",1,SWIGTYPE_p_Filters__AudioTK__Delays__UVDLDelay);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__UniversalVariableDelayLineFilterT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("UVDLDelay_filter_set",2,SWIGTYPE_p_ATK__UniversalVariableDelayLineFilterT_DspFloatType_t);
  }
...
static int _wrap_UVDLDelay_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Delays::UVDLDelay *arg1 = (Filters::AudioTK::Delays::UVDLDelay *) 0 ;
  ATK::UniversalVariableDelayLineFilter< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Delays::UVDLDelay::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Delays::UVDLDelay::filter",1,"Filters::AudioTK::Delays::UVDLDelay *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Delays__UVDLDelay,0))){
    SWIG_fail_ptr("UVDLDelay_filter_get",1,SWIGTYPE_p_Filters__AudioTK__Delays__UVDLDelay);
  }
  
  result = (ATK::UniversalVariableDelayLineFilter< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__UniversalVariableDelayLineFilterT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_UVDLDelay(lua_State* L) {
  int SWIG_arg = 0;
  size_t arg1 ;
  Filters::AudioTK::Delays::UVDLDelay *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Delays::UVDLDelay::UVDLDelay",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Filters::AudioTK::Delays::UVDLDelay::UVDLDelay",1,"size_t");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative");
  arg1 = (size_t)lua_tonumber(L, 1);
  result = (Filters::AudioTK::Delays::UVDLDelay *)new Filters::AudioTK::Delays::UVDLDelay(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__Delays__UVDLDelay,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_UVDLDelay_setPort(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Delays::UVDLDelay *arg1 = (Filters::AudioTK::Delays::UVDLDelay *) 0 ;
  size_t arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Filters::AudioTK::Delays::UVDLDelay::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Delays::UVDLDelay::setPort",1,"Filters::AudioTK::Delays::UVDLDelay *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AudioTK::Delays::UVDLDelay::setPort",2,"size_t");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AudioTK::Delays::UVDLDelay::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Delays__UVDLDelay,0))){
    SWIG_fail_ptr("UVDLDelay_setPort",1,SWIGTYPE_p_Filters__AudioTK__Delays__UVDLDelay);
  }
...
static void swig_delete_UVDLDelay(void *obj) {
Filters::AudioTK::Delays::UVDLDelay *arg1 = (Filters::AudioTK::Delays::UVDLDelay *) obj;
delete arg1;
}
static int _proxy__wrap_new_UVDLDelay(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_UVDLDelay);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_UVDLDelay_attributes[] = {
    { "filter", _wrap_UVDLDelay_filter_get, _wrap_UVDLDelay_filter_set },
    {0,0,0}
};
static swig_lua_method swig_UVDLDelay_methods[]= {
    { "setPort", _wrap_UVDLDelay_setPort},
    {0,0}
};
static swig_lua_method swig_UVDLDelay_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_UVDLDelay_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_UVDLDelay_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_DELAY", Filters::AudioTK::Delays::UVDLDelay::PORT_DELAY)},
    {SWIG_LUA_CONSTTAB_INT("PORT_BLEND", Filters::AudioTK::Delays::UVDLDelay::PORT_BLEND)},
    {SWIG_LUA_CONSTTAB_INT("PORT_FEEDBACK", Filters::AudioTK::Delays::UVDLDelay::PORT_FEEDBACK)},
    {SWIG_LUA_CONSTTAB_INT("PORT_FEEDFORWARD", Filters::AudioTK::Delays::UVDLDelay::PORT_FEEDFORWARD)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_UVDLDelay_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_UVDLDelay_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_UVDLDelay_Sf_SwigStatic = {
    "UVDLDelay",
    swig_UVDLDelay_Sf_SwigStatic_methods,
    swig_UVDLDelay_Sf_SwigStatic_attributes,
    swig_UVDLDelay_Sf_SwigStatic_constants,
    swig_UVDLDelay_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_UVDLDelay_bases[] = {0};
static const char *swig_UVDLDelay_base_names[] = {0};
static swig_lua_class _wrap_class_UVDLDelay = { "UVDLDelay", "UVDLDelay", &SWIGTYPE_p_Filters__AudioTK__Delays__UVDLDelay,_proxy__wrap_new_UVDLDelay, swig_delete_UVDLDelay, swig_UVDLDelay_methods, swig_UVDLDelay_attributes, &swig_UVDLDelay_Sf_SwigStatic, swig_UVDLDelay_meta, swig_UVDLDelay_bases, swig_UVDLDelay_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("UVDLDelay_PORT_DELAY", Filters::AudioTK::Delays::UVDLDelay::PORT_DELAY)},
    {SWIG_LUA_CONSTTAB_INT("UVDLDelay_PORT_BLEND", Filters::AudioTK::Delays::UVDLDelay::PORT_BLEND)},
    {SWIG_LUA_CONSTTAB_INT("UVDLDelay_PORT_FEEDBACK", Filters::AudioTK::Delays::UVDLDelay::PORT_FEEDBACK)},
    {SWIG_LUA_CONSTTAB_INT("UVDLDelay_PORT_FEEDFORWARD", Filters::AudioTK::Delays::UVDLDelay::PORT_FEEDFORWARD)},
    {0,0,0,0,0,0}
};
...
static swig_type_info _swigt__p_ATK__UniversalVariableDelayLineFilterT_DspFloatType_t = {"_p_ATK__UniversalVariableDelayLineFilterT_DspFloatType_t", "ATK::UniversalVariableDelayLineFilter< DspFloatType > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_Filters__AudioTK__Delays__UVDLDelay = {"_p_Filters__AudioTK__Delays__UVDLDelay", "Filters::AudioTK::Delays::UVDLDelay *", 0, 0, (void*)&_wrap_class_UVDLDelay, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ATK__UniversalVariableDelayLineFilterT_DspFloatType_t,
  &_swigt__p_AmplifierProcessor,
  &_swigt__p_FilterProcessor,
  &_swigt__p_Filters__AudioTK__Delays__UVDLDelay,
...
static swig_cast_info _swigc__p_ATK__UniversalVariableDelayLineFilterT_DspFloatType_t[] = {  {&_swigt__p_ATK__UniversalVariableDelayLineFilterT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_Filters__AudioTK__Delays__UVDLDelay[] = {  {&_swigt__p_Filters__AudioTK__Delays__UVDLDelay, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ATK__UniversalVariableDelayLineFilterT_DspFloatType_t,
  _swigc__p_AmplifierProcessor,
  _swigc__p_FilterProcessor,
  _swigc__p_Filters__AudioTK__Delays__UVDLDelay,
