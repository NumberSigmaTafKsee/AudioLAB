...
#define SWIGTYPE_p_BiquadFilterD swig_types[1]
#define SWIGTYPE_p_DSPFX__FxBiquadFilter swig_types[2]
#define SWIGTYPE_p_DSPFX__FxRBJFilter swig_types[3]
...
#define SWIGTYPE_p_RBJFilter swig_types[27]
...
#define SWIGTYPE_p_Std__RandomMersenne swig_types[33]
#define SWIGTYPE_p_StereoAmplifierProcessor swig_types[34]
#define SWIGTYPE_p_StereoCascadeProcessor swig_types[35]
#define SWIGTYPE_p_StereoFXProcessor swig_types[36]
#define SWIGTYPE_p_StereoFilterProcessor swig_types[37]
#define SWIGTYPE_p_StereoFunctionProcessor swig_types[38]
#define SWIGTYPE_p_StereoGeneratorProcessor swig_types[39]
#define SWIGTYPE_p_StereoOscillatorProcessor swig_types[40]
#define SWIGTYPE_p_StereoProcessor swig_types[41]
#define SWIGTYPE_p_StereoSplitterProcessor swig_types[42]
#define SWIGTYPE_p_double swig_types[43]
#define SWIGTYPE_p_f_float__float swig_types[44]
#define SWIGTYPE_p_f_r_q_const__float__float swig_types[45]
#define SWIGTYPE_p_fenv_t swig_types[46]
#define SWIGTYPE_p_fexcept_t swig_types[47]
...
#define SWIG_name      "FxDSPBiquads"
#define SWIG_init      luaopen_FxDSPBiquads
#define SWIG_init_user luaopen_FxDSPBiquads_user

#define SWIG_LUACODE   luaopen_FxDSPBiquads_luacode
...
static int _wrap_FxBiquadFilter_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxBiquadFilter *arg1 = (DSPFX::FxBiquadFilter *) 0 ;
  BiquadFilterD *arg2 = (BiquadFilterD *) 0 ;
  
  SWIG_check_num_args("DSPFX::FxBiquadFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxBiquadFilter::filter",1,"DSPFX::FxBiquadFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("DSPFX::FxBiquadFilter::filter",2,"BiquadFilterD *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxBiquadFilter,0))){
    SWIG_fail_ptr("FxBiquadFilter_filter_set",1,SWIGTYPE_p_DSPFX__FxBiquadFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_BiquadFilterD,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("FxBiquadFilter_filter_set",2,SWIGTYPE_p_BiquadFilterD);
  }
...
static int _wrap_FxBiquadFilter_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxBiquadFilter *arg1 = (DSPFX::FxBiquadFilter *) 0 ;
  BiquadFilterD *result = 0 ;
  
  SWIG_check_num_args("DSPFX::FxBiquadFilter::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxBiquadFilter::filter",1,"DSPFX::FxBiquadFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxBiquadFilter,0))){
    SWIG_fail_ptr("FxBiquadFilter_filter_get",1,SWIGTYPE_p_DSPFX__FxBiquadFilter);
  }
  
  result = (BiquadFilterD *) ((arg1)->filter);
...
static int _wrap_new_FxBiquadFilter(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType *arg1 = (DspFloatType *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  DSPFX::FxBiquadFilter *result = 0 ;
  
  SWIG_check_num_args("DSPFX::FxBiquadFilter::FxBiquadFilter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxBiquadFilter::FxBiquadFilter",1,"DspFloatType const *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("DSPFX::FxBiquadFilter::FxBiquadFilter",2,"DspFloatType const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("new_FxBiquadFilter",1,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("new_FxBiquadFilter",2,SWIGTYPE_p_float);
  }
  
  result = (DSPFX::FxBiquadFilter *)new DSPFX::FxBiquadFilter((DspFloatType const *)arg1,(DspFloatType const *)arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_DSPFX__FxBiquadFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_FxBiquadFilter_flush(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxBiquadFilter *arg1 = (DSPFX::FxBiquadFilter *) 0 ;
  
  SWIG_check_num_args("DSPFX::FxBiquadFilter::flush",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxBiquadFilter::flush",1,"DSPFX::FxBiquadFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxBiquadFilter,0))){
    SWIG_fail_ptr("FxBiquadFilter_flush",1,SWIGTYPE_p_DSPFX__FxBiquadFilter);
  }
...
static int _wrap_FxBiquadFilter_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxBiquadFilter *arg1 = (DSPFX::FxBiquadFilter *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("DSPFX::FxBiquadFilter::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxBiquadFilter::ProcessBlock",1,"DSPFX::FxBiquadFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxBiquadFilter::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("DSPFX::FxBiquadFilter::ProcessBlock",3,"DspFloatType const *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("DSPFX::FxBiquadFilter::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxBiquadFilter,0))){
    SWIG_fail_ptr("FxBiquadFilter_ProcessBlock",1,SWIGTYPE_p_DSPFX__FxBiquadFilter);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxBiquadFilter_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxBiquadFilter_ProcessBlock",4,SWIGTYPE_p_float);
  }
  
  (arg1)->ProcessBlock(arg2,(DspFloatType const *)arg3,arg4);
...
static int _wrap_FxBiquadFilter_Tick(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxBiquadFilter *arg1 = (DSPFX::FxBiquadFilter *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("DSPFX::FxBiquadFilter::Tick",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxBiquadFilter::Tick",1,"DSPFX::FxBiquadFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxBiquadFilter::Tick",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxBiquadFilter,0))){
    SWIG_fail_ptr("FxBiquadFilter_Tick",1,SWIGTYPE_p_DSPFX__FxBiquadFilter);
  }
...
static int _wrap_FxBiquadFilter_updateCoefficients(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxBiquadFilter *arg1 = (DSPFX::FxBiquadFilter *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  
  SWIG_check_num_args("DSPFX::FxBiquadFilter::updateCoefficients",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxBiquadFilter::updateCoefficients",1,"DSPFX::FxBiquadFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("DSPFX::FxBiquadFilter::updateCoefficients",2,"DspFloatType const *");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("DSPFX::FxBiquadFilter::updateCoefficients",3,"DspFloatType const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxBiquadFilter,0))){
    SWIG_fail_ptr("FxBiquadFilter_updateCoefficients",1,SWIGTYPE_p_DSPFX__FxBiquadFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxBiquadFilter_updateCoefficients",2,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxBiquadFilter_updateCoefficients",3,SWIGTYPE_p_float);
  }
  
  (arg1)->updateCoefficients((DspFloatType const *)arg2,(DspFloatType const *)arg3);
...
static int _wrap_FxBiquadFilter_setPortV(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxBiquadFilter *arg1 = (DSPFX::FxBiquadFilter *) 0 ;
  int arg2 ;
  std::vector< DspFloatType > *arg3 = 0 ;
  
  SWIG_check_num_args("DSPFX::FxBiquadFilter::setPortV",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxBiquadFilter::setPortV",1,"DSPFX::FxBiquadFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxBiquadFilter::setPortV",2,"int");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("DSPFX::FxBiquadFilter::setPortV",3,"std::vector< DspFloatType > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxBiquadFilter,0))){
    SWIG_fail_ptr("FxBiquadFilter_setPortV",1,SWIGTYPE_p_DSPFX__FxBiquadFilter);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("FxBiquadFilter_setPortV",3,SWIGTYPE_p_std__vectorT_float_t);
  }
...
static void swig_delete_FxBiquadFilter(void *obj) {
DSPFX::FxBiquadFilter *arg1 = (DSPFX::FxBiquadFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_FxBiquadFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_FxBiquadFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_FxBiquadFilter_attributes[] = {
    { "filter", _wrap_FxBiquadFilter_filter_get, _wrap_FxBiquadFilter_filter_set },
    {0,0,0}
};
static swig_lua_method swig_FxBiquadFilter_methods[]= {
    { "flush", _wrap_FxBiquadFilter_flush},
    { "ProcessBlock", _wrap_FxBiquadFilter_ProcessBlock},
    { "Tick", _wrap_FxBiquadFilter_Tick},
    { "updateCoefficients", _wrap_FxBiquadFilter_updateCoefficients},
    { "setPortV", _wrap_FxBiquadFilter_setPortV},
    {0,0}
};
static swig_lua_method swig_FxBiquadFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_FxBiquadFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_FxBiquadFilter_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_COEFF", DSPFX::FxBiquadFilter::PORT_COEFF)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_FxBiquadFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_FxBiquadFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_FxBiquadFilter_Sf_SwigStatic = {
    "FxBiquadFilter",
    swig_FxBiquadFilter_Sf_SwigStatic_methods,
    swig_FxBiquadFilter_Sf_SwigStatic_attributes,
    swig_FxBiquadFilter_Sf_SwigStatic_constants,
    swig_FxBiquadFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_FxBiquadFilter_bases[] = {0,0};
static const char *swig_FxBiquadFilter_base_names[] = {"MonoFXProcessor *",0};
static swig_lua_class _wrap_class_FxBiquadFilter = { "FxBiquadFilter", "FxBiquadFilter", &SWIGTYPE_p_DSPFX__FxBiquadFilter,_proxy__wrap_new_FxBiquadFilter, swig_delete_FxBiquadFilter, swig_FxBiquadFilter_methods, swig_FxBiquadFilter_attributes, &swig_FxBiquadFilter_Sf_SwigStatic, swig_FxBiquadFilter_meta, swig_FxBiquadFilter_bases, swig_FxBiquadFilter_base_names };

static int _wrap_FxRBJFilter_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  RBJFilter *arg2 = (RBJFilter *) 0 ;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::filter",1,"DSPFX::FxRBJFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("DSPFX::FxRBJFilter::filter",2,"RBJFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_filter_set",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_RBJFilter,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("FxRBJFilter_filter_set",2,SWIGTYPE_p_RBJFilter);
  }
...
static int _wrap_FxRBJFilter_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  RBJFilter *result = 0 ;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::filter",1,"DSPFX::FxRBJFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_filter_get",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
...
static int _wrap_FxRBJFilter_Cutoff_set(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::Cutoff",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::Cutoff",1,"DSPFX::FxRBJFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxRBJFilter::Cutoff",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_Cutoff_set",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
...
static int _wrap_FxRBJFilter_Cutoff_get(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::Cutoff",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::Cutoff",1,"DSPFX::FxRBJFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_Cutoff_get",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
...
static int _wrap_FxRBJFilter_Q_set(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::Q",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::Q",1,"DSPFX::FxRBJFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxRBJFilter::Q",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_Q_set",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
...
static int _wrap_FxRBJFilter_Q_get(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::Q",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::Q",1,"DSPFX::FxRBJFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_Q_get",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
...
static int _wrap_new_FxRBJFilter(lua_State* L) {
  int SWIG_arg = 0;
  int arg1 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  DSPFX::FxRBJFilter *result = 0 ;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::FxRBJFilter",3,3)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::FxRBJFilter",1,"int");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxRBJFilter::FxRBJFilter",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("DSPFX::FxRBJFilter::FxRBJFilter",3,"DspFloatType");
  arg1 = (int)lua_tonumber(L, 1);
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  arg3 = (DspFloatType)lua_tonumber(L, 3);
  result = (DSPFX::FxRBJFilter *)new DSPFX::FxRBJFilter(arg1,arg2,arg3);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_DSPFX__FxRBJFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_FxRBJFilter_setType(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  DSPFX::FxRBJFilter::Type arg2 ;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::setType",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::setType",1,"DSPFX::FxRBJFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxRBJFilter::setType",2,"DSPFX::FxRBJFilter::Type");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_setType",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
  
  arg2 = (DSPFX::FxRBJFilter::Type)(int)lua_tonumber(L, 2);
  (arg1)->setType(arg2);
...
static int _wrap_FxRBJFilter_setCutoff(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::setCutoff",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::setCutoff",1,"DSPFX::FxRBJFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxRBJFilter::setCutoff",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_setCutoff",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
...
static int _wrap_FxRBJFilter_setQ(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::setQ",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::setQ",1,"DSPFX::FxRBJFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxRBJFilter::setQ",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_setQ",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
...
static int _wrap_FxRBJFilter_flush(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::flush",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::flush",1,"DSPFX::FxRBJFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_flush",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
...
static int _wrap_FxRBJFilter_setPort(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  int arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("DSPFX::FxRBJFilter::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::setPort",1,"DSPFX::FxRBJFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxRBJFilter::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("DSPFX::FxRBJFilter::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_setPort",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
...
static int _wrap_FxRBJFilter_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("DSPFX::FxRBJFilter::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxRBJFilter::ProcessBlock",1,"DSPFX::FxRBJFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxRBJFilter::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("DSPFX::FxRBJFilter::ProcessBlock",3,"DspFloatType const *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("DSPFX::FxRBJFilter::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxRBJFilter,0))){
    SWIG_fail_ptr("FxRBJFilter_ProcessBlock",1,SWIGTYPE_p_DSPFX__FxRBJFilter);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxRBJFilter_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxRBJFilter_ProcessBlock",4,SWIGTYPE_p_float);
  }
...
static void swig_delete_FxRBJFilter(void *obj) {
DSPFX::FxRBJFilter *arg1 = (DSPFX::FxRBJFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_FxRBJFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_FxRBJFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_FxRBJFilter_attributes[] = {
    { "filter", _wrap_FxRBJFilter_filter_get, _wrap_FxRBJFilter_filter_set },
    { "Cutoff", _wrap_FxRBJFilter_Cutoff_get, _wrap_FxRBJFilter_Cutoff_set },
    { "Q", _wrap_FxRBJFilter_Q_get, _wrap_FxRBJFilter_Q_set },
    {0,0,0}
};
static swig_lua_method swig_FxRBJFilter_methods[]= {
    { "setType", _wrap_FxRBJFilter_setType},
    { "setCutoff", _wrap_FxRBJFilter_setCutoff},
    { "setQ", _wrap_FxRBJFilter_setQ},
    { "flush", _wrap_FxRBJFilter_flush},
    { "setPort", _wrap_FxRBJFilter_setPort},
    { "ProcessBlock", _wrap_FxRBJFilter_ProcessBlock},
    {0,0}
};
static swig_lua_method swig_FxRBJFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_FxRBJFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_FxRBJFilter_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("LOWPASS", DSPFX::FxRBJFilter::LOWPASS)},
    {SWIG_LUA_CONSTTAB_INT("HIGHPASS", DSPFX::FxRBJFilter::HIGHPASS)},
    {SWIG_LUA_CONSTTAB_INT("BANDPASS", DSPFX::FxRBJFilter::BANDPASS)},
    {SWIG_LUA_CONSTTAB_INT("ALLPASS", DSPFX::FxRBJFilter::ALLPASS)},
    {SWIG_LUA_CONSTTAB_INT("NOTCH", DSPFX::FxRBJFilter::NOTCH)},
    {SWIG_LUA_CONSTTAB_INT("PEAK", DSPFX::FxRBJFilter::PEAK)},
    {SWIG_LUA_CONSTTAB_INT("LOW_SHELF", DSPFX::FxRBJFilter::LOW_SHELF)},
    {SWIG_LUA_CONSTTAB_INT("HIGH_SHELF", DSPFX::FxRBJFilter::HIGH_SHELF)},
    {SWIG_LUA_CONSTTAB_INT("N_FILTER_TYPES", DSPFX::FxRBJFilter::N_FILTER_TYPES)},
    {SWIG_LUA_CONSTTAB_INT("PORT_TYPE", DSPFX::FxRBJFilter::PORT_TYPE)},
    {SWIG_LUA_CONSTTAB_INT("PORT_CUTOFF", DSPFX::FxRBJFilter::PORT_CUTOFF)},
    {SWIG_LUA_CONSTTAB_INT("PORT_Q", DSPFX::FxRBJFilter::PORT_Q)},
    {SWIG_LUA_CONSTTAB_INT("PORT_FLUSH", DSPFX::FxRBJFilter::PORT_FLUSH)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_FxRBJFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_FxRBJFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_FxRBJFilter_Sf_SwigStatic = {
    "FxRBJFilter",
    swig_FxRBJFilter_Sf_SwigStatic_methods,
    swig_FxRBJFilter_Sf_SwigStatic_attributes,
    swig_FxRBJFilter_Sf_SwigStatic_constants,
    swig_FxRBJFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_FxRBJFilter_bases[] = {0,0};
static const char *swig_FxRBJFilter_base_names[] = {"MonoFXProcessor *",0};
static swig_lua_class _wrap_class_FxRBJFilter = { "FxRBJFilter", "FxRBJFilter", &SWIGTYPE_p_DSPFX__FxRBJFilter,_proxy__wrap_new_FxRBJFilter, swig_delete_FxRBJFilter, swig_FxRBJFilter_methods, swig_FxRBJFilter_attributes, &swig_FxRBJFilter_Sf_SwigStatic, swig_FxRBJFilter_meta, swig_FxRBJFilter_bases, swig_FxRBJFilter_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("FxBiquadFilter_PORT_COEFF", DSPFX::FxBiquadFilter::PORT_COEFF)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_LOWPASS", DSPFX::FxRBJFilter::LOWPASS)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_HIGHPASS", DSPFX::FxRBJFilter::HIGHPASS)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_BANDPASS", DSPFX::FxRBJFilter::BANDPASS)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_ALLPASS", DSPFX::FxRBJFilter::ALLPASS)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_NOTCH", DSPFX::FxRBJFilter::NOTCH)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_PEAK", DSPFX::FxRBJFilter::PEAK)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_LOW_SHELF", DSPFX::FxRBJFilter::LOW_SHELF)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_HIGH_SHELF", DSPFX::FxRBJFilter::HIGH_SHELF)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_N_FILTER_TYPES", DSPFX::FxRBJFilter::N_FILTER_TYPES)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_PORT_TYPE", DSPFX::FxRBJFilter::PORT_TYPE)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_PORT_CUTOFF", DSPFX::FxRBJFilter::PORT_CUTOFF)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_PORT_Q", DSPFX::FxRBJFilter::PORT_Q)},
    {SWIG_LUA_CONSTTAB_INT("FxRBJFilter_PORT_FLUSH", DSPFX::FxRBJFilter::PORT_FLUSH)},
    {0,0,0,0,0,0}
};
...
&_wrap_class_FxBiquadFilter,
&_wrap_class_FxRBJFilter,
...
static void *_p_DSPFX__FxBiquadFilterTo_p_MonoFXProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoFXProcessor *)  ((DSPFX::FxBiquadFilter *) x));
}
static void *_p_DSPFX__FxRBJFilterTo_p_MonoFXProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoFXProcessor *)  ((DSPFX::FxRBJFilter *) x));
}
...
static void *_p_DSPFX__FxBiquadFilterTo_p_MonoProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoProcessor *) (MonoFXProcessor *) ((DSPFX::FxBiquadFilter *) x));
}
static void *_p_DSPFX__FxRBJFilterTo_p_MonoProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoProcessor *) (MonoFXProcessor *) ((DSPFX::FxRBJFilter *) x));
}
...
static void *_p_DSPFX__FxBiquadFilterTo_p_SoundProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SoundProcessor *) (MonoProcessor *)(MonoFXProcessor *) ((DSPFX::FxBiquadFilter *) x));
}
static void *_p_DSPFX__FxRBJFilterTo_p_SoundProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SoundProcessor *) (MonoProcessor *)(MonoFXProcessor *) ((DSPFX::FxRBJFilter *) x));
}
...
static swig_type_info _swigt__p_DSPFX__FxBiquadFilter = {"_p_DSPFX__FxBiquadFilter", "DSPFX::FxBiquadFilter *", 0, 0, (void*)&_wrap_class_FxBiquadFilter, 0};
static swig_type_info _swigt__p_DSPFX__FxRBJFilter = {"_p_DSPFX__FxRBJFilter", "DSPFX::FxRBJFilter *", 0, 0, (void*)&_wrap_class_FxRBJFilter, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_DSPFX__FxBiquadFilter,
  &_swigt__p_DSPFX__FxRBJFilter,
...
static swig_cast_info _swigc__p_DSPFX__FxBiquadFilter[] = {  {&_swigt__p_DSPFX__FxBiquadFilter, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_DSPFX__FxRBJFilter[] = {  {&_swigt__p_DSPFX__FxRBJFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_MonoFXProcessor[] = {  {&_swigt__p_DSPFX__FxBiquadFilter, _p_DSPFX__FxBiquadFilterTo_p_MonoFXProcessor, 0, 0},  {&_swigt__p_DSPFX__FxRBJFilter, _p_DSPFX__FxRBJFilterTo_p_MonoFXProcessor, 0, 0},  {&_swigt__p_MonoFXProcessor, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_DSPFX__FxBiquadFilter,
  _swigc__p_DSPFX__FxRBJFilter,
