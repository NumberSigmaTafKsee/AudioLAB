...
#define SWIGTYPE_p_PinkNoise2 swig_types[21]
...
#define SWIG_name      "NoiseGenerators"
#define SWIG_init      luaopen_NoiseGenerators
#define SWIG_init_user luaopen_NoiseGenerators_user

#define SWIG_LUACODE   luaopen_NoiseGenerators_luacode
...
static int _wrap_WhiteNoise(lua_State* L) {
  ...
  SWIG_check_num_args("WhiteNoise",0,0)
  result = (float)WhiteNoise();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_new_PinkNoise2(lua_State* L) {
  int SWIG_arg = 0;
  PinkNoise2 *result = 0 ;
  
  SWIG_check_num_args("PinkNoise2::PinkNoise2",0,0)
  result = (PinkNoise2 *)new PinkNoise2();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_PinkNoise2,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_PinkNoise2_clear(lua_State* L) {
  int SWIG_arg = 0;
  PinkNoise2 *arg1 = (PinkNoise2 *) 0 ;
  
  SWIG_check_num_args("PinkNoise2::clear",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("PinkNoise2::clear",1,"PinkNoise2 *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_PinkNoise2,0))){
    SWIG_fail_ptr("PinkNoise2_clear",1,SWIGTYPE_p_PinkNoise2);
  }
...
static int _wrap_PinkNoise2_tick(lua_State* L) {
  int SWIG_arg = 0;
  PinkNoise2 *arg1 = (PinkNoise2 *) 0 ;
  float result;
  
  SWIG_check_num_args("PinkNoise2::tick",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("PinkNoise2::tick",1,"PinkNoise2 *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_PinkNoise2,0))){
    SWIG_fail_ptr("PinkNoise2_tick",1,SWIGTYPE_p_PinkNoise2);
  }
...
static void swig_delete_PinkNoise2(void *obj) {
PinkNoise2 *arg1 = (PinkNoise2 *) obj;
delete arg1;
}
static int _proxy__wrap_new_PinkNoise2(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_PinkNoise2);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_PinkNoise2_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_PinkNoise2_methods[]= {
    { "clear", _wrap_PinkNoise2_clear},
    { "tick", _wrap_PinkNoise2_tick},
    {0,0}
};
static swig_lua_method swig_PinkNoise2_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_PinkNoise2_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_PinkNoise2_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_PinkNoise2_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_PinkNoise2_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_PinkNoise2_Sf_SwigStatic = {
    "PinkNoise2",
    swig_PinkNoise2_Sf_SwigStatic_methods,
    swig_PinkNoise2_Sf_SwigStatic_attributes,
    swig_PinkNoise2_Sf_SwigStatic_constants,
    swig_PinkNoise2_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_PinkNoise2_bases[] = {0};
static const char *swig_PinkNoise2_base_names[] = {0};
static swig_lua_class _wrap_class_PinkNoise2 = { "PinkNoise2", "PinkNoise2", &SWIGTYPE_p_PinkNoise2,_proxy__wrap_new_PinkNoise2, swig_delete_PinkNoise2, swig_PinkNoise2_methods, swig_PinkNoise2_attributes, &swig_PinkNoise2_Sf_SwigStatic, swig_PinkNoise2_meta, swig_PinkNoise2_bases, swig_PinkNoise2_base_names };

static int _wrap_Pink(lua_State* L) {
  int SWIG_arg = 0;
  float result;
  
  SWIG_check_num_args("Pink",0,0)
  result = (float)Pink();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_GaussianWhiteNoise(lua_State* L) {
  ...
  SWIG_check_num_args("GaussianWhiteNoise",0,0)
  result = (float)GaussianWhiteNoise();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_GaussRand(lua_State* L) {
  ...
  SWIG_check_num_args("GaussRand",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("GaussRand",1,"int");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("GaussRand",2,"float");
  arg1 = (int)lua_tonumber(L, 1);
  arg2 = (float)lua_tonumber(L, 2);
  result = (float)GaussRand(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_PinkNoise(lua_State* L) {
  int SWIG_arg = 0;
  float result;
  
  SWIG_check_num_args("PinkNoise",0,0)
  result = (float)PinkNoise();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_BrownNoise(lua_State* L) {
  int SWIG_arg = 0;
  float result;
  
  SWIG_check_num_args("BrownNoise",0,0)
  result = (float)BrownNoise();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static swig_lua_method swig_SwigModule_methods[]= {
    ...
    { "PinkNoise", _wrap_PinkNoise},
    { "BrownNoise", _wrap_BrownNoise},
    {0,0}
};
...
static swig_type_info _swigt__p_PinkNoise2 = {"_p_PinkNoise2", "PinkNoise2 *", 0, 0, (void*)&_wrap_class_PinkNoise2, 0};
...
static swig_cast_info _swigc__p_PinkNoise2[] = {  {&_swigt__p_PinkNoise2, 0, 0, 0},{0, 0, 0, 0}};
