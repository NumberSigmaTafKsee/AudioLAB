...
#define SWIGTYPE_p_ATK__RemezBasedCoefficientsT_DspFloatType_t swig_types[0]
#define SWIGTYPE_p_AmplifierProcessor swig_types[1]
#define SWIGTYPE_p_FilterProcessor swig_types[2]
#define SWIGTYPE_p_Filters__AudioTK__EQ__RemezBasedFilter swig_types[3]
...
#define SWIGTYPE_p_std__vectorT_std__pairT_std__pairT_float_float_t_std__pairT_float_float_t_t_t swig_types[92]
...
#define SWIG_name      "ATKRemezFilter"
#define SWIG_init      luaopen_ATKRemezFilter
#define SWIG_init_user luaopen_ATKRemezFilter_user

#define SWIG_LUACODE   luaopen_ATKRemezFilter_luacode
...
static int _wrap_RemezBasedFilter_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::RemezBasedFilter *arg1 = (Filters::AudioTK::EQ::RemezBasedFilter *) 0 ;
  ATK::RemezBasedCoefficients< DspFloatType > *arg2 = (ATK::RemezBasedCoefficients< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::RemezBasedFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::RemezBasedFilter::filter",1,"Filters::AudioTK::EQ::RemezBasedFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::EQ::RemezBasedFilter::filter",2,"ATK::RemezBasedCoefficients< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__RemezBasedFilter,0))){
    SWIG_fail_ptr("RemezBasedFilter_filter_set",1,SWIGTYPE_p_Filters__AudioTK__EQ__RemezBasedFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__RemezBasedCoefficientsT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("RemezBasedFilter_filter_set",2,SWIGTYPE_p_ATK__RemezBasedCoefficientsT_DspFloatType_t);
  }
...
static int _wrap_RemezBasedFilter_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::RemezBasedFilter *arg1 = (Filters::AudioTK::EQ::RemezBasedFilter *) 0 ;
  ATK::RemezBasedCoefficients< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::RemezBasedFilter::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::RemezBasedFilter::filter",1,"Filters::AudioTK::EQ::RemezBasedFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__RemezBasedFilter,0))){
    SWIG_fail_ptr("RemezBasedFilter_filter_get",1,SWIGTYPE_p_Filters__AudioTK__EQ__RemezBasedFilter);
  }
  
  result = (ATK::RemezBasedCoefficients< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__RemezBasedCoefficientsT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_RemezBasedFilter(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::RemezBasedFilter *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::RemezBasedFilter::RemezBasedFilter",0,0)
  result = (Filters::AudioTK::EQ::RemezBasedFilter *)new Filters::AudioTK::EQ::RemezBasedFilter();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__EQ__RemezBasedFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_RemezBasedFilter_setTemplate(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::RemezBasedFilter *arg1 = (Filters::AudioTK::EQ::RemezBasedFilter *) 0 ;
  std::vector< std::pair< std::pair< DspFloatType,DspFloatType >,std::pair< DspFloatType,DspFloatType > > > *arg2 = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::RemezBasedFilter::setTemplate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::RemezBasedFilter::setTemplate",1,"Filters::AudioTK::EQ::RemezBasedFilter *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("Filters::AudioTK::EQ::RemezBasedFilter::setTemplate",2,"std::vector< std::pair< std::pair< DspFloatType,DspFloatType >,std::pair< DspFloatType,DspFloatType > > > &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__RemezBasedFilter,0))){
    SWIG_fail_ptr("RemezBasedFilter_setTemplate",1,SWIGTYPE_p_Filters__AudioTK__EQ__RemezBasedFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__vectorT_std__pairT_std__pairT_float_float_t_std__pairT_float_float_t_t_t,0))){
    SWIG_fail_ptr("RemezBasedFilter_setTemplate",2,SWIGTYPE_p_std__vectorT_std__pairT_std__pairT_float_float_t_std__pairT_float_float_t_t_t);
  }
  
  (arg1)->setTemplate(*arg2);
...
static void swig_delete_RemezBasedFilter(void *obj) {
Filters::AudioTK::EQ::RemezBasedFilter *arg1 = (Filters::AudioTK::EQ::RemezBasedFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_RemezBasedFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_RemezBasedFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_RemezBasedFilter_attributes[] = {
    { "filter", _wrap_RemezBasedFilter_filter_get, _wrap_RemezBasedFilter_filter_set },
    {0,0,0}
};
static swig_lua_method swig_RemezBasedFilter_methods[]= {
    { "setTemplate", _wrap_RemezBasedFilter_setTemplate},
    {0,0}
};
static swig_lua_method swig_RemezBasedFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_RemezBasedFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_RemezBasedFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_RemezBasedFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_RemezBasedFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_RemezBasedFilter_Sf_SwigStatic = {
    "RemezBasedFilter",
    swig_RemezBasedFilter_Sf_SwigStatic_methods,
    swig_RemezBasedFilter_Sf_SwigStatic_attributes,
    swig_RemezBasedFilter_Sf_SwigStatic_constants,
    swig_RemezBasedFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_RemezBasedFilter_bases[] = {0};
static const char *swig_RemezBasedFilter_base_names[] = {0};
static swig_lua_class _wrap_class_RemezBasedFilter = { "RemezBasedFilter", "RemezBasedFilter", &SWIGTYPE_p_Filters__AudioTK__EQ__RemezBasedFilter,_proxy__wrap_new_RemezBasedFilter, swig_delete_RemezBasedFilter, swig_RemezBasedFilter_methods, swig_RemezBasedFilter_attributes, &swig_RemezBasedFilter_Sf_SwigStatic, swig_RemezBasedFilter_meta, swig_RemezBasedFilter_bases, swig_RemezBasedFilter_base_names };
...
static swig_type_info _swigt__p_ATK__RemezBasedCoefficientsT_DspFloatType_t = {"_p_ATK__RemezBasedCoefficientsT_DspFloatType_t", "ATK::RemezBasedCoefficients< DspFloatType > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_Filters__AudioTK__EQ__RemezBasedFilter = {"_p_Filters__AudioTK__EQ__RemezBasedFilter", "Filters::AudioTK::EQ::RemezBasedFilter *", 0, 0, (void*)&_wrap_class_RemezBasedFilter, 0};
...
static swig_type_info _swigt__p_std__vectorT_std__pairT_std__pairT_float_float_t_std__pairT_float_float_t_t_t = {"_p_std__vectorT_std__pairT_std__pairT_float_float_t_std__pairT_float_float_t_t_t", "std::vector< std::pair< std::pair< float,float >,std::pair< float,float > > > *|std::vector< std::pair< std::pair< DspFloatType,DspFloatType >,std::pair< DspFloatType,DspFloatType > > > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ATK__RemezBasedCoefficientsT_DspFloatType_t,
  &_swigt__p_AmplifierProcessor,
  &_swigt__p_FilterProcessor,
  &_swigt__p_Filters__AudioTK__EQ__RemezBasedFilter,
  ...
  &_swigt__p_std__vectorT_std__pairT_std__pairT_float_float_t_std__pairT_float_float_t_t_t,
...
static swig_cast_info _swigc__p_ATK__RemezBasedCoefficientsT_DspFloatType_t[] = {  {&_swigt__p_ATK__RemezBasedCoefficientsT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_Filters__AudioTK__EQ__RemezBasedFilter[] = {  {&_swigt__p_Filters__AudioTK__EQ__RemezBasedFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__vectorT_std__pairT_std__pairT_float_float_t_std__pairT_float_float_t_t_t[] = {  {&_swigt__p_std__vectorT_std__pairT_std__pairT_float_float_t_std__pairT_float_float_t_t_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ATK__RemezBasedCoefficientsT_DspFloatType_t,
  _swigc__p_AmplifierProcessor,
  _swigc__p_FilterProcessor,
  _swigc__p_Filters__AudioTK__EQ__RemezBasedFilter,
  ...
  _swigc__p_std__vectorT_std__pairT_std__pairT_float_float_t_std__pairT_float_float_t_t_t,
