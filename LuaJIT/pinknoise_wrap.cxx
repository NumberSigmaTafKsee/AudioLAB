...
#define SWIGTYPE_p_PinkNoise swig_types[21]
...
#define SWIG_name      "pinknoise"
#define SWIG_init      luaopen_pinknoise
#define SWIG_init_user luaopen_pinknoise_user

#define SWIG_LUACODE   luaopen_pinknoise_luacode
...
static int _wrap_PinkNoise_clear(lua_State* L) {
  ...
  SWIG_check_num_args("PinkNoise::clear",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("PinkNoise::clear",1,"PinkNoise *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_PinkNoise,0))){
    SWIG_fail_ptr("PinkNoise_clear",1,SWIGTYPE_p_PinkNoise);
  }
...
static int _wrap_PinkNoise_tick(lua_State* L) {
  ...
  SWIG_check_num_args("PinkNoise::tick",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("PinkNoise::tick",1,"PinkNoise *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_PinkNoise,0))){
    SWIG_fail_ptr("PinkNoise_tick",1,SWIGTYPE_p_PinkNoise);
  }
