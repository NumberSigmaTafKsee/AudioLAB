...
#define SWIG_name      "AudioEffects"
#define SWIG_init      luaopen_AudioEffects
#define SWIG_init_user luaopen_AudioEffects_user

#define SWIG_LUACODE   luaopen_AudioEffects_luacode
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("kWaveformSine", FX::kWaveformSine)},
    {SWIG_LUA_CONSTTAB_INT("kWaveformTriangle", FX::kWaveformTriangle)},
    {SWIG_LUA_CONSTTAB_INT("kWaveformSquare", FX::kWaveformSquare)},
    {SWIG_LUA_CONSTTAB_INT("kWaveformSquareSlopedEdges", FX::kWaveformSquareSlopedEdges)},
    {SWIG_LUA_CONSTTAB_INT("kWaveformSaw", FX::kWaveformSaw)},
    {SWIG_LUA_CONSTTAB_INT("kWaveformReverseSaw", FX::kWaveformReverseSaw)},
    {SWIG_LUA_CONSTTAB_INT("kWaveformRandomPhase", FX::kWaveformRandomPhase)},
    {SWIG_LUA_CONSTTAB_INT("kWaveformRandom", FX::kWaveformRandom)},
    {SWIG_LUA_CONSTTAB_INT("kWaveformTangent", FX::kWaveformTangent)},
    {SWIG_LUA_CONSTTAB_INT("kNumWaveforms", FX::kNumWaveforms)},
    {SWIG_LUA_CONSTTAB_INT("kInterpolationNearestNeighbour", FX::kInterpolationNearestNeighbour)},
    {SWIG_LUA_CONSTTAB_INT("kInterpolationLinear", FX::kInterpolationLinear)},
    {SWIG_LUA_CONSTTAB_INT("kInterpolationCubic", FX::kInterpolationCubic)},
    {SWIG_LUA_CONSTTAB_INT("kNumInterpolations", FX::kNumInterpolations)},
    {0,0,0,0,0,0}
};
