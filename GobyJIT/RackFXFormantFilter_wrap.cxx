...
#define SWIGTYPE_p_FX__RackFX__FormantFilter swig_types[1]
#define SWIGTYPE_p_FilterParams swig_types[2]
...
#define SWIG_name      "RackFXFormantFilter"
#define SWIG_init      luaopen_RackFXFormantFilter
#define SWIG_init_user luaopen_RackFXFormantFilter_user

#define SWIG_LUACODE   luaopen_RackFXFormantFilter_luacode
...
static int _wrap_new_FormantFilter(lua_State* L) {
  int SWIG_arg = 0;
  FilterParams *arg1 = (FilterParams *) 0 ;
  FX::RackFX::FormantFilter *result = 0 ;
  
  SWIG_check_num_args("FX::RackFX::FormantFilter::FormantFilter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::FormantFilter::FormantFilter",1,"FilterParams *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FilterParams,0))){
    SWIG_fail_ptr("new_FormantFilter",1,SWIGTYPE_p_FilterParams);
  }
  
  result = (FX::RackFX::FormantFilter *)new FX::RackFX::FormantFilter(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__RackFX__FormantFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_FormantFilter_filterout(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::FormantFilter *arg1 = (FX::RackFX::FormantFilter *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  
  SWIG_check_num_args("FX::RackFX::FormantFilter::filterout",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::FormantFilter::filterout",1,"FX::RackFX::FormantFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::RackFX::FormantFilter::filterout",2,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__FormantFilter,0))){
    SWIG_fail_ptr("FormantFilter_filterout",1,SWIGTYPE_p_FX__RackFX__FormantFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FormantFilter_filterout",2,SWIGTYPE_p_float);
  }
...
static int _wrap_FormantFilter_setfreq(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::FormantFilter *arg1 = (FX::RackFX::FormantFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::RackFX::FormantFilter::setfreq",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::FormantFilter::setfreq",1,"FX::RackFX::FormantFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::RackFX::FormantFilter::setfreq",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__FormantFilter,0))){
    SWIG_fail_ptr("FormantFilter_setfreq",1,SWIGTYPE_p_FX__RackFX__FormantFilter);
  }
...
static int _wrap_FormantFilter_setfreq_and_q(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::FormantFilter *arg1 = (FX::RackFX::FormantFilter *) 0 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("FX::RackFX::FormantFilter::setfreq_and_q",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::FormantFilter::setfreq_and_q",1,"FX::RackFX::FormantFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::RackFX::FormantFilter::setfreq_and_q",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("FX::RackFX::FormantFilter::setfreq_and_q",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__FormantFilter,0))){
    SWIG_fail_ptr("FormantFilter_setfreq_and_q",1,SWIGTYPE_p_FX__RackFX__FormantFilter);
  }
...
static int _wrap_FormantFilter_setq(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::FormantFilter *arg1 = (FX::RackFX::FormantFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::RackFX::FormantFilter::setq",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::FormantFilter::setq",1,"FX::RackFX::FormantFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::RackFX::FormantFilter::setq",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__FormantFilter,0))){
    SWIG_fail_ptr("FormantFilter_setq",1,SWIGTYPE_p_FX__RackFX__FormantFilter);
  }
...
static int _wrap_FormantFilter_cleanup(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::FormantFilter *arg1 = (FX::RackFX::FormantFilter *) 0 ;
  
  SWIG_check_num_args("FX::RackFX::FormantFilter::cleanup",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::FormantFilter::cleanup",1,"FX::RackFX::FormantFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__FormantFilter,0))){
    SWIG_fail_ptr("FormantFilter_cleanup",1,SWIGTYPE_p_FX__RackFX__FormantFilter);
  }
...
static void swig_delete_FormantFilter(void *obj) {
FX::RackFX::FormantFilter *arg1 = (FX::RackFX::FormantFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_FormantFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_FormantFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_FormantFilter_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_FormantFilter_methods[]= {
    { "filterout", _wrap_FormantFilter_filterout},
    { "setfreq", _wrap_FormantFilter_setfreq},
    { "setfreq_and_q", _wrap_FormantFilter_setfreq_and_q},
    { "setq", _wrap_FormantFilter_setq},
    { "cleanup", _wrap_FormantFilter_cleanup},
    {0,0}
};
static swig_lua_method swig_FormantFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_FormantFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_FormantFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_FormantFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_FormantFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_FormantFilter_Sf_SwigStatic = {
    "FormantFilter",
    swig_FormantFilter_Sf_SwigStatic_methods,
    swig_FormantFilter_Sf_SwigStatic_attributes,
    swig_FormantFilter_Sf_SwigStatic_constants,
    swig_FormantFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_FormantFilter_bases[] = {0};
static const char *swig_FormantFilter_base_names[] = {0};
static swig_lua_class _wrap_class_FormantFilter = { "FormantFilter", "FormantFilter", &SWIGTYPE_p_FX__RackFX__FormantFilter,_proxy__wrap_new_FormantFilter, swig_delete_FormantFilter, swig_FormantFilter_methods, swig_FormantFilter_attributes, &swig_FormantFilter_Sf_SwigStatic, swig_FormantFilter_meta, swig_FormantFilter_bases, swig_FormantFilter_base_names };
...
static swig_type_info _swigt__p_FX__RackFX__FormantFilter = {"_p_FX__RackFX__FormantFilter", "FX::RackFX::FormantFilter *", 0, 0, (void*)&_wrap_class_FormantFilter, 0};
static swig_type_info _swigt__p_FilterParams = {"_p_FilterParams", "FilterParams *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FX__RackFX__FormantFilter,
  &_swigt__p_FilterParams,
...
static swig_cast_info _swigc__p_FX__RackFX__FormantFilter[] = {  {&_swigt__p_FX__RackFX__FormantFilter, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FilterParams[] = {  {&_swigt__p_FilterParams, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FX__RackFX__FormantFilter,
  _swigc__p_FilterParams,
