...
#define SWIGTYPE_p_DSPFX__FxFIRFilter swig_types[1]
#define SWIGTYPE_p_FIRFilter swig_types[2]
...
#define SWIG_name      "FxDSPFIRFilter"
#define SWIG_init      luaopen_FxDSPFIRFilter
#define SWIG_init_user luaopen_FxDSPFIRFilter_user

#define SWIG_LUACODE   luaopen_FxDSPFIRFilter_luacode
...
static int _wrap_FxFIRFilter_fir_set(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxFIRFilter *arg1 = (DSPFX::FxFIRFilter *) 0 ;
  FIRFilter *arg2 = (FIRFilter *) 0 ;
  
  SWIG_check_num_args("DSPFX::FxFIRFilter::fir",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxFIRFilter::fir",1,"DSPFX::FxFIRFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("DSPFX::FxFIRFilter::fir",2,"FIRFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxFIRFilter,0))){
    SWIG_fail_ptr("FxFIRFilter_fir_set",1,SWIGTYPE_p_DSPFX__FxFIRFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_FIRFilter,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("FxFIRFilter_fir_set",2,SWIGTYPE_p_FIRFilter);
  }
...
static int _wrap_FxFIRFilter_fir_get(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxFIRFilter *arg1 = (DSPFX::FxFIRFilter *) 0 ;
  FIRFilter *result = 0 ;
  
  SWIG_check_num_args("DSPFX::FxFIRFilter::fir",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxFIRFilter::fir",1,"DSPFX::FxFIRFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxFIRFilter,0))){
    SWIG_fail_ptr("FxFIRFilter_fir_get",1,SWIGTYPE_p_DSPFX__FxFIRFilter);
  }
  
  result = (FIRFilter *) ((arg1)->fir);
...
static int _wrap_new_FxFIRFilter(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType *arg1 = (DspFloatType *) 0 ;
  size_t arg2 ;
  int arg3 ;
  DSPFX::FxFIRFilter *result = 0 ;
  
  SWIG_check_num_args("DSPFX::FxFIRFilter::FxFIRFilter",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxFIRFilter::FxFIRFilter",1,"DspFloatType *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxFIRFilter::FxFIRFilter",2,"size_t");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("DSPFX::FxFIRFilter::FxFIRFilter",3,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("new_FxFIRFilter",1,SWIGTYPE_p_float);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative");
  arg2 = (size_t)lua_tonumber(L, 2);
  arg3 = (int)lua_tonumber(L, 3);
  result = (DSPFX::FxFIRFilter *)new DSPFX::FxFIRFilter(arg1,arg2,arg3);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_DSPFX__FxFIRFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_FxFIRFilter_flush(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxFIRFilter *arg1 = (DSPFX::FxFIRFilter *) 0 ;
  
  SWIG_check_num_args("DSPFX::FxFIRFilter::flush",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxFIRFilter::flush",1,"DSPFX::FxFIRFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxFIRFilter,0))){
    SWIG_fail_ptr("FxFIRFilter_flush",1,SWIGTYPE_p_DSPFX__FxFIRFilter);
  }
...
static int _wrap_FxFIRFilter_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxFIRFilter *arg1 = (DSPFX::FxFIRFilter *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("DSPFX::FxFIRFilter::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxFIRFilter::ProcessBlock",1,"DSPFX::FxFIRFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxFIRFilter::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("DSPFX::FxFIRFilter::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("DSPFX::FxFIRFilter::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxFIRFilter,0))){
    SWIG_fail_ptr("FxFIRFilter_ProcessBlock",1,SWIGTYPE_p_DSPFX__FxFIRFilter);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxFIRFilter_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxFIRFilter_ProcessBlock",4,SWIGTYPE_p_float);
  }
...
static int _wrap_FxFIRFilter_updateKernel(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxFIRFilter *arg1 = (DSPFX::FxFIRFilter *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  
  SWIG_check_num_args("DSPFX::FxFIRFilter::updateKernel",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxFIRFilter::updateKernel",1,"DSPFX::FxFIRFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("DSPFX::FxFIRFilter::updateKernel",2,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxFIRFilter,0))){
    SWIG_fail_ptr("FxFIRFilter_updateKernel",1,SWIGTYPE_p_DSPFX__FxFIRFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxFIRFilter_updateKernel",2,SWIGTYPE_p_float);
  }
  
  (arg1)->updateKernel(arg2);
...
static int _wrap_FxFIRFilter_setPortV(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxFIRFilter *arg1 = (DSPFX::FxFIRFilter *) 0 ;
  int arg2 ;
  std::vector< DspFloatType > *arg3 = 0 ;
  
  SWIG_check_num_args("DSPFX::FxFIRFilter::setPortV",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxFIRFilter::setPortV",1,"DSPFX::FxFIRFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxFIRFilter::setPortV",2,"int");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("DSPFX::FxFIRFilter::setPortV",3,"std::vector< DspFloatType > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxFIRFilter,0))){
    SWIG_fail_ptr("FxFIRFilter_setPortV",1,SWIGTYPE_p_DSPFX__FxFIRFilter);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("FxFIRFilter_setPortV",3,SWIGTYPE_p_std__vectorT_float_t);
  }
...
static void swig_delete_FxFIRFilter(void *obj) {
DSPFX::FxFIRFilter *arg1 = (DSPFX::FxFIRFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_FxFIRFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_FxFIRFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_FxFIRFilter_attributes[] = {
    { "fir", _wrap_FxFIRFilter_fir_get, _wrap_FxFIRFilter_fir_set },
    {0,0,0}
};
static swig_lua_method swig_FxFIRFilter_methods[]= {
    { "flush", _wrap_FxFIRFilter_flush},
    { "ProcessBlock", _wrap_FxFIRFilter_ProcessBlock},
    { "updateKernel", _wrap_FxFIRFilter_updateKernel},
    { "setPortV", _wrap_FxFIRFilter_setPortV},
    {0,0}
};
static swig_lua_method swig_FxFIRFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_FxFIRFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_FxFIRFilter_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("BEST", DSPFX::FxFIRFilter::BEST)},
    {SWIG_LUA_CONSTTAB_INT("DIRECT", DSPFX::FxFIRFilter::DIRECT)},
    {SWIG_LUA_CONSTTAB_INT("FFT", DSPFX::FxFIRFilter::FFT)},
    {SWIG_LUA_CONSTTAB_INT("PORT_KERNEL", DSPFX::FxFIRFilter::PORT_KERNEL)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_FxFIRFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_FxFIRFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_FxFIRFilter_Sf_SwigStatic = {
    "FxFIRFilter",
    swig_FxFIRFilter_Sf_SwigStatic_methods,
    swig_FxFIRFilter_Sf_SwigStatic_attributes,
    swig_FxFIRFilter_Sf_SwigStatic_constants,
    swig_FxFIRFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_FxFIRFilter_bases[] = {0,0};
static const char *swig_FxFIRFilter_base_names[] = {"MonoFXProcessor *",0};
static swig_lua_class _wrap_class_FxFIRFilter = { "FxFIRFilter", "FxFIRFilter", &SWIGTYPE_p_DSPFX__FxFIRFilter,_proxy__wrap_new_FxFIRFilter, swig_delete_FxFIRFilter, swig_FxFIRFilter_methods, swig_FxFIRFilter_attributes, &swig_FxFIRFilter_Sf_SwigStatic, swig_FxFIRFilter_meta, swig_FxFIRFilter_bases, swig_FxFIRFilter_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("FxFIRFilter_BEST", DSPFX::FxFIRFilter::BEST)},
    {SWIG_LUA_CONSTTAB_INT("FxFIRFilter_DIRECT", DSPFX::FxFIRFilter::DIRECT)},
    {SWIG_LUA_CONSTTAB_INT("FxFIRFilter_FFT", DSPFX::FxFIRFilter::FFT)},
    {SWIG_LUA_CONSTTAB_INT("FxFIRFilter_PORT_KERNEL", DSPFX::FxFIRFilter::PORT_KERNEL)},
    {0,0,0,0,0,0}
};
...
static void *_p_DSPFX__FxFIRFilterTo_p_MonoFXProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoFXProcessor *)  ((DSPFX::FxFIRFilter *) x));
}
...
static void *_p_DSPFX__FxFIRFilterTo_p_MonoProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoProcessor *) (MonoFXProcessor *) ((DSPFX::FxFIRFilter *) x));
}
...
static void *_p_DSPFX__FxFIRFilterTo_p_SoundProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SoundProcessor *) (MonoProcessor *)(MonoFXProcessor *) ((DSPFX::FxFIRFilter *) x));
}
...
static swig_type_info _swigt__p_DSPFX__FxFIRFilter = {"_p_DSPFX__FxFIRFilter", "DSPFX::FxFIRFilter *", 0, 0, (void*)&_wrap_class_FxFIRFilter, 0};
...
static swig_cast_info _swigc__p_DSPFX__FxFIRFilter[] = {  {&_swigt__p_DSPFX__FxFIRFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_MonoFXProcessor[] = {  {&_swigt__p_DSPFX__FxFIRFilter, _p_DSPFX__FxFIRFilterTo_p_MonoFXProcessor, 0, 0},  {&_swigt__p_MonoFXProcessor, 0, 0, 0},{0, 0, 0, 0}};
