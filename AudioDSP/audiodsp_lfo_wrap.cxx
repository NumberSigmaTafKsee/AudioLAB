...
#define SWIGTYPE_p_phase_t swig_types[47]
...
#define SWIGTYPE_p_waveform_t swig_types[86]
...
static int _wrap_new_LFO(lua_State* L) {
  ...
  if(!lua_isnumber(L,1)) SWIG_fail_arg("LFO::LFO",1,"DspFloatType");
...
static int _wrap_LFO_setRate(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("LFO::setRate",2,"DspFloatType const");
...
static int _wrap_LFO_setSampleRate(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("LFO::setSampleRate",2,"DspFloatType const");
...
static int _wrap_k1Div24lowerBits_get(lua_State* L) {
  ...
  result = (DspFloatType)(DspFloatType)k1Div24lowerBits;
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
