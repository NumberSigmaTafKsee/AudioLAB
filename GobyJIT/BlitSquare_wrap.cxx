...
#define SWIGTYPE_p_Analog__Oscillators__BlitSquare swig_types[1]
...
#define SWIG_name      "BlitSquare"
#define SWIG_init      luaopen_BlitSquare
#define SWIG_init_user luaopen_BlitSquare_user

#define SWIG_LUACODE   luaopen_BlitSquare_luacode
...
static int _wrap_BlitSquare_setPhase(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::Oscillators::BlitSquare::setPhase",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::Oscillators::BlitSquare::setPhase",1,"Analog::Oscillators::BlitSquare *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::Oscillators::BlitSquare::setPhase",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__Oscillators__BlitSquare,0))){
    SWIG_fail_ptr("BlitSquare_setPhase",1,SWIGTYPE_p_Analog__Oscillators__BlitSquare);
  }
...
static int _wrap_BlitSquare_getPhase(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::Oscillators::BlitSquare::getPhase",1,"Analog::Oscillators::BlitSquare const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__Oscillators__BlitSquare,0))){
    SWIG_fail_ptr("BlitSquare_getPhase",1,SWIGTYPE_p_Analog__Oscillators__BlitSquare);
  }
  
  result = (DspFloatType)((Analog::Oscillators::BlitSquare const *)arg1)->getPhase();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static swig_cast_info _swigc__p_OscillatorProcessor[] = {  {&_swigt__p_Analog__Oscillators__BlitSquare, _p_Analog__Oscillators__BlitSquareTo_p_OscillatorProcessor, 0, 0},  {&_swigt__p_OscillatorProcessor, 0, 0, 0},{0, 0, 0, 0}};
