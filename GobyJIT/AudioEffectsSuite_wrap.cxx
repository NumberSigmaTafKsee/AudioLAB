...
#define SWIG_name      "AudioEffectsSuite"
#define SWIG_init      luaopen_AudioEffectsSuite
#define SWIG_init_user luaopen_AudioEffectsSuite_user

#define SWIG_LUACODE   luaopen_AudioEffectsSuite_luacode
...
static int _wrap_TimeToSamples(lua_State* L) {
  int SWIG_arg = 0;
  float arg1 ;
  float arg2 ;
  float result;
  
  SWIG_check_num_args("TimeToSamples",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("TimeToSamples",1,"float");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("TimeToSamples",2,"float");
  arg1 = (float)lua_tonumber(L, 1);
  arg2 = (float)lua_tonumber(L, 2);
  result = (float)TimeToSamples(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static swig_lua_method swig_SwigModule_methods[]= {
    ...
    { "TimeToSamples", _wrap_TimeToSamples},
    {0,0}
};
