...
static int _wrap_RandomMersenne_randint(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Std::RandomMersenne::randint",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Std::RandomMersenne::randint",3,"int");
...
static int _wrap_RandomMersenne64_randint(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Std::RandomMersenne64::randint",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Std::RandomMersenne64::randint",3,"int");
...
static int _wrap_RandomRanLux24_randint(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Std::RandomRanLux24::randint",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Std::RandomRanLux24::randint",3,"int");
...
static int _wrap_RandomRanLux48_randint(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Std::RandomRanLux48::randint",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Std::RandomRanLux48::randint",3,"int");
...
static int _wrap_RandomKnuth_randint(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Std::RandomKnuth::randint",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Std::RandomKnuth::randint",3,"int");
