...
#define SWIGTYPE_p_TSClipper swig_types[39]
...
#define SWIG_name      "TSClipper"
#define SWIG_init      luaopen_TSClipper
#define SWIG_init_user luaopen_TSClipper_user

#define SWIG_LUACODE   luaopen_TSClipper_luacode
...
static int _wrap_new_TSClipper(lua_State* L) {
  int SWIG_arg = 0;
  TSClipper *result = 0 ;
  
  SWIG_check_num_args("TSClipper::TSClipper",0,0)
  result = (TSClipper *)new TSClipper();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_TSClipper,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_TSClipper_prepare(lua_State* L) {
  int SWIG_arg = 0;
  TSClipper *arg1 = (TSClipper *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("TSClipper::prepare",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("TSClipper::prepare",1,"TSClipper *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("TSClipper::prepare",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_TSClipper,0))){
    SWIG_fail_ptr("TSClipper_prepare",1,SWIGTYPE_p_TSClipper);
  }
...
static int _wrap_TSClipper_processSample(lua_State* L) {
  int SWIG_arg = 0;
  TSClipper *arg1 = (TSClipper *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("TSClipper::processSample",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("TSClipper::processSample",1,"TSClipper *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("TSClipper::processSample",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_TSClipper,0))){
    SWIG_fail_ptr("TSClipper_processSample",1,SWIGTYPE_p_TSClipper);
  }
...
static int _wrap_TSClipper_setKnob(lua_State* L) {
  int SWIG_arg = 0;
  TSClipper *arg1 = (TSClipper *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("TSClipper::setKnob",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("TSClipper::setKnob",1,"TSClipper *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("TSClipper::setKnob",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_TSClipper,0))){
    SWIG_fail_ptr("TSClipper_setKnob",1,SWIGTYPE_p_TSClipper);
  }
...
static void swig_delete_TSClipper(void *obj) {
TSClipper *arg1 = (TSClipper *) obj;
delete arg1;
}
static int _proxy__wrap_new_TSClipper(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_TSClipper);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_TSClipper_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_TSClipper_methods[]= {
    { "prepare", _wrap_TSClipper_prepare},
    { "processSample", _wrap_TSClipper_processSample},
    { "setKnob", _wrap_TSClipper_setKnob},
    {0,0}
};
static swig_lua_method swig_TSClipper_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_TSClipper_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_TSClipper_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_TSClipper_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_TSClipper_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_TSClipper_Sf_SwigStatic = {
    "TSClipper",
    swig_TSClipper_Sf_SwigStatic_methods,
    swig_TSClipper_Sf_SwigStatic_attributes,
    swig_TSClipper_Sf_SwigStatic_constants,
    swig_TSClipper_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_TSClipper_bases[] = {0};
static const char *swig_TSClipper_base_names[] = {0};
static swig_lua_class _wrap_class_TSClipper = { "TSClipper", "TSClipper", &SWIGTYPE_p_TSClipper,_proxy__wrap_new_TSClipper, swig_delete_TSClipper, swig_TSClipper_methods, swig_TSClipper_attributes, &swig_TSClipper_Sf_SwigStatic, swig_TSClipper_meta, swig_TSClipper_bases, swig_TSClipper_base_names };
...
static swig_type_info _swigt__p_TSClipper = {"_p_TSClipper", "TSClipper *", 0, 0, (void*)&_wrap_class_TSClipper, 0};
...
static swig_cast_info _swigc__p_TSClipper[] = {  {&_swigt__p_TSClipper, 0, 0, 0},{0, 0, 0, 0}};
