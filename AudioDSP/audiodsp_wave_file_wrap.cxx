...
#define SWIGTYPE_p_WaveFile swig_types[38]
...
#define SWIG_name      "audiodsp_wave_file"
#define SWIG_init      luaopen_audiodsp_wave_file
#define SWIG_init_user luaopen_audiodsp_wave_file_user

#define SWIG_LUACODE   luaopen_audiodsp_wave_file_luacode
...
#include "audiodsp_wave_file.hpp"
...
static int _wrap_WaveFile_buffer_set(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("WaveFile::buffer",2,"std::vector< float,std::allocator< float > > *");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__vectorT_float_std__allocatorT_float_t_t,0))){
    SWIG_fail_ptr("WaveFile_buffer_set",2,SWIGTYPE_p_std__vectorT_float_std__allocatorT_float_t_t);
  }
...
static int _wrap_WaveFile_buffer_get(lua_State* L) {
  ...
  result = (std::vector< float,std::allocator< float > > *)& ((arg1)->buffer);
