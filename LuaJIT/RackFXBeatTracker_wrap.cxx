...
#define SWIGTYPE_p_FX__RackFX__beattracker swig_types[1]
...
#define SWIG_name      "RackFXBeatTracker"
#define SWIG_init      luaopen_RackFXBeatTracker
#define SWIG_init_user luaopen_RackFXBeatTracker_user

#define SWIG_LUACODE   luaopen_RackFXBeatTracker_luacode
...
static int _wrap_new_beattracker(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::beattracker *result = 0 ;
  
  SWIG_check_num_args("FX::RackFX::beattracker::beattracker",0,0)
  result = (FX::RackFX::beattracker *)new FX::RackFX::beattracker();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__RackFX__beattracker,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_beattracker_cleanup(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::beattracker *arg1 = (FX::RackFX::beattracker *) 0 ;
  
  SWIG_check_num_args("FX::RackFX::beattracker::cleanup",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::beattracker::cleanup",1,"FX::RackFX::beattracker *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__beattracker,0))){
    SWIG_fail_ptr("beattracker_cleanup",1,SWIGTYPE_p_FX__RackFX__beattracker);
  }
...
static int _wrap_beattracker_detect(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::beattracker *arg1 = (FX::RackFX::beattracker *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  
  SWIG_check_num_args("FX::RackFX::beattracker::detect",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::beattracker::detect",1,"FX::RackFX::beattracker *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::RackFX::beattracker::detect",2,"DspFloatType *");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FX::RackFX::beattracker::detect",3,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__beattracker,0))){
    SWIG_fail_ptr("beattracker_detect",1,SWIGTYPE_p_FX__RackFX__beattracker);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("beattracker_detect",2,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("beattracker_detect",3,SWIGTYPE_p_float);
  }
  
  (arg1)->detect(arg2,arg3);
...
static int _wrap_beattracker_get_tempo(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::beattracker *arg1 = (FX::RackFX::beattracker *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::RackFX::beattracker::get_tempo",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::beattracker::get_tempo",1,"FX::RackFX::beattracker *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__beattracker,0))){
    SWIG_fail_ptr("beattracker_get_tempo",1,SWIGTYPE_p_FX__RackFX__beattracker);
  }
  
  result = (DspFloatType)(arg1)->get_tempo();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_beattracker_index_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::beattracker *arg1 = (FX::RackFX::beattracker *) 0 ;
  int *arg2 = (int *) 0 ;
  
  SWIG_check_num_args("FX::RackFX::beattracker::index",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::beattracker::index",1,"FX::RackFX::beattracker *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::RackFX::beattracker::index",2,"int *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__beattracker,0))){
    SWIG_fail_ptr("beattracker_index_set",1,SWIGTYPE_p_FX__RackFX__beattracker);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_int,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("beattracker_index_set",2,SWIGTYPE_p_int);
  }
...
static int _wrap_beattracker_index_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::beattracker *arg1 = (FX::RackFX::beattracker *) 0 ;
  int *result = 0 ;
  
  SWIG_check_num_args("FX::RackFX::beattracker::index",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::beattracker::index",1,"FX::RackFX::beattracker *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__beattracker,0))){
    SWIG_fail_ptr("beattracker_index_get",1,SWIGTYPE_p_FX__RackFX__beattracker);
  }
...
static void swig_delete_beattracker(void *obj) {
FX::RackFX::beattracker *arg1 = (FX::RackFX::beattracker *) obj;
delete arg1;
}
static int _proxy__wrap_new_beattracker(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_beattracker);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_beattracker_attributes[] = {
    { "index", _wrap_beattracker_index_get, _wrap_beattracker_index_set },
    {0,0,0}
};
static swig_lua_method swig_beattracker_methods[]= {
    { "cleanup", _wrap_beattracker_cleanup},
    { "detect", _wrap_beattracker_detect},
    { "get_tempo", _wrap_beattracker_get_tempo},
    {0,0}
};
static swig_lua_method swig_beattracker_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_beattracker_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_beattracker_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_beattracker_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_beattracker_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_beattracker_Sf_SwigStatic = {
    "beattracker",
    swig_beattracker_Sf_SwigStatic_methods,
    swig_beattracker_Sf_SwigStatic_attributes,
    swig_beattracker_Sf_SwigStatic_constants,
    swig_beattracker_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_beattracker_bases[] = {0};
static const char *swig_beattracker_base_names[] = {0};
static swig_lua_class _wrap_class_beattracker = { "beattracker", "beattracker", &SWIGTYPE_p_FX__RackFX__beattracker,_proxy__wrap_new_beattracker, swig_delete_beattracker, swig_beattracker_methods, swig_beattracker_attributes, &swig_beattracker_Sf_SwigStatic, swig_beattracker_meta, swig_beattracker_bases, swig_beattracker_base_names };
...
static swig_type_info _swigt__p_FX__RackFX__beattracker = {"_p_FX__RackFX__beattracker", "FX::RackFX::beattracker *", 0, 0, (void*)&_wrap_class_beattracker, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FX__RackFX__beattracker,
...
static swig_cast_info _swigc__p_FX__RackFX__beattracker[] = {  {&_swigt__p_FX__RackFX__beattracker, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FX__RackFX__beattracker,
