...
#define SWIGTYPE_p_StereoVector swig_types[39]
...
#define SWIG_name      "StereoVector"
#define SWIG_init      luaopen_StereoVector
#define SWIG_init_user luaopen_StereoVector_user

#define SWIG_LUACODE   luaopen_StereoVector_luacode
...
static int _wrap_StereoVector_buffer_set(lua_State* L) {
  int SWIG_arg = 0;
  StereoVector *arg1 = (StereoVector *) 0 ;
  std::vector< DspFloatType > *arg2 ;
  
  SWIG_check_num_args("StereoVector::buffer",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("StereoVector::buffer",1,"StereoVector *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("StereoVector::buffer",2,"std::vector< DspFloatType > [2]");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_StereoVector,0))){
    SWIG_fail_ptr("StereoVector_buffer_set",1,SWIGTYPE_p_StereoVector);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("StereoVector_buffer_set",2,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  {
    size_t ii;
    std::vector< DspFloatType > *b = (std::vector< DspFloatType > *) arg1->buffer;
...
static int _wrap_StereoVector_buffer_get(lua_State* L) {
  int SWIG_arg = 0;
  StereoVector *arg1 = (StereoVector *) 0 ;
  std::vector< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("StereoVector::buffer",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("StereoVector::buffer",1,"StereoVector *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_StereoVector,0))){
    SWIG_fail_ptr("StereoVector_buffer_get",1,SWIGTYPE_p_StereoVector);
  }
  
  result = (std::vector< DspFloatType > *)(std::vector< DspFloatType > *) ((arg1)->buffer);
...
static int _wrap_new_StereoVector(lua_State* L) {
  int SWIG_arg = 0;
  StereoVector *result = 0 ;
  
  SWIG_check_num_args("StereoVector::StereoVector",0,0)
  result = (StereoVector *)new StereoVector();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_StereoVector,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_StereoVector_resize(lua_State* L) {
  int SWIG_arg = 0;
  StereoVector *arg1 = (StereoVector *) 0 ;
  size_t arg2 ;
  
  SWIG_check_num_args("StereoVector::resize",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("StereoVector::resize",1,"StereoVector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("StereoVector::resize",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_StereoVector,0))){
    SWIG_fail_ptr("StereoVector_resize",1,SWIGTYPE_p_StereoVector);
  }
...
static int _wrap_StereoVector_size(lua_State* L) {
  int SWIG_arg = 0;
  StereoVector *arg1 = (StereoVector *) 0 ;
  size_t result;
  
  SWIG_check_num_args("StereoVector::size",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("StereoVector::size",1,"StereoVector const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_StereoVector,0))){
    SWIG_fail_ptr("StereoVector_size",1,SWIGTYPE_p_StereoVector);
  }
  
  result = ((StereoVector const *)arg1)->size();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_StereoVector_clear(lua_State* L) {
  int SWIG_arg = 0;
  StereoVector *arg1 = (StereoVector *) 0 ;
  
  SWIG_check_num_args("StereoVector::clear",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("StereoVector::clear",1,"StereoVector *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_StereoVector,0))){
    SWIG_fail_ptr("StereoVector_clear",1,SWIGTYPE_p_StereoVector);
  }
...
static int _wrap_StereoVector_get(lua_State* L) {
  int SWIG_arg = 0;
  StereoVector *arg1 = (StereoVector *) 0 ;
  size_t arg2 ;
  size_t arg3 ;
  ...
  SWIG_check_num_args("StereoVector::get",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("StereoVector::get",1,"StereoVector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("StereoVector::get",2,"size_t");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("StereoVector::get",3,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_StereoVector,0))){
    SWIG_fail_ptr("StereoVector_get",1,SWIGTYPE_p_StereoVector);
  }
  ...
  SWIG_contract_assert((lua_tonumber(L,3)>=0),"number must not be negative");
  arg3 = (size_t)lua_tonumber(L, 3);
  result = (DspFloatType)(arg1)->get(arg2,arg3);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_StereoVector_set(lua_State* L) {
  int SWIG_arg = 0;
  StereoVector *arg1 = (StereoVector *) 0 ;
  size_t arg2 ;
  size_t arg3 ;
  ...
  SWIG_check_num_args("StereoVector::set",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("StereoVector::set",1,"StereoVector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("StereoVector::set",2,"size_t");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("StereoVector::set",3,"size_t");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("StereoVector::set",4,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_StereoVector,0))){
    SWIG_fail_ptr("StereoVector_set",1,SWIGTYPE_p_StereoVector);
  }
...
static int _wrap_StereoVector_get_channel(lua_State* L) {
  int SWIG_arg = 0;
  StereoVector *arg1 = (StereoVector *) 0 ;
  size_t arg2 ;
  std::vector< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("StereoVector::get_channel",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("StereoVector::get_channel",1,"StereoVector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("StereoVector::get_channel",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_StereoVector,0))){
    SWIG_fail_ptr("StereoVector_get_channel",1,SWIGTYPE_p_StereoVector);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative");
  arg2 = (size_t)lua_tonumber(L, 2);
  result = (std::vector< DspFloatType > *) &(arg1)->get_channel(arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__vectorT_float_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_StereoVector_set_channel(lua_State* L) {
  int SWIG_arg = 0;
  StereoVector *arg1 = (StereoVector *) 0 ;
  size_t arg2 ;
  std::vector< DspFloatType > *arg3 = 0 ;
  
  SWIG_check_num_args("StereoVector::set_channel",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("StereoVector::set_channel",1,"StereoVector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("StereoVector::set_channel",2,"size_t");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("StereoVector::set_channel",3,"std::vector< DspFloatType > &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_StereoVector,0))){
    SWIG_fail_ptr("StereoVector_set_channel",1,SWIGTYPE_p_StereoVector);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("StereoVector_set_channel",3,SWIGTYPE_p_std__vectorT_float_t);
  }
...
static void swig_delete_StereoVector(void *obj) {
StereoVector *arg1 = (StereoVector *) obj;
delete arg1;
}
static int _proxy__wrap_new_StereoVector(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_StereoVector);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_StereoVector_attributes[] = {
    { "buffer", _wrap_StereoVector_buffer_get, _wrap_StereoVector_buffer_set },
    {0,0,0}
};
static swig_lua_method swig_StereoVector_methods[]= {
    { "resize", _wrap_StereoVector_resize},
    { "size", _wrap_StereoVector_size},
    { "clear", _wrap_StereoVector_clear},
    { "get", _wrap_StereoVector_get},
    { "set", _wrap_StereoVector_set},
    { "get_channel", _wrap_StereoVector_get_channel},
    { "set_channel", _wrap_StereoVector_set_channel},
    {0,0}
};
static swig_lua_method swig_StereoVector_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_StereoVector_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_StereoVector_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_StereoVector_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_StereoVector_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_StereoVector_Sf_SwigStatic = {
    "StereoVector",
    swig_StereoVector_Sf_SwigStatic_methods,
    swig_StereoVector_Sf_SwigStatic_attributes,
    swig_StereoVector_Sf_SwigStatic_constants,
    swig_StereoVector_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_StereoVector_bases[] = {0};
static const char *swig_StereoVector_base_names[] = {0};
static swig_lua_class _wrap_class_StereoVector = { "StereoVector", "StereoVector", &SWIGTYPE_p_StereoVector,_proxy__wrap_new_StereoVector, swig_delete_StereoVector, swig_StereoVector_methods, swig_StereoVector_attributes, &swig_StereoVector_Sf_SwigStatic, swig_StereoVector_meta, swig_StereoVector_bases, swig_StereoVector_base_names };
...
static swig_type_info _swigt__p_StereoVector = {"_p_StereoVector", "StereoVector *", 0, 0, (void*)&_wrap_class_StereoVector, 0};
...
static swig_cast_info _swigc__p_StereoVector[] = {  {&_swigt__p_StereoVector, 0, 0, 0},{0, 0, 0, 0}};
