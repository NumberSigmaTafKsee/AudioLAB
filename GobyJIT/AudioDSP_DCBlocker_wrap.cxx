...
#define SWIGTYPE_p_JoonasFX__DCBlocker swig_types[4]
...
#define SWIGTYPE_p_std__vectorT_std__vectorT_float_t_t swig_types[91]
...
#define SWIG_name      "AudioDSP_DCBlocker"
#define SWIG_init      luaopen_AudioDSP_DCBlocker
#define SWIG_init_user luaopen_AudioDSP_DCBlocker_user

#define SWIG_LUACODE   luaopen_AudioDSP_DCBlocker_luacode
...
static int _wrap_new_DCBlocker(lua_State* L) {
  int SWIG_arg = 0;
  JoonasFX::DCBlocker *result = 0 ;
  
  SWIG_check_num_args("JoonasFX::DCBlocker::DCBlocker",0,0)
  result = (JoonasFX::DCBlocker *)new JoonasFX::DCBlocker();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_JoonasFX__DCBlocker,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_DCBlocker_prepare(lua_State* L) {
  int SWIG_arg = 0;
  JoonasFX::DCBlocker *arg1 = (JoonasFX::DCBlocker *) 0 ;
  int *arg2 = 0 ;
  int temp2 ;
  
  SWIG_check_num_args("JoonasFX::DCBlocker::prepare",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("JoonasFX::DCBlocker::prepare",1,"JoonasFX::DCBlocker *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("JoonasFX::DCBlocker::prepare",2,"int const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_JoonasFX__DCBlocker,0))){
    SWIG_fail_ptr("DCBlocker_prepare",1,SWIGTYPE_p_JoonasFX__DCBlocker);
  }
...
static int _wrap_DCBlocker_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  JoonasFX::DCBlocker *arg1 = (JoonasFX::DCBlocker *) 0 ;
  size_t arg2 ;
  DspFloatType **arg3 = (DspFloatType **) 0 ;
  ...
  SWIG_check_num_args("JoonasFX::DCBlocker::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("JoonasFX::DCBlocker::ProcessBlock",1,"JoonasFX::DCBlocker *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("JoonasFX::DCBlocker::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("JoonasFX::DCBlocker::ProcessBlock",3,"DspFloatType **");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("JoonasFX::DCBlocker::ProcessBlock",4,"DspFloatType **");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_JoonasFX__DCBlocker,0))){
    SWIG_fail_ptr("DCBlocker_ProcessBlock",1,SWIGTYPE_p_JoonasFX__DCBlocker);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_p_float,0))){
    SWIG_fail_ptr("DCBlocker_ProcessBlock",3,SWIGTYPE_p_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_p_float,0))){
    SWIG_fail_ptr("DCBlocker_ProcessBlock",4,SWIGTYPE_p_p_float);
  }
...
static int _wrap_DCBlocker_setPort(lua_State* L) {
  int SWIG_arg = 0;
  JoonasFX::DCBlocker *arg1 = (JoonasFX::DCBlocker *) 0 ;
  int arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("JoonasFX::DCBlocker::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("JoonasFX::DCBlocker::setPort",1,"JoonasFX::DCBlocker *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("JoonasFX::DCBlocker::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("JoonasFX::DCBlocker::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_JoonasFX__DCBlocker,0))){
    SWIG_fail_ptr("DCBlocker_setPort",1,SWIGTYPE_p_JoonasFX__DCBlocker);
  }
...
static int _wrap_DCBlocker_mXh_set(lua_State* L) {
  int SWIG_arg = 0;
  JoonasFX::DCBlocker *arg1 = (JoonasFX::DCBlocker *) 0 ;
  std::vector< std::vector< DspFloatType > > *arg2 = (std::vector< std::vector< DspFloatType > > *) 0 ;
  
  SWIG_check_num_args("JoonasFX::DCBlocker::mXh",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("JoonasFX::DCBlocker::mXh",1,"JoonasFX::DCBlocker *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("JoonasFX::DCBlocker::mXh",2,"std::vector< std::vector< DspFloatType > > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_JoonasFX__DCBlocker,0))){
    SWIG_fail_ptr("DCBlocker_mXh_set",1,SWIGTYPE_p_JoonasFX__DCBlocker);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__vectorT_std__vectorT_float_t_t,0))){
    SWIG_fail_ptr("DCBlocker_mXh_set",2,SWIGTYPE_p_std__vectorT_std__vectorT_float_t_t);
  }
  
  if (arg1) (arg1)->mXh = *arg2;
...
static int _wrap_DCBlocker_mXh_get(lua_State* L) {
  int SWIG_arg = 0;
  JoonasFX::DCBlocker *arg1 = (JoonasFX::DCBlocker *) 0 ;
  std::vector< std::vector< DspFloatType > > *result = 0 ;
  
  SWIG_check_num_args("JoonasFX::DCBlocker::mXh",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("JoonasFX::DCBlocker::mXh",1,"JoonasFX::DCBlocker *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_JoonasFX__DCBlocker,0))){
    SWIG_fail_ptr("DCBlocker_mXh_get",1,SWIGTYPE_p_JoonasFX__DCBlocker);
  }
  
  result = (std::vector< std::vector< DspFloatType > > *)& ((arg1)->mXh);
...
static int _wrap_DCBlocker_p_set(lua_State* L) {
  int SWIG_arg = 0;
  JoonasFX::DCBlocker *arg1 = (JoonasFX::DCBlocker *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("JoonasFX::DCBlocker::p",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("JoonasFX::DCBlocker::p",1,"JoonasFX::DCBlocker *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("JoonasFX::DCBlocker::p",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_JoonasFX__DCBlocker,0))){
    SWIG_fail_ptr("DCBlocker_p_set",1,SWIGTYPE_p_JoonasFX__DCBlocker);
  }
...
static int _wrap_DCBlocker_p_get(lua_State* L) {
  int SWIG_arg = 0;
  JoonasFX::DCBlocker *arg1 = (JoonasFX::DCBlocker *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("JoonasFX::DCBlocker::p",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("JoonasFX::DCBlocker::p",1,"JoonasFX::DCBlocker *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_JoonasFX__DCBlocker,0))){
    SWIG_fail_ptr("DCBlocker_p_get",1,SWIGTYPE_p_JoonasFX__DCBlocker);
  }
...
static void swig_delete_DCBlocker(void *obj) {
JoonasFX::DCBlocker *arg1 = (JoonasFX::DCBlocker *) obj;
delete arg1;
}
static int _proxy__wrap_new_DCBlocker(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_DCBlocker);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_DCBlocker_attributes[] = {
    { "mXh", _wrap_DCBlocker_mXh_get, _wrap_DCBlocker_mXh_set },
    { "p", _wrap_DCBlocker_p_get, _wrap_DCBlocker_p_set },
    {0,0,0}
};
static swig_lua_method swig_DCBlocker_methods[]= {
    { "prepare", _wrap_DCBlocker_prepare},
    { "ProcessBlock", _wrap_DCBlocker_ProcessBlock},
    { "setPort", _wrap_DCBlocker_setPort},
    {0,0}
};
static swig_lua_method swig_DCBlocker_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_DCBlocker_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_DCBlocker_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_COEFFICIENT", JoonasFX::DCBlocker::PORT_COEFFICIENT)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_DCBlocker_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_DCBlocker_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_DCBlocker_Sf_SwigStatic = {
    "DCBlocker",
    swig_DCBlocker_Sf_SwigStatic_methods,
    swig_DCBlocker_Sf_SwigStatic_attributes,
    swig_DCBlocker_Sf_SwigStatic_constants,
    swig_DCBlocker_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_DCBlocker_bases[] = {0,0};
static const char *swig_DCBlocker_base_names[] = {"StereoFXProcessor *",0};
static swig_lua_class _wrap_class_DCBlocker = { "DCBlocker", "DCBlocker", &SWIGTYPE_p_JoonasFX__DCBlocker,_proxy__wrap_new_DCBlocker, swig_delete_DCBlocker, swig_DCBlocker_methods, swig_DCBlocker_attributes, &swig_DCBlocker_Sf_SwigStatic, swig_DCBlocker_meta, swig_DCBlocker_bases, swig_DCBlocker_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("DCBlocker_PORT_COEFFICIENT", JoonasFX::DCBlocker::PORT_COEFFICIENT)},
    {0,0,0,0,0,0}
};
...
static void *_p_JoonasFX__DCBlockerTo_p_StereoFXProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((StereoFXProcessor *)  ((JoonasFX::DCBlocker *) x));
}
...
static void *_p_JoonasFX__DCBlockerTo_p_StereoProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((StereoProcessor *) (StereoFXProcessor *) ((JoonasFX::DCBlocker *) x));
}
...
static void *_p_JoonasFX__DCBlockerTo_p_SoundProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SoundProcessor *) (StereoProcessor *)(StereoFXProcessor *) ((JoonasFX::DCBlocker *) x));
}
...
static swig_type_info _swigt__p_JoonasFX__DCBlocker = {"_p_JoonasFX__DCBlocker", "JoonasFX::DCBlocker *", 0, 0, (void*)&_wrap_class_DCBlocker, 0};
...
static swig_type_info _swigt__p_std__vectorT_std__vectorT_float_t_t = {"_p_std__vectorT_std__vectorT_float_t_t", "std::vector< std::vector< DspFloatType > > *|std::vector< std::vector< float > > *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_JoonasFX__DCBlocker[] = {  {&_swigt__p_JoonasFX__DCBlocker, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_StereoFXProcessor[] = {  {&_swigt__p_StereoFXProcessor, 0, 0, 0},  {&_swigt__p_JoonasFX__DCBlocker, _p_JoonasFX__DCBlockerTo_p_StereoFXProcessor, 0, 0},{0, 0, 0, 0}};
