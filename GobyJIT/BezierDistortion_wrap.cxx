...
#define SWIGTYPE_p_Bezier__BezierT_3_t swig_types[1]
#define SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion swig_types[2]
...
#define SWIG_name      "BezierDistortion"
#define SWIG_init      luaopen_BezierDistortion
#define SWIG_init_user luaopen_BezierDistortion_user

#define SWIG_LUACODE   luaopen_BezierDistortion_luacode
...
static int _wrap_BezierDistortion_cbezier_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::BezierDistortion::BezierDistortion *arg1 = (FX::Distortion::BezierDistortion::BezierDistortion *) 0 ;
  Bezier::Bezier< 3 > *arg2 = (Bezier::Bezier< 3 > *) 0 ;
  
  SWIG_check_num_args("FX::Distortion::BezierDistortion::BezierDistortion::cbezier",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::BezierDistortion::BezierDistortion::cbezier",1,"FX::Distortion::BezierDistortion::BezierDistortion *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::Distortion::BezierDistortion::BezierDistortion::cbezier",2,"Bezier::Bezier< 3 > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion,0))){
    SWIG_fail_ptr("BezierDistortion_cbezier_set",1,SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_Bezier__BezierT_3_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("BezierDistortion_cbezier_set",2,SWIGTYPE_p_Bezier__BezierT_3_t);
  }
  
  if (arg1) (arg1)->cbezier = arg2;
...
static int _wrap_BezierDistortion_cbezier_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::BezierDistortion::BezierDistortion *arg1 = (FX::Distortion::BezierDistortion::BezierDistortion *) 0 ;
  Bezier::Bezier< 3 > *result = 0 ;
  
  SWIG_check_num_args("FX::Distortion::BezierDistortion::BezierDistortion::cbezier",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::BezierDistortion::BezierDistortion::cbezier",1,"FX::Distortion::BezierDistortion::BezierDistortion *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion,0))){
    SWIG_fail_ptr("BezierDistortion_cbezier_get",1,SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion);
  }
  
  result = (Bezier::Bezier< 3 > *) ((arg1)->cbezier);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Bezier__BezierT_3_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_BezierDistortion(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::BezierDistortion::BezierDistortion *result = 0 ;
  
  SWIG_check_num_args("FX::Distortion::BezierDistortion::BezierDistortion::BezierDistortion",0,0)
  result = (FX::Distortion::BezierDistortion::BezierDistortion *)new FX::Distortion::BezierDistortion::BezierDistortion();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_BezierDistortion_init(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::BezierDistortion::BezierDistortion *arg1 = (FX::Distortion::BezierDistortion::BezierDistortion *) 0 ;
  
  SWIG_check_num_args("FX::Distortion::BezierDistortion::BezierDistortion::init",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::BezierDistortion::BezierDistortion::init",1,"FX::Distortion::BezierDistortion::BezierDistortion *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion,0))){
    SWIG_fail_ptr("BezierDistortion_init",1,SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion);
  }
...
static int _wrap_BezierDistortion_Tick(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::BezierDistortion::BezierDistortion *arg1 = (FX::Distortion::BezierDistortion::BezierDistortion *) 0 ;
  double arg2 ;
  double result;
  
  SWIG_check_num_args("FX::Distortion::BezierDistortion::BezierDistortion::Tick",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::BezierDistortion::BezierDistortion::Tick",1,"FX::Distortion::BezierDistortion::BezierDistortion *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::BezierDistortion::BezierDistortion::Tick",2,"double");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion,0))){
    SWIG_fail_ptr("BezierDistortion_Tick",1,SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion);
  }
...
static void swig_delete_BezierDistortion(void *obj) {
FX::Distortion::BezierDistortion::BezierDistortion *arg1 = (FX::Distortion::BezierDistortion::BezierDistortion *) obj;
delete arg1;
}
static int _proxy__wrap_new_BezierDistortion(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_BezierDistortion);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_BezierDistortion_attributes[] = {
    { "cbezier", _wrap_BezierDistortion_cbezier_get, _wrap_BezierDistortion_cbezier_set },
    {0,0,0}
};
static swig_lua_method swig_BezierDistortion_methods[]= {
    { "init", _wrap_BezierDistortion_init},
    { "Tick", _wrap_BezierDistortion_Tick},
    {0,0}
};
static swig_lua_method swig_BezierDistortion_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_BezierDistortion_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_BezierDistortion_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_BezierDistortion_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_BezierDistortion_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_BezierDistortion_Sf_SwigStatic = {
    "BezierDistortion",
    swig_BezierDistortion_Sf_SwigStatic_methods,
    swig_BezierDistortion_Sf_SwigStatic_attributes,
    swig_BezierDistortion_Sf_SwigStatic_constants,
    swig_BezierDistortion_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_BezierDistortion_bases[] = {0};
static const char *swig_BezierDistortion_base_names[] = {0};
static swig_lua_class _wrap_class_BezierDistortion = { "BezierDistortion", "BezierDistortion", &SWIGTYPE_p_FX__Distortion__BezierDistortion__BezierDistortion,_proxy__wrap_new_BezierDistortion, swig_delete_BezierDistortion, swig_BezierDistortion_methods, swig_BezierDistortion_attributes, &swig_BezierDistortion_Sf_SwigStatic, swig_BezierDistortion_meta, swig_BezierDistortion_bases, swig_BezierDistortion_base_names };
...
static swig_type_info _swigt__p_FX__Distortion__BezierDistortion__BezierDistortion = {"_p_FX__Distortion__BezierDistortion__BezierDistortion", "FX::Distortion::BezierDistortion::BezierDistortion *", 0, 0, (void*)&_wrap_class_BezierDistortion, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_Bezier__BezierT_3_t,
  &_swigt__p_FX__Distortion__BezierDistortion__BezierDistortion,
...
static swig_cast_info _swigc__p_FX__Distortion__BezierDistortion__BezierDistortion[] = {  {&_swigt__p_FX__Distortion__BezierDistortion__BezierDistortion, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_Bezier__BezierT_3_t,
  _swigc__p_FX__Distortion__BezierDistortion__BezierDistortion,
