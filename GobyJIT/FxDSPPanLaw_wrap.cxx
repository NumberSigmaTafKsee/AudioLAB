...
#define SWIGTYPE_p_DSPFX__FxPanLaw swig_types[1]
...
#define SWIG_name      "FxDSPPanLaw"
#define SWIG_init      luaopen_FxDSPPanLaw
#define SWIG_init_user luaopen_FxDSPPanLaw_user

#define SWIG_LUACODE   luaopen_FxDSPPanLaw_luacode
...
static int _wrap_FxPanLaw_linear_pan(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxPanLaw *arg1 = (DSPFX::FxPanLaw *) 0 ;
  DspFloatType arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  DspFloatType *arg4 = (DspFloatType *) 0 ;
  
  SWIG_check_num_args("DSPFX::FxPanLaw::linear_pan",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxPanLaw::linear_pan",1,"DSPFX::FxPanLaw *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxPanLaw::linear_pan",2,"DspFloatType");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("DSPFX::FxPanLaw::linear_pan",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("DSPFX::FxPanLaw::linear_pan",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxPanLaw,0))){
    SWIG_fail_ptr("FxPanLaw_linear_pan",1,SWIGTYPE_p_DSPFX__FxPanLaw);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxPanLaw_linear_pan",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxPanLaw_linear_pan",4,SWIGTYPE_p_float);
  }
  
  (arg1)->linear_pan(arg2,arg3,arg4);
...
static int _wrap_FxPanLaw_equal_power_3db_pan(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxPanLaw *arg1 = (DSPFX::FxPanLaw *) 0 ;
  DspFloatType arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("DSPFX::FxPanLaw::equal_power_3db_pan",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxPanLaw::equal_power_3db_pan",1,"DSPFX::FxPanLaw *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxPanLaw::equal_power_3db_pan",2,"DspFloatType");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("DSPFX::FxPanLaw::equal_power_3db_pan",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("DSPFX::FxPanLaw::equal_power_3db_pan",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxPanLaw,0))){
    SWIG_fail_ptr("FxPanLaw_equal_power_3db_pan",1,SWIGTYPE_p_DSPFX__FxPanLaw);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxPanLaw_equal_power_3db_pan",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxPanLaw_equal_power_3db_pan",4,SWIGTYPE_p_float);
  }
  
  (arg1)->equal_power_3db_pan(arg2,arg3,arg4);
...
static int _wrap_FxPanLaw_equal_power_6db_pan(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxPanLaw *arg1 = (DSPFX::FxPanLaw *) 0 ;
  DspFloatType arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("DSPFX::FxPanLaw::equal_power_6db_pan",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("DSPFX::FxPanLaw::equal_power_6db_pan",1,"DSPFX::FxPanLaw *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("DSPFX::FxPanLaw::equal_power_6db_pan",2,"DspFloatType");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("DSPFX::FxPanLaw::equal_power_6db_pan",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("DSPFX::FxPanLaw::equal_power_6db_pan",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DSPFX__FxPanLaw,0))){
    SWIG_fail_ptr("FxPanLaw_equal_power_6db_pan",1,SWIGTYPE_p_DSPFX__FxPanLaw);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxPanLaw_equal_power_6db_pan",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FxPanLaw_equal_power_6db_pan",4,SWIGTYPE_p_float);
  }
  
  (arg1)->equal_power_6db_pan(arg2,arg3,arg4);
...
static int _wrap_new_FxPanLaw(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxPanLaw *result = 0 ;
  
  SWIG_check_num_args("DSPFX::FxPanLaw::FxPanLaw",0,0)
  result = (DSPFX::FxPanLaw *)new DSPFX::FxPanLaw();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_DSPFX__FxPanLaw,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_FxPanLaw(void *obj) {
DSPFX::FxPanLaw *arg1 = (DSPFX::FxPanLaw *) obj;
delete arg1;
}
static int _proxy__wrap_new_FxPanLaw(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_FxPanLaw);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_FxPanLaw_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_FxPanLaw_methods[]= {
    { "linear_pan", _wrap_FxPanLaw_linear_pan},
    { "equal_power_3db_pan", _wrap_FxPanLaw_equal_power_3db_pan},
    { "equal_power_6db_pan", _wrap_FxPanLaw_equal_power_6db_pan},
    {0,0}
};
static swig_lua_method swig_FxPanLaw_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_FxPanLaw_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_FxPanLaw_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_FxPanLaw_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_FxPanLaw_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_FxPanLaw_Sf_SwigStatic = {
    "FxPanLaw",
    swig_FxPanLaw_Sf_SwigStatic_methods,
    swig_FxPanLaw_Sf_SwigStatic_attributes,
    swig_FxPanLaw_Sf_SwigStatic_constants,
    swig_FxPanLaw_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_FxPanLaw_bases[] = {0};
static const char *swig_FxPanLaw_base_names[] = {0};
static swig_lua_class _wrap_class_FxPanLaw = { "FxPanLaw", "FxPanLaw", &SWIGTYPE_p_DSPFX__FxPanLaw,_proxy__wrap_new_FxPanLaw, swig_delete_FxPanLaw, swig_FxPanLaw_methods, swig_FxPanLaw_attributes, &swig_FxPanLaw_Sf_SwigStatic, swig_FxPanLaw_meta, swig_FxPanLaw_bases, swig_FxPanLaw_base_names };
...
static swig_type_info _swigt__p_DSPFX__FxPanLaw = {"_p_DSPFX__FxPanLaw", "DSPFX::FxPanLaw *", 0, 0, (void*)&_wrap_class_FxPanLaw, 0};
...
static swig_cast_info _swigc__p_DSPFX__FxPanLaw[] = {  {&_swigt__p_DSPFX__FxPanLaw, 0, 0, 0},{0, 0, 0, 0}};
