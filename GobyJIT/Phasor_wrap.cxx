...
#define SWIG_name      "Phasor"
#define SWIG_init      luaopen_Phasor
#define SWIG_init_user luaopen_Phasor_user

#define SWIG_LUACODE   luaopen_Phasor_luacode
...
static int _wrap_Phasor_getSample(lua_State* L) {
  int SWIG_arg = 0;
  Phasor *arg1 = (Phasor *) 0 ;
  double result;
  
  SWIG_check_num_args("Phasor::getSample",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Phasor::getSample",1,"Phasor *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Phasor,0))){
    SWIG_fail_ptr("Phasor_getSample",1,SWIGTYPE_p_Phasor);
  }
  
  result = (double)(arg1)->getSample();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Phasor_Reset(lua_State* L) {
  int SWIG_arg = 0;
  Phasor *arg1 = (Phasor *) 0 ;
  
  SWIG_check_num_args("Phasor::Reset",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Phasor::Reset",1,"Phasor *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Phasor,0))){
    SWIG_fail_ptr("Phasor_Reset",1,SWIGTYPE_p_Phasor);
  }
...
static int _wrap_Phasor_getPhase_inc(lua_State* L) {
  int SWIG_arg = 0;
  Phasor *arg1 = (Phasor *) 0 ;
  double result;
  
  SWIG_check_num_args("Phasor::getPhase_inc",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Phasor::getPhase_inc",1,"Phasor *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Phasor,0))){
    SWIG_fail_ptr("Phasor_getPhase_inc",1,SWIGTYPE_p_Phasor);
  }
  
  result = (double)(arg1)->getPhase_inc();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_FLOAT("PI", 3.14159265358979311599796346854)},
    {0,0,0,0,0,0}
};
