...
#define SWIGTYPE_p_std__vectorT_SoundProcessor_p_std__allocatorT_SoundProcessor_p_t_t swig_types[76]
#define SWIGTYPE_p_std__vectorT_StereoProcessor_p_std__allocatorT_StereoProcessor_p_t_t swig_types[77]
...
#define SWIGTYPE_p_std__vectorT_std__complexT_float_t_std__allocatorT_std__complexT_float_t_t_t swig_types[81]
#define SWIGTYPE_p_std__vector_iteratorT_double_std__allocatorT_double_t_t swig_types[82]
#define SWIGTYPE_p_std__vector_iteratorT_float_std__allocatorT_float_t_t swig_types[83]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_double_t_std__allocatorT_std__complexT_double_t_t_t swig_types[84]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_float_t_std__allocatorT_std__complexT_float_t_t_t swig_types[85]
...
static int _wrap_ADSR2_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  Envelopes::ADSR2 *arg1 = (Envelopes::ADSR2 *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("Envelopes::ADSR2::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Envelopes::ADSR2::ProcessBlock",1,"Envelopes::ADSR2 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Envelopes::ADSR2::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Envelopes::ADSR2::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("Envelopes::ADSR2::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Envelopes__ADSR2,0))){
    SWIG_fail_ptr("ADSR2_ProcessBlock",1,SWIGTYPE_p_Envelopes__ADSR2);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("ADSR2_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("ADSR2_ProcessBlock",4,SWIGTYPE_p_float);
  }
...
static int _wrap_ADSR2_ProcessInplace(lua_State* L) {
  int SWIG_arg = 0;
  Envelopes::ADSR2 *arg1 = (Envelopes::ADSR2 *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  size_t arg3 ;
  
  SWIG_check_num_args("Envelopes::ADSR2::ProcessInplace",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Envelopes::ADSR2::ProcessInplace",1,"Envelopes::ADSR2 *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Envelopes::ADSR2::ProcessInplace",2,"DspFloatType *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Envelopes::ADSR2::ProcessInplace",3,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Envelopes__ADSR2,0))){
    SWIG_fail_ptr("ADSR2_ProcessInplace",1,SWIGTYPE_p_Envelopes__ADSR2);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("ADSR2_ProcessInplace",2,SWIGTYPE_p_float);
  }
...
static swig_lua_method swig_ADSR2_methods[]= {
    ...
    { "ProcessBlock", _wrap_ADSR2_ProcessBlock},
    { "ProcessInplace", _wrap_ADSR2_ProcessInplace},
