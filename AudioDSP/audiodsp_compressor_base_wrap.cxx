...
#define SWIGTYPE_p_CompressorBase swig_types[2]
...
#define SWIG_name      "audiodsp_compressor_base"
#define SWIG_init      luaopen_audiodsp_compressor_base
#define SWIG_init_user luaopen_audiodsp_compressor_base_user

#define SWIG_LUACODE   luaopen_audiodsp_compressor_base_luacode
...
#include "audiodsp_compressor_base.hpp"
...
static int _wrap_new_CompressorBase(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *result = 0 ;
  
  SWIG_check_num_args("CompressorBase::CompressorBase",0,0)
  result = (CompressorBase *)new CompressorBase();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_CompressorBase,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_CompressorBase_setup(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  double arg2 ;
  int arg3 ;
  
  SWIG_check_num_args("CompressorBase::setup",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::setup",1,"CompressorBase *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CompressorBase::setup",2,"double");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("CompressorBase::setup",3,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_setup",1,SWIGTYPE_p_CompressorBase);
  }
...
static int _wrap_CompressorBase_process(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  AudioBuffer< float > *arg2 = 0 ;
  
  SWIG_check_num_args("CompressorBase::process",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::process",1,"CompressorBase *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("CompressorBase::process",2,"AudioBuffer< float > &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_process",1,SWIGTYPE_p_CompressorBase);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_AudioBufferT_float_t,0))){
    SWIG_fail_ptr("CompressorBase_process",2,SWIGTYPE_p_AudioBufferT_float_t);
  }
...
static int _wrap_CompressorBase_setAttack(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("CompressorBase::setAttack",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::setAttack",1,"CompressorBase *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CompressorBase::setAttack",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_setAttack",1,SWIGTYPE_p_CompressorBase);
  }
...
static int _wrap_CompressorBase_setRelease(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("CompressorBase::setRelease",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::setRelease",1,"CompressorBase *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CompressorBase::setRelease",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_setRelease",1,SWIGTYPE_p_CompressorBase);
  }
...
static int _wrap_CompressorBase_setRatio(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("CompressorBase::setRatio",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::setRatio",1,"CompressorBase *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CompressorBase::setRatio",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_setRatio",1,SWIGTYPE_p_CompressorBase);
  }
...
static int _wrap_CompressorBase_setThreshold(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("CompressorBase::setThreshold",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::setThreshold",1,"CompressorBase *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CompressorBase::setThreshold",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_setThreshold",1,SWIGTYPE_p_CompressorBase);
  }
...
static int _wrap_CompressorBase_getAttack(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  float result;
  
  SWIG_check_num_args("CompressorBase::getAttack",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::getAttack",1,"CompressorBase *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_getAttack",1,SWIGTYPE_p_CompressorBase);
  }
...
static int _wrap_CompressorBase_getRelease(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  float result;
  
  SWIG_check_num_args("CompressorBase::getRelease",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::getRelease",1,"CompressorBase *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_getRelease",1,SWIGTYPE_p_CompressorBase);
  }
...
static int _wrap_CompressorBase_getRatio(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  float result;
  
  SWIG_check_num_args("CompressorBase::getRatio",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::getRatio",1,"CompressorBase *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_getRatio",1,SWIGTYPE_p_CompressorBase);
  }
...
static int _wrap_CompressorBase_getThreshold(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  float result;
  
  SWIG_check_num_args("CompressorBase::getThreshold",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::getThreshold",1,"CompressorBase *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_getThreshold",1,SWIGTYPE_p_CompressorBase);
  }
...
static int _wrap_CompressorBase_getCompressionAmountDB(lua_State* L) {
  int SWIG_arg = 0;
  CompressorBase *arg1 = (CompressorBase *) 0 ;
  float result;
  
  SWIG_check_num_args("CompressorBase::getCompressionAmountDB",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CompressorBase::getCompressionAmountDB",1,"CompressorBase *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CompressorBase,0))){
    SWIG_fail_ptr("CompressorBase_getCompressionAmountDB",1,SWIGTYPE_p_CompressorBase);
  }
  
  result = (float)(arg1)->getCompressionAmountDB();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static void swig_delete_CompressorBase(void *obj) {
CompressorBase *arg1 = (CompressorBase *) obj;
delete arg1;
}
static int _proxy__wrap_new_CompressorBase(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_CompressorBase);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_CompressorBase_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_CompressorBase_methods[]= {
    { "setup", _wrap_CompressorBase_setup},
    { "process", _wrap_CompressorBase_process},
    { "setAttack", _wrap_CompressorBase_setAttack},
    { "setRelease", _wrap_CompressorBase_setRelease},
    { "setRatio", _wrap_CompressorBase_setRatio},
    { "setThreshold", _wrap_CompressorBase_setThreshold},
    { "getAttack", _wrap_CompressorBase_getAttack},
    { "getRelease", _wrap_CompressorBase_getRelease},
    { "getRatio", _wrap_CompressorBase_getRatio},
    { "getThreshold", _wrap_CompressorBase_getThreshold},
    { "getCompressionAmountDB", _wrap_CompressorBase_getCompressionAmountDB},
    {0,0}
};
static swig_lua_method swig_CompressorBase_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_CompressorBase_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_CompressorBase_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_CompressorBase_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_CompressorBase_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_CompressorBase_Sf_SwigStatic = {
    "CompressorBase",
    swig_CompressorBase_Sf_SwigStatic_methods,
    swig_CompressorBase_Sf_SwigStatic_attributes,
    swig_CompressorBase_Sf_SwigStatic_constants,
    swig_CompressorBase_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_CompressorBase_bases[] = {0};
static const char *swig_CompressorBase_base_names[] = {0};
static swig_lua_class _wrap_class_CompressorBase = { "CompressorBase", "CompressorBase", &SWIGTYPE_p_CompressorBase,_proxy__wrap_new_CompressorBase, swig_delete_CompressorBase, swig_CompressorBase_methods, swig_CompressorBase_attributes, &swig_CompressorBase_Sf_SwigStatic, swig_CompressorBase_meta, swig_CompressorBase_bases, swig_CompressorBase_base_names };
...
static swig_type_info _swigt__p_AudioBufferT_float_t = {"_p_AudioBufferT_float_t", "AudioBuffer< float > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_CompressorBase = {"_p_CompressorBase", "CompressorBase *", 0, 0, (void*)&_wrap_class_CompressorBase, 0};
...
static swig_cast_info _swigc__p_CompressorBase[] = {  {&_swigt__p_CompressorBase, 0, 0, 0},{0, 0, 0, 0}};
