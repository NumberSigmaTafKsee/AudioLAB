...
#define SWIGTYPE_p_TSTone swig_types[39]
...
#define SWIG_name      "TSTone"
#define SWIG_init      luaopen_TSTone
#define SWIG_init_user luaopen_TSTone_user

#define SWIG_LUACODE   luaopen_TSTone_luacode
...
static int _wrap_new_TSTone(lua_State* L) {
  int SWIG_arg = 0;
  TSTone *result = 0 ;
  
  SWIG_check_num_args("TSTone::TSTone",0,0)
  result = (TSTone *)new TSTone();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_TSTone,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_TSTone_prepare(lua_State* L) {
  int SWIG_arg = 0;
  TSTone *arg1 = (TSTone *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("TSTone::prepare",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("TSTone::prepare",1,"TSTone *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("TSTone::prepare",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_TSTone,0))){
    SWIG_fail_ptr("TSTone_prepare",1,SWIGTYPE_p_TSTone);
  }
...
static int _wrap_TSTone_processSample(lua_State* L) {
  int SWIG_arg = 0;
  TSTone *arg1 = (TSTone *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("TSTone::processSample",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("TSTone::processSample",1,"TSTone *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("TSTone::processSample",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_TSTone,0))){
    SWIG_fail_ptr("TSTone_processSample",1,SWIGTYPE_p_TSTone);
  }
...
static int _wrap_TSTone_setKnobs(lua_State* L) {
  int SWIG_arg = 0;
  TSTone *arg1 = (TSTone *) 0 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("TSTone::setKnobs",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("TSTone::setKnobs",1,"TSTone *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("TSTone::setKnobs",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("TSTone::setKnobs",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_TSTone,0))){
    SWIG_fail_ptr("TSTone_setKnobs",1,SWIGTYPE_p_TSTone);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  arg3 = (DspFloatType)lua_tonumber(L, 3);
  (arg1)->setKnobs(arg2,arg3);
...
static void swig_delete_TSTone(void *obj) {
TSTone *arg1 = (TSTone *) obj;
delete arg1;
}
static int _proxy__wrap_new_TSTone(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_TSTone);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_TSTone_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_TSTone_methods[]= {
    { "prepare", _wrap_TSTone_prepare},
    { "processSample", _wrap_TSTone_processSample},
    { "setKnobs", _wrap_TSTone_setKnobs},
    {0,0}
};
static swig_lua_method swig_TSTone_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_TSTone_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_TSTone_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_TSTone_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_TSTone_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_TSTone_Sf_SwigStatic = {
    "TSTone",
    swig_TSTone_Sf_SwigStatic_methods,
    swig_TSTone_Sf_SwigStatic_attributes,
    swig_TSTone_Sf_SwigStatic_constants,
    swig_TSTone_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_TSTone_bases[] = {0};
static const char *swig_TSTone_base_names[] = {0};
static swig_lua_class _wrap_class_TSTone = { "TSTone", "TSTone", &SWIGTYPE_p_TSTone,_proxy__wrap_new_TSTone, swig_delete_TSTone, swig_TSTone_methods, swig_TSTone_attributes, &swig_TSTone_Sf_SwigStatic, swig_TSTone_meta, swig_TSTone_bases, swig_TSTone_base_names };
...
static swig_type_info _swigt__p_TSTone = {"_p_TSTone", "TSTone *", 0, 0, (void*)&_wrap_class_TSTone, 0};
...
static swig_cast_info _swigc__p_TSTone[] = {  {&_swigt__p_TSTone, 0, 0, 0},{0, 0, 0, 0}};
