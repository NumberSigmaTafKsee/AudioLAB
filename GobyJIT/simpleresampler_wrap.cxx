...
#define SWIGTYPE_p_SimpleResampler swig_types[0]
...
#define SWIG_name      "simpleresampler"
#define SWIG_init      luaopen_simpleresampler
#define SWIG_init_user luaopen_simpleresampler_user

#define SWIG_LUACODE   luaopen_simpleresampler_luacode
...
static int _wrap_SimpleResampler_up(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("SimpleResampler::up",3,"float *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("SimpleResampler::up",4,"float *");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("SimpleResampler_up",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("SimpleResampler_up",4,SWIGTYPE_p_float);
  }
...
static int _wrap_SimpleResampler_down(lua_State* L) {
  ...
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("SimpleResampler::down",3,"float *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("SimpleResampler::down",4,"float *");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("SimpleResampler_down",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("SimpleResampler_down",4,SWIGTYPE_p_float);
  }
