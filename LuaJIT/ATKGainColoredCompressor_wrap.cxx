...
#define SWIGTYPE_p_ATK__GainColoredCompressorFilterT_DspFloatType_t swig_types[0]
#define SWIGTYPE_p_AmplifierProcessor swig_types[1]
#define SWIGTYPE_p_FilterProcessor swig_types[2]
#define SWIGTYPE_p_Filters__AudioTK__Dynamics__GainColoredCompressor swig_types[3]
...
#define SWIG_name      "ATKGainColoredCompressor"
#define SWIG_init      luaopen_ATKGainColoredCompressor
#define SWIG_init_user luaopen_ATKGainColoredCompressor_user

#define SWIG_LUACODE   luaopen_ATKGainColoredCompressor_luacode
...
static int _wrap_GainColoredCompressor_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Dynamics::GainColoredCompressor *arg1 = (Filters::AudioTK::Dynamics::GainColoredCompressor *) 0 ;
  ATK::GainColoredCompressorFilter< DspFloatType > *arg2 = (ATK::GainColoredCompressorFilter< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Dynamics::GainColoredCompressor::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Dynamics::GainColoredCompressor::filter",1,"Filters::AudioTK::Dynamics::GainColoredCompressor *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::Dynamics::GainColoredCompressor::filter",2,"ATK::GainColoredCompressorFilter< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Dynamics__GainColoredCompressor,0))){
    SWIG_fail_ptr("GainColoredCompressor_filter_set",1,SWIGTYPE_p_Filters__AudioTK__Dynamics__GainColoredCompressor);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__GainColoredCompressorFilterT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("GainColoredCompressor_filter_set",2,SWIGTYPE_p_ATK__GainColoredCompressorFilterT_DspFloatType_t);
  }
...
static int _wrap_GainColoredCompressor_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Dynamics::GainColoredCompressor *arg1 = (Filters::AudioTK::Dynamics::GainColoredCompressor *) 0 ;
  ATK::GainColoredCompressorFilter< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Dynamics::GainColoredCompressor::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Dynamics::GainColoredCompressor::filter",1,"Filters::AudioTK::Dynamics::GainColoredCompressor *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Dynamics__GainColoredCompressor,0))){
    SWIG_fail_ptr("GainColoredCompressor_filter_get",1,SWIGTYPE_p_Filters__AudioTK__Dynamics__GainColoredCompressor);
  }
  
  result = (ATK::GainColoredCompressorFilter< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__GainColoredCompressorFilterT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_GainColoredCompressor(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Dynamics::GainColoredCompressor *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Dynamics::GainColoredCompressor::GainColoredCompressor",0,0)
  result = (Filters::AudioTK::Dynamics::GainColoredCompressor *)new Filters::AudioTK::Dynamics::GainColoredCompressor();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__Dynamics__GainColoredCompressor,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_GainColoredCompressor_setPort(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Dynamics::GainColoredCompressor *arg1 = (Filters::AudioTK::Dynamics::GainColoredCompressor *) 0 ;
  int arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Filters::AudioTK::Dynamics::GainColoredCompressor::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Dynamics::GainColoredCompressor::setPort",1,"Filters::AudioTK::Dynamics::GainColoredCompressor *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AudioTK::Dynamics::GainColoredCompressor::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AudioTK::Dynamics::GainColoredCompressor::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Dynamics__GainColoredCompressor,0))){
    SWIG_fail_ptr("GainColoredCompressor_setPort",1,SWIGTYPE_p_Filters__AudioTK__Dynamics__GainColoredCompressor);
  }
...
static void swig_delete_GainColoredCompressor(void *obj) {
Filters::AudioTK::Dynamics::GainColoredCompressor *arg1 = (Filters::AudioTK::Dynamics::GainColoredCompressor *) obj;
delete arg1;
}
static int _proxy__wrap_new_GainColoredCompressor(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_GainColoredCompressor);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_GainColoredCompressor_attributes[] = {
    { "filter", _wrap_GainColoredCompressor_filter_get, _wrap_GainColoredCompressor_filter_set },
    {0,0,0}
};
static swig_lua_method swig_GainColoredCompressor_methods[]= {
    { "setPort", _wrap_GainColoredCompressor_setPort},
    {0,0}
};
static swig_lua_method swig_GainColoredCompressor_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_GainColoredCompressor_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_GainColoredCompressor_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_SOFTNESS", Filters::AudioTK::Dynamics::GainColoredCompressor::PORT_SOFTNESS)},
    {SWIG_LUA_CONSTTAB_INT("PORT_COLOR", Filters::AudioTK::Dynamics::GainColoredCompressor::PORT_COLOR)},
    {SWIG_LUA_CONSTTAB_INT("PORT_QUALITY", Filters::AudioTK::Dynamics::GainColoredCompressor::PORT_QUALITY)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_GainColoredCompressor_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_GainColoredCompressor_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_GainColoredCompressor_Sf_SwigStatic = {
    "GainColoredCompressor",
    swig_GainColoredCompressor_Sf_SwigStatic_methods,
    swig_GainColoredCompressor_Sf_SwigStatic_attributes,
    swig_GainColoredCompressor_Sf_SwigStatic_constants,
    swig_GainColoredCompressor_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_GainColoredCompressor_bases[] = {0};
static const char *swig_GainColoredCompressor_base_names[] = {0};
static swig_lua_class _wrap_class_GainColoredCompressor = { "GainColoredCompressor", "GainColoredCompressor", &SWIGTYPE_p_Filters__AudioTK__Dynamics__GainColoredCompressor,_proxy__wrap_new_GainColoredCompressor, swig_delete_GainColoredCompressor, swig_GainColoredCompressor_methods, swig_GainColoredCompressor_attributes, &swig_GainColoredCompressor_Sf_SwigStatic, swig_GainColoredCompressor_meta, swig_GainColoredCompressor_bases, swig_GainColoredCompressor_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("GainColoredCompressor_PORT_SOFTNESS", Filters::AudioTK::Dynamics::GainColoredCompressor::PORT_SOFTNESS)},
    {SWIG_LUA_CONSTTAB_INT("GainColoredCompressor_PORT_COLOR", Filters::AudioTK::Dynamics::GainColoredCompressor::PORT_COLOR)},
    {SWIG_LUA_CONSTTAB_INT("GainColoredCompressor_PORT_QUALITY", Filters::AudioTK::Dynamics::GainColoredCompressor::PORT_QUALITY)},
    {0,0,0,0,0,0}
};
...
&_wrap_class_GainColoredCompressor,
...
static swig_type_info _swigt__p_ATK__GainColoredCompressorFilterT_DspFloatType_t = {"_p_ATK__GainColoredCompressorFilterT_DspFloatType_t", "ATK::GainColoredCompressorFilter< DspFloatType > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_Filters__AudioTK__Dynamics__GainColoredCompressor = {"_p_Filters__AudioTK__Dynamics__GainColoredCompressor", "Filters::AudioTK::Dynamics::GainColoredCompressor *", 0, 0, (void*)&_wrap_class_GainColoredCompressor, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ATK__GainColoredCompressorFilterT_DspFloatType_t,
  &_swigt__p_AmplifierProcessor,
  &_swigt__p_FilterProcessor,
  &_swigt__p_Filters__AudioTK__Dynamics__GainColoredCompressor,
...
static swig_cast_info _swigc__p_ATK__GainColoredCompressorFilterT_DspFloatType_t[] = {  {&_swigt__p_ATK__GainColoredCompressorFilterT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_Filters__AudioTK__Dynamics__GainColoredCompressor[] = {  {&_swigt__p_Filters__AudioTK__Dynamics__GainColoredCompressor, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ATK__GainColoredCompressorFilterT_DspFloatType_t,
  _swigc__p_AmplifierProcessor,
  _swigc__p_FilterProcessor,
  _swigc__p_Filters__AudioTK__Dynamics__GainColoredCompressor,
