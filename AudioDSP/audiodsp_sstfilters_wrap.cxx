...
#define SWIGTYPE_p_FX__SstFilter__SstFilter swig_types[1]
#define SWIGTYPE_p_FX__SstFilter__SstFilterState swig_types[2]
...
#define SWIGTYPE_p_a_FX__SstFilter__SstFilterState__dbLength__float swig_types[40]
...
#define SWIGTYPE_p_sst__filters__FilterCoefficientMakerT_t swig_types[51]
...
#define SWIG_name      "audiodsp_sstfilters"
#define SWIG_init      luaopen_audiodsp_sstfilters
#define SWIG_init_user luaopen_audiodsp_sstfilters_user

#define SWIG_LUACODE   luaopen_audiodsp_sstfilters_luacode
...
#include "audiodsp_sstfilters.hpp"
...
static int _wrap_SstFilterState_delayBufferData_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::SstFilter::SstFilterState *arg1 = (FX::SstFilter::SstFilterState *) 0 ;
  float (*arg2)[FX::SstFilter::SstFilterState::dbLength] ;
  
  SWIG_check_num_args("FX::SstFilter::SstFilterState::delayBufferData",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::SstFilter::SstFilterState::delayBufferData",1,"FX::SstFilter::SstFilterState *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::SstFilter::SstFilterState::delayBufferData",2,"float [4][FX::SstFilter::SstFilterState::dbLength]");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__SstFilter__SstFilterState,0))){
    SWIG_fail_ptr("SstFilterState_delayBufferData_set",1,SWIGTYPE_p_FX__SstFilter__SstFilterState);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_a_FX__SstFilter__SstFilterState__dbLength__float,0))){
    SWIG_fail_ptr("SstFilterState_delayBufferData_set",2,SWIGTYPE_p_a_FX__SstFilter__SstFilterState__dbLength__float);
  }
  
  {
    float (*inp)[FX::SstFilter::SstFilterState::dbLength] = (float (*)[FX::SstFilter::SstFilterState::dbLength])(arg2);
    float (*dest)[FX::SstFilter::SstFilterState::dbLength] = (float (*)[FX::SstFilter::SstFilterState::dbLength])(arg1->delayBufferData);
    size_t ii = 0;
    for (; ii < 4; ++ii) {
      float *ip = inp[ii];
      float *dp = dest[ii];
      size_t jj = 0;
      for (; jj < FX::SstFilter::SstFilterState::dbLength; ++jj) dp[jj] = ip[jj];
    }
  }
...
static int _wrap_SstFilterState_delayBufferData_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::SstFilter::SstFilterState *arg1 = (FX::SstFilter::SstFilterState *) 0 ;
  float (*result)[FX::SstFilter::SstFilterState::dbLength] = 0 ;
  
  SWIG_check_num_args("FX::SstFilter::SstFilterState::delayBufferData",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::SstFilter::SstFilterState::delayBufferData",1,"FX::SstFilter::SstFilterState *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__SstFilter__SstFilterState,0))){
    SWIG_fail_ptr("SstFilterState_delayBufferData_get",1,SWIGTYPE_p_FX__SstFilter__SstFilterState);
  }
  
  result = (float (*)[FX::SstFilter::SstFilterState::dbLength])(float (*)[FX::SstFilter::SstFilterState::dbLength]) ((arg1)->delayBufferData);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_a_FX__SstFilter__SstFilterState__dbLength__float,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_SstFilterState(lua_State* L) {
  ...
  SWIG_check_num_args("FX::SstFilter::SstFilterState::SstFilterState",0,0)
  result = (FX::SstFilter::SstFilterState *)new FX::SstFilter::SstFilterState();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__SstFilter__SstFilterState,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_SstFilterState_reset(lua_State* L) {
  ...
  SWIG_check_num_args("FX::SstFilter::SstFilterState::reset",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::SstFilter::SstFilterState::reset",1,"FX::SstFilter::SstFilterState *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__SstFilter__SstFilterState,0))){
    SWIG_fail_ptr("SstFilterState_reset",1,SWIGTYPE_p_FX__SstFilter__SstFilterState);
  }
...
FX::SstFilter::SstFilterState *arg1 = (FX::SstFilter::SstFilterState *) obj;
delete arg1;
}
...
static swig_lua_attribute swig_SstFilterState_attributes[] = {
    { "delayBufferData", _wrap_SstFilterState_delayBufferData_get, _wrap_SstFilterState_delayBufferData_set },
    {0,0,0}
};
...
static swig_lua_class _wrap_class_SstFilterState = { "SstFilterState", "SstFilterState", &SWIGTYPE_p_FX__SstFilter__SstFilterState,_proxy__wrap_new_SstFilterState, swig_delete_SstFilterState, swig_SstFilterState_methods, swig_SstFilterState_attributes, &swig_SstFilterState_Sf_SwigStatic, swig_SstFilterState_meta, swig_SstFilterState_bases, swig_SstFilterState_base_names };
...
static swig_type_info _swigt__p_FX__SstFilter__SstFilterState = {"_p_FX__SstFilter__SstFilterState", "FX::SstFilter::SstFilterState *", 0, 0, (void*)&_wrap_class_SstFilterState, 0};
...
static swig_type_info _swigt__p_a_FX__SstFilter__SstFilterState__dbLength__float = {"_p_a_FX__SstFilter__SstFilterState__dbLength__float", "float (*)[FX::SstFilter::SstFilterState::dbLength]", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_a_FX__SstFilter__SstFilterState__dbLength__float,
  &_swigt__p_double,
  &_swigt__p_float,
  &_swigt__p_int,
  &_swigt__p_long_long,
...
static swig_cast_info _swigc__p_a_FX__SstFilter__SstFilterState__dbLength__float[] = {  {&_swigt__p_a_FX__SstFilter__SstFilterState__dbLength__float, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_a_FX__SstFilter__SstFilterState__dbLength__float,
  _swigc__p_double,
  _swigc__p_float,
  _swigc__p_int,
  _swigc__p_long_long,
