...
#define SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t swig_types[0]
#define SWIGTYPE_p_ListT_SWIGLUA_REF_t swig_types[1]
#define SWIGTYPE_p_SWIGLUA_REF swig_types[2]
#define SWIGTYPE_p_double swig_types[3]
#define SWIGTYPE_p_f_float__float swig_types[4]
#define SWIGTYPE_p_f_r_q_const__float__float swig_types[5]
#define SWIGTYPE_p_fenv_t swig_types[6]
#define SWIGTYPE_p_fexcept_t swig_types[7]
...
#define SWIGTYPE_p_std__gslice swig_types[16]
#define SWIGTYPE_p_std__gslice_arrayT_float_t swig_types[17]
#define SWIGTYPE_p_std__indirect_arrayT_float_t swig_types[18]
#define SWIGTYPE_p_std__mapT_std__string_SWIGLUA_REF_t swig_types[19]
#define SWIGTYPE_p_std__map_iteratorT_std__string_SWIGLUA_REF_t swig_types[20]
#define SWIGTYPE_p_std__mask_arrayT_float_t swig_types[21]
#define SWIGTYPE_p_std__numeric_limitsT_double_t swig_types[22]
#define SWIGTYPE_p_std__numeric_limitsT_float_t swig_types[23]
#define SWIGTYPE_p_std__numeric_limitsT_int_t swig_types[24]
#define SWIGTYPE_p_std__numeric_limitsT_long_long_t swig_types[25]
#define SWIGTYPE_p_std__numeric_limitsT_long_t swig_types[26]
#define SWIGTYPE_p_std__numeric_limitsT_short_t swig_types[27]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_int_t swig_types[28]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_long_long_t swig_types[29]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_long_t swig_types[30]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_short_t swig_types[31]
#define SWIGTYPE_p_std__slice swig_types[32]
#define SWIGTYPE_p_std__slice_arrayT_float_t swig_types[33]
#define SWIGTYPE_p_std__string swig_types[34]
#define SWIGTYPE_p_std__valarrayT_float_t swig_types[35]
#define SWIGTYPE_p_std__vectorT_SWIGLUA_REF_t swig_types[36]
#define SWIGTYPE_p_std__vector_iteratorT_SWIGLUA_REF_t swig_types[37]
...
static int _wrap_lua_map___getitem(lua_State* L) {
  ...
  if(!lua_isstring(L,2)) SWIG_fail_arg("std::map< std::string,SWIGLUA_REF >::__getitem",2,"std::string const &");
...
static int _wrap_lua_map___setitem(lua_State* L) {
  ...
  if(!lua_isstring(L,2)) SWIG_fail_arg("std::map< std::string,SWIGLUA_REF >::__setitem",2,"std::string const &");
...
static int _wrap_lua_map_erase(lua_State* L) {
  ...
  if(!lua_isstring(L,2)) SWIG_fail_arg("std::map< std::string,SWIGLUA_REF >::erase",2,"std::string const &");
...
static int _wrap_lua_map_count(lua_State* L) {
  ...
  if(!lua_isstring(L,2)) SWIG_fail_arg("std::map< std::string,SWIGLUA_REF >::count",2,"std::string const &");
...
static int _wrap_new_lua_list(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *result = 0 ;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::List",0,0)
  result = (List< SWIGLUA_REF > *)new List< SWIGLUA_REF >();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ListT_SWIGLUA_REF_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_lua_list_count(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  size_t result;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::count",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::count",1,"List< SWIGLUA_REF > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_count",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_list___getitem(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  size_t arg2 ;
  SWIGLUA_REF result;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::__getitem__",1,"List< SWIGLUA_REF > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("List< SWIGLUA_REF >::__getitem__",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list___getitem",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_list___setitem(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  size_t arg2 ;
  SWIGLUA_REF arg3 ;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::__setitem__",1,"List< SWIGLUA_REF > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("List< SWIGLUA_REF >::__setitem__",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list___setitem",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_list_getAt(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  size_t arg2 ;
  SWIGLUA_REF result;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::getAt",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::getAt",1,"List< SWIGLUA_REF > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("List< SWIGLUA_REF >::getAt",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_getAt",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_list_setAt(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  size_t arg2 ;
  SWIGLUA_REF arg3 ;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::setAt",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::setAt",1,"List< SWIGLUA_REF > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("List< SWIGLUA_REF >::setAt",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_setAt",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_list_pushBack(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  SWIGLUA_REF arg2 ;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::pushBack",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::pushBack",1,"List< SWIGLUA_REF > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_pushBack",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_list_popBack(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  SWIGLUA_REF result;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::popBack",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::popBack",1,"List< SWIGLUA_REF > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_popBack",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_list_pushFront(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  SWIGLUA_REF arg2 ;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::pushFront",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::pushFront",1,"List< SWIGLUA_REF > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_pushFront",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_list_popFront(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  SWIGLUA_REF result;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::popFront",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::popFront",1,"List< SWIGLUA_REF > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_popFront",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
  
  result = (arg1)->popFront();
  if ((&result)->L!=0)  {
    swiglua_ref_get(&result);
  } else {
    lua_pushnil(L);
...
static int _wrap_lua_list_insertAt(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  size_t arg2 ;
  SWIGLUA_REF arg3 ;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::insertAt",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::insertAt",1,"List< SWIGLUA_REF > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("List< SWIGLUA_REF >::insertAt",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_insertAt",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_list_removeAt(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  size_t arg2 ;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::removeAt",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::removeAt",1,"List< SWIGLUA_REF > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("List< SWIGLUA_REF >::removeAt",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_removeAt",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_list_split(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  size_t arg2 ;
  List< SWIGLUA_REF > result;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::split",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::split",1,"List< SWIGLUA_REF > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("List< SWIGLUA_REF >::split",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_split",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
  ...
  {
    List< SWIGLUA_REF > * resultptr = new List< SWIGLUA_REF >((const List< SWIGLUA_REF > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_ListT_SWIGLUA_REF_t,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static int _wrap_lua_list_mergeBack(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  List< SWIGLUA_REF > *arg2 = 0 ;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::mergeBack",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::mergeBack",1,"List< SWIGLUA_REF > *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("List< SWIGLUA_REF >::mergeBack",2,"List< SWIGLUA_REF > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_mergeBack",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_mergeBack",2,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
  
  (arg1)->mergeBack((List< SWIGLUA_REF > const &)*arg2);
...
static int _wrap_lua_list_mergeFront(lua_State* L) {
  int SWIG_arg = 0;
  List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) 0 ;
  List< SWIGLUA_REF > *arg2 = 0 ;
  
  SWIG_check_num_args("List< SWIGLUA_REF >::mergeFront",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("List< SWIGLUA_REF >::mergeFront",1,"List< SWIGLUA_REF > *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("List< SWIGLUA_REF >::mergeFront",2,"List< SWIGLUA_REF > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_mergeFront",1,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ListT_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_list_mergeFront",2,SWIGTYPE_p_ListT_SWIGLUA_REF_t);
  }
  
  (arg1)->mergeFront((List< SWIGLUA_REF > const &)*arg2);
...
static void swig_delete_lua_list(void *obj) {
List< SWIGLUA_REF > *arg1 = (List< SWIGLUA_REF > *) obj;
delete arg1;
}
static int _proxy__wrap_new_lua_list(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_lua_list);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_lua_list_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_lua_list_methods[]= {
    { "count", _wrap_lua_list_count},
    { "__getitem", _wrap_lua_list___getitem},
    { "__setitem", _wrap_lua_list___setitem},
    { "getAt", _wrap_lua_list_getAt},
    { "setAt", _wrap_lua_list_setAt},
    { "pushBack", _wrap_lua_list_pushBack},
    { "popBack", _wrap_lua_list_popBack},
    { "pushFront", _wrap_lua_list_pushFront},
    { "popFront", _wrap_lua_list_popFront},
    { "insertAt", _wrap_lua_list_insertAt},
    { "removeAt", _wrap_lua_list_removeAt},
    { "split", _wrap_lua_list_split},
    { "mergeBack", _wrap_lua_list_mergeBack},
    { "mergeFront", _wrap_lua_list_mergeFront},
    {0,0}
};
static swig_lua_method swig_lua_list_meta[] = {
    { "__getitem", _wrap_lua_list___getitem},
    { "__setitem", _wrap_lua_list___setitem},
    {0,0}
};

static swig_lua_attribute swig_lua_list_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_lua_list_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_lua_list_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_lua_list_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_lua_list_Sf_SwigStatic = {
    "lua_list",
    swig_lua_list_Sf_SwigStatic_methods,
    swig_lua_list_Sf_SwigStatic_attributes,
    swig_lua_list_Sf_SwigStatic_constants,
    swig_lua_list_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_lua_list_bases[] = {0};
static const char *swig_lua_list_base_names[] = {0};
static swig_lua_class _wrap_class_lua_list = { "lua_list", "lua_list", &SWIGTYPE_p_ListT_SWIGLUA_REF_t,_proxy__wrap_new_lua_list, swig_delete_lua_list, swig_lua_list_methods, swig_lua_list_attributes, &swig_lua_list_Sf_SwigStatic, swig_lua_list_meta, swig_lua_list_bases, swig_lua_list_base_names };

static int _wrap_lua_dict_null_set(lua_State* L) {
  int SWIG_arg = 0;
  Dict< std::string,SWIGLUA_REF > *arg1 = (Dict< std::string,SWIGLUA_REF > *) 0 ;
  SWIGLUA_REF arg2 ;
  
  SWIG_check_num_args("Dict< std::string,SWIGLUA_REF >::null",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::null",1,"Dict< std::string,SWIGLUA_REF > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_dict_null_set",1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_dict_null_get(lua_State* L) {
  int SWIG_arg = 0;
  Dict< std::string,SWIGLUA_REF > *arg1 = (Dict< std::string,SWIGLUA_REF > *) 0 ;
  SWIGLUA_REF result;
  
  SWIG_check_num_args("Dict< std::string,SWIGLUA_REF >::null",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::null",1,"Dict< std::string,SWIGLUA_REF > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_dict_null_get",1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t);
  }
...
static int _wrap_new_lua_dict(lua_State* L) {
  int SWIG_arg = 0;
  Dict< std::string,SWIGLUA_REF > *result = 0 ;
  
  SWIG_check_num_args("Dict< std::string,SWIGLUA_REF >::Dict",0,0)
  result = (Dict< std::string,SWIGLUA_REF > *)new Dict< std::string,SWIGLUA_REF >();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_lua_dict_findKey(lua_State* L) {
  int SWIG_arg = 0;
  Dict< std::string,SWIGLUA_REF > *arg1 = (Dict< std::string,SWIGLUA_REF > *) 0 ;
  std::string *arg2 = 0 ;
  std::string temp2 ;
  ...
  SWIG_check_num_args("Dict< std::string,SWIGLUA_REF >::findKey",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::findKey",1,"Dict< std::string,SWIGLUA_REF > *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::findKey",2,"std::string const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_dict_findKey",1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t);
  }
  
  temp2.assign(lua_tostring(L,2),lua_rawlen(L,2)); arg2=&temp2;
  result = (bool)(arg1)->findKey((std::string const &)*arg2);
  lua_pushboolean(L,(int)(result!=0)); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_lua_dict_insert(lua_State* L) {
  int SWIG_arg = 0;
  Dict< std::string,SWIGLUA_REF > *arg1 = (Dict< std::string,SWIGLUA_REF > *) 0 ;
  std::string *arg2 = 0 ;
  SWIGLUA_REF *arg3 = 0 ;
  ...
  SWIG_check_num_args("Dict< std::string,SWIGLUA_REF >::insert",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::insert",1,"Dict< std::string,SWIGLUA_REF > *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::insert",2,"std::string const &");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::insert",3,"SWIGLUA_REF const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_dict_insert",1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t);
  }
  
  temp2.assign(lua_tostring(L,2),lua_rawlen(L,2)); arg2=&temp2;
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_SWIGLUA_REF,0))){
    SWIG_fail_ptr("lua_dict_insert",3,SWIGTYPE_p_SWIGLUA_REF);
  }
  
  (arg1)->insert((std::string const &)*arg2,(SWIGLUA_REF const &)*arg3);
...
static int _wrap_lua_dict_remove(lua_State* L) {
  int SWIG_arg = 0;
  Dict< std::string,SWIGLUA_REF > *arg1 = (Dict< std::string,SWIGLUA_REF > *) 0 ;
  std::string *arg2 = 0 ;
  std::string temp2 ;
  
  SWIG_check_num_args("Dict< std::string,SWIGLUA_REF >::remove",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::remove",1,"Dict< std::string,SWIGLUA_REF > *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::remove",2,"std::string const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_dict_remove",1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t);
  }
...
static int _wrap_lua_dict_isNull(lua_State* L) {
  int SWIG_arg = 0;
  Dict< std::string,SWIGLUA_REF > *arg1 = (Dict< std::string,SWIGLUA_REF > *) 0 ;
  SWIGLUA_REF *arg2 = 0 ;
  bool result;
  
  SWIG_check_num_args("Dict< std::string,SWIGLUA_REF >::isNull",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::isNull",1,"Dict< std::string,SWIGLUA_REF > *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("Dict< std::string,SWIGLUA_REF >::isNull",2,"SWIGLUA_REF const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t,0))){
    SWIG_fail_ptr("lua_dict_isNull",1,SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_SWIGLUA_REF,0))){
    SWIG_fail_ptr("lua_dict_isNull",2,SWIGTYPE_p_SWIGLUA_REF);
  }
  
  result = (bool)(arg1)->isNull((SWIGLUA_REF const &)*arg2);
  lua_pushboolean(L,(int)(result!=0)); SWIG_arg++;
  return SWIG_arg;
...
static void swig_delete_lua_dict(void *obj) {
Dict< std::string,SWIGLUA_REF > *arg1 = (Dict< std::string,SWIGLUA_REF > *) obj;
delete arg1;
}
static int _proxy__wrap_new_lua_dict(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_lua_dict);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_lua_dict_attributes[] = {
    { "null", _wrap_lua_dict_null_get, _wrap_lua_dict_null_set },
    {0,0,0}
};
static swig_lua_method swig_lua_dict_methods[]= {
    { "findKey", _wrap_lua_dict_findKey},
    { "insert", _wrap_lua_dict_insert},
    { "remove", _wrap_lua_dict_remove},
    { "isNull", _wrap_lua_dict_isNull},
    {0,0}
};
static swig_lua_method swig_lua_dict_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_lua_dict_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_lua_dict_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_lua_dict_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_lua_dict_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_lua_dict_Sf_SwigStatic = {
    "lua_dict",
    swig_lua_dict_Sf_SwigStatic_methods,
    swig_lua_dict_Sf_SwigStatic_attributes,
    swig_lua_dict_Sf_SwigStatic_constants,
    swig_lua_dict_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_lua_dict_bases[] = {0,0};
static const char *swig_lua_dict_base_names[] = {"std::map< std::string,SWIGLUA_REF > *",0};
static swig_lua_class _wrap_class_lua_dict = { "lua_dict", "lua_dict", &SWIGTYPE_p_DictT_std__string_SWIGLUA_REF_t,_proxy__wrap_new_lua_dict, swig_delete_lua_dict, swig_lua_dict_methods, swig_lua_dict_attributes, &swig_lua_dict_Sf_SwigStatic, swig_lua_dict_meta, swig_lua_dict_bases, swig_lua_dict_base_names };
...
&_wrap_class_lua_list,
&_wrap_class_lua_dict,
    0
};
...
static void *_p_DictT_std__string_SWIGLUA_REF_tTo_p_std__mapT_std__string_SWIGLUA_REF_t(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((std::map< std::string,SWIGLUA_REF > *)  ((Dict< std::string,SWIGLUA_REF > *) x));
}
static swig_type_info _swigt__p_DictT_std__string_SWIGLUA_REF_t = {"_p_DictT_std__string_SWIGLUA_REF_t", "Dict< std::string,SWIGLUA_REF > *", 0, 0, (void*)&_wrap_class_lua_dict, 0};
static swig_type_info _swigt__p_ListT_SWIGLUA_REF_t = {"_p_ListT_SWIGLUA_REF_t", "List< SWIGLUA_REF > *", 0, 0, (void*)&_wrap_class_lua_list, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_DictT_std__string_SWIGLUA_REF_t,
  &_swigt__p_ListT_SWIGLUA_REF_t,
...
static swig_cast_info _swigc__p_DictT_std__string_SWIGLUA_REF_t[] = {  {&_swigt__p_DictT_std__string_SWIGLUA_REF_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ListT_SWIGLUA_REF_t[] = {  {&_swigt__p_ListT_SWIGLUA_REF_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__mapT_std__string_SWIGLUA_REF_t[] = {  {&_swigt__p_std__mapT_std__string_SWIGLUA_REF_t, 0, 0, 0},  {&_swigt__p_DictT_std__string_SWIGLUA_REF_t, _p_DictT_std__string_SWIGLUA_REF_tTo_p_std__mapT_std__string_SWIGLUA_REF_t, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_DictT_std__string_SWIGLUA_REF_t,
  _swigc__p_ListT_SWIGLUA_REF_t,
