swig -lua -c++ -Iinclude audiodsp_faustfx.i
...
-o faustfx.so audiodsp_faustfx_wrap.cxx -lstdc++ -lm -lsndfile -lluajit -lfaustwithllvm -lpthread -lrt -ldl -lLLVM-10 -lz -lcurses 
