...
#define SWIGTYPE_p_OnePole swig_types[18]
...
#define SWIG_name      "OnePole"
#define SWIG_init      luaopen_OnePole
#define SWIG_init_user luaopen_OnePole_user

#define SWIG_LUACODE   luaopen_OnePole_luacode
...
static int _wrap_new_OnePole__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("OnePole::OnePole",0,0)
  result = (OnePole *)new OnePole();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_OnePole,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_OnePole__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("OnePole::OnePole",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("OnePole::OnePole",1,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  result = (OnePole *)new OnePole(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_OnePole,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_OnePole(lua_State* L) {
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'new_OnePole'\n"
    "  Possible C/C++ prototypes are:\n"
    "    OnePole::OnePole()\n"
    "    OnePole::OnePole(DspFloatType)\n");
  lua_error(L);return 0;
}


static int _wrap_OnePole_setFc(lua_State* L) {
  int SWIG_arg = 0;
  OnePole *arg1 = (OnePole *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("OnePole::setFc",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("OnePole::setFc",1,"OnePole *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("OnePole::setFc",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_OnePole,0))){
    SWIG_fail_ptr("OnePole_setFc",1,SWIGTYPE_p_OnePole);
  }
...
static int _wrap_OnePole_setHighPass(lua_State* L) {
  int SWIG_arg = 0;
  OnePole *arg1 = (OnePole *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("OnePole::setHighPass",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("OnePole::setHighPass",1,"OnePole *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("OnePole::setHighPass",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_OnePole,0))){
    SWIG_fail_ptr("OnePole_setHighPass",1,SWIGTYPE_p_OnePole);
  }
...
static int _wrap_OnePole_process(lua_State* L) {
  ...
  SWIG_check_num_args("OnePole::process",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("OnePole::process",1,"OnePole *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("OnePole::process",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_OnePole,0))){
    SWIG_fail_ptr("OnePole_process",1,SWIGTYPE_p_OnePole);
  }
...
static swig_lua_method swig_OnePole_methods[]= {
    { "setFc", _wrap_OnePole_setFc},
    { "setHighPass", _wrap_OnePole_setHighPass},
...
static swig_lua_class _wrap_class_OnePole = { "OnePole", "OnePole", &SWIGTYPE_p_OnePole,_proxy__wrap_new_OnePole, swig_delete_OnePole, swig_OnePole_methods, swig_OnePole_attributes, &swig_OnePole_Sf_SwigStatic, swig_OnePole_meta, swig_OnePole_bases, swig_OnePole_base_names };
...
static swig_type_info _swigt__p_OnePole = {"_p_OnePole", "OnePole *", 0, 0, (void*)&_wrap_class_OnePole, 0};
