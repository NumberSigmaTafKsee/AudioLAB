...
#define SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion swig_types[1]
#define SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion__Controls swig_types[2]
#define SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics swig_types[3]
#define SWIGTYPE_p_FX__Distortion__DistortionCompressor__PeakLevelDetector swig_types[4]
...
#define SWIG_name      "DistortionCompressor"
#define SWIG_init      luaopen_DistortionCompressor
#define SWIG_init_user luaopen_DistortionCompressor_user

#define SWIG_LUACODE   luaopen_DistortionCompressor_luacode
...
static int _wrap_new_PeakLevelDetector(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  FX::Distortion::DistortionCompressor::PeakLevelDetector *result = 0 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::PeakLevelDetector::PeakLevelDetector",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::PeakLevelDetector::PeakLevelDetector",1,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  result = (FX::Distortion::DistortionCompressor::PeakLevelDetector *)new FX::Distortion::DistortionCompressor::PeakLevelDetector(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__Distortion__DistortionCompressor__PeakLevelDetector,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_PeakLevelDetector_tick(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::PeakLevelDetector *arg1 = (FX::Distortion::DistortionCompressor::PeakLevelDetector *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::PeakLevelDetector::tick",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::PeakLevelDetector::tick",1,"FX::Distortion::DistortionCompressor::PeakLevelDetector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::PeakLevelDetector::tick",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__PeakLevelDetector,0))){
    SWIG_fail_ptr("PeakLevelDetector_tick",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__PeakLevelDetector);
  }
...
static int _wrap_PeakLevelDetector_setDetector(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::PeakLevelDetector *arg1 = (FX::Distortion::DistortionCompressor::PeakLevelDetector *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::PeakLevelDetector::setDetector",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::PeakLevelDetector::setDetector",1,"FX::Distortion::DistortionCompressor::PeakLevelDetector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::PeakLevelDetector::setDetector",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__PeakLevelDetector,0))){
    SWIG_fail_ptr("PeakLevelDetector_setDetector",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__PeakLevelDetector);
  }
...
static void swig_delete_PeakLevelDetector(void *obj) {
FX::Distortion::DistortionCompressor::PeakLevelDetector *arg1 = (FX::Distortion::DistortionCompressor::PeakLevelDetector *) obj;
delete arg1;
}
static int _proxy__wrap_new_PeakLevelDetector(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_PeakLevelDetector);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_PeakLevelDetector_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_PeakLevelDetector_methods[]= {
    { "tick", _wrap_PeakLevelDetector_tick},
    { "setDetector", _wrap_PeakLevelDetector_setDetector},
    {0,0}
};
static swig_lua_method swig_PeakLevelDetector_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_PeakLevelDetector_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_PeakLevelDetector_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_PeakLevelDetector_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_PeakLevelDetector_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_PeakLevelDetector_Sf_SwigStatic = {
    "PeakLevelDetector",
    swig_PeakLevelDetector_Sf_SwigStatic_methods,
    swig_PeakLevelDetector_Sf_SwigStatic_attributes,
    swig_PeakLevelDetector_Sf_SwigStatic_constants,
    swig_PeakLevelDetector_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_PeakLevelDetector_bases[] = {0};
static const char *swig_PeakLevelDetector_base_names[] = {0};
static swig_lua_class _wrap_class_PeakLevelDetector = { "PeakLevelDetector", "PeakLevelDetector", &SWIGTYPE_p_FX__Distortion__DistortionCompressor__PeakLevelDetector,_proxy__wrap_new_PeakLevelDetector, swig_delete_PeakLevelDetector, swig_PeakLevelDetector_methods, swig_PeakLevelDetector_attributes, &swig_PeakLevelDetector_Sf_SwigStatic, swig_PeakLevelDetector_meta, swig_PeakLevelDetector_bases, swig_PeakLevelDetector_base_names };

static int _wrap_new_GainDynamics(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  FX::Distortion::DistortionCompressor::GainDynamics *result = 0 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::GainDynamics::GainDynamics",3,3)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::GainDynamics",1,"DspFloatType");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::GainDynamics",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::GainDynamics",3,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  arg3 = (DspFloatType)lua_tonumber(L, 3);
  result = (FX::Distortion::DistortionCompressor::GainDynamics *)new FX::Distortion::DistortionCompressor::GainDynamics(arg1,arg2,arg3);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_GainDynamics_tick(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::GainDynamics *arg1 = (FX::Distortion::DistortionCompressor::GainDynamics *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::GainDynamics::tick",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::tick",1,"FX::Distortion::DistortionCompressor::GainDynamics *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::tick",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics,0))){
    SWIG_fail_ptr("GainDynamics_tick",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics);
  }
...
static int _wrap_GainDynamics_setDetector(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::GainDynamics *arg1 = (FX::Distortion::DistortionCompressor::GainDynamics *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::GainDynamics::setDetector",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::setDetector",1,"FX::Distortion::DistortionCompressor::GainDynamics *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::setDetector",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics,0))){
    SWIG_fail_ptr("GainDynamics_setDetector",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics);
  }
...
static int _wrap_GainDynamics_setAttack(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::GainDynamics *arg1 = (FX::Distortion::DistortionCompressor::GainDynamics *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::GainDynamics::setAttack",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::setAttack",1,"FX::Distortion::DistortionCompressor::GainDynamics *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::setAttack",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics,0))){
    SWIG_fail_ptr("GainDynamics_setAttack",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics);
  }
...
static int _wrap_GainDynamics_setRelease(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::GainDynamics *arg1 = (FX::Distortion::DistortionCompressor::GainDynamics *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::GainDynamics::setRelease",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::setRelease",1,"FX::Distortion::DistortionCompressor::GainDynamics *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::GainDynamics::setRelease",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics,0))){
    SWIG_fail_ptr("GainDynamics_setRelease",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics);
  }
...
static void swig_delete_GainDynamics(void *obj) {
FX::Distortion::DistortionCompressor::GainDynamics *arg1 = (FX::Distortion::DistortionCompressor::GainDynamics *) obj;
delete arg1;
}
static int _proxy__wrap_new_GainDynamics(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_GainDynamics);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_GainDynamics_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_GainDynamics_methods[]= {
    { "tick", _wrap_GainDynamics_tick},
    { "setDetector", _wrap_GainDynamics_setDetector},
    { "setAttack", _wrap_GainDynamics_setAttack},
    { "setRelease", _wrap_GainDynamics_setRelease},
    {0,0}
};
static swig_lua_method swig_GainDynamics_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_GainDynamics_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_GainDynamics_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_GainDynamics_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_GainDynamics_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_GainDynamics_Sf_SwigStatic = {
    "GainDynamics",
    swig_GainDynamics_Sf_SwigStatic_methods,
    swig_GainDynamics_Sf_SwigStatic_attributes,
    swig_GainDynamics_Sf_SwigStatic_constants,
    swig_GainDynamics_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_GainDynamics_bases[] = {0};
static const char *swig_GainDynamics_base_names[] = {0};
static swig_lua_class _wrap_class_GainDynamics = { "GainDynamics", "GainDynamics", &SWIGTYPE_p_FX__Distortion__DistortionCompressor__GainDynamics,_proxy__wrap_new_GainDynamics, swig_delete_GainDynamics, swig_GainDynamics_methods, swig_GainDynamics_attributes, &swig_GainDynamics_Sf_SwigStatic, swig_GainDynamics_meta, swig_GainDynamics_bases, swig_GainDynamics_base_names };

static int _wrap_Distortion_controls_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::Distortion *arg1 = (FX::Distortion::DistortionCompressor::Distortion *) 0 ;
  FX::Distortion::DistortionCompressor::Distortion::Controls *arg2 = (FX::Distortion::DistortionCompressor::Distortion::Controls *) 0 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::Distortion::controls",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::controls",1,"FX::Distortion::DistortionCompressor::Distortion *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::controls",2,"FX::Distortion::DistortionCompressor::Distortion::Controls *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion,0))){
    SWIG_fail_ptr("Distortion_controls_set",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion__Controls,0))){
    SWIG_fail_ptr("Distortion_controls_set",2,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion__Controls);
  }
...
static int _wrap_Distortion_controls_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::Distortion *arg1 = (FX::Distortion::DistortionCompressor::Distortion *) 0 ;
  FX::Distortion::DistortionCompressor::Distortion::Controls *result = 0 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::Distortion::controls",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::controls",1,"FX::Distortion::DistortionCompressor::Distortion *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion,0))){
    SWIG_fail_ptr("Distortion_controls_get",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion);
  }
  
  result = (FX::Distortion::DistortionCompressor::Distortion::Controls *)& ((arg1)->controls);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion__Controls,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_Distortion(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::Distortion *result = 0 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::Distortion::Distortion",0,0)
  result = (FX::Distortion::DistortionCompressor::Distortion *)new FX::Distortion::DistortionCompressor::Distortion();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Distortion_processSample(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::Distortion *arg1 = (FX::Distortion::DistortionCompressor::Distortion *) 0 ;
  DspFloatType arg2 ;
  int arg3 ;
  ...
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::Distortion::processSample",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::processSample",1,"FX::Distortion::DistortionCompressor::Distortion *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::processSample",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::processSample",3,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion,0))){
    SWIG_fail_ptr("Distortion_processSample",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion);
  }
...
static int _wrap_Distortion_input_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::Distortion *arg1 = (FX::Distortion::DistortionCompressor::Distortion *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::Distortion::input",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::input",1,"FX::Distortion::DistortionCompressor::Distortion *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::input",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion,0))){
    SWIG_fail_ptr("Distortion_input_set",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion);
  }
...
static int _wrap_Distortion_input_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::Distortion *arg1 = (FX::Distortion::DistortionCompressor::Distortion *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::Distortion::input",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::input",1,"FX::Distortion::DistortionCompressor::Distortion *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion,0))){
    SWIG_fail_ptr("Distortion_input_get",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion);
  }
  
  result = (DspFloatType) ((arg1)->input);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Distortion_output_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::Distortion *arg1 = (FX::Distortion::DistortionCompressor::Distortion *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::Distortion::output",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::output",1,"FX::Distortion::DistortionCompressor::Distortion *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::output",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion,0))){
    SWIG_fail_ptr("Distortion_output_set",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion);
  }
...
static int _wrap_Distortion_output_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::Distortion::DistortionCompressor::Distortion *arg1 = (FX::Distortion::DistortionCompressor::Distortion *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::Distortion::DistortionCompressor::Distortion::output",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Distortion::DistortionCompressor::Distortion::output",1,"FX::Distortion::DistortionCompressor::Distortion *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion,0))){
    SWIG_fail_ptr("Distortion_output_get",1,SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion);
  }
...
FX::Distortion::DistortionCompressor::Distortion *arg1 = (FX::Distortion::DistortionCompressor::Distortion *) obj;
delete arg1;
}
...
static swig_lua_attribute swig_Distortion_attributes[] = {
    { "controls", _wrap_Distortion_controls_get, _wrap_Distortion_controls_set },
    { "input", _wrap_Distortion_input_get, _wrap_Distortion_input_set },
    { "output", _wrap_Distortion_output_get, _wrap_Distortion_output_set },
    {0,0,0}
};
static swig_lua_method swig_Distortion_methods[]= {
    { "processSample", _wrap_Distortion_processSample},
    {0,0}
};
...
static swig_lua_class *swig_Distortion_bases[] = {0};
static const char *swig_Distortion_base_names[] = {0};
static swig_lua_class _wrap_class_Distortion = { "Distortion", "Distortion", &SWIGTYPE_p_FX__Distortion__DistortionCompressor__Distortion,_proxy__wrap_new_Distortion, swig_delete_Distortion, swig_Distortion_methods, swig_Distortion_attributes, &swig_Distortion_Sf_SwigStatic, swig_Distortion_meta, swig_Distortion_bases, swig_Distortion_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_FLOAT("TAU", 6.28318530717958647692)},
    {0,0,0,0,0,0}
};
...
&_wrap_class_PeakLevelDetector,
&_wrap_class_GainDynamics,
...
static swig_type_info _swigt__p_FX__Distortion__DistortionCompressor__Distortion = {"_p_FX__Distortion__DistortionCompressor__Distortion", "FX::Distortion::DistortionCompressor::Distortion *", 0, 0, (void*)&_wrap_class_Distortion, 0};
static swig_type_info _swigt__p_FX__Distortion__DistortionCompressor__Distortion__Controls = {"_p_FX__Distortion__DistortionCompressor__Distortion__Controls", "FX::Distortion::DistortionCompressor::Distortion::Controls *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_FX__Distortion__DistortionCompressor__GainDynamics = {"_p_FX__Distortion__DistortionCompressor__GainDynamics", "FX::Distortion::DistortionCompressor::GainDynamics *", 0, 0, (void*)&_wrap_class_GainDynamics, 0};
static swig_type_info _swigt__p_FX__Distortion__DistortionCompressor__PeakLevelDetector = {"_p_FX__Distortion__DistortionCompressor__PeakLevelDetector", "FX::Distortion::DistortionCompressor::PeakLevelDetector *", 0, 0, (void*)&_wrap_class_PeakLevelDetector, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FX__Distortion__DistortionCompressor__Distortion,
  &_swigt__p_FX__Distortion__DistortionCompressor__Distortion__Controls,
  &_swigt__p_FX__Distortion__DistortionCompressor__GainDynamics,
  &_swigt__p_FX__Distortion__DistortionCompressor__PeakLevelDetector,
...
static swig_cast_info _swigc__p_FX__Distortion__DistortionCompressor__Distortion[] = {  {&_swigt__p_FX__Distortion__DistortionCompressor__Distortion, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FX__Distortion__DistortionCompressor__Distortion__Controls[] = {  {&_swigt__p_FX__Distortion__DistortionCompressor__Distortion__Controls, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FX__Distortion__DistortionCompressor__GainDynamics[] = {  {&_swigt__p_FX__Distortion__DistortionCompressor__GainDynamics, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FX__Distortion__DistortionCompressor__PeakLevelDetector[] = {  {&_swigt__p_FX__Distortion__DistortionCompressor__PeakLevelDetector, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FX__Distortion__DistortionCompressor__Distortion,
  _swigc__p_FX__Distortion__DistortionCompressor__Distortion__Controls,
  _swigc__p_FX__Distortion__DistortionCompressor__GainDynamics,
  _swigc__p_FX__Distortion__DistortionCompressor__PeakLevelDetector,
