...
#define SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator swig_types[1]
#define SWIGTYPE_p_Analog__MinBLEP__TMinBlepPulseOscillator swig_types[2]
#define SWIGTYPE_p_Analog__MinBLEP__TMinBlepSawOscillator swig_types[3]
...
#define SWIGTYPE_p_p_FilterProcessor swig_types[52]
#define SWIGTYPE_p_p_FunctionProcessor swig_types[53]
#define SWIGTYPE_p_p_float swig_types[54]
#define SWIGTYPE_p_short swig_types[55]
#define SWIGTYPE_p_signed_char swig_types[56]
#define SWIGTYPE_p_std__complexT_double_t swig_types[57]
#define SWIGTYPE_p_std__complexT_float_t swig_types[58]
#define SWIGTYPE_p_std__gslice swig_types[59]
#define SWIGTYPE_p_std__gslice_arrayT_float_t swig_types[60]
#define SWIGTYPE_p_std__indirect_arrayT_float_t swig_types[61]
...
#define SWIGTYPE_p_std__mask_arrayT_float_t swig_types[70]
#define SWIGTYPE_p_std__numeric_limitsT_double_t swig_types[71]
#define SWIGTYPE_p_std__numeric_limitsT_float_t swig_types[72]
#define SWIGTYPE_p_std__numeric_limitsT_int_t swig_types[73]
#define SWIGTYPE_p_std__numeric_limitsT_long_long_t swig_types[74]
#define SWIGTYPE_p_std__numeric_limitsT_long_t swig_types[75]
#define SWIGTYPE_p_std__numeric_limitsT_short_t swig_types[76]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_int_t swig_types[77]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_long_long_t swig_types[78]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_long_t swig_types[79]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_short_t swig_types[80]
#define SWIGTYPE_p_std__slice swig_types[81]
#define SWIGTYPE_p_std__slice_arrayT_float_t swig_types[82]
#define SWIGTYPE_p_std__string swig_types[83]
#define SWIGTYPE_p_std__valarrayT_float_t swig_types[84]
#define SWIGTYPE_p_std__vectorT_MonoProcessor_p_t swig_types[85]
#define SWIGTYPE_p_std__vectorT_OscillatorProcessor_p_t swig_types[86]
#define SWIGTYPE_p_std__vectorT_SoundProcessor_p_t swig_types[87]
#define SWIGTYPE_p_std__vectorT_StereoProcessor_p_t swig_types[88]
#define SWIGTYPE_p_std__vectorT_double_t swig_types[89]
#define SWIGTYPE_p_std__vectorT_float_t swig_types[90]
#define SWIGTYPE_p_std__vectorT_std__complexT_double_t_t swig_types[91]
#define SWIGTYPE_p_std__vectorT_std__complexT_float_t_t swig_types[92]
#define SWIGTYPE_p_std__vector_iteratorT_double_t swig_types[93]
#define SWIGTYPE_p_std__vector_iteratorT_float_t swig_types[94]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_double_t_t swig_types[95]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_float_t_t swig_types[96]
...
#define SWIG_name      "MinBLEP"
#define SWIG_init      luaopen_MinBLEP
#define SWIG_init_user luaopen_MinBLEP_user

#define SWIG_LUACODE   luaopen_MinBLEP_luacode
...
static int _wrap_octaves(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::octaves",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::MinBLEP::octaves",1,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  result = (DspFloatType)Analog::MinBLEP::octaves(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_semitones(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::semitones",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::MinBLEP::semitones",1,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  result = (DspFloatType)Analog::MinBLEP::semitones(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_cents(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::cents",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::MinBLEP::cents",1,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  result = (DspFloatType)Analog::MinBLEP::cents(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_ms_to_samples(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::ms_to_samples",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::MinBLEP::ms_to_samples",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  result = (int)Analog::MinBLEP::ms_to_samples(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_hi7(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::hi7",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::MinBLEP::hi7",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  result = (uint8_t)Analog::MinBLEP::hi7(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_lo7(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::lo7",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::MinBLEP::lo7",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  result = (uint8_t)Analog::MinBLEP::lo7(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_fpow2(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::fpow2",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::MinBLEP::fpow2",1,"DspFloatType const");
  arg1 = (DspFloatType const)lua_tonumber(L, 1);
  result = (DspFloatType)Analog::MinBLEP::fpow2(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_zeroCrossings_get(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::zeroCrossings",0,0)
  result = (int)(int)Analog::MinBLEP::zeroCrossings;
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_overSampling_get(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::overSampling",0,0)
  result = (int)(int)Analog::MinBLEP::overSampling;
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_tablelength_get(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::tablelength",0,0)
  result = (int)(int)Analog::MinBLEP::tablelength;
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_length_get(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::length",0,0)
  result = (int)(int)Analog::MinBLEP::length;
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_integral_get(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::integral",0,0)
  result = (DspFloatType)(DspFloatType)Analog::MinBLEP::integral;
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_table_get(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::table",0,0)
  result = (DspFloatType *)(DspFloatType *)Analog::MinBLEP::table;
...
static int _wrap_new_TBaseOscillator(lua_State* L) {
  int SWIG_arg = 0;
  Analog::MinBLEP::TBaseOscillator *result = 0 ;
  
  SWIG_check_num_args("Analog::MinBLEP::TBaseOscillator::TBaseOscillator",0,0)
  result = (Analog::MinBLEP::TBaseOscillator *)new Analog::MinBLEP::TBaseOscillator();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_TBaseOscillator_SetFrequency(lua_State* L) {
  int SWIG_arg = 0;
  Analog::MinBLEP::TBaseOscillator *arg1 = (Analog::MinBLEP::TBaseOscillator *) 0 ;
  Analog::MinBLEP::TFrequency arg2 ;
  
  SWIG_check_num_args("Analog::MinBLEP::TBaseOscillator::SetFrequency",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::SetFrequency",1,"Analog::MinBLEP::TBaseOscillator *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::SetFrequency",2,"Analog::MinBLEP::TFrequency");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator,0))){
    SWIG_fail_ptr("TBaseOscillator_SetFrequency",1,SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator);
  }
  
  arg2 = (Analog::MinBLEP::TFrequency)lua_tonumber(L, 2);
  (arg1)->SetFrequency(arg2);
...
static int _wrap_TBaseOscillator_SetPulseWidth(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::TBaseOscillator::SetPulseWidth",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::SetPulseWidth",1,"Analog::MinBLEP::TBaseOscillator *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::SetPulseWidth",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator,0))){
    SWIG_fail_ptr("TBaseOscillator_SetPulseWidth",1,SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator);
  }
...
static int _wrap_TBaseOscillator_SetSync(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::TBaseOscillator::SetSync",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::SetSync",1,"Analog::MinBLEP::TBaseOscillator *");
  if(!lua_isboolean(L,2)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::SetSync",2,"bool");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator,0))){
    SWIG_fail_ptr("TBaseOscillator_SetSync",1,SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator);
  }
...
static int _wrap_TBaseOscillator_Process(lua_State* L) {
  int SWIG_arg = 0;
  Analog::MinBLEP::TBaseOscillator *arg1 = (Analog::MinBLEP::TBaseOscillator *) 0 ;
  Analog::MinBLEP::TSampleBuffer *arg2 = 0 ;
  Analog::MinBLEP::TSampleBuffer *arg3 = 0 ;
  Analog::MinBLEP::TSampleBuffer *arg4 = 0 ;
  Analog::MinBLEP::TSampleBuffer *arg5 = 0 ;
  
  SWIG_check_num_args("Analog::MinBLEP::TBaseOscillator::Process",5,5)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::Process",1,"Analog::MinBLEP::TBaseOscillator *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::Process",2,"Analog::MinBLEP::TSampleBuffer &");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::Process",3,"Analog::MinBLEP::TSampleBuffer &");
  if(!lua_isuserdata(L,4)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::Process",4,"Analog::MinBLEP::TSampleBuffer &");
  if(!lua_isuserdata(L,5)) SWIG_fail_arg("Analog::MinBLEP::TBaseOscillator::Process",5,"Analog::MinBLEP::TSampleBuffer &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator,0))){
    SWIG_fail_ptr("TBaseOscillator_Process",1,SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TBaseOscillator_Process",2,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TBaseOscillator_Process",3,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TBaseOscillator_Process",4,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,5,(void**)&arg5,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TBaseOscillator_Process",5,SWIGTYPE_p_std__vectorT_float_t);
  }
...
Analog::MinBLEP::TBaseOscillator *arg1 = (Analog::MinBLEP::TBaseOscillator *) obj;
delete arg1;
}
...
static swig_lua_class _wrap_class_TBaseOscillator = { "TBaseOscillator", "TBaseOscillator", &SWIGTYPE_p_Analog__MinBLEP__TBaseOscillator,_proxy__wrap_new_TBaseOscillator, swig_delete_TBaseOscillator, swig_TBaseOscillator_methods, swig_TBaseOscillator_attributes, &swig_TBaseOscillator_Sf_SwigStatic, swig_TBaseOscillator_meta, swig_TBaseOscillator_bases, swig_TBaseOscillator_base_names };

static int _wrap_new_TMinBlepPulseOscillator(lua_State* L) {
  int SWIG_arg = 0;
  Analog::MinBLEP::TMinBlepPulseOscillator *result = 0 ;
  
  SWIG_check_num_args("Analog::MinBLEP::TMinBlepPulseOscillator::TMinBlepPulseOscillator",0,0)
  result = (Analog::MinBLEP::TMinBlepPulseOscillator *)new Analog::MinBLEP::TMinBlepPulseOscillator();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__MinBLEP__TMinBlepPulseOscillator,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_TMinBlepPulseOscillator_SetPulseWidth(lua_State* L) {
  int SWIG_arg = 0;
  Analog::MinBLEP::TMinBlepPulseOscillator *arg1 = (Analog::MinBLEP::TMinBlepPulseOscillator *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::MinBLEP::TMinBlepPulseOscillator::SetPulseWidth",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepPulseOscillator::SetPulseWidth",1,"Analog::MinBLEP::TMinBlepPulseOscillator *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepPulseOscillator::SetPulseWidth",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MinBLEP__TMinBlepPulseOscillator,0))){
    SWIG_fail_ptr("TMinBlepPulseOscillator_SetPulseWidth",1,SWIGTYPE_p_Analog__MinBLEP__TMinBlepPulseOscillator);
  }
...
static int _wrap_TMinBlepPulseOscillator_Process(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MinBLEP::TMinBlepPulseOscillator::Process",5,5)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepPulseOscillator::Process",1,"Analog::MinBLEP::TMinBlepPulseOscillator *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepPulseOscillator::Process",2,"Analog::MinBLEP::TSampleBuffer &");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepPulseOscillator::Process",3,"Analog::MinBLEP::TSampleBuffer &");
  if(!lua_isuserdata(L,4)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepPulseOscillator::Process",4,"Analog::MinBLEP::TSampleBuffer &");
  if(!lua_isuserdata(L,5)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepPulseOscillator::Process",5,"Analog::MinBLEP::TSampleBuffer &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MinBLEP__TMinBlepPulseOscillator,0))){
    SWIG_fail_ptr("TMinBlepPulseOscillator_Process",1,SWIGTYPE_p_Analog__MinBLEP__TMinBlepPulseOscillator);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TMinBlepPulseOscillator_Process",2,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TMinBlepPulseOscillator_Process",3,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TMinBlepPulseOscillator_Process",4,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,5,(void**)&arg5,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TMinBlepPulseOscillator_Process",5,SWIGTYPE_p_std__vectorT_float_t);
  }
...
static int _wrap_TMinBlepPulseOscillator_Tick(lua_State* L) {
  int SWIG_arg = 0;
  Analog::MinBLEP::TMinBlepPulseOscillator *arg1 = (Analog::MinBLEP::TMinBlepPulseOscillator *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::MinBLEP::TMinBlepPulseOscillator::Tick",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepPulseOscillator::Tick",1,"Analog::MinBLEP::TMinBlepPulseOscillator *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MinBLEP__TMinBlepPulseOscillator,0))){
    SWIG_fail_ptr("TMinBlepPulseOscillator_Tick",1,SWIGTYPE_p_Analog__MinBLEP__TMinBlepPulseOscillator);
  }
...
Analog::MinBLEP::TMinBlepPulseOscillator *arg1 = (Analog::MinBLEP::TMinBlepPulseOscillator *) obj;
delete arg1;
}
...
static swig_lua_method swig_TMinBlepPulseOscillator_methods[]= {
    ...
    { "Tick", _wrap_TMinBlepPulseOscillator_Tick},
    {0,0}
};
...
static const char *swig_TMinBlepPulseOscillator_base_names[] = {"Analog::MinBLEP::TBaseOscillator *",0};
static swig_lua_class _wrap_class_TMinBlepPulseOscillator = { "TMinBlepPulseOscillator", "TMinBlepPulseOscillator", &SWIGTYPE_p_Analog__MinBLEP__TMinBlepPulseOscillator,_proxy__wrap_new_TMinBlepPulseOscillator, swig_delete_TMinBlepPulseOscillator, swig_TMinBlepPulseOscillator_methods, swig_TMinBlepPulseOscillator_attributes, &swig_TMinBlepPulseOscillator_Sf_SwigStatic, swig_TMinBlepPulseOscillator_meta, swig_TMinBlepPulseOscillator_bases, swig_TMinBlepPulseOscillator_base_names };

static int _wrap_new_TMinBlepSawOscillator(lua_State* L) {
  int SWIG_arg = 0;
  Analog::MinBLEP::TMinBlepSawOscillator *result = 0 ;
  
  SWIG_check_num_args("Analog::MinBLEP::TMinBlepSawOscillator::TMinBlepSawOscillator",0,0)
  result = (Analog::MinBLEP::TMinBlepSawOscillator *)new Analog::MinBLEP::TMinBlepSawOscillator();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__MinBLEP__TMinBlepSawOscillator,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_TMinBlepSawOscillator_Process(lua_State* L) {
  int SWIG_arg = 0;
  Analog::MinBLEP::TMinBlepSawOscillator *arg1 = (Analog::MinBLEP::TMinBlepSawOscillator *) 0 ;
  Analog::MinBLEP::TSampleBuffer *arg2 = 0 ;
  Analog::MinBLEP::TSampleBuffer *arg3 = 0 ;
  Analog::MinBLEP::TSampleBuffer *arg4 = 0 ;
  Analog::MinBLEP::TSampleBuffer *arg5 = 0 ;
  
  SWIG_check_num_args("Analog::MinBLEP::TMinBlepSawOscillator::Process",5,5)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepSawOscillator::Process",1,"Analog::MinBLEP::TMinBlepSawOscillator *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepSawOscillator::Process",2,"Analog::MinBLEP::TSampleBuffer &");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepSawOscillator::Process",3,"Analog::MinBLEP::TSampleBuffer &");
  if(!lua_isuserdata(L,4)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepSawOscillator::Process",4,"Analog::MinBLEP::TSampleBuffer &");
  if(!lua_isuserdata(L,5)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepSawOscillator::Process",5,"Analog::MinBLEP::TSampleBuffer &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MinBLEP__TMinBlepSawOscillator,0))){
    SWIG_fail_ptr("TMinBlepSawOscillator_Process",1,SWIGTYPE_p_Analog__MinBLEP__TMinBlepSawOscillator);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TMinBlepSawOscillator_Process",2,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TMinBlepSawOscillator_Process",3,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TMinBlepSawOscillator_Process",4,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,5,(void**)&arg5,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("TMinBlepSawOscillator_Process",5,SWIGTYPE_p_std__vectorT_float_t);
  }
...
static int _wrap_TMinBlepSawOscillator_Tick(lua_State* L) {
  int SWIG_arg = 0;
  Analog::MinBLEP::TMinBlepSawOscillator *arg1 = (Analog::MinBLEP::TMinBlepSawOscillator *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::MinBLEP::TMinBlepSawOscillator::Tick",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MinBLEP::TMinBlepSawOscillator::Tick",1,"Analog::MinBLEP::TMinBlepSawOscillator *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MinBLEP__TMinBlepSawOscillator,0))){
    SWIG_fail_ptr("TMinBlepSawOscillator_Tick",1,SWIGTYPE_p_Analog__MinBLEP__TMinBlepSawOscillator);
  }
...
Analog::MinBLEP::TMinBlepSawOscillator *arg1 = (Analog::MinBLEP::TMinBlepSawOscillator *) obj;
delete arg1;
}
...
static swig_lua_method swig_TMinBlepSawOscillator_methods[]= {
    ...
    { "Tick", _wrap_TMinBlepSawOscillator_Tick},
    {0,0}
};
...
static void *_p_Analog__MinBLEP__TMinBlepPulseOscillatorTo_p_Analog__MinBLEP__TBaseOscillator(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Analog::MinBLEP::TBaseOscillator *)  ((Analog::MinBLEP::TMinBlepPulseOscillator *) x));
}
static void *_p_Analog__MinBLEP__TMinBlepSawOscillatorTo_p_Analog__MinBLEP__TBaseOscillator(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Analog::MinBLEP::TBaseOscillator *)  ((Analog::MinBLEP::TMinBlepSawOscillator *) x));
}
...
static swig_type_info _swigt__p_Analog__MinBLEP__TBaseOscillator = {"_p_Analog__MinBLEP__TBaseOscillator", "Analog::MinBLEP::TBaseOscillator *", 0, 0, (void*)&_wrap_class_TBaseOscillator, 0};
static swig_type_info _swigt__p_Analog__MinBLEP__TMinBlepPulseOscillator = {"_p_Analog__MinBLEP__TMinBlepPulseOscillator", "Analog::MinBLEP::TMinBlepPulseOscillator *", 0, 0, (void*)&_wrap_class_TMinBlepPulseOscillator, 0};
static swig_type_info _swigt__p_Analog__MinBLEP__TMinBlepSawOscillator = {"_p_Analog__MinBLEP__TMinBlepSawOscillator", "Analog::MinBLEP::TMinBlepSawOscillator *", 0, 0, (void*)&_wrap_class_TMinBlepSawOscillator, 0};
...
static swig_type_info _swigt__p_float = {"_p_float", "DspFloatType *|f32 *|float *|Analog::MinBLEP::TFrequency *|Analog::MinBLEP::TSample *|Analog::MinBLEP::TFraction *|Analog::MinBLEP::TTime *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__vectorT_float_t = {"_p_std__vectorT_float_t", "std::vector< float > *|Analog::MinBLEP::TSampleBuffer *|std::vector< DspFloatType > *", 0, 0, (void*)&_wrap_class_float_vector, 0};
...
static swig_type_info _swigt__p_unsigned_char = {"_p_unsigned_char", "u8 *|Analog::MinBLEP::TUnsigned7 *|Analog::MinBLEP::TSigned7 *|unsigned char *|uint_least8_t *|uint_fast8_t *|uint8_t *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_Analog__MinBLEP__TBaseOscillator,
  &_swigt__p_Analog__MinBLEP__TMinBlepPulseOscillator,
  &_swigt__p_Analog__MinBLEP__TMinBlepSawOscillator,
...
static swig_cast_info _swigc__p_Analog__MinBLEP__TBaseOscillator[] = {  {&_swigt__p_Analog__MinBLEP__TBaseOscillator, 0, 0, 0},  {&_swigt__p_Analog__MinBLEP__TMinBlepPulseOscillator, _p_Analog__MinBLEP__TMinBlepPulseOscillatorTo_p_Analog__MinBLEP__TBaseOscillator, 0, 0},  {&_swigt__p_Analog__MinBLEP__TMinBlepSawOscillator, _p_Analog__MinBLEP__TMinBlepSawOscillatorTo_p_Analog__MinBLEP__TBaseOscillator, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Analog__MinBLEP__TMinBlepPulseOscillator[] = {  {&_swigt__p_Analog__MinBLEP__TMinBlepPulseOscillator, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Analog__MinBLEP__TMinBlepSawOscillator[] = {  {&_swigt__p_Analog__MinBLEP__TMinBlepSawOscillator, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_Analog__MinBLEP__TBaseOscillator,
  _swigc__p_Analog__MinBLEP__TMinBlepPulseOscillator,
  _swigc__p_Analog__MinBLEP__TMinBlepSawOscillator,
