...
#define SWIGTYPE_p_ATK__TransistorClassAFilterT_DspFloatType_t swig_types[0]
#define SWIGTYPE_p_AmplifierProcessor swig_types[1]
#define SWIGTYPE_p_FilterProcessor swig_types[2]
#define SWIGTYPE_p_Filters__AudioTK__Preamp__TransistorClassA swig_types[3]
...
#define SWIG_name      "ATKTransistorClassAProcessor"
#define SWIG_init      luaopen_ATKTransistorClassAProcessor
#define SWIG_init_user luaopen_ATKTransistorClassAProcessor_user

#define SWIG_LUACODE   luaopen_ATKTransistorClassAProcessor_luacode
...
static int _wrap_TransistorClassA_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Preamp::TransistorClassA *arg1 = (Filters::AudioTK::Preamp::TransistorClassA *) 0 ;
  ATK::TransistorClassAFilter< DspFloatType > *arg2 = (ATK::TransistorClassAFilter< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Preamp::TransistorClassA::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Preamp::TransistorClassA::filter",1,"Filters::AudioTK::Preamp::TransistorClassA *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::Preamp::TransistorClassA::filter",2,"ATK::TransistorClassAFilter< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Preamp__TransistorClassA,0))){
    SWIG_fail_ptr("TransistorClassA_filter_set",1,SWIGTYPE_p_Filters__AudioTK__Preamp__TransistorClassA);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__TransistorClassAFilterT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("TransistorClassA_filter_set",2,SWIGTYPE_p_ATK__TransistorClassAFilterT_DspFloatType_t);
  }
...
static int _wrap_TransistorClassA_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Preamp::TransistorClassA *arg1 = (Filters::AudioTK::Preamp::TransistorClassA *) 0 ;
  ATK::TransistorClassAFilter< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Preamp::TransistorClassA::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Preamp::TransistorClassA::filter",1,"Filters::AudioTK::Preamp::TransistorClassA *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Preamp__TransistorClassA,0))){
    SWIG_fail_ptr("TransistorClassA_filter_get",1,SWIGTYPE_p_Filters__AudioTK__Preamp__TransistorClassA);
  }
  
  result = (ATK::TransistorClassAFilter< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__TransistorClassAFilterT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_TransistorClassA(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Preamp::TransistorClassA *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Preamp::TransistorClassA::TransistorClassA",0,0)
  result = (Filters::AudioTK::Preamp::TransistorClassA *)new Filters::AudioTK::Preamp::TransistorClassA();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__Preamp__TransistorClassA,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_TransistorClassA(void *obj) {
Filters::AudioTK::Preamp::TransistorClassA *arg1 = (Filters::AudioTK::Preamp::TransistorClassA *) obj;
delete arg1;
}
static int _proxy__wrap_new_TransistorClassA(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_TransistorClassA);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_TransistorClassA_attributes[] = {
    { "filter", _wrap_TransistorClassA_filter_get, _wrap_TransistorClassA_filter_set },
    {0,0,0}
};
static swig_lua_method swig_TransistorClassA_methods[]= {
    {0,0}
};
static swig_lua_method swig_TransistorClassA_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_TransistorClassA_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_TransistorClassA_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_TransistorClassA_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_TransistorClassA_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_TransistorClassA_Sf_SwigStatic = {
    "TransistorClassA",
    swig_TransistorClassA_Sf_SwigStatic_methods,
    swig_TransistorClassA_Sf_SwigStatic_attributes,
    swig_TransistorClassA_Sf_SwigStatic_constants,
    swig_TransistorClassA_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_TransistorClassA_bases[] = {0};
static const char *swig_TransistorClassA_base_names[] = {0};
static swig_lua_class _wrap_class_TransistorClassA = { "TransistorClassA", "TransistorClassA", &SWIGTYPE_p_Filters__AudioTK__Preamp__TransistorClassA,_proxy__wrap_new_TransistorClassA, swig_delete_TransistorClassA, swig_TransistorClassA_methods, swig_TransistorClassA_attributes, &swig_TransistorClassA_Sf_SwigStatic, swig_TransistorClassA_meta, swig_TransistorClassA_bases, swig_TransistorClassA_base_names };
...
static swig_type_info _swigt__p_ATK__TransistorClassAFilterT_DspFloatType_t = {"_p_ATK__TransistorClassAFilterT_DspFloatType_t", "ATK::TransistorClassAFilter< DspFloatType > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_Filters__AudioTK__Preamp__TransistorClassA = {"_p_Filters__AudioTK__Preamp__TransistorClassA", "Filters::AudioTK::Preamp::TransistorClassA *", 0, 0, (void*)&_wrap_class_TransistorClassA, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ATK__TransistorClassAFilterT_DspFloatType_t,
  &_swigt__p_AmplifierProcessor,
  &_swigt__p_FilterProcessor,
  &_swigt__p_Filters__AudioTK__Preamp__TransistorClassA,
...
static swig_cast_info _swigc__p_ATK__TransistorClassAFilterT_DspFloatType_t[] = {  {&_swigt__p_ATK__TransistorClassAFilterT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_Filters__AudioTK__Preamp__TransistorClassA[] = {  {&_swigt__p_Filters__AudioTK__Preamp__TransistorClassA, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ATK__TransistorClassAFilterT_DspFloatType_t,
  _swigc__p_AmplifierProcessor,
  _swigc__p_FilterProcessor,
  _swigc__p_Filters__AudioTK__Preamp__TransistorClassA,
