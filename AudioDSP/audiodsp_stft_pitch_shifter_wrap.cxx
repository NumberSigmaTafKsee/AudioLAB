...
#define SWIGTYPE_p_FX__SHIFTER__ISTFT swig_types[1]
#define SWIGTYPE_p_FX__SHIFTER__SHIFTER swig_types[2]
#define SWIGTYPE_p_FX__SHIFTER__STFT swig_types[3]
...
#define SWIG_name      "audiodsp_stft_pitch_shifter"
#define SWIG_init      luaopen_audiodsp_stft_pitch_shifter
#define SWIG_init_user luaopen_audiodsp_stft_pitch_shifter_user

#define SWIG_LUACODE   luaopen_audiodsp_stft_pitch_shifter_luacode
...
#include "audiodsp_stft_pitch_shifter.hpp"
...
static int _wrap_new_STFT(lua_State* L) {
  int SWIG_arg = 0;
  FX::SHIFTER::STFT *result = 0 ;
  
  SWIG_check_num_args("FX::SHIFTER::STFT::STFT",0,0)
  result = (FX::SHIFTER::STFT *)new FX::SHIFTER::STFT();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__SHIFTER__STFT,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_STFT_init(lua_State* L) {
  int SWIG_arg = 0;
  FX::SHIFTER::STFT *arg1 = (FX::SHIFTER::STFT *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("FX::SHIFTER::STFT::init",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::SHIFTER::STFT::init",1,"FX::SHIFTER::STFT *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::SHIFTER::STFT::init",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__SHIFTER__STFT,0))){
    SWIG_fail_ptr("STFT_init",1,SWIGTYPE_p_FX__SHIFTER__STFT);
  }
...
static int _wrap_STFT_step(lua_State* L) {
  int SWIG_arg = 0;
  FX::SHIFTER::STFT *arg1 = (FX::SHIFTER::STFT *) 0 ;
  float *arg2 = (float *) 0 ;
  int arg3 ;
  FX::SHIFTER::Cfloat *arg4 = (FX::SHIFTER::Cfloat *) 0 ;
  
  SWIG_check_num_args("FX::SHIFTER::STFT::step",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::SHIFTER::STFT::step",1,"FX::SHIFTER::STFT *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::SHIFTER::STFT::step",2,"float *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("FX::SHIFTER::STFT::step",3,"int");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("FX::SHIFTER::STFT::step",4,"FX::SHIFTER::Cfloat *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__SHIFTER__STFT,0))){
    SWIG_fail_ptr("STFT_step",1,SWIGTYPE_p_FX__SHIFTER__STFT);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("STFT_step",2,SWIGTYPE_p_float);
  }
  
  arg3 = (int)lua_tonumber(L, 3);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_std__complexT_float_t,0))){
    SWIG_fail_ptr("STFT_step",4,SWIGTYPE_p_std__complexT_float_t);
  }
...
FX::SHIFTER::STFT *arg1 = (FX::SHIFTER::STFT *) obj;
delete arg1;
}
...
static swig_lua_method swig_STFT_methods[]= {
    { "init", _wrap_STFT_init},
    { "step", _wrap_STFT_step},
    {0,0}
};
...
static swig_lua_class _wrap_class_STFT = { "STFT", "STFT", &SWIGTYPE_p_FX__SHIFTER__STFT,_proxy__wrap_new_STFT, swig_delete_STFT, swig_STFT_methods, swig_STFT_attributes, &swig_STFT_Sf_SwigStatic, swig_STFT_meta, swig_STFT_bases, swig_STFT_base_names };

static int _wrap_new_ISTFT(lua_State* L) {
  int SWIG_arg = 0;
  FX::SHIFTER::ISTFT *result = 0 ;
  
  SWIG_check_num_args("FX::SHIFTER::ISTFT::ISTFT",0,0)
  result = (FX::SHIFTER::ISTFT *)new FX::SHIFTER::ISTFT();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__SHIFTER__ISTFT,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_ISTFT_init(lua_State* L) {
  int SWIG_arg = 0;
  FX::SHIFTER::ISTFT *arg1 = (FX::SHIFTER::ISTFT *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("FX::SHIFTER::ISTFT::init",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::SHIFTER::ISTFT::init",1,"FX::SHIFTER::ISTFT *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::SHIFTER::ISTFT::init",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__SHIFTER__ISTFT,0))){
    SWIG_fail_ptr("ISTFT_init",1,SWIGTYPE_p_FX__SHIFTER__ISTFT);
  }
...
static int _wrap_ISTFT_step(lua_State* L) {
  int SWIG_arg = 0;
  FX::SHIFTER::ISTFT *arg1 = (FX::SHIFTER::ISTFT *) 0 ;
  FX::SHIFTER::Cfloat *arg2 = (FX::SHIFTER::Cfloat *) 0 ;
  float *arg3 = (float *) 0 ;
  int arg4 ;
  
  SWIG_check_num_args("FX::SHIFTER::ISTFT::step",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::SHIFTER::ISTFT::step",1,"FX::SHIFTER::ISTFT *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::SHIFTER::ISTFT::step",2,"FX::SHIFTER::Cfloat *");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FX::SHIFTER::ISTFT::step",3,"float *");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("FX::SHIFTER::ISTFT::step",4,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__SHIFTER__ISTFT,0))){
    SWIG_fail_ptr("ISTFT_step",1,SWIGTYPE_p_FX__SHIFTER__ISTFT);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__complexT_float_t,0))){
    SWIG_fail_ptr("ISTFT_step",2,SWIGTYPE_p_std__complexT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("ISTFT_step",3,SWIGTYPE_p_float);
  }
...
static void swig_delete_ISTFT(void *obj) {
FX::SHIFTER::ISTFT *arg1 = (FX::SHIFTER::ISTFT *) obj;
delete arg1;
}
static int _proxy__wrap_new_ISTFT(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_ISTFT);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_ISTFT_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_ISTFT_methods[]= {
    { "init", _wrap_ISTFT_init},
    { "step", _wrap_ISTFT_step},
    {0,0}
};
static swig_lua_method swig_ISTFT_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_ISTFT_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_ISTFT_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_ISTFT_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_ISTFT_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_ISTFT_Sf_SwigStatic = {
    "ISTFT",
    swig_ISTFT_Sf_SwigStatic_methods,
    swig_ISTFT_Sf_SwigStatic_attributes,
    swig_ISTFT_Sf_SwigStatic_constants,
    swig_ISTFT_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_ISTFT_bases[] = {0};
static const char *swig_ISTFT_base_names[] = {0};
static swig_lua_class _wrap_class_ISTFT = { "ISTFT", "ISTFT", &SWIGTYPE_p_FX__SHIFTER__ISTFT,_proxy__wrap_new_ISTFT, swig_delete_ISTFT, swig_ISTFT_methods, swig_ISTFT_attributes, &swig_ISTFT_Sf_SwigStatic, swig_ISTFT_meta, swig_ISTFT_bases, swig_ISTFT_base_names };

static int _wrap_new_SHIFTER(lua_State* L) {
  int SWIG_arg = 0;
  FX::SHIFTER::SHIFTER *result = 0 ;
  
  SWIG_check_num_args("FX::SHIFTER::SHIFTER::SHIFTER",0,0)
  result = (FX::SHIFTER::SHIFTER *)new FX::SHIFTER::SHIFTER();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__SHIFTER__SHIFTER,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_SHIFTER_init(lua_State* L) {
  int SWIG_arg = 0;
  FX::SHIFTER::SHIFTER *arg1 = (FX::SHIFTER::SHIFTER *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("FX::SHIFTER::SHIFTER::init",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::SHIFTER::SHIFTER::init",1,"FX::SHIFTER::SHIFTER *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::SHIFTER::SHIFTER::init",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__SHIFTER__SHIFTER,0))){
    SWIG_fail_ptr("SHIFTER_init",1,SWIGTYPE_p_FX__SHIFTER__SHIFTER);
  }
...
static int _wrap_SHIFTER_step(lua_State* L) {
  int SWIG_arg = 0;
  FX::SHIFTER::SHIFTER *arg1 = (FX::SHIFTER::SHIFTER *) 0 ;
  float *arg2 = (float *) 0 ;
  int arg3 ;
  ...
  SWIG_check_num_args("FX::SHIFTER::SHIFTER::step",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::SHIFTER::SHIFTER::step",1,"FX::SHIFTER::SHIFTER *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::SHIFTER::SHIFTER::step",2,"float *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("FX::SHIFTER::SHIFTER::step",3,"int");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("FX::SHIFTER::SHIFTER::step",4,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__SHIFTER__SHIFTER,0))){
    SWIG_fail_ptr("SHIFTER_step",1,SWIGTYPE_p_FX__SHIFTER__SHIFTER);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("SHIFTER_step",2,SWIGTYPE_p_float);
  }
...
static void swig_delete_SHIFTER(void *obj) {
FX::SHIFTER::SHIFTER *arg1 = (FX::SHIFTER::SHIFTER *) obj;
delete arg1;
}
static int _proxy__wrap_new_SHIFTER(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_SHIFTER);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_SHIFTER_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_SHIFTER_methods[]= {
    { "init", _wrap_SHIFTER_init},
    { "step", _wrap_SHIFTER_step},
    {0,0}
};
static swig_lua_method swig_SHIFTER_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_SHIFTER_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_SHIFTER_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_SHIFTER_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_SHIFTER_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_SHIFTER_Sf_SwigStatic = {
    "SHIFTER",
    swig_SHIFTER_Sf_SwigStatic_methods,
    swig_SHIFTER_Sf_SwigStatic_attributes,
    swig_SHIFTER_Sf_SwigStatic_constants,
    swig_SHIFTER_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_SHIFTER_bases[] = {0};
static const char *swig_SHIFTER_base_names[] = {0};
static swig_lua_class _wrap_class_SHIFTER = { "SHIFTER", "SHIFTER", &SWIGTYPE_p_FX__SHIFTER__SHIFTER,_proxy__wrap_new_SHIFTER, swig_delete_SHIFTER, swig_SHIFTER_methods, swig_SHIFTER_attributes, &swig_SHIFTER_Sf_SwigStatic, swig_SHIFTER_meta, swig_SHIFTER_bases, swig_SHIFTER_base_names };

static int _wrap_PVresample(lua_State* L) {
  int SWIG_arg = 0;
  float *arg1 = (float *) 0 ;
  int arg2 ;
  float *arg3 = (float *) 0 ;
  ...
  SWIG_check_num_args("FX::SHIFTER::PVresample",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::SHIFTER::PVresample",1,"float *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::SHIFTER::PVresample",2,"int");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FX::SHIFTER::PVresample",3,"float *");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("FX::SHIFTER::PVresample",4,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("PVresample",1,SWIGTYPE_p_float);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("PVresample",3,SWIGTYPE_p_float);
  }
  
  arg4 = (int)lua_tonumber(L, 4);
  FX::SHIFTER::PVresample(arg1,arg2,arg3,arg4);
...
static swig_type_info _swigt__p_FX__SHIFTER__ISTFT = {"_p_FX__SHIFTER__ISTFT", "FX::SHIFTER::ISTFT *", 0, 0, (void*)&_wrap_class_ISTFT, 0};
static swig_type_info _swigt__p_FX__SHIFTER__SHIFTER = {"_p_FX__SHIFTER__SHIFTER", "FX::SHIFTER::SHIFTER *", 0, 0, (void*)&_wrap_class_SHIFTER, 0};
static swig_type_info _swigt__p_FX__SHIFTER__STFT = {"_p_FX__SHIFTER__STFT", "FX::SHIFTER::STFT *", 0, 0, (void*)&_wrap_class_STFT, 0};
...
static swig_type_info _swigt__p_std__complexT_float_t = {"_p_std__complexT_float_t", "std::complex< float > *|FX::SHIFTER::Cfloat *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FX__SHIFTER__ISTFT,
  &_swigt__p_FX__SHIFTER__SHIFTER,
  &_swigt__p_FX__SHIFTER__STFT,
...
static swig_cast_info _swigc__p_FX__SHIFTER__ISTFT[] = {  {&_swigt__p_FX__SHIFTER__ISTFT, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FX__SHIFTER__SHIFTER[] = {  {&_swigt__p_FX__SHIFTER__SHIFTER, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FX__SHIFTER__STFT[] = {  {&_swigt__p_FX__SHIFTER__STFT, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FX__SHIFTER__ISTFT,
  _swigc__p_FX__SHIFTER__SHIFTER,
  _swigc__p_FX__SHIFTER__STFT,
