...
#define SWIGTYPE_p_Limiter swig_types[5]
...
#define SWIG_name      "audiodsp_env_follower_limiter"
#define SWIG_init      luaopen_audiodsp_env_follower_limiter
#define SWIG_init_user luaopen_audiodsp_env_follower_limiter_user

#define SWIG_LUACODE   luaopen_audiodsp_env_follower_limiter_luacode
...
#include "audiodsp_env_follower_limiter.hpp"
...
static int _wrap_EnvelopeFollower_Setup(lua_State* L) {
  ...
  SWIG_check_num_args("EnvelopeFollower::Setup",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("EnvelopeFollower::Setup",1,"EnvelopeFollower *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("EnvelopeFollower::Setup",2,"double");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("EnvelopeFollower::Setup",3,"double");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("EnvelopeFollower::Setup",4,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_EnvelopeFollower,0))){
    SWIG_fail_ptr("EnvelopeFollower_Setup",1,SWIGTYPE_p_EnvelopeFollower);
  }
...
static int _wrap_EnvelopeFollower_envelope_set(lua_State* L) {
  ...
  SWIG_check_num_args("EnvelopeFollower::envelope",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("EnvelopeFollower::envelope",1,"EnvelopeFollower *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("EnvelopeFollower::envelope",2,"double");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_EnvelopeFollower,0))){
    SWIG_fail_ptr("EnvelopeFollower_envelope_set",1,SWIGTYPE_p_EnvelopeFollower);
  }
...
static int _wrap_EnvelopeFollower_envelope_get(lua_State* L) {
  ...
  SWIG_check_num_args("EnvelopeFollower::envelope",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("EnvelopeFollower::envelope",1,"EnvelopeFollower *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_EnvelopeFollower,0))){
    SWIG_fail_ptr("EnvelopeFollower_envelope_get",1,SWIGTYPE_p_EnvelopeFollower);
  }
  
  result = (double) ((arg1)->envelope);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Limiter_Setup(lua_State* L) {
  ...
  SWIG_check_num_args("Limiter::Setup",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Limiter::Setup",1,"Limiter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Limiter::Setup",2,"double");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Limiter::Setup",3,"double");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("Limiter::Setup",4,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Limiter,0))){
    SWIG_fail_ptr("Limiter_Setup",1,SWIGTYPE_p_Limiter);
  }
