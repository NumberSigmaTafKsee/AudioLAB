...
#define SWIGTYPE_p_ATK__ChamberlinFilterT_DspFloatType_t swig_types[0]
#define SWIGTYPE_p_AmplifierProcessor swig_types[1]
#define SWIGTYPE_p_FilterProcessor swig_types[2]
#define SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter swig_types[3]
...
#define SWIG_name      "ATKChamberlinFilter"
#define SWIG_init      luaopen_ATKChamberlinFilter
#define SWIG_init_user luaopen_ATKChamberlinFilter_user

#define SWIG_LUACODE   luaopen_ATKChamberlinFilter_luacode
...
static int _wrap_ChamberlinFilter_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::ChamberlinFilter *arg1 = (Filters::AudioTK::EQ::ChamberlinFilter *) 0 ;
  ATK::ChamberlinFilter< DspFloatType > *arg2 = (ATK::ChamberlinFilter< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::ChamberlinFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::ChamberlinFilter::filter",1,"Filters::AudioTK::EQ::ChamberlinFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::EQ::ChamberlinFilter::filter",2,"ATK::ChamberlinFilter< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter,0))){
    SWIG_fail_ptr("ChamberlinFilter_filter_set",1,SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__ChamberlinFilterT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("ChamberlinFilter_filter_set",2,SWIGTYPE_p_ATK__ChamberlinFilterT_DspFloatType_t);
  }
...
static int _wrap_ChamberlinFilter_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::ChamberlinFilter *arg1 = (Filters::AudioTK::EQ::ChamberlinFilter *) 0 ;
  ATK::ChamberlinFilter< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::ChamberlinFilter::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::ChamberlinFilter::filter",1,"Filters::AudioTK::EQ::ChamberlinFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter,0))){
    SWIG_fail_ptr("ChamberlinFilter_filter_get",1,SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter);
  }
  
  result = (ATK::ChamberlinFilter< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__ChamberlinFilterT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_ChamberlinFilter(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::ChamberlinFilter *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::ChamberlinFilter::ChamberlinFilter",0,0)
  result = (Filters::AudioTK::EQ::ChamberlinFilter *)new Filters::AudioTK::EQ::ChamberlinFilter();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_ChamberlinFilter_setPort(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::ChamberlinFilter *arg1 = (Filters::AudioTK::EQ::ChamberlinFilter *) 0 ;
  int arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::ChamberlinFilter::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::ChamberlinFilter::setPort",1,"Filters::AudioTK::EQ::ChamberlinFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AudioTK::EQ::ChamberlinFilter::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AudioTK::EQ::ChamberlinFilter::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter,0))){
    SWIG_fail_ptr("ChamberlinFilter_setPort",1,SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter);
  }
...
static int _wrap_ChamberlinFilter_getPort(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::ChamberlinFilter *arg1 = (Filters::AudioTK::EQ::ChamberlinFilter *) 0 ;
  int arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::ChamberlinFilter::getPort",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::ChamberlinFilter::getPort",1,"Filters::AudioTK::EQ::ChamberlinFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AudioTK::EQ::ChamberlinFilter::getPort",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter,0))){
    SWIG_fail_ptr("ChamberlinFilter_getPort",1,SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter);
  }
...
static void swig_delete_ChamberlinFilter(void *obj) {
Filters::AudioTK::EQ::ChamberlinFilter *arg1 = (Filters::AudioTK::EQ::ChamberlinFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_ChamberlinFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_ChamberlinFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_ChamberlinFilter_attributes[] = {
    { "filter", _wrap_ChamberlinFilter_filter_get, _wrap_ChamberlinFilter_filter_set },
    {0,0,0}
};
static swig_lua_method swig_ChamberlinFilter_methods[]= {
    { "setPort", _wrap_ChamberlinFilter_setPort},
    { "getPort", _wrap_ChamberlinFilter_getPort},
    {0,0}
};
static swig_lua_method swig_ChamberlinFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_ChamberlinFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_ChamberlinFilter_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_CUTOFF", Filters::AudioTK::EQ::ChamberlinFilter::PORT_CUTOFF)},
    {SWIG_LUA_CONSTTAB_INT("PORT_ATTEN", Filters::AudioTK::EQ::ChamberlinFilter::PORT_ATTEN)},
    {SWIG_LUA_CONSTTAB_INT("PORT_LP", Filters::AudioTK::EQ::ChamberlinFilter::PORT_LP)},
    {SWIG_LUA_CONSTTAB_INT("PORT_BP", Filters::AudioTK::EQ::ChamberlinFilter::PORT_BP)},
    {SWIG_LUA_CONSTTAB_INT("PORT_HP", Filters::AudioTK::EQ::ChamberlinFilter::PORT_HP)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_ChamberlinFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_ChamberlinFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_ChamberlinFilter_Sf_SwigStatic = {
    "ChamberlinFilter",
    swig_ChamberlinFilter_Sf_SwigStatic_methods,
    swig_ChamberlinFilter_Sf_SwigStatic_attributes,
    swig_ChamberlinFilter_Sf_SwigStatic_constants,
    swig_ChamberlinFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_ChamberlinFilter_bases[] = {0};
static const char *swig_ChamberlinFilter_base_names[] = {0};
static swig_lua_class _wrap_class_ChamberlinFilter = { "ChamberlinFilter", "ChamberlinFilter", &SWIGTYPE_p_Filters__AudioTK__EQ__ChamberlinFilter,_proxy__wrap_new_ChamberlinFilter, swig_delete_ChamberlinFilter, swig_ChamberlinFilter_methods, swig_ChamberlinFilter_attributes, &swig_ChamberlinFilter_Sf_SwigStatic, swig_ChamberlinFilter_meta, swig_ChamberlinFilter_bases, swig_ChamberlinFilter_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("ChamberlinFilter_PORT_CUTOFF", Filters::AudioTK::EQ::ChamberlinFilter::PORT_CUTOFF)},
    {SWIG_LUA_CONSTTAB_INT("ChamberlinFilter_PORT_ATTEN", Filters::AudioTK::EQ::ChamberlinFilter::PORT_ATTEN)},
    {SWIG_LUA_CONSTTAB_INT("ChamberlinFilter_PORT_LP", Filters::AudioTK::EQ::ChamberlinFilter::PORT_LP)},
    {SWIG_LUA_CONSTTAB_INT("ChamberlinFilter_PORT_BP", Filters::AudioTK::EQ::ChamberlinFilter::PORT_BP)},
    {SWIG_LUA_CONSTTAB_INT("ChamberlinFilter_PORT_HP", Filters::AudioTK::EQ::ChamberlinFilter::PORT_HP)},
    {0,0,0,0,0,0}
};
...
static swig_type_info _swigt__p_ATK__ChamberlinFilterT_DspFloatType_t = {"_p_ATK__ChamberlinFilterT_DspFloatType_t", "ATK::ChamberlinFilter< DspFloatType > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_Filters__AudioTK__EQ__ChamberlinFilter = {"_p_Filters__AudioTK__EQ__ChamberlinFilter", "Filters::AudioTK::EQ::ChamberlinFilter *", 0, 0, (void*)&_wrap_class_ChamberlinFilter, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ATK__ChamberlinFilterT_DspFloatType_t,
  &_swigt__p_AmplifierProcessor,
  &_swigt__p_FilterProcessor,
  &_swigt__p_Filters__AudioTK__EQ__ChamberlinFilter,
...
static swig_cast_info _swigc__p_ATK__ChamberlinFilterT_DspFloatType_t[] = {  {&_swigt__p_ATK__ChamberlinFilterT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_Filters__AudioTK__EQ__ChamberlinFilter[] = {  {&_swigt__p_Filters__AudioTK__EQ__ChamberlinFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ATK__ChamberlinFilterT_DspFloatType_t,
  _swigc__p_AmplifierProcessor,
  _swigc__p_FilterProcessor,
  _swigc__p_Filters__AudioTK__EQ__ChamberlinFilter,
