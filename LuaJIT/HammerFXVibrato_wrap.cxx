...
#define SWIGTYPE_p_FX__HammerFX__Vibrato swig_types[1]
...
#define SWIGTYPE_p_vibrato_params swig_types[100]
...
#define SWIG_name      "HammerFXVibrato"
#define SWIG_init      luaopen_HammerFXVibrato
#define SWIG_init_user luaopen_HammerFXVibrato_user

#define SWIG_LUACODE   luaopen_HammerFXVibrato_luacode
...
static int _wrap_Vibrato_cp_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Vibrato *arg1 = (FX::HammerFX::Vibrato *) 0 ;
  vibrato_params arg2 ;
  vibrato_params *argp2 ;
  
  SWIG_check_num_args("FX::HammerFX::Vibrato::cp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Vibrato::cp",1,"FX::HammerFX::Vibrato *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("FX::HammerFX::Vibrato::cp",2,"vibrato_params");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Vibrato,0))){
    SWIG_fail_ptr("Vibrato_cp_set",1,SWIGTYPE_p_FX__HammerFX__Vibrato);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_vibrato_params,0))){
    SWIG_fail_ptr("Vibrato_cp_set",2,SWIGTYPE_p_vibrato_params);
  }
  arg2 = *argp2;
...
static int _wrap_Vibrato_cp_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Vibrato *arg1 = (FX::HammerFX::Vibrato *) 0 ;
  vibrato_params result;
  
  SWIG_check_num_args("FX::HammerFX::Vibrato::cp",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Vibrato::cp",1,"FX::HammerFX::Vibrato *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Vibrato,0))){
    SWIG_fail_ptr("Vibrato_cp_get",1,SWIGTYPE_p_FX__HammerFX__Vibrato);
  }
  
  result =  ((arg1)->cp);
  {
    vibrato_params * resultptr = new vibrato_params((const vibrato_params &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_vibrato_params,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static int _wrap_new_Vibrato(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Vibrato *result = 0 ;
  
  SWIG_check_num_args("FX::HammerFX::Vibrato::Vibrato",0,0)
  result = (FX::HammerFX::Vibrato *)new FX::HammerFX::Vibrato();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__HammerFX__Vibrato,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Vibrato_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Vibrato *arg1 = (FX::HammerFX::Vibrato *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("FX::HammerFX::Vibrato::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Vibrato::ProcessBlock",1,"FX::HammerFX::Vibrato *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::HammerFX::Vibrato::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FX::HammerFX::Vibrato::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("FX::HammerFX::Vibrato::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Vibrato,0))){
    SWIG_fail_ptr("Vibrato_ProcessBlock",1,SWIGTYPE_p_FX__HammerFX__Vibrato);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Vibrato_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Vibrato_ProcessBlock",4,SWIGTYPE_p_float);
  }
...
static void swig_delete_Vibrato(void *obj) {
FX::HammerFX::Vibrato *arg1 = (FX::HammerFX::Vibrato *) obj;
delete arg1;
}
static int _proxy__wrap_new_Vibrato(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_Vibrato);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_Vibrato_attributes[] = {
    { "cp", _wrap_Vibrato_cp_get, _wrap_Vibrato_cp_set },
    {0,0,0}
};
static swig_lua_method swig_Vibrato_methods[]= {
    { "ProcessBlock", _wrap_Vibrato_ProcessBlock},
    {0,0}
};
static swig_lua_method swig_Vibrato_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_Vibrato_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_Vibrato_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_Vibrato_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_Vibrato_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_Vibrato_Sf_SwigStatic = {
    "Vibrato",
    swig_Vibrato_Sf_SwigStatic_methods,
    swig_Vibrato_Sf_SwigStatic_attributes,
    swig_Vibrato_Sf_SwigStatic_constants,
    swig_Vibrato_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_Vibrato_bases[] = {0};
static const char *swig_Vibrato_base_names[] = {0};
static swig_lua_class _wrap_class_Vibrato = { "Vibrato", "Vibrato", &SWIGTYPE_p_FX__HammerFX__Vibrato,_proxy__wrap_new_Vibrato, swig_delete_Vibrato, swig_Vibrato_methods, swig_Vibrato_attributes, &swig_Vibrato_Sf_SwigStatic, swig_Vibrato_meta, swig_Vibrato_bases, swig_Vibrato_base_names };
...
static swig_type_info _swigt__p_FX__HammerFX__Vibrato = {"_p_FX__HammerFX__Vibrato", "FX::HammerFX::Vibrato *", 0, 0, (void*)&_wrap_class_Vibrato, 0};
...
static swig_type_info _swigt__p_vibrato_params = {"_p_vibrato_params", "vibrato_params *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_AmplifierProcessor,
  &_swigt__p_FX__HammerFX__Vibrato,
  ...
  &_swigt__p_vibrato_params,
};

static swig_cast_info _swigc__p_AmplifierProcessor[] = {  {&_swigt__p_AmplifierProcessor, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FX__HammerFX__Vibrato[] = {  {&_swigt__p_FX__HammerFX__Vibrato, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_vibrato_params[] = {  {&_swigt__p_vibrato_params, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_AmplifierProcessor,
  _swigc__p_FX__HammerFX__Vibrato,
