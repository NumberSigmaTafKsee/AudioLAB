...
#define SWIGTYPE_p_Pareq swig_types[21]
...
#define SWIG_name      "paraeq"
#define SWIG_init      luaopen_paraeq
#define SWIG_init_user luaopen_paraeq_user

#define SWIG_LUACODE   luaopen_paraeq_luacode
...
static int _wrap_new_Pareq(lua_State* L) {
  ...
  SWIG_check_num_args("Pareq::Pareq",0,0)
  result = (Pareq *)new Pareq();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Pareq,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Pareq_setfsamp(lua_State* L) {
  ...
  SWIG_check_num_args("Pareq::setfsamp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Pareq::setfsamp",1,"Pareq *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Pareq::setfsamp",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Pareq,0))){
    SWIG_fail_ptr("Pareq_setfsamp",1,SWIGTYPE_p_Pareq);
  }
...
static int _wrap_Pareq_setparam(lua_State* L) {
  ...
  SWIG_check_num_args("Pareq::setparam",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Pareq::setparam",1,"Pareq *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Pareq::setparam",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Pareq::setparam",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Pareq,0))){
    SWIG_fail_ptr("Pareq_setparam",1,SWIGTYPE_p_Pareq);
  }
...
static int _wrap_Pareq_reset(lua_State* L) {
  ...
  SWIG_check_num_args("Pareq::reset",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Pareq::reset",1,"Pareq *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Pareq,0))){
    SWIG_fail_ptr("Pareq_reset",1,SWIGTYPE_p_Pareq);
  }
...
static int _wrap_Pareq_prepare(lua_State* L) {
  ...
  SWIG_check_num_args("Pareq::prepare",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Pareq::prepare",1,"Pareq *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Pareq::prepare",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Pareq,0))){
    SWIG_fail_ptr("Pareq_prepare",1,SWIGTYPE_p_Pareq);
  }
...
static int _wrap_Pareq_process(lua_State* L) {
  ...
  SWIG_check_num_args("Pareq::process",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Pareq::process",1,"Pareq *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Pareq::process",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Pareq::process",3,"int");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("Pareq::process",4,"DspFloatType *[]");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Pareq,0))){
    SWIG_fail_ptr("Pareq_process",1,SWIGTYPE_p_Pareq);
  }
...
static swig_lua_class _wrap_class_Pareq = { "Pareq", "Pareq", &SWIGTYPE_p_Pareq,_proxy__wrap_new_Pareq, swig_delete_Pareq, swig_Pareq_methods, swig_Pareq_attributes, &swig_Pareq_Sf_SwigStatic, swig_Pareq_meta, swig_Pareq_bases, swig_Pareq_base_names };
...
static swig_type_info _swigt__p_Pareq = {"_p_Pareq", "Pareq *", 0, 0, (void*)&_wrap_class_Pareq, 0};
...
static swig_cast_info _swigc__p_Pareq[] = {  {&_swigt__p_Pareq, 0, 0, 0},{0, 0, 0, 0}};
