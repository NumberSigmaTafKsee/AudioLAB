...
#define SWIGTYPE_p_AudioSampleBuffer swig_types[1]
#define SWIGTYPE_p_BandFilter swig_types[2]
#define SWIGTYPE_p_BicuadFilter swig_types[3]
#define SWIGTYPE_p_FilterBank swig_types[4]
...
#define SWIGTYPE_p_OwnedArrayT_AudioSampleBuffer_t swig_types[24]
#define SWIGTYPE_p_Parameter2Processor swig_types[25]
#define SWIGTYPE_p_Port swig_types[26]
#define SWIGTYPE_p_PortMap swig_types[27]
#define SWIGTYPE_p_Ports swig_types[28]
#define SWIGTYPE_p_Random swig_types[29]
#define SWIGTYPE_p_SignalSinkProcessor swig_types[30]
#define SWIGTYPE_p_SignalSourceProcessor swig_types[31]
#define SWIGTYPE_p_SoundProcessor swig_types[32]
#define SWIGTYPE_p_SpectrumProcessor swig_types[33]
#define SWIGTYPE_p_Std__RandomMersenne swig_types[34]
...
#define SWIGTYPE_p_a_6__float swig_types[44]
...
#define SWIGTYPE_p_std__vectorT_BicuadFilter_p_t swig_types[88]
#define SWIGTYPE_p_std__vectorT_MonoProcessor_p_t swig_types[89]
#define SWIGTYPE_p_std__vectorT_OscillatorProcessor_p_t swig_types[90]
#define SWIGTYPE_p_std__vectorT_SoundProcessor_p_t swig_types[91]
#define SWIGTYPE_p_std__vectorT_StereoProcessor_p_t swig_types[92]
#define SWIGTYPE_p_std__vectorT_double_t swig_types[93]
#define SWIGTYPE_p_std__vectorT_float_t swig_types[94]
#define SWIGTYPE_p_std__vectorT_std__complexT_double_t_t swig_types[95]
#define SWIGTYPE_p_std__vectorT_std__complexT_float_t_t swig_types[96]
#define SWIGTYPE_p_std__vector_iteratorT_double_t swig_types[97]
#define SWIGTYPE_p_std__vector_iteratorT_float_t swig_types[98]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_double_t_t swig_types[99]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_float_t_t swig_types[100]
...
#define SWIG_name      "OctaveFilterBank"
#define SWIG_init      luaopen_OctaveFilterBank
#define SWIG_init_user luaopen_OctaveFilterBank_user

#define SWIG_LUACODE   luaopen_OctaveFilterBank_luacode
...
static int _wrap_new_BicuadFilter(lua_State* L) {
  int SWIG_arg = 0;
  BicuadFilter *result = 0 ;
  
  SWIG_check_num_args("BicuadFilter::BicuadFilter",0,0)
  result = (BicuadFilter *)new BicuadFilter();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_BicuadFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_BicuadFilter_makeInactive(lua_State* L) {
  int SWIG_arg = 0;
  BicuadFilter *arg1 = (BicuadFilter *) 0 ;
  
  SWIG_check_num_args("BicuadFilter::makeInactive",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("BicuadFilter::makeInactive",1,"BicuadFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_BicuadFilter,0))){
    SWIG_fail_ptr("BicuadFilter_makeInactive",1,SWIGTYPE_p_BicuadFilter);
  }
...
static int _wrap_BicuadFilter_setCoeficientes(lua_State* L) {
  int SWIG_arg = 0;
  BicuadFilter *arg1 = (BicuadFilter *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  
  SWIG_check_num_args("BicuadFilter::setCoeficientes",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("BicuadFilter::setCoeficientes",1,"BicuadFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("BicuadFilter::setCoeficientes",2,"DspFloatType const *");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("BicuadFilter::setCoeficientes",3,"DspFloatType const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_BicuadFilter,0))){
    SWIG_fail_ptr("BicuadFilter_setCoeficientes",1,SWIGTYPE_p_BicuadFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("BicuadFilter_setCoeficientes",2,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("BicuadFilter_setCoeficientes",3,SWIGTYPE_p_float);
  }
  
  (arg1)->setCoeficientes((DspFloatType const *)arg2,(DspFloatType const *)arg3);
...
static int _wrap_BicuadFilter_reset(lua_State* L) {
  int SWIG_arg = 0;
  BicuadFilter *arg1 = (BicuadFilter *) 0 ;
  
  SWIG_check_num_args("BicuadFilter::reset",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("BicuadFilter::reset",1,"BicuadFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_BicuadFilter,0))){
    SWIG_fail_ptr("BicuadFilter_reset",1,SWIGTYPE_p_BicuadFilter);
  }
...
static int _wrap_BicuadFilter_processSamples(lua_State* L) {
  int SWIG_arg = 0;
  BicuadFilter *arg1 = (BicuadFilter *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  int arg3 ;
  
  SWIG_check_num_args("BicuadFilter::processSamples",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("BicuadFilter::processSamples",1,"BicuadFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("BicuadFilter::processSamples",2,"DspFloatType *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("BicuadFilter::processSamples",3,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_BicuadFilter,0))){
    SWIG_fail_ptr("BicuadFilter_processSamples",1,SWIGTYPE_p_BicuadFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("BicuadFilter_processSamples",2,SWIGTYPE_p_float);
  }
...
static void swig_delete_BicuadFilter(void *obj) {
BicuadFilter *arg1 = (BicuadFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_BicuadFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_BicuadFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_BicuadFilter_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_BicuadFilter_methods[]= {
    { "makeInactive", _wrap_BicuadFilter_makeInactive},
    { "setCoeficientes", _wrap_BicuadFilter_setCoeficientes},
    { "reset", _wrap_BicuadFilter_reset},
    { "processSamples", _wrap_BicuadFilter_processSamples},
    {0,0}
};
static swig_lua_method swig_BicuadFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_BicuadFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_BicuadFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_BicuadFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_BicuadFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_BicuadFilter_Sf_SwigStatic = {
    "BicuadFilter",
    swig_BicuadFilter_Sf_SwigStatic_methods,
    swig_BicuadFilter_Sf_SwigStatic_attributes,
    swig_BicuadFilter_Sf_SwigStatic_constants,
    swig_BicuadFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_BicuadFilter_bases[] = {0};
static const char *swig_BicuadFilter_base_names[] = {0};
static swig_lua_class _wrap_class_BicuadFilter = { "BicuadFilter", "BicuadFilter", &SWIGTYPE_p_BicuadFilter,_proxy__wrap_new_BicuadFilter, swig_delete_BicuadFilter, swig_BicuadFilter_methods, swig_BicuadFilter_attributes, &swig_BicuadFilter_Sf_SwigStatic, swig_BicuadFilter_meta, swig_BicuadFilter_bases, swig_BicuadFilter_base_names };

static int _wrap_new_BandFilter(lua_State* L) {
  int SWIG_arg = 0;
  int arg1 ;
  BandFilter *result = 0 ;
  
  SWIG_check_num_args("BandFilter::BandFilter",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("BandFilter::BandFilter",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  result = (BandFilter *)new BandFilter(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_BandFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_BandFilter_processSamples(lua_State* L) {
  int SWIG_arg = 0;
  BandFilter *arg1 = (BandFilter *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  int arg3 ;
  
  SWIG_check_num_args("BandFilter::processSamples",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("BandFilter::processSamples",1,"BandFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("BandFilter::processSamples",2,"DspFloatType *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("BandFilter::processSamples",3,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_BandFilter,0))){
    SWIG_fail_ptr("BandFilter_processSamples",1,SWIGTYPE_p_BandFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("BandFilter_processSamples",2,SWIGTYPE_p_float);
  }
...
static int _wrap_BandFilter_reset(lua_State* L) {
  int SWIG_arg = 0;
  BandFilter *arg1 = (BandFilter *) 0 ;
  
  SWIG_check_num_args("BandFilter::reset",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("BandFilter::reset",1,"BandFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_BandFilter,0))){
    SWIG_fail_ptr("BandFilter_reset",1,SWIGTYPE_p_BandFilter);
  }
...
static int _wrap_BandFilter_bicuadFiltersArray_set(lua_State* L) {
  int SWIG_arg = 0;
  BandFilter *arg1 = (BandFilter *) 0 ;
  std::vector< BicuadFilter * > *arg2 = (std::vector< BicuadFilter * > *) 0 ;
  
  SWIG_check_num_args("BandFilter::bicuadFiltersArray",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("BandFilter::bicuadFiltersArray",1,"BandFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("BandFilter::bicuadFiltersArray",2,"std::vector< BicuadFilter * > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_BandFilter,0))){
    SWIG_fail_ptr("BandFilter_bicuadFiltersArray_set",1,SWIGTYPE_p_BandFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__vectorT_BicuadFilter_p_t,0))){
    SWIG_fail_ptr("BandFilter_bicuadFiltersArray_set",2,SWIGTYPE_p_std__vectorT_BicuadFilter_p_t);
  }
  
  if (arg1) (arg1)->bicuadFiltersArray = *arg2;
...
static int _wrap_BandFilter_bicuadFiltersArray_get(lua_State* L) {
  int SWIG_arg = 0;
  BandFilter *arg1 = (BandFilter *) 0 ;
  std::vector< BicuadFilter * > *result = 0 ;
  
  SWIG_check_num_args("BandFilter::bicuadFiltersArray",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("BandFilter::bicuadFiltersArray",1,"BandFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_BandFilter,0))){
    SWIG_fail_ptr("BandFilter_bicuadFiltersArray_get",1,SWIGTYPE_p_BandFilter);
  }
  
  result = (std::vector< BicuadFilter * > *)& ((arg1)->bicuadFiltersArray);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__vectorT_BicuadFilter_p_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_BandFilter(void *obj) {
BandFilter *arg1 = (BandFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_BandFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_BandFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_BandFilter_attributes[] = {
    { "bicuadFiltersArray", _wrap_BandFilter_bicuadFiltersArray_get, _wrap_BandFilter_bicuadFiltersArray_set },
    {0,0,0}
};
static swig_lua_method swig_BandFilter_methods[]= {
    { "processSamples", _wrap_BandFilter_processSamples},
    { "reset", _wrap_BandFilter_reset},
    {0,0}
};
static swig_lua_method swig_BandFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_BandFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_BandFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_BandFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_BandFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_BandFilter_Sf_SwigStatic = {
    "BandFilter",
    swig_BandFilter_Sf_SwigStatic_methods,
    swig_BandFilter_Sf_SwigStatic_attributes,
    swig_BandFilter_Sf_SwigStatic_constants,
    swig_BandFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_BandFilter_bases[] = {0};
static const char *swig_BandFilter_base_names[] = {0};
static swig_lua_class _wrap_class_BandFilter = { "BandFilter", "BandFilter", &SWIGTYPE_p_BandFilter,_proxy__wrap_new_BandFilter, swig_delete_BandFilter, swig_BandFilter_methods, swig_BandFilter_attributes, &swig_BandFilter_Sf_SwigStatic, swig_BandFilter_meta, swig_BandFilter_bases, swig_BandFilter_base_names };
...
static int _wrap_new_FilterBank(lua_State* L) {
  ...
  SWIG_check_num_args("FilterBank::FilterBank",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("FilterBank::FilterBank",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  result = (FilterBank *)new FilterBank(arg1);
...
static int _wrap_FilterBank_setCoeficientes(lua_State* L) {
  int SWIG_arg = 0;
  FilterBank *arg1 = (FilterBank *) 0 ;
  
  SWIG_check_num_args("FilterBank::setCoeficientes",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FilterBank::setCoeficientes",1,"FilterBank *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FilterBank,0))){
    SWIG_fail_ptr("FilterBank_setCoeficientes",1,SWIGTYPE_p_FilterBank);
  }
  
  (arg1)->setCoeficientes();
...
static int _wrap_FilterBank_processSamples__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  FilterBank *arg1 = (FilterBank *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) (DspFloatType *)0 ;
  AudioSampleBuffer *arg3 = (AudioSampleBuffer *) 0 ;
  int arg4 ;
  
  SWIG_check_num_args("FilterBank::processSamples",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FilterBank::processSamples",1,"FilterBank *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FilterBank::processSamples",2,"DspFloatType *const");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FilterBank::processSamples",3,"AudioSampleBuffer *");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("FilterBank::processSamples",4,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FilterBank,0))){
    SWIG_fail_ptr("FilterBank_processSamples",1,SWIGTYPE_p_FilterBank);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FilterBank_processSamples",2,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_AudioSampleBuffer,0))){
    SWIG_fail_ptr("FilterBank_processSamples",3,SWIGTYPE_p_AudioSampleBuffer);
  }
  
  arg4 = (int)lua_tonumber(L, 4);
  (arg1)->processSamples(arg2,arg3,arg4);
...
static int _wrap_FilterBank_processSamples__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  FilterBank *arg1 = (FilterBank *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) (DspFloatType *)0 ;
  OwnedArray< AudioSampleBuffer > *arg3 = (OwnedArray< AudioSampleBuffer > *) 0 ;
  int arg4 ;
  
  SWIG_check_num_args("FilterBank::processSamples",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FilterBank::processSamples",1,"FilterBank *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FilterBank::processSamples",2,"DspFloatType *const");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FilterBank::processSamples",3,"OwnedArray< AudioSampleBuffer > *");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("FilterBank::processSamples",4,"int");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_OwnedArrayT_AudioSampleBuffer_t,0))){
    SWIG_fail_ptr("FilterBank_processSamples",3,SWIGTYPE_p_OwnedArrayT_AudioSampleBuffer_t);
  }
...
static int _wrap_FilterBank_processSamples__SWIG_2(lua_State* L) {
  int SWIG_arg = 0;
  FilterBank *arg1 = (FilterBank *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) (DspFloatType *)0 ;
  DspFloatType *arg3 = (DspFloatType *) (DspFloatType *)0 ;
  int arg4 ;
  
  SWIG_check_num_args("FilterBank::processSamples",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FilterBank::processSamples",1,"FilterBank *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FilterBank::processSamples",2,"DspFloatType *const");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FilterBank::processSamples",3,"DspFloatType *const");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("FilterBank::processSamples",4,"int");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FilterBank_processSamples",3,SWIGTYPE_p_float);
  }
...
static int _wrap_FilterBank_processSamples(lua_State* L) {
  int argc;
  int argv[5]={
    1,2,3,4,5
  };
  ...
  if (argc == 4) {
    ...
    {
      void *ptr;
      if (SWIG_isptrtype(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_FilterBank, 0)) {
        _v = 0;
      } else {
        _v = 1;
      }
    ...
    if (_v) {
      ...
      if (_v) {
        {
          void *ptr;
          if (SWIG_isptrtype(L,argv[2])==0 || SWIG_ConvertPtr(L,argv[2], (void **) &ptr, SWIGTYPE_p_AudioSampleBuffer, 0)) {
            _v = 0;
          } else {
            _v = 1;
          }
        ...
        if (_v) {
          ...
          if (_v) {
            return _wrap_FilterBank_processSamples__SWIG_0(L);
          }
        }
      }
    }
  ...
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        {
          void *ptr;
          if (SWIG_isptrtype(L,argv[2])==0 || SWIG_ConvertPtr(L,argv[2], (void **) &ptr, SWIGTYPE_p_OwnedArrayT_AudioSampleBuffer_t, 0)) {
            _v = 0;
          } else {
            _v = 1;
          }
        ...
        if (_v) {
          ...
          if (_v) {
            return _wrap_FilterBank_processSamples__SWIG_1(L);
          }
        }
      }
    }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          if (_v) {
            return _wrap_FilterBank_processSamples__SWIG_2(L);
          }
        }
      }
    }
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'FilterBank_processSamples'\n"
    "  Possible C/C++ prototypes are:\n"
    "    FilterBank::processSamples(DspFloatType *const,AudioSampleBuffer *,int)\n"
    "    FilterBank::processSamples(DspFloatType *const,OwnedArray< AudioSampleBuffer > *,int)\n"
    "    FilterBank::processSamples(DspFloatType *const,DspFloatType *const,int)\n");
  lua_error(L);return 0;
}
...
static swig_lua_method swig_FilterBank_methods[]= {
    { "setCoeficientes", _wrap_FilterBank_setCoeficientes},
    { "processSamples", _wrap_FilterBank_processSamples},
    {0,0}
};
...
static int _wrap_SOS8_get(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType (*result)[6] = 0 ;
  
  SWIG_check_num_args("SOS8",0,0)
  result = (DspFloatType (*)[6])(DspFloatType (*)[6])SOS8;
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_a_6__float,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_G8_get(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType *result = 0 ;
  
  SWIG_check_num_args("G8",0,0)
  result = (DspFloatType *)(DspFloatType *)G8;
...
static int _wrap_SOS3_get(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType (*result)[6] = 0 ;
  
  SWIG_check_num_args("SOS3",0,0)
  result = (DspFloatType (*)[6])(DspFloatType (*)[6])SOS3;
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_a_6__float,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_G3_get(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType *result = 0 ;
  
  SWIG_check_num_args("G3",0,0)
  result = (DspFloatType *)(DspFloatType *)G3;
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_float,0); SWIG_arg++; 
  return SWIG_arg;
...
static swig_lua_attribute swig_SwigModule_attributes[] = {
    ...
    { "SOS8", _wrap_SOS8_get, SWIG_Lua_set_immutable },
    { "G8", _wrap_G8_get, SWIG_Lua_set_immutable },
    { "SOS3", _wrap_SOS3_get, SWIG_Lua_set_immutable },
    { "G3", _wrap_G3_get, SWIG_Lua_set_immutable },
...
&_wrap_class_BicuadFilter,
&_wrap_class_BandFilter,
...
static swig_type_info _swigt__p_AudioSampleBuffer = {"_p_AudioSampleBuffer", "AudioSampleBuffer *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_BandFilter = {"_p_BandFilter", "BandFilter *", 0, 0, (void*)&_wrap_class_BandFilter, 0};
static swig_type_info _swigt__p_BicuadFilter = {"_p_BicuadFilter", "BicuadFilter *", 0, 0, (void*)&_wrap_class_BicuadFilter, 0};
...
static swig_type_info _swigt__p_OwnedArrayT_AudioSampleBuffer_t = {"_p_OwnedArrayT_AudioSampleBuffer_t", "OwnedArray< AudioSampleBuffer > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_a_6__float = {"_p_a_6__float", "float (*)[6]|DspFloatType (*)[6]", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_std__vectorT_BicuadFilter_p_t = {"_p_std__vectorT_BicuadFilter_p_t", "std::vector< BicuadFilter * > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_AudioSampleBuffer,
  &_swigt__p_BandFilter,
  &_swigt__p_BicuadFilter,
  ...
  &_swigt__p_OwnedArrayT_AudioSampleBuffer_t,
  ...
  &_swigt__p_std__vectorT_BicuadFilter_p_t,
...
static swig_cast_info _swigc__p_AudioSampleBuffer[] = {  {&_swigt__p_AudioSampleBuffer, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_BandFilter[] = {  {&_swigt__p_BandFilter, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_BicuadFilter[] = {  {&_swigt__p_BicuadFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_OwnedArrayT_AudioSampleBuffer_t[] = {  {&_swigt__p_OwnedArrayT_AudioSampleBuffer_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__vectorT_BicuadFilter_p_t[] = {  {&_swigt__p_std__vectorT_BicuadFilter_p_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_AudioSampleBuffer,
  _swigc__p_BandFilter,
  _swigc__p_BicuadFilter,
  ...
  _swigc__p_OwnedArrayT_AudioSampleBuffer_t,
  ...
  _swigc__p_std__vectorT_BicuadFilter_p_t,
