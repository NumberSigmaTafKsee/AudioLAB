...
%template(ldouble_valarray) std::valarray<long double>;
%template(short_valarray) std::valarray<short>;
%template(ushort_valarray) std::valarray<unsigned short>;
%template(int_valarray) std::valarray<int>;
%template(uint_valarray) std::valarray<unsigned int>;
%template(long_valarray) std::valarray<long>;
%template(ulong_valarray) std::valarray<unsigned long>;
%template(llong_valarray) std::valarray<long long>;
%template(ullong_valarray) std::valarray<unsigned long long>;
