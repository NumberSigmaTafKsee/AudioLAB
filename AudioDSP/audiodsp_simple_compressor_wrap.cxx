...
#define SWIGTYPE_p_EnvelopeShaper swig_types[2]
...
#define SWIG_name      "audiodsp_simple_compressor"
#define SWIG_init      luaopen_audiodsp_simple_compressor
#define SWIG_init_user luaopen_audiodsp_simple_compressor_user

#define SWIG_LUACODE   luaopen_audiodsp_simple_compressor_luacode
...
#include "audiodsp_simple_compressor.hpp"
...
static int _wrap_new_EnvelopeShaper(lua_State* L) {
  int SWIG_arg = 0;
  EnvelopeShaper *result = 0 ;
  
  SWIG_check_num_args("EnvelopeShaper::EnvelopeShaper",0,0)
  result = (EnvelopeShaper *)new EnvelopeShaper();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_EnvelopeShaper,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_EnvelopeShaper_processAudioSample(lua_State* L) {
  int SWIG_arg = 0;
  EnvelopeShaper *arg1 = (EnvelopeShaper *) 0 ;
  float *arg2 = 0 ;
  
  SWIG_check_num_args("EnvelopeShaper::processAudioSample",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("EnvelopeShaper::processAudioSample",1,"EnvelopeShaper *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("EnvelopeShaper::processAudioSample",2,"float &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_EnvelopeShaper,0))){
    SWIG_fail_ptr("EnvelopeShaper_processAudioSample",1,SWIGTYPE_p_EnvelopeShaper);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("EnvelopeShaper_processAudioSample",2,SWIGTYPE_p_float);
  }
  
  (arg1)->processAudioSample(*arg2);
...
static int _wrap_EnvelopeShaper_setAttack(lua_State* L) {
  int SWIG_arg = 0;
  EnvelopeShaper *arg1 = (EnvelopeShaper *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("EnvelopeShaper::setAttack",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("EnvelopeShaper::setAttack",1,"EnvelopeShaper *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("EnvelopeShaper::setAttack",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_EnvelopeShaper,0))){
    SWIG_fail_ptr("EnvelopeShaper_setAttack",1,SWIGTYPE_p_EnvelopeShaper);
  }
...
static int _wrap_EnvelopeShaper_setRelease(lua_State* L) {
  int SWIG_arg = 0;
  EnvelopeShaper *arg1 = (EnvelopeShaper *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("EnvelopeShaper::setRelease",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("EnvelopeShaper::setRelease",1,"EnvelopeShaper *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("EnvelopeShaper::setRelease",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_EnvelopeShaper,0))){
    SWIG_fail_ptr("EnvelopeShaper_setRelease",1,SWIGTYPE_p_EnvelopeShaper);
  }
...
static int _wrap_EnvelopeShaper_setSampleRate(lua_State* L) {
  int SWIG_arg = 0;
  EnvelopeShaper *arg1 = (EnvelopeShaper *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("EnvelopeShaper::setSampleRate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("EnvelopeShaper::setSampleRate",1,"EnvelopeShaper *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("EnvelopeShaper::setSampleRate",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_EnvelopeShaper,0))){
    SWIG_fail_ptr("EnvelopeShaper_setSampleRate",1,SWIGTYPE_p_EnvelopeShaper);
  }
...
static void swig_delete_EnvelopeShaper(void *obj) {
EnvelopeShaper *arg1 = (EnvelopeShaper *) obj;
delete arg1;
}
static int _proxy__wrap_new_EnvelopeShaper(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_EnvelopeShaper);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_EnvelopeShaper_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_EnvelopeShaper_methods[]= {
    { "processAudioSample", _wrap_EnvelopeShaper_processAudioSample},
    { "setAttack", _wrap_EnvelopeShaper_setAttack},
    { "setRelease", _wrap_EnvelopeShaper_setRelease},
    { "setSampleRate", _wrap_EnvelopeShaper_setSampleRate},
    {0,0}
};
static swig_lua_method swig_EnvelopeShaper_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_EnvelopeShaper_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_EnvelopeShaper_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_EnvelopeShaper_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_EnvelopeShaper_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_EnvelopeShaper_Sf_SwigStatic = {
    "EnvelopeShaper",
    swig_EnvelopeShaper_Sf_SwigStatic_methods,
    swig_EnvelopeShaper_Sf_SwigStatic_attributes,
    swig_EnvelopeShaper_Sf_SwigStatic_constants,
    swig_EnvelopeShaper_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_EnvelopeShaper_bases[] = {0};
static const char *swig_EnvelopeShaper_base_names[] = {0};
static swig_lua_class _wrap_class_EnvelopeShaper = { "EnvelopeShaper", "EnvelopeShaper", &SWIGTYPE_p_EnvelopeShaper,_proxy__wrap_new_EnvelopeShaper, swig_delete_EnvelopeShaper, swig_EnvelopeShaper_methods, swig_EnvelopeShaper_attributes, &swig_EnvelopeShaper_Sf_SwigStatic, swig_EnvelopeShaper_meta, swig_EnvelopeShaper_bases, swig_EnvelopeShaper_base_names };
...
static int _wrap_Compressor_setRatio(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Compressor::setRatio",2,"float");
...
static int _wrap_Compressor_setTreshold(lua_State* L) {
  int SWIG_arg = 0;
  Compressor *arg1 = (Compressor *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("Compressor::setTreshold",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Compressor::setTreshold",1,"Compressor *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Compressor::setTreshold",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Compressor,0))){
    SWIG_fail_ptr("Compressor_setTreshold",1,SWIGTYPE_p_Compressor);
  }
  
  arg2 = (float)lua_tonumber(L, 2);
  (arg1)->setTreshold(arg2);
...
static int _wrap_Compressor_setAttack(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Compressor::setAttack",2,"float");
...
static int _wrap_Compressor_setRelease(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Compressor::setRelease",2,"float");
...
static int _wrap_Compressor_setSampleRate(lua_State* L) {
  int SWIG_arg = 0;
  Compressor *arg1 = (Compressor *) 0 ;
  float arg2 ;
  
  SWIG_check_num_args("Compressor::setSampleRate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Compressor::setSampleRate",1,"Compressor *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Compressor::setSampleRate",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Compressor,0))){
    SWIG_fail_ptr("Compressor_setSampleRate",1,SWIGTYPE_p_Compressor);
  }
...
static int _wrap_Compressor_processAudioSample(lua_State* L) {
  int SWIG_arg = 0;
  Compressor *arg1 = (Compressor *) 0 ;
  float *arg2 = 0 ;
  
  SWIG_check_num_args("Compressor::processAudioSample",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Compressor::processAudioSample",1,"Compressor *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("Compressor::processAudioSample",2,"float &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Compressor,0))){
    SWIG_fail_ptr("Compressor_processAudioSample",1,SWIGTYPE_p_Compressor);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Compressor_processAudioSample",2,SWIGTYPE_p_float);
  }
...
static swig_lua_method swig_Compressor_methods[]= {
    ...
    { "setTreshold", _wrap_Compressor_setTreshold},
    { "setAttack", _wrap_Compressor_setAttack},
    { "setRelease", _wrap_Compressor_setRelease},
    { "setSampleRate", _wrap_Compressor_setSampleRate},
    { "processAudioSample", _wrap_Compressor_processAudioSample},
    {0,0}
};
...
static swig_type_info _swigt__p_EnvelopeShaper = {"_p_EnvelopeShaper", "EnvelopeShaper *", 0, 0, (void*)&_wrap_class_EnvelopeShaper, 0};
...
static swig_cast_info _swigc__p_EnvelopeShaper[] = {  {&_swigt__p_EnvelopeShaper, 0, 0, 0},{0, 0, 0, 0}};
