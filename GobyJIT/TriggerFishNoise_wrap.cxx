...
#define SWIGTYPE_p_tfdsp__PinkNoiseSource swig_types[94]
#define SWIGTYPE_p_tfdsp__WhiteNoiseSource swig_types[95]
#define SWIGTYPE_p_tfdsp__detune swig_types[96]
...
#define SWIG_name      "TriggerFishNoise"
#define SWIG_init      luaopen_TriggerFishNoise
#define SWIG_init_user luaopen_TriggerFishNoise_user

#define SWIG_LUACODE   luaopen_TriggerFishNoise_luacode
...
static int _wrap_new_WhiteNoiseSource(lua_State* L) {
  int SWIG_arg = 0;
  tfdsp::WhiteNoiseSource *result = 0 ;
  
  SWIG_check_num_args("tfdsp::WhiteNoiseSource::WhiteNoiseSource",0,0)
  result = (tfdsp::WhiteNoiseSource *)new tfdsp::WhiteNoiseSource();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_tfdsp__WhiteNoiseSource,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_WhiteNoiseSource_Step(lua_State* L) {
  int SWIG_arg = 0;
  tfdsp::WhiteNoiseSource *arg1 = (tfdsp::WhiteNoiseSource *) 0 ;
  float result;
  
  SWIG_check_num_args("tfdsp::WhiteNoiseSource::Step",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("tfdsp::WhiteNoiseSource::Step",1,"tfdsp::WhiteNoiseSource *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_tfdsp__WhiteNoiseSource,0))){
    SWIG_fail_ptr("WhiteNoiseSource_Step",1,SWIGTYPE_p_tfdsp__WhiteNoiseSource);
  }
...
tfdsp::WhiteNoiseSource *arg1 = (tfdsp::WhiteNoiseSource *) obj;
delete arg1;
}
...
static swig_lua_method swig_WhiteNoiseSource_methods[]= {
    { "Step", _wrap_WhiteNoiseSource_Step},
    {0,0}
};
...
static swig_lua_class _wrap_class_WhiteNoiseSource = { "WhiteNoiseSource", "WhiteNoiseSource", &SWIGTYPE_p_tfdsp__WhiteNoiseSource,_proxy__wrap_new_WhiteNoiseSource, swig_delete_WhiteNoiseSource, swig_WhiteNoiseSource_methods, swig_WhiteNoiseSource_attributes, &swig_WhiteNoiseSource_Sf_SwigStatic, swig_WhiteNoiseSource_meta, swig_WhiteNoiseSource_bases, swig_WhiteNoiseSource_base_names };

static int _wrap_new_PinkNoiseSource(lua_State* L) {
  int SWIG_arg = 0;
  tfdsp::PinkNoiseSource *result = 0 ;
  
  SWIG_check_num_args("tfdsp::PinkNoiseSource::PinkNoiseSource",0,0)
  result = (tfdsp::PinkNoiseSource *)new tfdsp::PinkNoiseSource();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_tfdsp__PinkNoiseSource,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_PinkNoiseSource_Filter3dbPerOctave(lua_State* L) {
  int SWIG_arg = 0;
  tfdsp::PinkNoiseSource *arg1 = (tfdsp::PinkNoiseSource *) 0 ;
  float arg2 ;
  float result;
  
  SWIG_check_num_args("tfdsp::PinkNoiseSource::Filter3dbPerOctave",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("tfdsp::PinkNoiseSource::Filter3dbPerOctave",1,"tfdsp::PinkNoiseSource *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("tfdsp::PinkNoiseSource::Filter3dbPerOctave",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_tfdsp__PinkNoiseSource,0))){
    SWIG_fail_ptr("PinkNoiseSource_Filter3dbPerOctave",1,SWIGTYPE_p_tfdsp__PinkNoiseSource);
  }
  
  arg2 = (float)lua_tonumber(L, 2);
  result = (float)(arg1)->Filter3dbPerOctave(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_PinkNoiseSource_Step(lua_State* L) {
  int SWIG_arg = 0;
  tfdsp::PinkNoiseSource *arg1 = (tfdsp::PinkNoiseSource *) 0 ;
  float result;
  
  SWIG_check_num_args("tfdsp::PinkNoiseSource::Step",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("tfdsp::PinkNoiseSource::Step",1,"tfdsp::PinkNoiseSource *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_tfdsp__PinkNoiseSource,0))){
    SWIG_fail_ptr("PinkNoiseSource_Step",1,SWIGTYPE_p_tfdsp__PinkNoiseSource);
  }
...
static void swig_delete_PinkNoiseSource(void *obj) {
tfdsp::PinkNoiseSource *arg1 = (tfdsp::PinkNoiseSource *) obj;
delete arg1;
}
static int _proxy__wrap_new_PinkNoiseSource(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_PinkNoiseSource);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_PinkNoiseSource_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_PinkNoiseSource_methods[]= {
    { "Filter3dbPerOctave", _wrap_PinkNoiseSource_Filter3dbPerOctave},
    { "Step", _wrap_PinkNoiseSource_Step},
    {0,0}
};
static swig_lua_method swig_PinkNoiseSource_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_PinkNoiseSource_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_PinkNoiseSource_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_PinkNoiseSource_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_PinkNoiseSource_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_PinkNoiseSource_Sf_SwigStatic = {
    "PinkNoiseSource",
    swig_PinkNoiseSource_Sf_SwigStatic_methods,
    swig_PinkNoiseSource_Sf_SwigStatic_attributes,
    swig_PinkNoiseSource_Sf_SwigStatic_constants,
    swig_PinkNoiseSource_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_PinkNoiseSource_bases[] = {0};
static const char *swig_PinkNoiseSource_base_names[] = {0};
static swig_lua_class _wrap_class_PinkNoiseSource = { "PinkNoiseSource", "PinkNoiseSource", &SWIGTYPE_p_tfdsp__PinkNoiseSource,_proxy__wrap_new_PinkNoiseSource, swig_delete_PinkNoiseSource, swig_PinkNoiseSource_methods, swig_PinkNoiseSource_attributes, &swig_PinkNoiseSource_Sf_SwigStatic, swig_PinkNoiseSource_meta, swig_PinkNoiseSource_bases, swig_PinkNoiseSource_base_names };

static int _wrap_detune_linear__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  double arg1 ;
  double arg2 ;
  double arg3 ;
  ...
  SWIG_check_num_args("tfdsp::detune::linear",3,3)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("tfdsp::detune::linear",1,"double");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("tfdsp::detune::linear",2,"double");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("tfdsp::detune::linear",3,"double");
  arg1 = (double)lua_tonumber(L, 1);
  arg2 = (double)lua_tonumber(L, 2);
  arg3 = (double)lua_tonumber(L, 3);
  result = (double)tfdsp::detune::linear(arg1,arg2,arg3);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_detune_linear__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  double arg1 ;
  double arg2 ;
  double result;
  
  SWIG_check_num_args("tfdsp::detune::linear",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("tfdsp::detune::linear",1,"double");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("tfdsp::detune::linear",2,"double");
  arg1 = (double)lua_tonumber(L, 1);
  arg2 = (double)lua_tonumber(L, 2);
  result = (double)tfdsp::detune::linear(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_detune_linear(lua_State* L) {
  int argc;
  int argv[4]={
    1,2,3,4
  };
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_detune_linear__SWIG_1(L);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_detune_linear__SWIG_0(L);
        }
      }
    }
  }
  
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'detune_linear'\n"
    "  Possible C/C++ prototypes are:\n"
    "    tfdsp::detune::linear(double,double,double)\n"
    "    tfdsp::detune::linear(double,double)\n");
  lua_error(L);return 0;
}


static int _wrap_new_detune(lua_State* L) {
  int SWIG_arg = 0;
  tfdsp::detune *result = 0 ;
  
  SWIG_check_num_args("tfdsp::detune::detune",0,0)
  result = (tfdsp::detune *)new tfdsp::detune();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_tfdsp__detune,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_detune(void *obj) {
tfdsp::detune *arg1 = (tfdsp::detune *) obj;
delete arg1;
}
static int _proxy__wrap_new_detune(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_detune);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_detune_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_detune_methods[]= {
    {0,0}
};
static swig_lua_method swig_detune_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_detune_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_detune_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_detune_Sf_SwigStatic_methods[]= {
    { "linear", _wrap_detune_linear},
    {0,0}
};
static swig_lua_class* swig_detune_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_detune_Sf_SwigStatic = {
    "detune",
    swig_detune_Sf_SwigStatic_methods,
    swig_detune_Sf_SwigStatic_attributes,
    swig_detune_Sf_SwigStatic_constants,
    swig_detune_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_detune_bases[] = {0};
static const char *swig_detune_base_names[] = {0};
static swig_lua_class _wrap_class_detune = { "detune", "detune", &SWIGTYPE_p_tfdsp__detune,_proxy__wrap_new_detune, swig_delete_detune, swig_detune_methods, swig_detune_attributes, &swig_detune_Sf_SwigStatic, swig_detune_meta, swig_detune_bases, swig_detune_base_names };
...
static swig_lua_method swig_SwigModule_methods[]= {
    ...
    { "detune_linear", _wrap_detune_linear},
    {0,0}
};
...
static swig_type_info _swigt__p_tfdsp__PinkNoiseSource = {"_p_tfdsp__PinkNoiseSource", "tfdsp::PinkNoiseSource *", 0, 0, (void*)&_wrap_class_PinkNoiseSource, 0};
static swig_type_info _swigt__p_tfdsp__WhiteNoiseSource = {"_p_tfdsp__WhiteNoiseSource", "tfdsp::WhiteNoiseSource *", 0, 0, (void*)&_wrap_class_WhiteNoiseSource, 0};
static swig_type_info _swigt__p_tfdsp__detune = {"_p_tfdsp__detune", "tfdsp::detune *", 0, 0, (void*)&_wrap_class_detune, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_tfdsp__PinkNoiseSource,
  &_swigt__p_tfdsp__WhiteNoiseSource,
  &_swigt__p_tfdsp__detune,
...
static swig_cast_info _swigc__p_tfdsp__PinkNoiseSource[] = {  {&_swigt__p_tfdsp__PinkNoiseSource, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_tfdsp__WhiteNoiseSource[] = {  {&_swigt__p_tfdsp__WhiteNoiseSource, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_tfdsp__detune[] = {  {&_swigt__p_tfdsp__detune, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_tfdsp__PinkNoiseSource,
  _swigc__p_tfdsp__WhiteNoiseSource,
  _swigc__p_tfdsp__detune,
