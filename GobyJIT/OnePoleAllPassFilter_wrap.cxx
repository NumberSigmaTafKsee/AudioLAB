...
#define SWIGTYPE_p_OnePoleAllpassFilter swig_types[18]
...
#define SWIG_name      "OnePoleAllPassFilter"
#define SWIG_init      luaopen_OnePoleAllPassFilter
#define SWIG_init_user luaopen_OnePoleAllPassFilter_user

#define SWIG_LUACODE   luaopen_OnePoleAllPassFilter_luacode
...
static int _wrap_new_OnePoleAllpassFilter(lua_State* L) {
  int SWIG_arg = 0;
  OnePoleAllpassFilter *result = 0 ;
  
  SWIG_check_num_args("OnePoleAllpassFilter::OnePoleAllpassFilter",0,0)
  result = (OnePoleAllpassFilter *)new OnePoleAllpassFilter();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_OnePoleAllpassFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_OnePoleAllpassFilter_processSamples(lua_State* L) {
  int SWIG_arg = 0;
  OnePoleAllpassFilter *arg1 = (OnePoleAllpassFilter *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) (DspFloatType *)0 ;
  int arg3 ;
  
  SWIG_check_num_args("OnePoleAllpassFilter::processSamples",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("OnePoleAllpassFilter::processSamples",1,"OnePoleAllpassFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("OnePoleAllpassFilter::processSamples",2,"DspFloatType *const");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("OnePoleAllpassFilter::processSamples",3,"int const");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_OnePoleAllpassFilter,0))){
    SWIG_fail_ptr("OnePoleAllpassFilter_processSamples",1,SWIGTYPE_p_OnePoleAllpassFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("OnePoleAllpassFilter_processSamples",2,SWIGTYPE_p_float);
  }
...
static int _wrap_OnePoleAllpassFilter_processSingleSampleRaw(lua_State* L) {
  int SWIG_arg = 0;
  OnePoleAllpassFilter *arg1 = (OnePoleAllpassFilter *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("OnePoleAllpassFilter::processSingleSampleRaw",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("OnePoleAllpassFilter::processSingleSampleRaw",1,"OnePoleAllpassFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("OnePoleAllpassFilter::processSingleSampleRaw",2,"DspFloatType const");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_OnePoleAllpassFilter,0))){
    SWIG_fail_ptr("OnePoleAllpassFilter_processSingleSampleRaw",1,SWIGTYPE_p_OnePoleAllpassFilter);
  }
  
  arg2 = (DspFloatType const)lua_tonumber(L, 2);
  result = (DspFloatType)(arg1)->processSingleSampleRaw(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_OnePoleAllpassFilter_makeAllpass(lua_State* L) {
  int SWIG_arg = 0;
  OnePoleAllpassFilter *arg1 = (OnePoleAllpassFilter *) 0 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("OnePoleAllpassFilter::makeAllpass",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("OnePoleAllpassFilter::makeAllpass",1,"OnePoleAllpassFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("OnePoleAllpassFilter::makeAllpass",2,"DspFloatType const");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("OnePoleAllpassFilter::makeAllpass",3,"DspFloatType const");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_OnePoleAllpassFilter,0))){
    SWIG_fail_ptr("OnePoleAllpassFilter_makeAllpass",1,SWIGTYPE_p_OnePoleAllpassFilter);
  }
  
  arg2 = (DspFloatType const)lua_tonumber(L, 2);
  arg3 = (DspFloatType const)lua_tonumber(L, 3);
  (arg1)->makeAllpass(arg2,arg3);
...
static void swig_delete_OnePoleAllpassFilter(void *obj) {
OnePoleAllpassFilter *arg1 = (OnePoleAllpassFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_OnePoleAllpassFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_OnePoleAllpassFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_OnePoleAllpassFilter_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_OnePoleAllpassFilter_methods[]= {
    { "processSamples", _wrap_OnePoleAllpassFilter_processSamples},
    { "processSingleSampleRaw", _wrap_OnePoleAllpassFilter_processSingleSampleRaw},
    { "makeAllpass", _wrap_OnePoleAllpassFilter_makeAllpass},
    {0,0}
};
static swig_lua_method swig_OnePoleAllpassFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_OnePoleAllpassFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_OnePoleAllpassFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_OnePoleAllpassFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_OnePoleAllpassFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_OnePoleAllpassFilter_Sf_SwigStatic = {
    "OnePoleAllpassFilter",
    swig_OnePoleAllpassFilter_Sf_SwigStatic_methods,
    swig_OnePoleAllpassFilter_Sf_SwigStatic_attributes,
    swig_OnePoleAllpassFilter_Sf_SwigStatic_constants,
    swig_OnePoleAllpassFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_OnePoleAllpassFilter_bases[] = {0};
static const char *swig_OnePoleAllpassFilter_base_names[] = {0};
static swig_lua_class _wrap_class_OnePoleAllpassFilter = { "OnePoleAllpassFilter", "OnePoleAllpassFilter", &SWIGTYPE_p_OnePoleAllpassFilter,_proxy__wrap_new_OnePoleAllpassFilter, swig_delete_OnePoleAllpassFilter, swig_OnePoleAllpassFilter_methods, swig_OnePoleAllpassFilter_attributes, &swig_OnePoleAllpassFilter_Sf_SwigStatic, swig_OnePoleAllpassFilter_meta, swig_OnePoleAllpassFilter_bases, swig_OnePoleAllpassFilter_base_names };
...
&_wrap_class_OnePoleAllpassFilter,
...
static swig_type_info _swigt__p_OnePoleAllpassFilter = {"_p_OnePoleAllpassFilter", "OnePoleAllpassFilter *", 0, 0, (void*)&_wrap_class_OnePoleAllpassFilter, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_OnePoleAllpassFilter,
...
static swig_cast_info _swigc__p_OnePoleAllpassFilter[] = {  {&_swigt__p_OnePoleAllpassFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_OnePoleAllpassFilter,
