...
#define SWIGTYPE_p_ATK__InverseRIAACoefficientsT_DspFloatType_t swig_types[0]
#define SWIGTYPE_p_ATK__RIAACoefficientsT_DspFloatType_t swig_types[1]
#define SWIGTYPE_p_AmplifierProcessor swig_types[2]
#define SWIGTYPE_p_FilterProcessor swig_types[3]
#define SWIGTYPE_p_Filters__AudioTK__EQ__InverseRIAAFilter swig_types[4]
#define SWIGTYPE_p_Filters__AudioTK__EQ__RIAAFilter swig_types[5]
...
#define SWIG_name      "ATKRIAAFilters"
#define SWIG_init      luaopen_ATKRIAAFilters
#define SWIG_init_user luaopen_ATKRIAAFilters_user

#define SWIG_LUACODE   luaopen_ATKRIAAFilters_luacode
...
static int _wrap_RIAAFilter_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::RIAAFilter *arg1 = (Filters::AudioTK::EQ::RIAAFilter *) 0 ;
  ATK::RIAACoefficients< DspFloatType > *arg2 = (ATK::RIAACoefficients< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::RIAAFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::RIAAFilter::filter",1,"Filters::AudioTK::EQ::RIAAFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::EQ::RIAAFilter::filter",2,"ATK::RIAACoefficients< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__RIAAFilter,0))){
    SWIG_fail_ptr("RIAAFilter_filter_set",1,SWIGTYPE_p_Filters__AudioTK__EQ__RIAAFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__RIAACoefficientsT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("RIAAFilter_filter_set",2,SWIGTYPE_p_ATK__RIAACoefficientsT_DspFloatType_t);
  }
...
static int _wrap_RIAAFilter_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::RIAAFilter *arg1 = (Filters::AudioTK::EQ::RIAAFilter *) 0 ;
  ATK::RIAACoefficients< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::RIAAFilter::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::RIAAFilter::filter",1,"Filters::AudioTK::EQ::RIAAFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__RIAAFilter,0))){
    SWIG_fail_ptr("RIAAFilter_filter_get",1,SWIGTYPE_p_Filters__AudioTK__EQ__RIAAFilter);
  }
  
  result = (ATK::RIAACoefficients< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__RIAACoefficientsT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_RIAAFilter(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::RIAAFilter *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::RIAAFilter::RIAAFilter",0,0)
  result = (Filters::AudioTK::EQ::RIAAFilter *)new Filters::AudioTK::EQ::RIAAFilter();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__EQ__RIAAFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_RIAAFilter_setPort(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::RIAAFilter *arg1 = (Filters::AudioTK::EQ::RIAAFilter *) 0 ;
  int arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::RIAAFilter::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::RIAAFilter::setPort",1,"Filters::AudioTK::EQ::RIAAFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AudioTK::EQ::RIAAFilter::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AudioTK::EQ::RIAAFilter::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__RIAAFilter,0))){
    SWIG_fail_ptr("RIAAFilter_setPort",1,SWIGTYPE_p_Filters__AudioTK__EQ__RIAAFilter);
  }
...
static void swig_delete_RIAAFilter(void *obj) {
Filters::AudioTK::EQ::RIAAFilter *arg1 = (Filters::AudioTK::EQ::RIAAFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_RIAAFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_RIAAFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_RIAAFilter_attributes[] = {
    { "filter", _wrap_RIAAFilter_filter_get, _wrap_RIAAFilter_filter_set },
    {0,0,0}
};
static swig_lua_method swig_RIAAFilter_methods[]= {
    { "setPort", _wrap_RIAAFilter_setPort},
    {0,0}
};
static swig_lua_method swig_RIAAFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_RIAAFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_RIAAFilter_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_CUTOFF", Filters::AudioTK::EQ::RIAAFilter::PORT_CUTOFF)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_RIAAFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_RIAAFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_RIAAFilter_Sf_SwigStatic = {
    "RIAAFilter",
    swig_RIAAFilter_Sf_SwigStatic_methods,
    swig_RIAAFilter_Sf_SwigStatic_attributes,
    swig_RIAAFilter_Sf_SwigStatic_constants,
    swig_RIAAFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_RIAAFilter_bases[] = {0};
static const char *swig_RIAAFilter_base_names[] = {0};
static swig_lua_class _wrap_class_RIAAFilter = { "RIAAFilter", "RIAAFilter", &SWIGTYPE_p_Filters__AudioTK__EQ__RIAAFilter,_proxy__wrap_new_RIAAFilter, swig_delete_RIAAFilter, swig_RIAAFilter_methods, swig_RIAAFilter_attributes, &swig_RIAAFilter_Sf_SwigStatic, swig_RIAAFilter_meta, swig_RIAAFilter_bases, swig_RIAAFilter_base_names };

static int _wrap_InverseRIAAFilter_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::InverseRIAAFilter *arg1 = (Filters::AudioTK::EQ::InverseRIAAFilter *) 0 ;
  ATK::InverseRIAACoefficients< DspFloatType > *arg2 = (ATK::InverseRIAACoefficients< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::InverseRIAAFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::InverseRIAAFilter::filter",1,"Filters::AudioTK::EQ::InverseRIAAFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::EQ::InverseRIAAFilter::filter",2,"ATK::InverseRIAACoefficients< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__InverseRIAAFilter,0))){
    SWIG_fail_ptr("InverseRIAAFilter_filter_set",1,SWIGTYPE_p_Filters__AudioTK__EQ__InverseRIAAFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__InverseRIAACoefficientsT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("InverseRIAAFilter_filter_set",2,SWIGTYPE_p_ATK__InverseRIAACoefficientsT_DspFloatType_t);
  }
...
static int _wrap_InverseRIAAFilter_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::InverseRIAAFilter *arg1 = (Filters::AudioTK::EQ::InverseRIAAFilter *) 0 ;
  ATK::InverseRIAACoefficients< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::InverseRIAAFilter::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::InverseRIAAFilter::filter",1,"Filters::AudioTK::EQ::InverseRIAAFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__InverseRIAAFilter,0))){
    SWIG_fail_ptr("InverseRIAAFilter_filter_get",1,SWIGTYPE_p_Filters__AudioTK__EQ__InverseRIAAFilter);
  }
  
  result = (ATK::InverseRIAACoefficients< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__InverseRIAACoefficientsT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_InverseRIAAFilter(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::InverseRIAAFilter *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::InverseRIAAFilter::InverseRIAAFilter",0,0)
  result = (Filters::AudioTK::EQ::InverseRIAAFilter *)new Filters::AudioTK::EQ::InverseRIAAFilter();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__EQ__InverseRIAAFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_InverseRIAAFilter_setPort(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::EQ::InverseRIAAFilter *arg1 = (Filters::AudioTK::EQ::InverseRIAAFilter *) 0 ;
  int arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Filters::AudioTK::EQ::InverseRIAAFilter::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::EQ::InverseRIAAFilter::setPort",1,"Filters::AudioTK::EQ::InverseRIAAFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AudioTK::EQ::InverseRIAAFilter::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AudioTK::EQ::InverseRIAAFilter::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__EQ__InverseRIAAFilter,0))){
    SWIG_fail_ptr("InverseRIAAFilter_setPort",1,SWIGTYPE_p_Filters__AudioTK__EQ__InverseRIAAFilter);
  }
...
static void swig_delete_InverseRIAAFilter(void *obj) {
Filters::AudioTK::EQ::InverseRIAAFilter *arg1 = (Filters::AudioTK::EQ::InverseRIAAFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_InverseRIAAFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_InverseRIAAFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_InverseRIAAFilter_attributes[] = {
    { "filter", _wrap_InverseRIAAFilter_filter_get, _wrap_InverseRIAAFilter_filter_set },
    {0,0,0}
};
static swig_lua_method swig_InverseRIAAFilter_methods[]= {
    { "setPort", _wrap_InverseRIAAFilter_setPort},
    {0,0}
};
static swig_lua_method swig_InverseRIAAFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_InverseRIAAFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_InverseRIAAFilter_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_CUTOFF", Filters::AudioTK::EQ::InverseRIAAFilter::PORT_CUTOFF)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_InverseRIAAFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_InverseRIAAFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_InverseRIAAFilter_Sf_SwigStatic = {
    "InverseRIAAFilter",
    swig_InverseRIAAFilter_Sf_SwigStatic_methods,
    swig_InverseRIAAFilter_Sf_SwigStatic_attributes,
    swig_InverseRIAAFilter_Sf_SwigStatic_constants,
    swig_InverseRIAAFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_InverseRIAAFilter_bases[] = {0};
static const char *swig_InverseRIAAFilter_base_names[] = {0};
static swig_lua_class _wrap_class_InverseRIAAFilter = { "InverseRIAAFilter", "InverseRIAAFilter", &SWIGTYPE_p_Filters__AudioTK__EQ__InverseRIAAFilter,_proxy__wrap_new_InverseRIAAFilter, swig_delete_InverseRIAAFilter, swig_InverseRIAAFilter_methods, swig_InverseRIAAFilter_attributes, &swig_InverseRIAAFilter_Sf_SwigStatic, swig_InverseRIAAFilter_meta, swig_InverseRIAAFilter_bases, swig_InverseRIAAFilter_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("RIAAFilter_PORT_CUTOFF", Filters::AudioTK::EQ::RIAAFilter::PORT_CUTOFF)},
    {SWIG_LUA_CONSTTAB_INT("InverseRIAAFilter_PORT_CUTOFF", Filters::AudioTK::EQ::InverseRIAAFilter::PORT_CUTOFF)},
    {0,0,0,0,0,0}
};
...
&_wrap_class_RIAAFilter,
&_wrap_class_InverseRIAAFilter,
...
static swig_type_info _swigt__p_ATK__InverseRIAACoefficientsT_DspFloatType_t = {"_p_ATK__InverseRIAACoefficientsT_DspFloatType_t", "ATK::InverseRIAACoefficients< DspFloatType > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ATK__RIAACoefficientsT_DspFloatType_t = {"_p_ATK__RIAACoefficientsT_DspFloatType_t", "ATK::RIAACoefficients< DspFloatType > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_Filters__AudioTK__EQ__InverseRIAAFilter = {"_p_Filters__AudioTK__EQ__InverseRIAAFilter", "Filters::AudioTK::EQ::InverseRIAAFilter *", 0, 0, (void*)&_wrap_class_InverseRIAAFilter, 0};
static swig_type_info _swigt__p_Filters__AudioTK__EQ__RIAAFilter = {"_p_Filters__AudioTK__EQ__RIAAFilter", "Filters::AudioTK::EQ::RIAAFilter *", 0, 0, (void*)&_wrap_class_RIAAFilter, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ATK__InverseRIAACoefficientsT_DspFloatType_t,
  &_swigt__p_ATK__RIAACoefficientsT_DspFloatType_t,
  &_swigt__p_AmplifierProcessor,
  &_swigt__p_FilterProcessor,
  &_swigt__p_Filters__AudioTK__EQ__InverseRIAAFilter,
  &_swigt__p_Filters__AudioTK__EQ__RIAAFilter,
...
static swig_cast_info _swigc__p_ATK__InverseRIAACoefficientsT_DspFloatType_t[] = {  {&_swigt__p_ATK__InverseRIAACoefficientsT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ATK__RIAACoefficientsT_DspFloatType_t[] = {  {&_swigt__p_ATK__RIAACoefficientsT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_Filters__AudioTK__EQ__InverseRIAAFilter[] = {  {&_swigt__p_Filters__AudioTK__EQ__InverseRIAAFilter, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Filters__AudioTK__EQ__RIAAFilter[] = {  {&_swigt__p_Filters__AudioTK__EQ__RIAAFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ATK__InverseRIAACoefficientsT_DspFloatType_t,
  _swigc__p_ATK__RIAACoefficientsT_DspFloatType_t,
  _swigc__p_AmplifierProcessor,
  _swigc__p_FilterProcessor,
  _swigc__p_Filters__AudioTK__EQ__InverseRIAAFilter,
  _swigc__p_Filters__AudioTK__EQ__RIAAFilter,
