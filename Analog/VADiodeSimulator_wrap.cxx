...
static int _wrap_DiodeSaturation_sampleRate_set(lua_State* L) {
  int SWIG_arg = 0;
  Analog::Distortion::Diode::DiodeSaturation *arg1 = (Analog::Distortion::Diode::DiodeSaturation *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::Distortion::Diode::DiodeSaturation::sampleRate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::Distortion::Diode::DiodeSaturation::sampleRate",1,"Analog::Distortion::Diode::DiodeSaturation *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::Distortion::Diode::DiodeSaturation::sampleRate",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__Distortion__Diode__DiodeSaturation,0))){
    SWIG_fail_ptr("DiodeSaturation_sampleRate_set",1,SWIGTYPE_p_Analog__Distortion__Diode__DiodeSaturation);
  }
...
static int _wrap_DiodeSaturation_sampleRate_get(lua_State* L) {
  int SWIG_arg = 0;
  Analog::Distortion::Diode::DiodeSaturation *arg1 = (Analog::Distortion::Diode::DiodeSaturation *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::Distortion::Diode::DiodeSaturation::sampleRate",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::Distortion::Diode::DiodeSaturation::sampleRate",1,"Analog::Distortion::Diode::DiodeSaturation *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__Distortion__Diode__DiodeSaturation,0))){
    SWIG_fail_ptr("DiodeSaturation_sampleRate_get",1,SWIGTYPE_p_Analog__Distortion__Diode__DiodeSaturation);
  }
...
static int _wrap_new_DiodeSaturation__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  Analog::Distortion::Diode::DiodeSaturation *result = 0 ;
  
  SWIG_check_num_args("Analog::Distortion::Diode::DiodeSaturation::DiodeSaturation",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::Distortion::Diode::DiodeSaturation::DiodeSaturation",1,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  result = (Analog::Distortion::Diode::DiodeSaturation *)new Analog::Distortion::Diode::DiodeSaturation(arg1);
...
static int _wrap_new_DiodeSaturation__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  Analog::Distortion::Diode::DiodeSaturation *result = 0 ;
...
static int _wrap_new_DiodeSaturation(lua_State* L) {
  ...
  argc = lua_gettop(L);
  if (argc == 0) {
    return _wrap_new_DiodeSaturation__SWIG_1(L);
  }
  if (argc == 1) {
    int _v = 0;
    {
    ...
    if (_v) {
      return _wrap_new_DiodeSaturation__SWIG_0(L);
    }
  }
  
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'new_DiodeSaturation'\n"
    "  Possible C/C++ prototypes are:\n"
    "    Analog::Distortion::Diode::DiodeSaturation::DiodeSaturation(DspFloatType)\n"
    "    Analog::Distortion::Diode::DiodeSaturation::DiodeSaturation()\n");
  lua_error(L);return 0;
}
...
static swig_lua_attribute swig_DiodeSaturation_attributes[] = {
    ...
    { "sampleRate", _wrap_DiodeSaturation_sampleRate_get, _wrap_DiodeSaturation_sampleRate_set },
