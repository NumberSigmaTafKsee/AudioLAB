...
#define SWIGTYPE_p_FX__HammerFX__Distortion swig_types[1]
#define SWIGTYPE_p_FX__HammerFX__Distortion2 swig_types[2]
...
#define SWIGTYPE_p_distort_params swig_types[41]
#define SWIGTYPE_p_distort_params2 swig_types[42]
...
#define SWIG_name      "HammerFXDistortion"
#define SWIG_init      luaopen_HammerFXDistortion
#define SWIG_init_user luaopen_HammerFXDistortion_user

#define SWIG_LUACODE   luaopen_HammerFXDistortion_luacode
...
static int _wrap_Distortion_cp_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Distortion *arg1 = (FX::HammerFX::Distortion *) 0 ;
  distort_params arg2 ;
  distort_params *argp2 ;
  
  SWIG_check_num_args("FX::HammerFX::Distortion::cp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Distortion::cp",1,"FX::HammerFX::Distortion *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("FX::HammerFX::Distortion::cp",2,"distort_params");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Distortion,0))){
    SWIG_fail_ptr("Distortion_cp_set",1,SWIGTYPE_p_FX__HammerFX__Distortion);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_distort_params,0))){
    SWIG_fail_ptr("Distortion_cp_set",2,SWIGTYPE_p_distort_params);
  }
  arg2 = *argp2;
...
static int _wrap_Distortion_cp_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Distortion *arg1 = (FX::HammerFX::Distortion *) 0 ;
  distort_params result;
  
  SWIG_check_num_args("FX::HammerFX::Distortion::cp",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Distortion::cp",1,"FX::HammerFX::Distortion *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Distortion,0))){
    SWIG_fail_ptr("Distortion_cp_get",1,SWIGTYPE_p_FX__HammerFX__Distortion);
  }
  
  result =  ((arg1)->cp);
  {
    distort_params * resultptr = new distort_params((const distort_params &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_distort_params,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static int _wrap_new_Distortion(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Distortion *result = 0 ;
  
  SWIG_check_num_args("FX::HammerFX::Distortion::Distortion",0,0)
  result = (FX::HammerFX::Distortion *)new FX::HammerFX::Distortion();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__HammerFX__Distortion,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Distortion_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Distortion *arg1 = (FX::HammerFX::Distortion *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("FX::HammerFX::Distortion::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Distortion::ProcessBlock",1,"FX::HammerFX::Distortion *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::HammerFX::Distortion::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FX::HammerFX::Distortion::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("FX::HammerFX::Distortion::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Distortion,0))){
    SWIG_fail_ptr("Distortion_ProcessBlock",1,SWIGTYPE_p_FX__HammerFX__Distortion);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Distortion_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Distortion_ProcessBlock",4,SWIGTYPE_p_float);
  }
...
FX::HammerFX::Distortion *arg1 = (FX::HammerFX::Distortion *) obj;
delete arg1;
}
...
static swig_lua_attribute swig_Distortion_attributes[] = {
    { "cp", _wrap_Distortion_cp_get, _wrap_Distortion_cp_set },
    {0,0,0}
};
static swig_lua_method swig_Distortion_methods[]= {
    { "ProcessBlock", _wrap_Distortion_ProcessBlock},
    {0,0}
};
...
static swig_lua_class _wrap_class_Distortion = { "Distortion", "Distortion", &SWIGTYPE_p_FX__HammerFX__Distortion,_proxy__wrap_new_Distortion, swig_delete_Distortion, swig_Distortion_methods, swig_Distortion_attributes, &swig_Distortion_Sf_SwigStatic, swig_Distortion_meta, swig_Distortion_bases, swig_Distortion_base_names };

static int _wrap_Distortion2_cp_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Distortion2 *arg1 = (FX::HammerFX::Distortion2 *) 0 ;
  distort_params2 arg2 ;
  distort_params2 *argp2 ;
  
  SWIG_check_num_args("FX::HammerFX::Distortion2::cp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Distortion2::cp",1,"FX::HammerFX::Distortion2 *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("FX::HammerFX::Distortion2::cp",2,"distort_params2");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Distortion2,0))){
    SWIG_fail_ptr("Distortion2_cp_set",1,SWIGTYPE_p_FX__HammerFX__Distortion2);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_distort_params2,0))){
    SWIG_fail_ptr("Distortion2_cp_set",2,SWIGTYPE_p_distort_params2);
  }
  arg2 = *argp2;
...
static int _wrap_Distortion2_cp_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Distortion2 *arg1 = (FX::HammerFX::Distortion2 *) 0 ;
  distort_params2 result;
  
  SWIG_check_num_args("FX::HammerFX::Distortion2::cp",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Distortion2::cp",1,"FX::HammerFX::Distortion2 *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Distortion2,0))){
    SWIG_fail_ptr("Distortion2_cp_get",1,SWIGTYPE_p_FX__HammerFX__Distortion2);
  }
  
  result =  ((arg1)->cp);
  {
    distort_params2 * resultptr = new distort_params2((const distort_params2 &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_distort_params2,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static int _wrap_new_Distortion2(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Distortion2 *result = 0 ;
  
  SWIG_check_num_args("FX::HammerFX::Distortion2::Distortion2",0,0)
  result = (FX::HammerFX::Distortion2 *)new FX::HammerFX::Distortion2();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__HammerFX__Distortion2,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Distortion2_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Distortion2 *arg1 = (FX::HammerFX::Distortion2 *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("FX::HammerFX::Distortion2::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Distortion2::ProcessBlock",1,"FX::HammerFX::Distortion2 *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::HammerFX::Distortion2::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FX::HammerFX::Distortion2::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("FX::HammerFX::Distortion2::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Distortion2,0))){
    SWIG_fail_ptr("Distortion2_ProcessBlock",1,SWIGTYPE_p_FX__HammerFX__Distortion2);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Distortion2_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Distortion2_ProcessBlock",4,SWIGTYPE_p_float);
  }
...
static void swig_delete_Distortion2(void *obj) {
FX::HammerFX::Distortion2 *arg1 = (FX::HammerFX::Distortion2 *) obj;
delete arg1;
}
static int _proxy__wrap_new_Distortion2(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_Distortion2);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_Distortion2_attributes[] = {
    { "cp", _wrap_Distortion2_cp_get, _wrap_Distortion2_cp_set },
    {0,0,0}
};
static swig_lua_method swig_Distortion2_methods[]= {
    { "ProcessBlock", _wrap_Distortion2_ProcessBlock},
    {0,0}
};
static swig_lua_method swig_Distortion2_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_Distortion2_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_Distortion2_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_Distortion2_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_Distortion2_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_Distortion2_Sf_SwigStatic = {
    "Distortion2",
    swig_Distortion2_Sf_SwigStatic_methods,
    swig_Distortion2_Sf_SwigStatic_attributes,
    swig_Distortion2_Sf_SwigStatic_constants,
    swig_Distortion2_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_Distortion2_bases[] = {0};
static const char *swig_Distortion2_base_names[] = {0};
static swig_lua_class _wrap_class_Distortion2 = { "Distortion2", "Distortion2", &SWIGTYPE_p_FX__HammerFX__Distortion2,_proxy__wrap_new_Distortion2, swig_delete_Distortion2, swig_Distortion2_methods, swig_Distortion2_attributes, &swig_Distortion2_Sf_SwigStatic, swig_Distortion2_meta, swig_Distortion2_bases, swig_Distortion2_base_names };
...
static swig_type_info _swigt__p_FX__HammerFX__Distortion = {"_p_FX__HammerFX__Distortion", "FX::HammerFX::Distortion *", 0, 0, (void*)&_wrap_class_Distortion, 0};
static swig_type_info _swigt__p_FX__HammerFX__Distortion2 = {"_p_FX__HammerFX__Distortion2", "FX::HammerFX::Distortion2 *", 0, 0, (void*)&_wrap_class_Distortion2, 0};
...
static swig_type_info _swigt__p_distort_params = {"_p_distort_params", "distort_params *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_distort_params2 = {"_p_distort_params2", "distort_params2 *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FX__HammerFX__Distortion,
  &_swigt__p_FX__HammerFX__Distortion2,
  ...
  &_swigt__p_distort_params,
  &_swigt__p_distort_params2,
  &_swigt__p_double,
...
static swig_cast_info _swigc__p_FX__HammerFX__Distortion[] = {  {&_swigt__p_FX__HammerFX__Distortion, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FX__HammerFX__Distortion2[] = {  {&_swigt__p_FX__HammerFX__Distortion2, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_distort_params[] = {  {&_swigt__p_distort_params, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_distort_params2[] = {  {&_swigt__p_distort_params2, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FX__HammerFX__Distortion,
  _swigc__p_FX__HammerFX__Distortion2,
  ...
  _swigc__p_distort_params,
  _swigc__p_distort_params2,
  _swigc__p_double,
