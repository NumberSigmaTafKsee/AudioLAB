...
#define SWIGTYPE_p_Delay__StereoDelay__StereoDelay swig_types[1]
#define SWIGTYPE_p_Delay__StereoDelay__StereoEffect swig_types[2]
...
#define SWIG_name      "StereoDelay"
#define SWIG_init      luaopen_StereoDelay
#define SWIG_init_user luaopen_StereoDelay_user

#define SWIG_LUACODE   luaopen_StereoDelay_luacode
...
static int _wrap_StereoEffect_processStereo(lua_State* L) {
  int SWIG_arg = 0;
  Delay::StereoDelay::StereoEffect *arg1 = (Delay::StereoDelay::StereoEffect *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) (DspFloatType *)0 ;
  DspFloatType *arg3 = (DspFloatType *) (DspFloatType *)0 ;
  int arg4 ;
  
  SWIG_check_num_args("Delay::StereoDelay::StereoEffect::processStereo",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Delay::StereoDelay::StereoEffect::processStereo",1,"Delay::StereoDelay::StereoEffect *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Delay::StereoDelay::StereoEffect::processStereo",2,"DspFloatType *const");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Delay::StereoDelay::StereoEffect::processStereo",3,"DspFloatType *const");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("Delay::StereoDelay::StereoEffect::processStereo",4,"int const");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Delay__StereoDelay__StereoEffect,0))){
    SWIG_fail_ptr("StereoEffect_processStereo",1,SWIGTYPE_p_Delay__StereoDelay__StereoEffect);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("StereoEffect_processStereo",2,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("StereoEffect_processStereo",3,SWIGTYPE_p_float);
  }
...
static int _wrap_StereoEffect_setEnabled(lua_State* L) {
  int SWIG_arg = 0;
  Delay::StereoDelay::StereoEffect *arg1 = (Delay::StereoDelay::StereoEffect *) 0 ;
  bool arg2 ;
  
  SWIG_check_num_args("Delay::StereoDelay::StereoEffect::setEnabled",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Delay::StereoDelay::StereoEffect::setEnabled",1,"Delay::StereoDelay::StereoEffect *");
  if(!lua_isboolean(L,2)) SWIG_fail_arg("Delay::StereoDelay::StereoEffect::setEnabled",2,"bool");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Delay__StereoDelay__StereoEffect,0))){
    SWIG_fail_ptr("StereoEffect_setEnabled",1,SWIGTYPE_p_Delay__StereoDelay__StereoEffect);
  }
...
static void swig_delete_StereoEffect(void *obj) {
Delay::StereoDelay::StereoEffect *arg1 = (Delay::StereoDelay::StereoEffect *) obj;
delete arg1;
}
static swig_lua_attribute swig_StereoEffect_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_StereoEffect_methods[]= {
    { "processStereo", _wrap_StereoEffect_processStereo},
    { "setEnabled", _wrap_StereoEffect_setEnabled},
    {0,0}
};
static swig_lua_method swig_StereoEffect_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_StereoEffect_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_StereoEffect_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_StereoEffect_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_StereoEffect_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_StereoEffect_Sf_SwigStatic = {
    "StereoEffect",
    swig_StereoEffect_Sf_SwigStatic_methods,
    swig_StereoEffect_Sf_SwigStatic_attributes,
    swig_StereoEffect_Sf_SwigStatic_constants,
    swig_StereoEffect_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_StereoEffect_bases[] = {0};
static const char *swig_StereoEffect_base_names[] = {0};
static swig_lua_class _wrap_class_StereoEffect = { "StereoEffect", "StereoEffect", &SWIGTYPE_p_Delay__StereoDelay__StereoEffect,0, swig_delete_StereoEffect, swig_StereoEffect_methods, swig_StereoEffect_attributes, &swig_StereoEffect_Sf_SwigStatic, swig_StereoEffect_meta, swig_StereoEffect_bases, swig_StereoEffect_base_names };

static int _wrap_new_StereoDelay(lua_State* L) {
  int SWIG_arg = 0;
  Delay::StereoDelay::StereoDelay *result = 0 ;
  
  SWIG_check_num_args("Delay::StereoDelay::StereoDelay::StereoDelay",0,0)
  result = (Delay::StereoDelay::StereoDelay *)new Delay::StereoDelay::StereoDelay();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Delay__StereoDelay__StereoDelay,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_StereoDelay_processStereo(lua_State* L) {
  int SWIG_arg = 0;
  Delay::StereoDelay::StereoDelay *arg1 = (Delay::StereoDelay::StereoDelay *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) (DspFloatType *)0 ;
  DspFloatType *arg3 = (DspFloatType *) (DspFloatType *)0 ;
  int arg4 ;
  
  SWIG_check_num_args("Delay::StereoDelay::StereoDelay::processStereo",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::processStereo",1,"Delay::StereoDelay::StereoDelay *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::processStereo",2,"DspFloatType *const");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::processStereo",3,"DspFloatType *const");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::processStereo",4,"int const");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay,0))){
    SWIG_fail_ptr("StereoDelay_processStereo",1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("StereoDelay_processStereo",2,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("StereoDelay_processStereo",3,SWIGTYPE_p_float);
  }
...
static int _wrap_StereoDelay_setDelay(lua_State* L) {
  int SWIG_arg = 0;
  Delay::StereoDelay::StereoDelay *arg1 = (Delay::StereoDelay::StereoDelay *) 0 ;
  Delay::StereoDelay::StereoDelay::Channel arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Delay::StereoDelay::StereoDelay::setDelay",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setDelay",1,"Delay::StereoDelay::StereoDelay *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setDelay",2,"Delay::StereoDelay::StereoDelay::Channel");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setDelay",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay,0))){
    SWIG_fail_ptr("StereoDelay_setDelay",1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay);
  }
  
  arg2 = (Delay::StereoDelay::StereoDelay::Channel)(int)lua_tonumber(L, 2);
  arg3 = (DspFloatType)lua_tonumber(L, 3);
...
static int _wrap_StereoDelay_setFeedback(lua_State* L) {
  int SWIG_arg = 0;
  Delay::StereoDelay::StereoDelay *arg1 = (Delay::StereoDelay::StereoDelay *) 0 ;
  Delay::StereoDelay::StereoDelay::Channel arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Delay::StereoDelay::StereoDelay::setFeedback",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setFeedback",1,"Delay::StereoDelay::StereoDelay *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setFeedback",2,"Delay::StereoDelay::StereoDelay::Channel");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setFeedback",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay,0))){
    SWIG_fail_ptr("StereoDelay_setFeedback",1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay);
  }
...
static int _wrap_StereoDelay_setMix(lua_State* L) {
  int SWIG_arg = 0;
  Delay::StereoDelay::StereoDelay *arg1 = (Delay::StereoDelay::StereoDelay *) 0 ;
  Delay::StereoDelay::StereoDelay::Channel arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Delay::StereoDelay::StereoDelay::setMix",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setMix",1,"Delay::StereoDelay::StereoDelay *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setMix",2,"Delay::StereoDelay::StereoDelay::Channel");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setMix",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay,0))){
    SWIG_fail_ptr("StereoDelay_setMix",1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay);
  }
  
  arg2 = (Delay::StereoDelay::StereoDelay::Channel)(int)lua_tonumber(L, 2);
  arg3 = (DspFloatType)lua_tonumber(L, 3);
  (arg1)->setMix(arg2,arg3);
...
static int _wrap_StereoDelay_setByPass(lua_State* L) {
  int SWIG_arg = 0;
  Delay::StereoDelay::StereoDelay *arg1 = (Delay::StereoDelay::StereoDelay *) 0 ;
  bool arg2 ;
  
  SWIG_check_num_args("Delay::StereoDelay::StereoDelay::setByPass",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setByPass",1,"Delay::StereoDelay::StereoDelay *");
  if(!lua_isboolean(L,2)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::setByPass",2,"bool");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay,0))){
    SWIG_fail_ptr("StereoDelay_setByPass",1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay);
  }
...
static int _wrap_StereoDelay_resetDelay(lua_State* L) {
  int SWIG_arg = 0;
  Delay::StereoDelay::StereoDelay *arg1 = (Delay::StereoDelay::StereoDelay *) 0 ;
  
  SWIG_check_num_args("Delay::StereoDelay::StereoDelay::resetDelay",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Delay::StereoDelay::StereoDelay::resetDelay",1,"Delay::StereoDelay::StereoDelay *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay,0))){
    SWIG_fail_ptr("StereoDelay_resetDelay",1,SWIGTYPE_p_Delay__StereoDelay__StereoDelay);
  }
...
static void swig_delete_StereoDelay(void *obj) {
Delay::StereoDelay::StereoDelay *arg1 = (Delay::StereoDelay::StereoDelay *) obj;
delete arg1;
}
static int _proxy__wrap_new_StereoDelay(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_StereoDelay);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_StereoDelay_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_StereoDelay_methods[]= {
    { "processStereo", _wrap_StereoDelay_processStereo},
    { "setDelay", _wrap_StereoDelay_setDelay},
    { "setFeedback", _wrap_StereoDelay_setFeedback},
    { "setMix", _wrap_StereoDelay_setMix},
    { "setByPass", _wrap_StereoDelay_setByPass},
    { "resetDelay", _wrap_StereoDelay_resetDelay},
    {0,0}
};
static swig_lua_method swig_StereoDelay_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_StereoDelay_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_StereoDelay_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("LEFT", Delay::StereoDelay::StereoDelay::LEFT)},
    {SWIG_LUA_CONSTTAB_INT("RIGHT", Delay::StereoDelay::StereoDelay::RIGHT)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_StereoDelay_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_StereoDelay_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_StereoDelay_Sf_SwigStatic = {
    "StereoDelay",
    swig_StereoDelay_Sf_SwigStatic_methods,
    swig_StereoDelay_Sf_SwigStatic_attributes,
    swig_StereoDelay_Sf_SwigStatic_constants,
    swig_StereoDelay_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_StereoDelay_bases[] = {0,0};
static const char *swig_StereoDelay_base_names[] = {"Delay::StereoDelay::StereoEffect *",0};
static swig_lua_class _wrap_class_StereoDelay = { "StereoDelay", "StereoDelay", &SWIGTYPE_p_Delay__StereoDelay__StereoDelay,_proxy__wrap_new_StereoDelay, swig_delete_StereoDelay, swig_StereoDelay_methods, swig_StereoDelay_attributes, &swig_StereoDelay_Sf_SwigStatic, swig_StereoDelay_meta, swig_StereoDelay_bases, swig_StereoDelay_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("StereoDelay_LEFT", Delay::StereoDelay::StereoDelay::LEFT)},
    {SWIG_LUA_CONSTTAB_INT("StereoDelay_RIGHT", Delay::StereoDelay::StereoDelay::RIGHT)},
    {0,0,0,0,0,0}
};
...
&_wrap_class_StereoEffect,
&_wrap_class_StereoDelay,
...
static void *_p_Delay__StereoDelay__StereoDelayTo_p_Delay__StereoDelay__StereoEffect(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Delay::StereoDelay::StereoEffect *)  ((Delay::StereoDelay::StereoDelay *) x));
}
...
static swig_type_info _swigt__p_Delay__StereoDelay__StereoDelay = {"_p_Delay__StereoDelay__StereoDelay", "Delay::StereoDelay::StereoDelay *", 0, 0, (void*)&_wrap_class_StereoDelay, 0};
static swig_type_info _swigt__p_Delay__StereoDelay__StereoEffect = {"_p_Delay__StereoDelay__StereoEffect", "Delay::StereoDelay::StereoEffect *", 0, 0, (void*)&_wrap_class_StereoEffect, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_Delay__StereoDelay__StereoDelay,
  &_swigt__p_Delay__StereoDelay__StereoEffect,
...
static swig_cast_info _swigc__p_Delay__StereoDelay__StereoDelay[] = {  {&_swigt__p_Delay__StereoDelay__StereoDelay, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Delay__StereoDelay__StereoEffect[] = {  {&_swigt__p_Delay__StereoDelay__StereoDelay, _p_Delay__StereoDelay__StereoDelayTo_p_Delay__StereoDelay__StereoEffect, 0, 0},  {&_swigt__p_Delay__StereoDelay__StereoEffect, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_Delay__StereoDelay__StereoDelay,
  _swigc__p_Delay__StereoDelay__StereoEffect,
