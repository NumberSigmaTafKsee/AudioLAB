...
#define SWIGTYPE_p_FX__RackFX__metronome swig_types[1]
...
#define SWIG_name      "RackFXMetronome"
#define SWIG_init      luaopen_RackFXMetronome
#define SWIG_init_user luaopen_RackFXMetronome_user

#define SWIG_LUACODE   luaopen_RackFXMetronome_luacode
...
static int _wrap_new_metronome(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::metronome *result = 0 ;
  
  SWIG_check_num_args("FX::RackFX::metronome::metronome",0,0)
  result = (FX::RackFX::metronome *)new FX::RackFX::metronome();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__RackFX__metronome,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_metronome_cleanup(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::metronome *arg1 = (FX::RackFX::metronome *) 0 ;
  
  SWIG_check_num_args("FX::RackFX::metronome::cleanup",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::metronome::cleanup",1,"FX::RackFX::metronome *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__metronome,0))){
    SWIG_fail_ptr("metronome_cleanup",1,SWIGTYPE_p_FX__RackFX__metronome);
  }
...
static int _wrap_metronome_metronomeout(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::metronome *arg1 = (FX::RackFX::metronome *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  
  SWIG_check_num_args("FX::RackFX::metronome::metronomeout",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::metronome::metronomeout",1,"FX::RackFX::metronome *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::RackFX::metronome::metronomeout",2,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__metronome,0))){
    SWIG_fail_ptr("metronome_metronomeout",1,SWIGTYPE_p_FX__RackFX__metronome);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("metronome_metronomeout",2,SWIGTYPE_p_float);
  }
  
  (arg1)->metronomeout(arg2);
...
static int _wrap_metronome_set_tempo(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::metronome *arg1 = (FX::RackFX::metronome *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("FX::RackFX::metronome::set_tempo",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::metronome::set_tempo",1,"FX::RackFX::metronome *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::RackFX::metronome::set_tempo",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__metronome,0))){
    SWIG_fail_ptr("metronome_set_tempo",1,SWIGTYPE_p_FX__RackFX__metronome);
  }
...
static int _wrap_metronome_set_meter(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::metronome *arg1 = (FX::RackFX::metronome *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("FX::RackFX::metronome::set_meter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::metronome::set_meter",1,"FX::RackFX::metronome *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::RackFX::metronome::set_meter",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__metronome,0))){
    SWIG_fail_ptr("metronome_set_meter",1,SWIGTYPE_p_FX__RackFX__metronome);
  }
...
static int _wrap_metronome_markctr_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::metronome *arg1 = (FX::RackFX::metronome *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("FX::RackFX::metronome::markctr",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::metronome::markctr",1,"FX::RackFX::metronome *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::RackFX::metronome::markctr",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__metronome,0))){
    SWIG_fail_ptr("metronome_markctr_set",1,SWIGTYPE_p_FX__RackFX__metronome);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  if (arg1) (arg1)->markctr = arg2;
...
static int _wrap_metronome_markctr_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::RackFX::metronome *arg1 = (FX::RackFX::metronome *) 0 ;
  int result;
  
  SWIG_check_num_args("FX::RackFX::metronome::markctr",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::RackFX::metronome::markctr",1,"FX::RackFX::metronome *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__RackFX__metronome,0))){
    SWIG_fail_ptr("metronome_markctr_get",1,SWIGTYPE_p_FX__RackFX__metronome);
  }
  
  result = (int) ((arg1)->markctr);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static void swig_delete_metronome(void *obj) {
FX::RackFX::metronome *arg1 = (FX::RackFX::metronome *) obj;
delete arg1;
}
static int _proxy__wrap_new_metronome(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_metronome);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_metronome_attributes[] = {
    { "markctr", _wrap_metronome_markctr_get, _wrap_metronome_markctr_set },
    {0,0,0}
};
static swig_lua_method swig_metronome_methods[]= {
    { "cleanup", _wrap_metronome_cleanup},
    { "metronomeout", _wrap_metronome_metronomeout},
    { "set_tempo", _wrap_metronome_set_tempo},
    { "set_meter", _wrap_metronome_set_meter},
    {0,0}
};
static swig_lua_method swig_metronome_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_metronome_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_metronome_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_metronome_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_metronome_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_metronome_Sf_SwigStatic = {
    "metronome",
    swig_metronome_Sf_SwigStatic_methods,
    swig_metronome_Sf_SwigStatic_attributes,
    swig_metronome_Sf_SwigStatic_constants,
    swig_metronome_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_metronome_bases[] = {0};
static const char *swig_metronome_base_names[] = {0};
static swig_lua_class _wrap_class_metronome = { "metronome", "metronome", &SWIGTYPE_p_FX__RackFX__metronome,_proxy__wrap_new_metronome, swig_delete_metronome, swig_metronome_methods, swig_metronome_attributes, &swig_metronome_Sf_SwigStatic, swig_metronome_meta, swig_metronome_bases, swig_metronome_base_names };
...
static swig_type_info _swigt__p_FX__RackFX__metronome = {"_p_FX__RackFX__metronome", "FX::RackFX::metronome *", 0, 0, (void*)&_wrap_class_metronome, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FX__RackFX__metronome,
...
static swig_cast_info _swigc__p_FX__RackFX__metronome[] = {  {&_swigt__p_FX__RackFX__metronome, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FX__RackFX__metronome,
