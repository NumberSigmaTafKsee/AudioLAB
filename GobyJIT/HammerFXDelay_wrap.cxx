...
#define SWIGTYPE_p_FX__HammerFX__Delay swig_types[1]
...
#define SWIGTYPE_p_delay_params swig_types[40]
...
#define SWIG_name      "HammerFXDelay"
#define SWIG_init      luaopen_HammerFXDelay
#define SWIG_init_user luaopen_HammerFXDelay_user

#define SWIG_LUACODE   luaopen_HammerFXDelay_luacode
...
static int _wrap_Delay_cp_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Delay *arg1 = (FX::HammerFX::Delay *) 0 ;
  delay_params arg2 ;
  delay_params *argp2 ;
  
  SWIG_check_num_args("FX::HammerFX::Delay::cp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Delay::cp",1,"FX::HammerFX::Delay *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("FX::HammerFX::Delay::cp",2,"delay_params");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Delay,0))){
    SWIG_fail_ptr("Delay_cp_set",1,SWIGTYPE_p_FX__HammerFX__Delay);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_delay_params,0))){
    SWIG_fail_ptr("Delay_cp_set",2,SWIGTYPE_p_delay_params);
  }
  arg2 = *argp2;
...
static int _wrap_Delay_cp_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Delay *arg1 = (FX::HammerFX::Delay *) 0 ;
  delay_params result;
  
  SWIG_check_num_args("FX::HammerFX::Delay::cp",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Delay::cp",1,"FX::HammerFX::Delay *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Delay,0))){
    SWIG_fail_ptr("Delay_cp_get",1,SWIGTYPE_p_FX__HammerFX__Delay);
  }
  
  result =  ((arg1)->cp);
  {
    delay_params * resultptr = new delay_params((const delay_params &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_delay_params,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static int _wrap_new_Delay(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Delay *result = 0 ;
  
  SWIG_check_num_args("FX::HammerFX::Delay::Delay",0,0)
  result = (FX::HammerFX::Delay *)new FX::HammerFX::Delay();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__HammerFX__Delay,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Delay_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::Delay *arg1 = (FX::HammerFX::Delay *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("FX::HammerFX::Delay::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::Delay::ProcessBlock",1,"FX::HammerFX::Delay *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::HammerFX::Delay::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FX::HammerFX::Delay::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("FX::HammerFX::Delay::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__Delay,0))){
    SWIG_fail_ptr("Delay_ProcessBlock",1,SWIGTYPE_p_FX__HammerFX__Delay);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Delay_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("Delay_ProcessBlock",4,SWIGTYPE_p_float);
  }
...
FX::HammerFX::Delay *arg1 = (FX::HammerFX::Delay *) obj;
delete arg1;
}
...
static swig_lua_attribute swig_Delay_attributes[] = {
    { "cp", _wrap_Delay_cp_get, _wrap_Delay_cp_set },
    {0,0,0}
};
static swig_lua_method swig_Delay_methods[]= {
    { "ProcessBlock", _wrap_Delay_ProcessBlock},
    {0,0}
};
...
static swig_lua_class _wrap_class_Delay = { "Delay", "Delay", &SWIGTYPE_p_FX__HammerFX__Delay,_proxy__wrap_new_Delay, swig_delete_Delay, swig_Delay_methods, swig_Delay_attributes, &swig_Delay_Sf_SwigStatic, swig_Delay_meta, swig_Delay_bases, swig_Delay_base_names };
...
static swig_type_info _swigt__p_FX__HammerFX__Delay = {"_p_FX__HammerFX__Delay", "FX::HammerFX::Delay *", 0, 0, (void*)&_wrap_class_Delay, 0};
...
static swig_type_info _swigt__p_delay_params = {"_p_delay_params", "delay_params *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_FX__HammerFX__Delay[] = {  {&_swigt__p_FX__HammerFX__Delay, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_delay_params[] = {  {&_swigt__p_delay_params, 0, 0, 0},{0, 0, 0, 0}};
