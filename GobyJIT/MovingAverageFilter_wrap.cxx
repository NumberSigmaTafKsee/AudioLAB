...
#define SWIGTYPE_p_MovingAverageFilter swig_types[18]
...
#define SWIG_name      "MovingAverageFilter"
#define SWIG_init      luaopen_MovingAverageFilter
#define SWIG_init_user luaopen_MovingAverageFilter_user

#define SWIG_LUACODE   luaopen_MovingAverageFilter_luacode
...
static int _wrap_new_MovingAverageFilter(lua_State* L) {
  int SWIG_arg = 0;
  unsigned int arg1 ;
  MovingAverageFilter *result = 0 ;
  
  SWIG_check_num_args("MovingAverageFilter::MovingAverageFilter",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("MovingAverageFilter::MovingAverageFilter",1,"unsigned int");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative");
  arg1 = (unsigned int)lua_tonumber(L, 1);
  result = (MovingAverageFilter *)new MovingAverageFilter(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_MovingAverageFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_MovingAverageFilter_process(lua_State* L) {
  int SWIG_arg = 0;
  MovingAverageFilter *arg1 = (MovingAverageFilter *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("MovingAverageFilter::process",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("MovingAverageFilter::process",1,"MovingAverageFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("MovingAverageFilter::process",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_MovingAverageFilter,0))){
    SWIG_fail_ptr("MovingAverageFilter_process",1,SWIGTYPE_p_MovingAverageFilter);
  }
...
static void swig_delete_MovingAverageFilter(void *obj) {
MovingAverageFilter *arg1 = (MovingAverageFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_MovingAverageFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_MovingAverageFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_MovingAverageFilter_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_MovingAverageFilter_methods[]= {
    { "process", _wrap_MovingAverageFilter_process},
    {0,0}
};
static swig_lua_method swig_MovingAverageFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_MovingAverageFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_MovingAverageFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_MovingAverageFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_MovingAverageFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_MovingAverageFilter_Sf_SwigStatic = {
    "MovingAverageFilter",
    swig_MovingAverageFilter_Sf_SwigStatic_methods,
    swig_MovingAverageFilter_Sf_SwigStatic_attributes,
    swig_MovingAverageFilter_Sf_SwigStatic_constants,
    swig_MovingAverageFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_MovingAverageFilter_bases[] = {0};
static const char *swig_MovingAverageFilter_base_names[] = {0};
static swig_lua_class _wrap_class_MovingAverageFilter = { "MovingAverageFilter", "MovingAverageFilter", &SWIGTYPE_p_MovingAverageFilter,_proxy__wrap_new_MovingAverageFilter, swig_delete_MovingAverageFilter, swig_MovingAverageFilter_methods, swig_MovingAverageFilter_attributes, &swig_MovingAverageFilter_Sf_SwigStatic, swig_MovingAverageFilter_meta, swig_MovingAverageFilter_bases, swig_MovingAverageFilter_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("MAX_DATA_POINTS", 20)},
    {0,0,0,0,0,0}
};
...
&_wrap_class_MovingAverageFilter,
...
static swig_type_info _swigt__p_MovingAverageFilter = {"_p_MovingAverageFilter", "MovingAverageFilter *", 0, 0, (void*)&_wrap_class_MovingAverageFilter, 0};
...
static swig_cast_info _swigc__p_MovingAverageFilter[] = {  {&_swigt__p_MovingAverageFilter, 0, 0, 0},{0, 0, 0, 0}};
