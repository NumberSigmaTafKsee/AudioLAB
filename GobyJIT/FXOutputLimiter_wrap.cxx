...
#define SWIGTYPE_p_OutputLimiter__EnvelopeFollower swig_types[20]
#define SWIGTYPE_p_OutputLimiter__Limiter swig_types[21]
...
#define SWIG_name      "FXOutputLimiter"
#define SWIG_init      luaopen_FXOutputLimiter
#define SWIG_init_user luaopen_FXOutputLimiter_user

#define SWIG_LUACODE   luaopen_FXOutputLimiter_luacode
...
static int _wrap_new_EnvelopeFollower(lua_State* L) {
  int SWIG_arg = 0;
  OutputLimiter::EnvelopeFollower *result = 0 ;
  
  SWIG_check_num_args("OutputLimiter::EnvelopeFollower::EnvelopeFollower",0,0)
  result = (OutputLimiter::EnvelopeFollower *)new OutputLimiter::EnvelopeFollower();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_OutputLimiter__EnvelopeFollower,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_EnvelopeFollower_Setup(lua_State* L) {
  int SWIG_arg = 0;
  OutputLimiter::EnvelopeFollower *arg1 = (OutputLimiter::EnvelopeFollower *) 0 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  int arg4 ;
  
  SWIG_check_num_args("OutputLimiter::EnvelopeFollower::Setup",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("OutputLimiter::EnvelopeFollower::Setup",1,"OutputLimiter::EnvelopeFollower *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("OutputLimiter::EnvelopeFollower::Setup",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("OutputLimiter::EnvelopeFollower::Setup",3,"DspFloatType");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("OutputLimiter::EnvelopeFollower::Setup",4,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_OutputLimiter__EnvelopeFollower,0))){
    SWIG_fail_ptr("EnvelopeFollower_Setup",1,SWIGTYPE_p_OutputLimiter__EnvelopeFollower);
  }
...
static int _wrap_EnvelopeFollower_envelope_set(lua_State* L) {
  int SWIG_arg = 0;
  OutputLimiter::EnvelopeFollower *arg1 = (OutputLimiter::EnvelopeFollower *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("OutputLimiter::EnvelopeFollower::envelope",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("OutputLimiter::EnvelopeFollower::envelope",1,"OutputLimiter::EnvelopeFollower *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("OutputLimiter::EnvelopeFollower::envelope",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_OutputLimiter__EnvelopeFollower,0))){
    SWIG_fail_ptr("EnvelopeFollower_envelope_set",1,SWIGTYPE_p_OutputLimiter__EnvelopeFollower);
  }
...
static int _wrap_EnvelopeFollower_envelope_get(lua_State* L) {
  int SWIG_arg = 0;
  OutputLimiter::EnvelopeFollower *arg1 = (OutputLimiter::EnvelopeFollower *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("OutputLimiter::EnvelopeFollower::envelope",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("OutputLimiter::EnvelopeFollower::envelope",1,"OutputLimiter::EnvelopeFollower *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_OutputLimiter__EnvelopeFollower,0))){
    SWIG_fail_ptr("EnvelopeFollower_envelope_get",1,SWIGTYPE_p_OutputLimiter__EnvelopeFollower);
  }
  
  result = (DspFloatType) ((arg1)->envelope);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
OutputLimiter::EnvelopeFollower *arg1 = (OutputLimiter::EnvelopeFollower *) obj;
delete arg1;
}
...
static swig_lua_attribute swig_EnvelopeFollower_attributes[] = {
    { "envelope", _wrap_EnvelopeFollower_envelope_get, _wrap_EnvelopeFollower_envelope_set },
    {0,0,0}
};
static swig_lua_method swig_EnvelopeFollower_methods[]= {
    { "Setup", _wrap_EnvelopeFollower_Setup},
    {0,0}
};
...
static swig_lua_class *swig_EnvelopeFollower_bases[] = {0};
static const char *swig_EnvelopeFollower_base_names[] = {0};
static swig_lua_class _wrap_class_EnvelopeFollower = { "EnvelopeFollower", "EnvelopeFollower", &SWIGTYPE_p_OutputLimiter__EnvelopeFollower,_proxy__wrap_new_EnvelopeFollower, swig_delete_EnvelopeFollower, swig_EnvelopeFollower_methods, swig_EnvelopeFollower_attributes, &swig_EnvelopeFollower_Sf_SwigStatic, swig_EnvelopeFollower_meta, swig_EnvelopeFollower_bases, swig_EnvelopeFollower_base_names };

static int _wrap_Limiter_Setup(lua_State* L) {
  int SWIG_arg = 0;
  OutputLimiter::Limiter *arg1 = (OutputLimiter::Limiter *) 0 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  int arg4 ;
  
  SWIG_check_num_args("OutputLimiter::Limiter::Setup",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("OutputLimiter::Limiter::Setup",1,"OutputLimiter::Limiter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("OutputLimiter::Limiter::Setup",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("OutputLimiter::Limiter::Setup",3,"DspFloatType");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("OutputLimiter::Limiter::Setup",4,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_OutputLimiter__Limiter,0))){
    SWIG_fail_ptr("Limiter_Setup",1,SWIGTYPE_p_OutputLimiter__Limiter);
  }
...
static int _wrap_new_Limiter(lua_State* L) {
  int SWIG_arg = 0;
  OutputLimiter::Limiter *result = 0 ;
  
  SWIG_check_num_args("OutputLimiter::Limiter::Limiter",0,0)
  result = (OutputLimiter::Limiter *)new OutputLimiter::Limiter();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_OutputLimiter__Limiter,1); SWIG_arg++; 
  return SWIG_arg;
...
OutputLimiter::Limiter *arg1 = (OutputLimiter::Limiter *) obj;
delete arg1;
}
...
static swig_lua_class _wrap_class_Limiter = { "Limiter", "Limiter", &SWIGTYPE_p_OutputLimiter__Limiter,_proxy__wrap_new_Limiter, swig_delete_Limiter, swig_Limiter_methods, swig_Limiter_attributes, &swig_Limiter_Sf_SwigStatic, swig_Limiter_meta, swig_Limiter_bases, swig_Limiter_base_names };
...
static swig_type_info _swigt__p_OutputLimiter__EnvelopeFollower = {"_p_OutputLimiter__EnvelopeFollower", "OutputLimiter::EnvelopeFollower *", 0, 0, (void*)&_wrap_class_EnvelopeFollower, 0};
static swig_type_info _swigt__p_OutputLimiter__Limiter = {"_p_OutputLimiter__Limiter", "OutputLimiter::Limiter *", 0, 0, (void*)&_wrap_class_Limiter, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_OutputLimiter__EnvelopeFollower,
  &_swigt__p_OutputLimiter__Limiter,
...
static swig_cast_info _swigc__p_OutputLimiter__EnvelopeFollower[] = {  {&_swigt__p_OutputLimiter__EnvelopeFollower, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_OutputLimiter__Limiter[] = {  {&_swigt__p_OutputLimiter__Limiter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_OutputLimiter__EnvelopeFollower,
  _swigc__p_OutputLimiter__Limiter,
