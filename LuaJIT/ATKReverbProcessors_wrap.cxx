...
#define SWIGTYPE_p_ATK__AllPassReverbFilterT_DspFloatType_t swig_types[0]
#define SWIGTYPE_p_ATK__ConvolutionFilterT_DspFloatType_t swig_types[1]
#define SWIGTYPE_p_ATK__LowPassReverbFilterT_DspFloatType_t swig_types[2]
#define SWIGTYPE_p_AmplifierProcessor swig_types[3]
#define SWIGTYPE_p_FilterProcessor swig_types[4]
#define SWIGTYPE_p_Filters__AudioTK__Reverb__AllPassReverb swig_types[5]
#define SWIGTYPE_p_Filters__AudioTK__Reverb__ConvolutionFilter swig_types[6]
#define SWIGTYPE_p_Filters__AudioTK__Reverb__LowPassReverb swig_types[7]
...
#define SWIG_name      "ATKReverbProcessors"
#define SWIG_init      luaopen_ATKReverbProcessors
#define SWIG_init_user luaopen_ATKReverbProcessors_user

#define SWIG_LUACODE   luaopen_ATKReverbProcessors_luacode
...
static int _wrap_AllPassReverb_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Reverb::AllPassReverb *arg1 = (Filters::AudioTK::Reverb::AllPassReverb *) 0 ;
  ATK::AllPassReverbFilter< DspFloatType > *arg2 = (ATK::AllPassReverbFilter< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::AllPassReverb::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Reverb::AllPassReverb::filter",1,"Filters::AudioTK::Reverb::AllPassReverb *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::Reverb::AllPassReverb::filter",2,"ATK::AllPassReverbFilter< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Reverb__AllPassReverb,0))){
    SWIG_fail_ptr("AllPassReverb_filter_set",1,SWIGTYPE_p_Filters__AudioTK__Reverb__AllPassReverb);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__AllPassReverbFilterT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("AllPassReverb_filter_set",2,SWIGTYPE_p_ATK__AllPassReverbFilterT_DspFloatType_t);
  }
...
static int _wrap_AllPassReverb_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Reverb::AllPassReverb *arg1 = (Filters::AudioTK::Reverb::AllPassReverb *) 0 ;
  ATK::AllPassReverbFilter< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::AllPassReverb::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Reverb::AllPassReverb::filter",1,"Filters::AudioTK::Reverb::AllPassReverb *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Reverb__AllPassReverb,0))){
    SWIG_fail_ptr("AllPassReverb_filter_get",1,SWIGTYPE_p_Filters__AudioTK__Reverb__AllPassReverb);
  }
  
  result = (ATK::AllPassReverbFilter< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__AllPassReverbFilterT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_AllPassReverb(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Reverb::AllPassReverb *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::AllPassReverb::AllPassReverb",0,0)
  result = (Filters::AudioTK::Reverb::AllPassReverb *)new Filters::AudioTK::Reverb::AllPassReverb();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__Reverb__AllPassReverb,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_AllPassReverb_setPort(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Reverb::AllPassReverb *arg1 = (Filters::AudioTK::Reverb::AllPassReverb *) 0 ;
  int arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::AllPassReverb::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Reverb::AllPassReverb::setPort",1,"Filters::AudioTK::Reverb::AllPassReverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AudioTK::Reverb::AllPassReverb::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AudioTK::Reverb::AllPassReverb::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Reverb__AllPassReverb,0))){
    SWIG_fail_ptr("AllPassReverb_setPort",1,SWIGTYPE_p_Filters__AudioTK__Reverb__AllPassReverb);
  }
...
static void swig_delete_AllPassReverb(void *obj) {
Filters::AudioTK::Reverb::AllPassReverb *arg1 = (Filters::AudioTK::Reverb::AllPassReverb *) obj;
delete arg1;
}
static int _proxy__wrap_new_AllPassReverb(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_AllPassReverb);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_AllPassReverb_attributes[] = {
    { "filter", _wrap_AllPassReverb_filter_get, _wrap_AllPassReverb_filter_set },
    {0,0,0}
};
static swig_lua_method swig_AllPassReverb_methods[]= {
    { "setPort", _wrap_AllPassReverb_setPort},
    {0,0}
};
static swig_lua_method swig_AllPassReverb_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_AllPassReverb_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_AllPassReverb_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_DELAY", Filters::AudioTK::Reverb::AllPassReverb::PORT_DELAY)},
    {SWIG_LUA_CONSTTAB_INT("PORT_FEEDBACK", Filters::AudioTK::Reverb::AllPassReverb::PORT_FEEDBACK)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_AllPassReverb_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_AllPassReverb_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_AllPassReverb_Sf_SwigStatic = {
    "AllPassReverb",
    swig_AllPassReverb_Sf_SwigStatic_methods,
    swig_AllPassReverb_Sf_SwigStatic_attributes,
    swig_AllPassReverb_Sf_SwigStatic_constants,
    swig_AllPassReverb_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_AllPassReverb_bases[] = {0};
static const char *swig_AllPassReverb_base_names[] = {0};
static swig_lua_class _wrap_class_AllPassReverb = { "AllPassReverb", "AllPassReverb", &SWIGTYPE_p_Filters__AudioTK__Reverb__AllPassReverb,_proxy__wrap_new_AllPassReverb, swig_delete_AllPassReverb, swig_AllPassReverb_methods, swig_AllPassReverb_attributes, &swig_AllPassReverb_Sf_SwigStatic, swig_AllPassReverb_meta, swig_AllPassReverb_bases, swig_AllPassReverb_base_names };

static int _wrap_LowPassReverb_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Reverb::LowPassReverb *arg1 = (Filters::AudioTK::Reverb::LowPassReverb *) 0 ;
  ATK::LowPassReverbFilter< DspFloatType > *arg2 = (ATK::LowPassReverbFilter< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::LowPassReverb::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Reverb::LowPassReverb::filter",1,"Filters::AudioTK::Reverb::LowPassReverb *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::Reverb::LowPassReverb::filter",2,"ATK::LowPassReverbFilter< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Reverb__LowPassReverb,0))){
    SWIG_fail_ptr("LowPassReverb_filter_set",1,SWIGTYPE_p_Filters__AudioTK__Reverb__LowPassReverb);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__LowPassReverbFilterT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("LowPassReverb_filter_set",2,SWIGTYPE_p_ATK__LowPassReverbFilterT_DspFloatType_t);
  }
...
static int _wrap_LowPassReverb_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Reverb::LowPassReverb *arg1 = (Filters::AudioTK::Reverb::LowPassReverb *) 0 ;
  ATK::LowPassReverbFilter< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::LowPassReverb::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Reverb::LowPassReverb::filter",1,"Filters::AudioTK::Reverb::LowPassReverb *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Reverb__LowPassReverb,0))){
    SWIG_fail_ptr("LowPassReverb_filter_get",1,SWIGTYPE_p_Filters__AudioTK__Reverb__LowPassReverb);
  }
  
  result = (ATK::LowPassReverbFilter< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__LowPassReverbFilterT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_LowPassReverb(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Reverb::LowPassReverb *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::LowPassReverb::LowPassReverb",0,0)
  result = (Filters::AudioTK::Reverb::LowPassReverb *)new Filters::AudioTK::Reverb::LowPassReverb();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__Reverb__LowPassReverb,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_LowPassReverb_setPort(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Reverb::LowPassReverb *arg1 = (Filters::AudioTK::Reverb::LowPassReverb *) 0 ;
  int arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::LowPassReverb::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Reverb::LowPassReverb::setPort",1,"Filters::AudioTK::Reverb::LowPassReverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AudioTK::Reverb::LowPassReverb::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Filters::AudioTK::Reverb::LowPassReverb::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Reverb__LowPassReverb,0))){
    SWIG_fail_ptr("LowPassReverb_setPort",1,SWIGTYPE_p_Filters__AudioTK__Reverb__LowPassReverb);
  }
...
static void swig_delete_LowPassReverb(void *obj) {
Filters::AudioTK::Reverb::LowPassReverb *arg1 = (Filters::AudioTK::Reverb::LowPassReverb *) obj;
delete arg1;
}
static int _proxy__wrap_new_LowPassReverb(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_LowPassReverb);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_LowPassReverb_attributes[] = {
    { "filter", _wrap_LowPassReverb_filter_get, _wrap_LowPassReverb_filter_set },
    {0,0,0}
};
static swig_lua_method swig_LowPassReverb_methods[]= {
    { "setPort", _wrap_LowPassReverb_setPort},
    {0,0}
};
static swig_lua_method swig_LowPassReverb_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_LowPassReverb_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_LowPassReverb_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("PORT_DELAY", Filters::AudioTK::Reverb::LowPassReverb::PORT_DELAY)},
    {SWIG_LUA_CONSTTAB_INT("PORT_FEEDBACK", Filters::AudioTK::Reverb::LowPassReverb::PORT_FEEDBACK)},
    {SWIG_LUA_CONSTTAB_INT("PORT_CUTOFF", Filters::AudioTK::Reverb::LowPassReverb::PORT_CUTOFF)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_LowPassReverb_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_LowPassReverb_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_LowPassReverb_Sf_SwigStatic = {
    "LowPassReverb",
    swig_LowPassReverb_Sf_SwigStatic_methods,
    swig_LowPassReverb_Sf_SwigStatic_attributes,
    swig_LowPassReverb_Sf_SwigStatic_constants,
    swig_LowPassReverb_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_LowPassReverb_bases[] = {0};
static const char *swig_LowPassReverb_base_names[] = {0};
static swig_lua_class _wrap_class_LowPassReverb = { "LowPassReverb", "LowPassReverb", &SWIGTYPE_p_Filters__AudioTK__Reverb__LowPassReverb,_proxy__wrap_new_LowPassReverb, swig_delete_LowPassReverb, swig_LowPassReverb_methods, swig_LowPassReverb_attributes, &swig_LowPassReverb_Sf_SwigStatic, swig_LowPassReverb_meta, swig_LowPassReverb_bases, swig_LowPassReverb_base_names };

static int _wrap_ConvolutionFilter_filter_set(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Reverb::ConvolutionFilter *arg1 = (Filters::AudioTK::Reverb::ConvolutionFilter *) 0 ;
  ATK::ConvolutionFilter< DspFloatType > *arg2 = (ATK::ConvolutionFilter< DspFloatType > *) 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::ConvolutionFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Reverb::ConvolutionFilter::filter",1,"Filters::AudioTK::Reverb::ConvolutionFilter *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Filters::AudioTK::Reverb::ConvolutionFilter::filter",2,"ATK::ConvolutionFilter< DspFloatType > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Reverb__ConvolutionFilter,0))){
    SWIG_fail_ptr("ConvolutionFilter_filter_set",1,SWIGTYPE_p_Filters__AudioTK__Reverb__ConvolutionFilter);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ATK__ConvolutionFilterT_DspFloatType_t,SWIG_POINTER_DISOWN))){
    SWIG_fail_ptr("ConvolutionFilter_filter_set",2,SWIGTYPE_p_ATK__ConvolutionFilterT_DspFloatType_t);
  }
...
static int _wrap_ConvolutionFilter_filter_get(lua_State* L) {
  int SWIG_arg = 0;
  Filters::AudioTK::Reverb::ConvolutionFilter *arg1 = (Filters::AudioTK::Reverb::ConvolutionFilter *) 0 ;
  ATK::ConvolutionFilter< DspFloatType > *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::ConvolutionFilter::filter",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Filters::AudioTK::Reverb::ConvolutionFilter::filter",1,"Filters::AudioTK::Reverb::ConvolutionFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Filters__AudioTK__Reverb__ConvolutionFilter,0))){
    SWIG_fail_ptr("ConvolutionFilter_filter_get",1,SWIGTYPE_p_Filters__AudioTK__Reverb__ConvolutionFilter);
  }
  
  result = (ATK::ConvolutionFilter< DspFloatType > *) ((arg1)->filter);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ATK__ConvolutionFilterT_DspFloatType_t,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_ConvolutionFilter__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< DspFloatType > *arg1 = 0 ;
  size_t arg2 ;
  Filters::AudioTK::Reverb::ConvolutionFilter *result = 0 ;
  
  SWIG_check_num_args("Filters::AudioTK::Reverb::ConvolutionFilter::ConvolutionFilter",2,2)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("Filters::AudioTK::Reverb::ConvolutionFilter::ConvolutionFilter",1,"std::vector< DspFloatType > const &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Filters::AudioTK::Reverb::ConvolutionFilter::ConvolutionFilter",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("new_ConvolutionFilter",1,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative");
  arg2 = (size_t)lua_tonumber(L, 2);
  result = (Filters::AudioTK::Reverb::ConvolutionFilter *)new Filters::AudioTK::Reverb::ConvolutionFilter((std::vector< DspFloatType > const &)*arg1,arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__Reverb__ConvolutionFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_ConvolutionFilter__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("Filters::AudioTK::Reverb::ConvolutionFilter::ConvolutionFilter",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("Filters::AudioTK::Reverb::ConvolutionFilter::ConvolutionFilter",1,"std::vector< DspFloatType > const &");
  ...
  result = (Filters::AudioTK::Reverb::ConvolutionFilter *)new Filters::AudioTK::Reverb::ConvolutionFilter((std::vector< DspFloatType > const &)*arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Filters__AudioTK__Reverb__ConvolutionFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_ConvolutionFilter(lua_State* L) {
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'new_ConvolutionFilter'\n"
    "  Possible C/C++ prototypes are:\n"
    "    Filters::AudioTK::Reverb::ConvolutionFilter::ConvolutionFilter(std::vector< DspFloatType > const &,size_t)\n"
    "    Filters::AudioTK::Reverb::ConvolutionFilter::ConvolutionFilter(std::vector< DspFloatType > const &)\n");
  lua_error(L);return 0;
}


static void swig_delete_ConvolutionFilter(void *obj) {
Filters::AudioTK::Reverb::ConvolutionFilter *arg1 = (Filters::AudioTK::Reverb::ConvolutionFilter *) obj;
delete arg1;
}
...
static swig_lua_class _wrap_class_ConvolutionFilter = { "ConvolutionFilter", "ConvolutionFilter", &SWIGTYPE_p_Filters__AudioTK__Reverb__ConvolutionFilter,_proxy__wrap_new_ConvolutionFilter, swig_delete_ConvolutionFilter, swig_ConvolutionFilter_methods, swig_ConvolutionFilter_attributes, &swig_ConvolutionFilter_Sf_SwigStatic, swig_ConvolutionFilter_meta, swig_ConvolutionFilter_bases, swig_ConvolutionFilter_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("AllPassReverb_PORT_DELAY", Filters::AudioTK::Reverb::AllPassReverb::PORT_DELAY)},
    {SWIG_LUA_CONSTTAB_INT("AllPassReverb_PORT_FEEDBACK", Filters::AudioTK::Reverb::AllPassReverb::PORT_FEEDBACK)},
    {SWIG_LUA_CONSTTAB_INT("LowPassReverb_PORT_DELAY", Filters::AudioTK::Reverb::LowPassReverb::PORT_DELAY)},
    {SWIG_LUA_CONSTTAB_INT("LowPassReverb_PORT_FEEDBACK", Filters::AudioTK::Reverb::LowPassReverb::PORT_FEEDBACK)},
    {SWIG_LUA_CONSTTAB_INT("LowPassReverb_PORT_CUTOFF", Filters::AudioTK::Reverb::LowPassReverb::PORT_CUTOFF)},
    {0,0,0,0,0,0}
};
...
&_wrap_class_AllPassReverb,
&_wrap_class_LowPassReverb,
...
static swig_type_info _swigt__p_ATK__AllPassReverbFilterT_DspFloatType_t = {"_p_ATK__AllPassReverbFilterT_DspFloatType_t", "ATK::AllPassReverbFilter< DspFloatType > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ATK__ConvolutionFilterT_DspFloatType_t = {"_p_ATK__ConvolutionFilterT_DspFloatType_t", "ATK::ConvolutionFilter< DspFloatType > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ATK__LowPassReverbFilterT_DspFloatType_t = {"_p_ATK__LowPassReverbFilterT_DspFloatType_t", "ATK::LowPassReverbFilter< DspFloatType > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_Filters__AudioTK__Reverb__AllPassReverb = {"_p_Filters__AudioTK__Reverb__AllPassReverb", "Filters::AudioTK::Reverb::AllPassReverb *", 0, 0, (void*)&_wrap_class_AllPassReverb, 0};
static swig_type_info _swigt__p_Filters__AudioTK__Reverb__ConvolutionFilter = {"_p_Filters__AudioTK__Reverb__ConvolutionFilter", "Filters::AudioTK::Reverb::ConvolutionFilter *", 0, 0, (void*)&_wrap_class_ConvolutionFilter, 0};
static swig_type_info _swigt__p_Filters__AudioTK__Reverb__LowPassReverb = {"_p_Filters__AudioTK__Reverb__LowPassReverb", "Filters::AudioTK::Reverb::LowPassReverb *", 0, 0, (void*)&_wrap_class_LowPassReverb, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ATK__AllPassReverbFilterT_DspFloatType_t,
  &_swigt__p_ATK__ConvolutionFilterT_DspFloatType_t,
  &_swigt__p_ATK__LowPassReverbFilterT_DspFloatType_t,
  &_swigt__p_AmplifierProcessor,
  &_swigt__p_FilterProcessor,
  &_swigt__p_Filters__AudioTK__Reverb__AllPassReverb,
  &_swigt__p_Filters__AudioTK__Reverb__ConvolutionFilter,
  &_swigt__p_Filters__AudioTK__Reverb__LowPassReverb,
...
static swig_cast_info _swigc__p_ATK__AllPassReverbFilterT_DspFloatType_t[] = {  {&_swigt__p_ATK__AllPassReverbFilterT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ATK__ConvolutionFilterT_DspFloatType_t[] = {  {&_swigt__p_ATK__ConvolutionFilterT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ATK__LowPassReverbFilterT_DspFloatType_t[] = {  {&_swigt__p_ATK__LowPassReverbFilterT_DspFloatType_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_Filters__AudioTK__Reverb__AllPassReverb[] = {  {&_swigt__p_Filters__AudioTK__Reverb__AllPassReverb, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Filters__AudioTK__Reverb__ConvolutionFilter[] = {  {&_swigt__p_Filters__AudioTK__Reverb__ConvolutionFilter, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Filters__AudioTK__Reverb__LowPassReverb[] = {  {&_swigt__p_Filters__AudioTK__Reverb__LowPassReverb, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ATK__AllPassReverbFilterT_DspFloatType_t,
  _swigc__p_ATK__ConvolutionFilterT_DspFloatType_t,
  _swigc__p_ATK__LowPassReverbFilterT_DspFloatType_t,
  _swigc__p_AmplifierProcessor,
  _swigc__p_FilterProcessor,
  _swigc__p_Filters__AudioTK__Reverb__AllPassReverb,
  _swigc__p_Filters__AudioTK__Reverb__ConvolutionFilter,
  _swigc__p_Filters__AudioTK__Reverb__LowPassReverb,
