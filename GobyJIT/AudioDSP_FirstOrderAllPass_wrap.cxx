...
#define SWIGTYPE_p_FirstOrderAllPass swig_types[2]
...
#define SWIG_name      "AudioDSP_FirstOrderAllPass"
#define SWIG_init      luaopen_AudioDSP_FirstOrderAllPass
#define SWIG_init_user luaopen_AudioDSP_FirstOrderAllPass_user

#define SWIG_LUACODE   luaopen_AudioDSP_FirstOrderAllPass_luacode
...
static int _wrap_new_FirstOrderAllPass(lua_State* L) {
  int SWIG_arg = 0;
  FirstOrderAllPass *result = 0 ;
  
  SWIG_check_num_args("FirstOrderAllPass::FirstOrderAllPass",0,0)
  result = (FirstOrderAllPass *)new FirstOrderAllPass();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FirstOrderAllPass,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_FirstOrderAllPass_setPort(lua_State* L) {
  int SWIG_arg = 0;
  FirstOrderAllPass *arg1 = (FirstOrderAllPass *) 0 ;
  int arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("FirstOrderAllPass::setPort",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FirstOrderAllPass::setPort",1,"FirstOrderAllPass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FirstOrderAllPass::setPort",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("FirstOrderAllPass::setPort",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FirstOrderAllPass,0))){
    SWIG_fail_ptr("FirstOrderAllPass_setPort",1,SWIGTYPE_p_FirstOrderAllPass);
  }
...
static int _wrap_FirstOrderAllPass_printPorts(lua_State* L) {
  int SWIG_arg = 0;
  FirstOrderAllPass *arg1 = (FirstOrderAllPass *) 0 ;
  
  SWIG_check_num_args("FirstOrderAllPass::printPorts",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FirstOrderAllPass::printPorts",1,"FirstOrderAllPass *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FirstOrderAllPass,0))){
    SWIG_fail_ptr("FirstOrderAllPass_printPorts",1,SWIGTYPE_p_FirstOrderAllPass);
  }
...
static int _wrap_FirstOrderAllPass_prepare(lua_State* L) {
  int SWIG_arg = 0;
  FirstOrderAllPass *arg1 = (FirstOrderAllPass *) 0 ;
  int *arg2 = 0 ;
  int temp2 ;
  
  SWIG_check_num_args("FirstOrderAllPass::prepare",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FirstOrderAllPass::prepare",1,"FirstOrderAllPass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FirstOrderAllPass::prepare",2,"int const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FirstOrderAllPass,0))){
    SWIG_fail_ptr("FirstOrderAllPass_prepare",1,SWIGTYPE_p_FirstOrderAllPass);
  }
  
  temp2=(int)lua_tonumber(L,2); arg2=&temp2;
  (arg1)->prepare((int const &)*arg2);
...
static int _wrap_FirstOrderAllPass_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  FirstOrderAllPass *arg1 = (FirstOrderAllPass *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("FirstOrderAllPass::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FirstOrderAllPass::ProcessBlock",1,"FirstOrderAllPass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FirstOrderAllPass::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FirstOrderAllPass::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("FirstOrderAllPass::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FirstOrderAllPass,0))){
    SWIG_fail_ptr("FirstOrderAllPass_ProcessBlock",1,SWIGTYPE_p_FirstOrderAllPass);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FirstOrderAllPass_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("FirstOrderAllPass_ProcessBlock",4,SWIGTYPE_p_float);
  }
...
static int _wrap_FirstOrderAllPass_Tick(lua_State* L) {
  int SWIG_arg = 0;
  FirstOrderAllPass *arg1 = (FirstOrderAllPass *) 0 ;
  DspFloatType *arg2 = 0 ;
  int *arg3 = 0 ;
  ...
  SWIG_check_num_args("FirstOrderAllPass::Tick",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FirstOrderAllPass::Tick",1,"FirstOrderAllPass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FirstOrderAllPass::Tick",2,"DspFloatType const &");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("FirstOrderAllPass::Tick",3,"int const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FirstOrderAllPass,0))){
    SWIG_fail_ptr("FirstOrderAllPass_Tick",1,SWIGTYPE_p_FirstOrderAllPass);
  }
  
  temp2=(DspFloatType)lua_tonumber(L,2); arg2=&temp2;
  temp3=(int)lua_tonumber(L,3); arg3=&temp3;
  result = (DspFloatType)(arg1)->Tick((DspFloatType const &)*arg2,(int const &)*arg3);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_FirstOrderAllPass_updateCoefficients(lua_State* L) {
  int SWIG_arg = 0;
  FirstOrderAllPass *arg1 = (FirstOrderAllPass *) 0 ;
  DspFloatType *arg2 = 0 ;
  DspFloatType temp2 ;
  
  SWIG_check_num_args("FirstOrderAllPass::updateCoefficients",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FirstOrderAllPass::updateCoefficients",1,"FirstOrderAllPass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FirstOrderAllPass::updateCoefficients",2,"DspFloatType const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FirstOrderAllPass,0))){
    SWIG_fail_ptr("FirstOrderAllPass_updateCoefficients",1,SWIGTYPE_p_FirstOrderAllPass);
  }
  
  temp2=(DspFloatType)lua_tonumber(L,2); arg2=&temp2;
  (arg1)->updateCoefficients((DspFloatType const &)*arg2);
...
static int _wrap_FirstOrderAllPass_randomize(lua_State* L) {
  int SWIG_arg = 0;
  FirstOrderAllPass *arg1 = (FirstOrderAllPass *) 0 ;
  
  SWIG_check_num_args("FirstOrderAllPass::randomize",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FirstOrderAllPass::randomize",1,"FirstOrderAllPass *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FirstOrderAllPass,0))){
    SWIG_fail_ptr("FirstOrderAllPass_randomize",1,SWIGTYPE_p_FirstOrderAllPass);
  }
...
static void swig_delete_FirstOrderAllPass(void *obj) {
FirstOrderAllPass *arg1 = (FirstOrderAllPass *) obj;
delete arg1;
}
static int _proxy__wrap_new_FirstOrderAllPass(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_FirstOrderAllPass);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_FirstOrderAllPass_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_FirstOrderAllPass_methods[]= {
    { "setPort", _wrap_FirstOrderAllPass_setPort},
    { "printPorts", _wrap_FirstOrderAllPass_printPorts},
    { "prepare", _wrap_FirstOrderAllPass_prepare},
    { "ProcessBlock", _wrap_FirstOrderAllPass_ProcessBlock},
    { "Tick", _wrap_FirstOrderAllPass_Tick},
    { "updateCoefficients", _wrap_FirstOrderAllPass_updateCoefficients},
    { "randomize", _wrap_FirstOrderAllPass_randomize},
    {0,0}
};
static swig_lua_method swig_FirstOrderAllPass_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_FirstOrderAllPass_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_FirstOrderAllPass_Sf_SwigStatic_constants[]= {
    {SWIG_LUA_CONSTTAB_INT("COEFFICIENT_PORT", FirstOrderAllPass::COEFFICIENT_PORT)},
    {0,0,0,0,0,0}
};
static swig_lua_method swig_FirstOrderAllPass_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_FirstOrderAllPass_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_FirstOrderAllPass_Sf_SwigStatic = {
    "FirstOrderAllPass",
    swig_FirstOrderAllPass_Sf_SwigStatic_methods,
    swig_FirstOrderAllPass_Sf_SwigStatic_attributes,
    swig_FirstOrderAllPass_Sf_SwigStatic_constants,
    swig_FirstOrderAllPass_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_FirstOrderAllPass_bases[] = {0,0};
static const char *swig_FirstOrderAllPass_base_names[] = {"MonoFXProcessor *",0};
static swig_lua_class _wrap_class_FirstOrderAllPass = { "FirstOrderAllPass", "FirstOrderAllPass", &SWIGTYPE_p_FirstOrderAllPass,_proxy__wrap_new_FirstOrderAllPass, swig_delete_FirstOrderAllPass, swig_FirstOrderAllPass_methods, swig_FirstOrderAllPass_attributes, &swig_FirstOrderAllPass_Sf_SwigStatic, swig_FirstOrderAllPass_meta, swig_FirstOrderAllPass_bases, swig_FirstOrderAllPass_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("FirstOrderAllPass_COEFFICIENT_PORT", FirstOrderAllPass::COEFFICIENT_PORT)},
    {0,0,0,0,0,0}
};
...
static void *_p_FirstOrderAllPassTo_p_MonoFXProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoFXProcessor *)  ((FirstOrderAllPass *) x));
}
...
static void *_p_FirstOrderAllPassTo_p_MonoProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoProcessor *) (MonoFXProcessor *) ((FirstOrderAllPass *) x));
}
...
static void *_p_FirstOrderAllPassTo_p_SoundProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SoundProcessor *) (MonoProcessor *)(MonoFXProcessor *) ((FirstOrderAllPass *) x));
}
...
static swig_type_info _swigt__p_FirstOrderAllPass = {"_p_FirstOrderAllPass", "FirstOrderAllPass *", 0, 0, (void*)&_wrap_class_FirstOrderAllPass, 0};
...
static swig_cast_info _swigc__p_FirstOrderAllPass[] = {  {&_swigt__p_FirstOrderAllPass, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_MonoFXProcessor[] = {  {&_swigt__p_FirstOrderAllPass, _p_FirstOrderAllPassTo_p_MonoFXProcessor, 0, 0},  {&_swigt__p_MonoFXProcessor, 0, 0, 0},{0, 0, 0, 0}};
