gcc -g -std=c++17 -fmax-errors=1 -O2 -march=native -mavx2 -I. -Iinclude -I/usr/local/include -I/usr/local/include/luajit-2.1 \
-o effects audio_effects.cpp Audio-Midi/audiosystem.c  lib/libfv3_float.a lib/libsr2_float.a \
