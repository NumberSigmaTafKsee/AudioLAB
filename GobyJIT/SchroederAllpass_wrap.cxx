...
#define SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer swig_types[1]
#define SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass swig_types[2]
...
#define SWIG_name      "SchroederAllpass"
#define SWIG_init      luaopen_SchroederAllpass
#define SWIG_init_user luaopen_SchroederAllpass_user

#define SWIG_LUACODE   luaopen_SchroederAllpass_luacode
...
static int _wrap_new_CircularBuffer(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  FX::Filters::SchroederAllpass::CircularBuffer *result = 0 ;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::CircularBuffer::CircularBuffer",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::CircularBuffer",1,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  result = (FX::Filters::SchroederAllpass::CircularBuffer *)new FX::Filters::SchroederAllpass::CircularBuffer(arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_CircularBuffer_readCubic(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::CircularBuffer *arg1 = (FX::Filters::SchroederAllpass::CircularBuffer *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::CircularBuffer::readCubic",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::readCubic",1,"FX::Filters::SchroederAllpass::CircularBuffer *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::readCubic",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer,0))){
    SWIG_fail_ptr("CircularBuffer_readCubic",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  result = (DspFloatType)(arg1)->readCubic(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_CircularBuffer_readLinear(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::CircularBuffer *arg1 = (FX::Filters::SchroederAllpass::CircularBuffer *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::CircularBuffer::readLinear",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::readLinear",1,"FX::Filters::SchroederAllpass::CircularBuffer *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::readLinear",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer,0))){
    SWIG_fail_ptr("CircularBuffer_readLinear",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  result = (DspFloatType)(arg1)->readLinear(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_CircularBuffer_write(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::CircularBuffer *arg1 = (FX::Filters::SchroederAllpass::CircularBuffer *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::CircularBuffer::write",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::write",1,"FX::Filters::SchroederAllpass::CircularBuffer *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::write",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer,0))){
    SWIG_fail_ptr("CircularBuffer_write",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer);
  }
...
static int _wrap_CircularBuffer_cubicInterpolation(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::CircularBuffer *arg1 = (FX::Filters::SchroederAllpass::CircularBuffer *) 0 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  ...
  SWIG_check_num_args("FX::Filters::SchroederAllpass::CircularBuffer::cubicInterpolation",6,6)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::cubicInterpolation",1,"FX::Filters::SchroederAllpass::CircularBuffer *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::cubicInterpolation",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::cubicInterpolation",3,"DspFloatType");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::cubicInterpolation",4,"DspFloatType");
  if(!lua_isnumber(L,5)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::cubicInterpolation",5,"DspFloatType");
  if(!lua_isnumber(L,6)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::cubicInterpolation",6,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer,0))){
    SWIG_fail_ptr("CircularBuffer_cubicInterpolation",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer);
  }
  ...
  arg5 = (DspFloatType)lua_tonumber(L, 5);
  arg6 = (DspFloatType)lua_tonumber(L, 6);
  result = (DspFloatType)(arg1)->cubicInterpolation(arg2,arg3,arg4,arg5,arg6);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_CircularBuffer_getSample(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::CircularBuffer *arg1 = (FX::Filters::SchroederAllpass::CircularBuffer *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::CircularBuffer::getSample",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::getSample",1,"FX::Filters::SchroederAllpass::CircularBuffer *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::getSample",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer,0))){
    SWIG_fail_ptr("CircularBuffer_getSample",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  result = (DspFloatType)(arg1)->getSample(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_CircularBuffer_setBufferLength(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::CircularBuffer *arg1 = (FX::Filters::SchroederAllpass::CircularBuffer *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::CircularBuffer::setBufferLength",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::setBufferLength",1,"FX::Filters::SchroederAllpass::CircularBuffer *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::setBufferLength",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer,0))){
    SWIG_fail_ptr("CircularBuffer_setBufferLength",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer);
  }
...
static int _wrap_CircularBuffer_getBufferLength(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::CircularBuffer *arg1 = (FX::Filters::SchroederAllpass::CircularBuffer *) 0 ;
  int result;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::CircularBuffer::getBufferLength",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::CircularBuffer::getBufferLength",1,"FX::Filters::SchroederAllpass::CircularBuffer *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer,0))){
    SWIG_fail_ptr("CircularBuffer_getBufferLength",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer);
  }
...
static void swig_delete_CircularBuffer(void *obj) {
FX::Filters::SchroederAllpass::CircularBuffer *arg1 = (FX::Filters::SchroederAllpass::CircularBuffer *) obj;
delete arg1;
}
static int _proxy__wrap_new_CircularBuffer(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_CircularBuffer);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_CircularBuffer_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_CircularBuffer_methods[]= {
    { "readCubic", _wrap_CircularBuffer_readCubic},
    { "readLinear", _wrap_CircularBuffer_readLinear},
    { "write", _wrap_CircularBuffer_write},
    { "cubicInterpolation", _wrap_CircularBuffer_cubicInterpolation},
    { "getSample", _wrap_CircularBuffer_getSample},
    { "setBufferLength", _wrap_CircularBuffer_setBufferLength},
    { "getBufferLength", _wrap_CircularBuffer_getBufferLength},
    {0,0}
};
static swig_lua_method swig_CircularBuffer_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_CircularBuffer_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_CircularBuffer_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_CircularBuffer_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_CircularBuffer_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_CircularBuffer_Sf_SwigStatic = {
    "CircularBuffer",
    swig_CircularBuffer_Sf_SwigStatic_methods,
    swig_CircularBuffer_Sf_SwigStatic_attributes,
    swig_CircularBuffer_Sf_SwigStatic_constants,
    swig_CircularBuffer_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_CircularBuffer_bases[] = {0};
static const char *swig_CircularBuffer_base_names[] = {0};
static swig_lua_class _wrap_class_CircularBuffer = { "CircularBuffer", "CircularBuffer", &SWIGTYPE_p_FX__Filters__SchroederAllpass__CircularBuffer,_proxy__wrap_new_CircularBuffer, swig_delete_CircularBuffer, swig_CircularBuffer_methods, swig_CircularBuffer_attributes, &swig_CircularBuffer_Sf_SwigStatic, swig_CircularBuffer_meta, swig_CircularBuffer_bases, swig_CircularBuffer_base_names };

static int _wrap_new_SchroederAllPass(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  DspFloatType arg2 ;
  FX::Filters::SchroederAllpass::SchroederAllPass *result = 0 ;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::SchroederAllPass::SchroederAllPass",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::SchroederAllPass",1,"DspFloatType");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::SchroederAllPass",2,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  result = (FX::Filters::SchroederAllpass::SchroederAllPass *)new FX::Filters::SchroederAllpass::SchroederAllPass(arg1,arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_SchroederAllPass_process(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::SchroederAllPass *arg1 = (FX::Filters::SchroederAllpass::SchroederAllPass *) 0 ;
  DspFloatType *arg2 = (DspFloatType *) 0 ;
  int arg3 ;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::SchroederAllPass::process",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::process",1,"FX::Filters::SchroederAllpass::SchroederAllPass *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::process",2,"DspFloatType *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::process",3,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass,0))){
    SWIG_fail_ptr("SchroederAllPass_process",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("SchroederAllPass_process",2,SWIGTYPE_p_float);
  }
...
static int _wrap_SchroederAllPass_processSingleSample(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::SchroederAllPass *arg1 = (FX::Filters::SchroederAllpass::SchroederAllPass *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::SchroederAllPass::processSingleSample",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::processSingleSample",1,"FX::Filters::SchroederAllpass::SchroederAllPass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::processSingleSample",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass,0))){
    SWIG_fail_ptr("SchroederAllPass_processSingleSample",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  result = (DspFloatType)(arg1)->processSingleSample(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SchroederAllPass_setFeedback(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::SchroederAllPass *arg1 = (FX::Filters::SchroederAllpass::SchroederAllPass *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::SchroederAllPass::setFeedback",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::setFeedback",1,"FX::Filters::SchroederAllpass::SchroederAllPass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::setFeedback",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass,0))){
    SWIG_fail_ptr("SchroederAllPass_setFeedback",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass);
  }
...
static int _wrap_SchroederAllPass_getFeedback(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::SchroederAllPass *arg1 = (FX::Filters::SchroederAllpass::SchroederAllPass *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::SchroederAllPass::getFeedback",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::getFeedback",1,"FX::Filters::SchroederAllpass::SchroederAllPass *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass,0))){
    SWIG_fail_ptr("SchroederAllPass_getFeedback",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass);
  }
...
static int _wrap_SchroederAllPass_setDelayLength(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::SchroederAllPass *arg1 = (FX::Filters::SchroederAllpass::SchroederAllPass *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::SchroederAllPass::setDelayLength",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::setDelayLength",1,"FX::Filters::SchroederAllpass::SchroederAllPass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::setDelayLength",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass,0))){
    SWIG_fail_ptr("SchroederAllPass_setDelayLength",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  (arg1)->setDelayLength(arg2);
...
static int _wrap_SchroederAllPass_getDelayLength(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::SchroederAllPass *arg1 = (FX::Filters::SchroederAllpass::SchroederAllPass *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::SchroederAllPass::getDelayLength",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::getDelayLength",1,"FX::Filters::SchroederAllpass::SchroederAllPass *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass,0))){
    SWIG_fail_ptr("SchroederAllPass_getDelayLength",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass);
  }
  
  result = (DspFloatType)(arg1)->getDelayLength();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SchroederAllPass_setFs(lua_State* L) {
  int SWIG_arg = 0;
  FX::Filters::SchroederAllpass::SchroederAllPass *arg1 = (FX::Filters::SchroederAllpass::SchroederAllPass *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("FX::Filters::SchroederAllpass::SchroederAllPass::setFs",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::setFs",1,"FX::Filters::SchroederAllpass::SchroederAllPass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::Filters::SchroederAllpass::SchroederAllPass::setFs",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass,0))){
    SWIG_fail_ptr("SchroederAllPass_setFs",1,SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass);
  }
...
static void swig_delete_SchroederAllPass(void *obj) {
FX::Filters::SchroederAllpass::SchroederAllPass *arg1 = (FX::Filters::SchroederAllpass::SchroederAllPass *) obj;
delete arg1;
}
static int _proxy__wrap_new_SchroederAllPass(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_SchroederAllPass);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_SchroederAllPass_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_SchroederAllPass_methods[]= {
    { "process", _wrap_SchroederAllPass_process},
    { "processSingleSample", _wrap_SchroederAllPass_processSingleSample},
    { "setFeedback", _wrap_SchroederAllPass_setFeedback},
    { "getFeedback", _wrap_SchroederAllPass_getFeedback},
    { "setDelayLength", _wrap_SchroederAllPass_setDelayLength},
    { "getDelayLength", _wrap_SchroederAllPass_getDelayLength},
    { "setFs", _wrap_SchroederAllPass_setFs},
    {0,0}
};
static swig_lua_method swig_SchroederAllPass_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_SchroederAllPass_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_SchroederAllPass_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_SchroederAllPass_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_SchroederAllPass_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_SchroederAllPass_Sf_SwigStatic = {
    "SchroederAllPass",
    swig_SchroederAllPass_Sf_SwigStatic_methods,
    swig_SchroederAllPass_Sf_SwigStatic_attributes,
    swig_SchroederAllPass_Sf_SwigStatic_constants,
    swig_SchroederAllPass_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_SchroederAllPass_bases[] = {0};
static const char *swig_SchroederAllPass_base_names[] = {0};
static swig_lua_class _wrap_class_SchroederAllPass = { "SchroederAllPass", "SchroederAllPass", &SWIGTYPE_p_FX__Filters__SchroederAllpass__SchroederAllPass,_proxy__wrap_new_SchroederAllPass, swig_delete_SchroederAllPass, swig_SchroederAllPass_methods, swig_SchroederAllPass_attributes, &swig_SchroederAllPass_Sf_SwigStatic, swig_SchroederAllPass_meta, swig_SchroederAllPass_bases, swig_SchroederAllPass_base_names };
...
&_wrap_class_CircularBuffer,
&_wrap_class_SchroederAllPass,
...
static swig_type_info _swigt__p_FX__Filters__SchroederAllpass__CircularBuffer = {"_p_FX__Filters__SchroederAllpass__CircularBuffer", "FX::Filters::SchroederAllpass::CircularBuffer *", 0, 0, (void*)&_wrap_class_CircularBuffer, 0};
static swig_type_info _swigt__p_FX__Filters__SchroederAllpass__SchroederAllPass = {"_p_FX__Filters__SchroederAllpass__SchroederAllPass", "FX::Filters::SchroederAllpass::SchroederAllPass *", 0, 0, (void*)&_wrap_class_SchroederAllPass, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FX__Filters__SchroederAllpass__CircularBuffer,
  &_swigt__p_FX__Filters__SchroederAllpass__SchroederAllPass,
...
static swig_cast_info _swigc__p_FX__Filters__SchroederAllpass__CircularBuffer[] = {  {&_swigt__p_FX__Filters__SchroederAllpass__CircularBuffer, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FX__Filters__SchroederAllpass__SchroederAllPass[] = {  {&_swigt__p_FX__Filters__SchroederAllpass__SchroederAllPass, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FX__Filters__SchroederAllpass__CircularBuffer,
  _swigc__p_FX__Filters__SchroederAllpass__SchroederAllPass,
