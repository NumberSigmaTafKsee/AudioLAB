...
#define SWIGTYPE_p_FX__HammerFX__TubeAmp swig_types[1]
...
#define SWIGTYPE_p_tubeamp_params swig_types[95]
...
#define SWIG_name      "HammerFXTubeAmp"
#define SWIG_init      luaopen_HammerFXTubeAmp
#define SWIG_init_user luaopen_HammerFXTubeAmp_user

#define SWIG_LUACODE   luaopen_HammerFXTubeAmp_luacode
...
static int _wrap_TubeAmp_cp_set(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::TubeAmp *arg1 = (FX::HammerFX::TubeAmp *) 0 ;
  tubeamp_params arg2 ;
  tubeamp_params *argp2 ;
  
  SWIG_check_num_args("FX::HammerFX::TubeAmp::cp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::TubeAmp::cp",1,"FX::HammerFX::TubeAmp *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("FX::HammerFX::TubeAmp::cp",2,"tubeamp_params");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__TubeAmp,0))){
    SWIG_fail_ptr("TubeAmp_cp_set",1,SWIGTYPE_p_FX__HammerFX__TubeAmp);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_tubeamp_params,0))){
    SWIG_fail_ptr("TubeAmp_cp_set",2,SWIGTYPE_p_tubeamp_params);
  }
  arg2 = *argp2;
...
static int _wrap_TubeAmp_cp_get(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::TubeAmp *arg1 = (FX::HammerFX::TubeAmp *) 0 ;
  tubeamp_params result;
  
  SWIG_check_num_args("FX::HammerFX::TubeAmp::cp",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::TubeAmp::cp",1,"FX::HammerFX::TubeAmp *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__TubeAmp,0))){
    SWIG_fail_ptr("TubeAmp_cp_get",1,SWIGTYPE_p_FX__HammerFX__TubeAmp);
  }
  
  result =  ((arg1)->cp);
  {
    tubeamp_params * resultptr = new tubeamp_params((const tubeamp_params &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_tubeamp_params,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static int _wrap_new_TubeAmp(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::TubeAmp *result = 0 ;
  
  SWIG_check_num_args("FX::HammerFX::TubeAmp::TubeAmp",0,0)
  result = (FX::HammerFX::TubeAmp *)new FX::HammerFX::TubeAmp();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_FX__HammerFX__TubeAmp,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_TubeAmp_ProcessBlock(lua_State* L) {
  int SWIG_arg = 0;
  FX::HammerFX::TubeAmp *arg1 = (FX::HammerFX::TubeAmp *) 0 ;
  size_t arg2 ;
  DspFloatType *arg3 = (DspFloatType *) 0 ;
  ...
  SWIG_check_num_args("FX::HammerFX::TubeAmp::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("FX::HammerFX::TubeAmp::ProcessBlock",1,"FX::HammerFX::TubeAmp *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("FX::HammerFX::TubeAmp::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("FX::HammerFX::TubeAmp::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("FX::HammerFX::TubeAmp::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_FX__HammerFX__TubeAmp,0))){
    SWIG_fail_ptr("TubeAmp_ProcessBlock",1,SWIGTYPE_p_FX__HammerFX__TubeAmp);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("TubeAmp_ProcessBlock",3,SWIGTYPE_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("TubeAmp_ProcessBlock",4,SWIGTYPE_p_float);
  }
...
static void swig_delete_TubeAmp(void *obj) {
FX::HammerFX::TubeAmp *arg1 = (FX::HammerFX::TubeAmp *) obj;
delete arg1;
}
static int _proxy__wrap_new_TubeAmp(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_TubeAmp);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_TubeAmp_attributes[] = {
    { "cp", _wrap_TubeAmp_cp_get, _wrap_TubeAmp_cp_set },
    {0,0,0}
};
static swig_lua_method swig_TubeAmp_methods[]= {
    { "ProcessBlock", _wrap_TubeAmp_ProcessBlock},
    {0,0}
};
static swig_lua_method swig_TubeAmp_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_TubeAmp_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_TubeAmp_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_TubeAmp_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_TubeAmp_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_TubeAmp_SwigStatic = {
    "TubeAmp",
    swig_TubeAmp_SwigStatic_methods,
    swig_TubeAmp_SwigStatic_attributes,
    swig_TubeAmp_SwigStatic_constants,
    swig_TubeAmp_SwigStatic_classes,
    0
};
static swig_lua_class *swig_TubeAmp_bases[] = {0};
static const char *swig_TubeAmp_base_names[] = {0};
static swig_lua_class _wrap_class_TubeAmp = { "TubeAmp", "TubeAmp", &SWIGTYPE_p_FX__HammerFX__TubeAmp,_proxy__wrap_new_TubeAmp, swig_delete_TubeAmp, swig_TubeAmp_methods, swig_TubeAmp_attributes, &swig_TubeAmp_SwigStatic, swig_TubeAmp_meta, swig_TubeAmp_bases, swig_TubeAmp_base_names };
...
static swig_type_info _swigt__p_FX__HammerFX__TubeAmp = {"_p_FX__HammerFX__TubeAmp", "FX::HammerFX::TubeAmp *", 0, 0, (void*)&_wrap_class_TubeAmp, 0};
...
static swig_type_info _swigt__p_tubeamp_params = {"_p_tubeamp_params", "tubeamp_params *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_FX__HammerFX__TubeAmp,
...
static swig_cast_info _swigc__p_FX__HammerFX__TubeAmp[] = {  {&_swigt__p_FX__HammerFX__TubeAmp, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_tubeamp_params[] = {  {&_swigt__p_tubeamp_params, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_FX__HammerFX__TubeAmp,
