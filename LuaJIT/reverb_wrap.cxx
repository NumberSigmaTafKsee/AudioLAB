...
#define SWIGTYPE_p_Reverb__Delay swig_types[25]
#define SWIGTYPE_p_Reverb__Diff1 swig_types[26]
#define SWIGTYPE_p_Reverb__Filt1 swig_types[27]
#define SWIGTYPE_p_Reverb__Pareq swig_types[28]
#define SWIGTYPE_p_Reverb__Reverb swig_types[29]
#define SWIGTYPE_p_Reverb__Vdelay swig_types[30]
...
#define SWIGTYPE_p_Std__RandomMersenne swig_types[35]
...
#define SWIGTYPE_p_f_float__float swig_types[46]
#define SWIGTYPE_p_f_r_q_const__float__float swig_types[47]
#define SWIGTYPE_p_fenv_t swig_types[48]
#define SWIGTYPE_p_fexcept_t swig_types[49]
...
#define SWIGTYPE_p_p_AmplifierProcessor swig_types[54]
...
#define SWIGTYPE_p_std__complexT_double_t swig_types[60]
#define SWIGTYPE_p_std__complexT_float_t swig_types[61]
#define SWIGTYPE_p_std__gslice swig_types[62]
#define SWIGTYPE_p_std__gslice_arrayT_float_t swig_types[63]
#define SWIGTYPE_p_std__indirect_arrayT_float_t swig_types[64]
...
#define SWIGTYPE_p_std__mask_arrayT_float_t swig_types[73]
...
#define SWIGTYPE_p_std__slice swig_types[84]
#define SWIGTYPE_p_std__slice_arrayT_float_t swig_types[85]
#define SWIGTYPE_p_std__string swig_types[86]
#define SWIGTYPE_p_std__valarrayT_float_t swig_types[87]
#define SWIGTYPE_p_std__vectorT_MonoProcessor_p_t swig_types[88]
#define SWIGTYPE_p_std__vectorT_OscillatorProcessor_p_t swig_types[89]
#define SWIGTYPE_p_std__vectorT_SoundProcessor_p_t swig_types[90]
#define SWIGTYPE_p_std__vectorT_StereoProcessor_p_t swig_types[91]
#define SWIGTYPE_p_std__vectorT_double_t swig_types[92]
#define SWIGTYPE_p_std__vectorT_float_t swig_types[93]
#define SWIGTYPE_p_std__vectorT_std__complexT_double_t_t swig_types[94]
#define SWIGTYPE_p_std__vectorT_std__complexT_float_t_t swig_types[95]
#define SWIGTYPE_p_std__vector_iteratorT_double_t swig_types[96]
#define SWIGTYPE_p_std__vector_iteratorT_float_t swig_types[97]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_double_t_t swig_types[98]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_float_t_t swig_types[99]
...
#define SWIG_name      "reverb"
#define SWIG_init      luaopen_reverb
#define SWIG_init_user luaopen_reverb_user

#define SWIG_LUACODE   luaopen_reverb_luacode
...
static int _wrap_new_Pareq(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Pareq *result = 0 ;
  
  SWIG_check_num_args("Reverb::Pareq::Pareq",0,0)
  result = (Reverb::Pareq *)new Reverb::Pareq();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Reverb__Pareq,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Pareq_setfsamp(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Pareq *arg1 = (Reverb::Pareq *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Reverb::Pareq::setfsamp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Pareq::setfsamp",1,"Reverb::Pareq *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Pareq::setfsamp",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Pareq,0))){
    SWIG_fail_ptr("Pareq_setfsamp",1,SWIGTYPE_p_Reverb__Pareq);
  }
...
static int _wrap_Pareq_setparam(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Pareq *arg1 = (Reverb::Pareq *) 0 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Reverb::Pareq::setparam",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Pareq::setparam",1,"Reverb::Pareq *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Pareq::setparam",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Reverb::Pareq::setparam",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Pareq,0))){
    SWIG_fail_ptr("Pareq_setparam",1,SWIGTYPE_p_Reverb__Pareq);
  }
...
static int _wrap_Pareq_reset(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Pareq *arg1 = (Reverb::Pareq *) 0 ;
  
  SWIG_check_num_args("Reverb::Pareq::reset",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Pareq::reset",1,"Reverb::Pareq *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Pareq,0))){
    SWIG_fail_ptr("Pareq_reset",1,SWIGTYPE_p_Reverb__Pareq);
  }
...
static int _wrap_Pareq_prepare(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Pareq *arg1 = (Reverb::Pareq *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("Reverb::Pareq::prepare",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Pareq::prepare",1,"Reverb::Pareq *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Pareq::prepare",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Pareq,0))){
    SWIG_fail_ptr("Pareq_prepare",1,SWIGTYPE_p_Reverb__Pareq);
  }
...
static int _wrap_Pareq_process(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Pareq *arg1 = (Reverb::Pareq *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  SWIG_check_num_args("Reverb::Pareq::process",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Pareq::process",1,"Reverb::Pareq *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Pareq::process",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Reverb::Pareq::process",3,"int");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("Reverb::Pareq::process",4,"DspFloatType *[]");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Pareq,0))){
    SWIG_fail_ptr("Pareq_process",1,SWIGTYPE_p_Reverb__Pareq);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_p_float,0))){
    SWIG_fail_ptr("Pareq_process",4,SWIGTYPE_p_p_float);
  }
...
static void swig_delete_Pareq(void *obj) {
Reverb::Pareq *arg1 = (Reverb::Pareq *) obj;
delete arg1;
}
static int _proxy__wrap_new_Pareq(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_Pareq);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_Pareq_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Pareq_methods[]= {
    { "setfsamp", _wrap_Pareq_setfsamp},
    { "setparam", _wrap_Pareq_setparam},
    { "reset", _wrap_Pareq_reset},
    { "prepare", _wrap_Pareq_prepare},
    { "process", _wrap_Pareq_process},
    {0,0}
};
static swig_lua_method swig_Pareq_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_Pareq_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_Pareq_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_Pareq_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_Pareq_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_Pareq_Sf_SwigStatic = {
    "Pareq",
    swig_Pareq_Sf_SwigStatic_methods,
    swig_Pareq_Sf_SwigStatic_attributes,
    swig_Pareq_Sf_SwigStatic_constants,
    swig_Pareq_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_Pareq_bases[] = {0};
static const char *swig_Pareq_base_names[] = {0};
static swig_lua_class _wrap_class_Pareq = { "Pareq", "Pareq", &SWIGTYPE_p_Reverb__Pareq,_proxy__wrap_new_Pareq, swig_delete_Pareq, swig_Pareq_methods, swig_Pareq_attributes, &swig_Pareq_Sf_SwigStatic, swig_Pareq_meta, swig_Pareq_bases, swig_Pareq_base_names };

static swig_lua_attribute swig_Diff1_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Diff1_methods[]= {
    {0,0}
};
static swig_lua_method swig_Diff1_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_Diff1_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_Diff1_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_Diff1_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_Diff1_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_Diff1_Sf_SwigStatic = {
    "Diff1",
    swig_Diff1_Sf_SwigStatic_methods,
    swig_Diff1_Sf_SwigStatic_attributes,
    swig_Diff1_Sf_SwigStatic_constants,
    swig_Diff1_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_Diff1_bases[] = {0};
static const char *swig_Diff1_base_names[] = {0};
static swig_lua_class _wrap_class_Diff1 = { "Diff1", "Diff1", &SWIGTYPE_p_Reverb__Diff1,0,0, swig_Diff1_methods, swig_Diff1_attributes, &swig_Diff1_Sf_SwigStatic, swig_Diff1_meta, swig_Diff1_bases, swig_Diff1_base_names };

static swig_lua_attribute swig_Filt1_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Filt1_methods[]= {
    {0,0}
};
static swig_lua_method swig_Filt1_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_Filt1_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_Filt1_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_Filt1_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_Filt1_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_Filt1_Sf_SwigStatic = {
    "Filt1",
    swig_Filt1_Sf_SwigStatic_methods,
    swig_Filt1_Sf_SwigStatic_attributes,
    swig_Filt1_Sf_SwigStatic_constants,
    swig_Filt1_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_Filt1_bases[] = {0};
static const char *swig_Filt1_base_names[] = {0};
static swig_lua_class _wrap_class_Filt1 = { "Filt1", "Filt1", &SWIGTYPE_p_Reverb__Filt1,0,0, swig_Filt1_methods, swig_Filt1_attributes, &swig_Filt1_Sf_SwigStatic, swig_Filt1_meta, swig_Filt1_bases, swig_Filt1_base_names };
...
static swig_lua_class _wrap_class_Delay = { "Delay", "Delay", &SWIGTYPE_p_Reverb__Delay,0,0, swig_Delay_methods, swig_Delay_attributes, &swig_Delay_Sf_SwigStatic, swig_Delay_meta, swig_Delay_bases, swig_Delay_base_names };

static swig_lua_attribute swig_Vdelay_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Vdelay_methods[]= {
    {0,0}
};
static swig_lua_method swig_Vdelay_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_Vdelay_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_Vdelay_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_Vdelay_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_Vdelay_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_Vdelay_Sf_SwigStatic = {
    "Vdelay",
    swig_Vdelay_Sf_SwigStatic_methods,
    swig_Vdelay_Sf_SwigStatic_attributes,
    swig_Vdelay_Sf_SwigStatic_constants,
    swig_Vdelay_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_Vdelay_bases[] = {0};
static const char *swig_Vdelay_base_names[] = {0};
static swig_lua_class _wrap_class_Vdelay = { "Vdelay", "Vdelay", &SWIGTYPE_p_Reverb__Vdelay,0,0, swig_Vdelay_methods, swig_Vdelay_attributes, &swig_Vdelay_Sf_SwigStatic, swig_Vdelay_meta, swig_Vdelay_bases, swig_Vdelay_base_names };

static int _wrap_new_Reverb(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *result = 0 ;
  
  SWIG_check_num_args("Reverb::Reverb::Reverb",0,0)
  result = (Reverb::Reverb *)new Reverb::Reverb();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Reverb__Reverb,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Reverb_init(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  DspFloatType arg2 ;
  bool arg3 ;
  
  SWIG_check_num_args("Reverb::Reverb::init",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::init",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::init",2,"DspFloatType");
  if(!lua_isboolean(L,3)) SWIG_fail_arg("Reverb::Reverb::init",3,"bool");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_init",1,SWIGTYPE_p_Reverb__Reverb);
  }
...
static int _wrap_Reverb_fini(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  
  SWIG_check_num_args("Reverb::Reverb::fini",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::fini",1,"Reverb::Reverb *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_fini",1,SWIGTYPE_p_Reverb__Reverb);
  }
...
static int _wrap_Reverb_prepare(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("Reverb::Reverb::prepare",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::prepare",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::prepare",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_prepare",1,SWIGTYPE_p_Reverb__Reverb);
  }
...
static int _wrap_Reverb_process(lua_State* L) {
  ...
  SWIG_check_num_args("Reverb::Reverb::process",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::process",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::process",2,"int");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Reverb::Reverb::process",3,"DspFloatType *[]");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("Reverb::Reverb::process",4,"DspFloatType *[]");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_process",1,SWIGTYPE_p_Reverb__Reverb);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_p_float,0))){
    SWIG_fail_ptr("Reverb_process",3,SWIGTYPE_p_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_p_float,0))){
    SWIG_fail_ptr("Reverb_process",4,SWIGTYPE_p_p_float);
  }
...
static int _wrap_Reverb_set_delay(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Reverb::Reverb::set_delay",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::set_delay",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::set_delay",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_set_delay",1,SWIGTYPE_p_Reverb__Reverb);
  }
...
static int _wrap_Reverb_set_xover(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Reverb::Reverb::set_xover",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::set_xover",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::set_xover",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_set_xover",1,SWIGTYPE_p_Reverb__Reverb);
  }
...
static int _wrap_Reverb_set_rtlow(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Reverb::Reverb::set_rtlow",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::set_rtlow",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::set_rtlow",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_set_rtlow",1,SWIGTYPE_p_Reverb__Reverb);
  }
...
static int _wrap_Reverb_set_rtmid(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Reverb::Reverb::set_rtmid",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::set_rtmid",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::set_rtmid",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_set_rtmid",1,SWIGTYPE_p_Reverb__Reverb);
  }
...
static int _wrap_Reverb_set_fdamp(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Reverb::Reverb::set_fdamp",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::set_fdamp",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::set_fdamp",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_set_fdamp",1,SWIGTYPE_p_Reverb__Reverb);
  }
...
static int _wrap_Reverb_set_opmix(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Reverb::Reverb::set_opmix",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::set_opmix",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::set_opmix",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_set_opmix",1,SWIGTYPE_p_Reverb__Reverb);
  }
...
static int _wrap_Reverb_set_rgxyz(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Reverb::Reverb::set_rgxyz",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::set_rgxyz",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::set_rgxyz",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_set_rgxyz",1,SWIGTYPE_p_Reverb__Reverb);
  }
...
static int _wrap_Reverb_set_eq1(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Reverb::Reverb::set_eq1",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::set_eq1",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::set_eq1",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Reverb::Reverb::set_eq1",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_set_eq1",1,SWIGTYPE_p_Reverb__Reverb);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  arg3 = (DspFloatType)lua_tonumber(L, 3);
  (arg1)->set_eq1(arg2,arg3);
...
static int _wrap_Reverb_set_eq2(lua_State* L) {
  int SWIG_arg = 0;
  Reverb::Reverb *arg1 = (Reverb::Reverb *) 0 ;
  DspFloatType arg2 ;
  DspFloatType arg3 ;
  
  SWIG_check_num_args("Reverb::Reverb::set_eq2",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::Reverb::set_eq2",1,"Reverb::Reverb *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Reverb::Reverb::set_eq2",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Reverb::Reverb::set_eq2",3,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Reverb__Reverb,0))){
    SWIG_fail_ptr("Reverb_set_eq2",1,SWIGTYPE_p_Reverb__Reverb);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  arg3 = (DspFloatType)lua_tonumber(L, 3);
  (arg1)->set_eq2(arg2,arg3);
...
Reverb::Reverb *arg1 = (Reverb::Reverb *) obj;
delete arg1;
}
...
static swig_lua_method swig_Reverb_methods[]= {
    { "init", _wrap_Reverb_init},
    { "fini", _wrap_Reverb_fini},
    { "prepare", _wrap_Reverb_prepare},
    { "process", _wrap_Reverb_process},
    { "set_delay", _wrap_Reverb_set_delay},
    { "set_xover", _wrap_Reverb_set_xover},
    { "set_rtlow", _wrap_Reverb_set_rtlow},
    { "set_rtmid", _wrap_Reverb_set_rtmid},
    { "set_fdamp", _wrap_Reverb_set_fdamp},
    { "set_opmix", _wrap_Reverb_set_opmix},
    { "set_rgxyz", _wrap_Reverb_set_rgxyz},
    { "set_eq1", _wrap_Reverb_set_eq1},
    { "set_eq2", _wrap_Reverb_set_eq2},
    {0,0}
};
...
static swig_lua_class _wrap_class_Reverb = { "Reverb", "Reverb", &SWIGTYPE_p_Reverb__Reverb,_proxy__wrap_new_Reverb, swig_delete_Reverb, swig_Reverb_methods, swig_Reverb_attributes, &swig_Reverb_Sf_SwigStatic, swig_Reverb_meta, swig_Reverb_bases, swig_Reverb_base_names };

static int _wrap__tdiff1_set(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType *arg1 ;
  
  SWIG_check_num_args("Reverb::_tdiff1",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::_tdiff1",1,"DspFloatType [8]");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("_tdiff1_set",1,SWIGTYPE_p_float);
  }
  
  {
    size_t ii;
    DspFloatType *b = (DspFloatType *) Reverb::_tdiff1;
    for (ii = 0; ii < (size_t)8; ii++) b[ii] = *((DspFloatType *) arg1 + ii);
  }
...
static int _wrap__tdiff1_get(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType *result = 0 ;
  
  SWIG_check_num_args("Reverb::_tdiff1",0,0)
  result = (DspFloatType *)(DspFloatType *)Reverb::_tdiff1;
...
static int _wrap__tdelay_set(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType *arg1 ;
  
  SWIG_check_num_args("Reverb::_tdelay",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Reverb::_tdelay",1,"DspFloatType [8]");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_float,0))){
    SWIG_fail_ptr("_tdelay_set",1,SWIGTYPE_p_float);
  }
  
  {
    size_t ii;
    DspFloatType *b = (DspFloatType *) Reverb::_tdelay;
    for (ii = 0; ii < (size_t)8; ii++) b[ii] = *((DspFloatType *) arg1 + ii);
  }
...
static int _wrap__tdelay_get(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType *result = 0 ;
  
  SWIG_check_num_args("Reverb::_tdelay",0,0)
  result = (DspFloatType *)(DspFloatType *)Reverb::_tdelay;
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_float,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_init(lua_State* L) {
  ...
  SWIG_check_num_args("Reverb::init",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Reverb::init",1,"DspFloatType");
  if(!lua_isboolean(L,2)) SWIG_fail_arg("Reverb::init",2,"bool");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  arg2 = (lua_toboolean(L, 2)!=0);
  Reverb::init(arg1,arg2);
...
static int _wrap_fini(lua_State* L) {
  int SWIG_arg = 0;
  
  SWIG_check_num_args("Reverb::fini",0,0)
  Reverb::fini();
...
static int _wrap_prepare(lua_State* L) {
  int SWIG_arg = 0;
  int arg1 ;
  
  SWIG_check_num_args("Reverb::prepare",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Reverb::prepare",1,"int");
  arg1 = (int)lua_tonumber(L, 1);
  Reverb::prepare(arg1);
...
static int _wrap_process(lua_State* L) {
  ...
  SWIG_check_num_args("Reverb::process",3,3)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Reverb::process",1,"int");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Reverb::process",2,"DspFloatType *[]");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Reverb::process",3,"DspFloatType *[]");
  arg1 = (int)lua_tonumber(L, 1);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_p_float,0))){
    SWIG_fail_ptr("process",2,SWIGTYPE_p_p_float);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_p_float,0))){
    SWIG_fail_ptr("process",3,SWIGTYPE_p_p_float);
  }
  
  Reverb::process(arg1,arg2,arg3);
...
static swig_lua_attribute swig_SwigModule_attributes[] = {
    ...
    { "_tdiff1", _wrap__tdiff1_get, _wrap__tdiff1_set },
    { "_tdelay", _wrap__tdelay_get, _wrap__tdelay_set },
...
static swig_type_info _swigt__p_Reverb__Delay = {"_p_Reverb__Delay", "Reverb::Delay *", 0, 0, (void*)&_wrap_class_Delay, 0};
static swig_type_info _swigt__p_Reverb__Diff1 = {"_p_Reverb__Diff1", "Reverb::Diff1 *", 0, 0, (void*)&_wrap_class_Diff1, 0};
static swig_type_info _swigt__p_Reverb__Filt1 = {"_p_Reverb__Filt1", "Reverb::Filt1 *", 0, 0, (void*)&_wrap_class_Filt1, 0};
static swig_type_info _swigt__p_Reverb__Pareq = {"_p_Reverb__Pareq", "Reverb::Pareq *", 0, 0, (void*)&_wrap_class_Pareq, 0};
static swig_type_info _swigt__p_Reverb__Reverb = {"_p_Reverb__Reverb", "Reverb::Reverb *", 0, 0, (void*)&_wrap_class_Reverb, 0};
static swig_type_info _swigt__p_Reverb__Vdelay = {"_p_Reverb__Vdelay", "Reverb::Vdelay *", 0, 0, (void*)&_wrap_class_Vdelay, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_Ports,
  &_swigt__p_Random,
  &_swigt__p_Reverb__Delay,
  &_swigt__p_Reverb__Diff1,
  &_swigt__p_Reverb__Filt1,
  &_swigt__p_Reverb__Pareq,
  &_swigt__p_Reverb__Reverb,
  &_swigt__p_Reverb__Vdelay,
...
static swig_cast_info _swigc__p_Reverb__Delay[] = {  {&_swigt__p_Reverb__Delay, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Reverb__Diff1[] = {  {&_swigt__p_Reverb__Diff1, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Reverb__Filt1[] = {  {&_swigt__p_Reverb__Filt1, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Reverb__Pareq[] = {  {&_swigt__p_Reverb__Pareq, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Reverb__Reverb[] = {  {&_swigt__p_Reverb__Reverb, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Reverb__Vdelay[] = {  {&_swigt__p_Reverb__Vdelay, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_Ports,
  _swigc__p_Random,
  _swigc__p_Reverb__Delay,
  _swigc__p_Reverb__Diff1,
  _swigc__p_Reverb__Filt1,
  _swigc__p_Reverb__Pareq,
  _swigc__p_Reverb__Reverb,
  _swigc__p_Reverb__Vdelay,
