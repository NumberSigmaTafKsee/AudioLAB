...
#define SWIGTYPE_p_CEnvelopeDetector swig_types[1]
...
#define SWIG_name      "audiodsp_cenvelopedetector"
#define SWIG_init      luaopen_audiodsp_cenvelopedetector
#define SWIG_init_user luaopen_audiodsp_cenvelopedetector_user

#define SWIG_LUACODE   luaopen_audiodsp_cenvelopedetector_luacode
...
#include "audiodsp_cenvelopedetector.hpp"
...
static int _wrap_METER_UPDATE_INTERVAL_MSEC_get(lua_State* L) {
  ...
  result = (float)(float)METER_UPDATE_INTERVAL_MSEC;
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_METER_MIN_DB_get(lua_State* L) {
  ...
  result = (float)(float)METER_MIN_DB;
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_new_CEnvelopeDetector(lua_State* L) {
  int SWIG_arg = 0;
  CEnvelopeDetector *result = 0 ;
  
  SWIG_check_num_args("CEnvelopeDetector::CEnvelopeDetector",0,0)
  result = (CEnvelopeDetector *)new CEnvelopeDetector();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_CEnvelopeDetector,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_CEnvelopeDetector_init(lua_State* L) {
  int SWIG_arg = 0;
  CEnvelopeDetector *arg1 = (CEnvelopeDetector *) 0 ;
  float arg2 ;
  float arg3 ;
  float arg4 ;
  bool arg5 ;
  ...
  SWIG_check_num_args("CEnvelopeDetector::init",7,7)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEnvelopeDetector::init",1,"CEnvelopeDetector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CEnvelopeDetector::init",2,"float");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("CEnvelopeDetector::init",3,"float");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("CEnvelopeDetector::init",4,"float");
  if(!lua_isboolean(L,5)) SWIG_fail_arg("CEnvelopeDetector::init",5,"bool");
  if(!lua_isnumber(L,6)) SWIG_fail_arg("CEnvelopeDetector::init",6,"UINT");
  if(!lua_isboolean(L,7)) SWIG_fail_arg("CEnvelopeDetector::init",7,"bool");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEnvelopeDetector,0))){
    SWIG_fail_ptr("CEnvelopeDetector_init",1,SWIGTYPE_p_CEnvelopeDetector);
  }
...
static int _wrap_CEnvelopeDetector_setTCModeAnalog(lua_State* L) {
  ...
  SWIG_check_num_args("CEnvelopeDetector::setTCModeAnalog",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEnvelopeDetector::setTCModeAnalog",1,"CEnvelopeDetector *");
  if(!lua_isboolean(L,2)) SWIG_fail_arg("CEnvelopeDetector::setTCModeAnalog",2,"bool");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEnvelopeDetector,0))){
    SWIG_fail_ptr("CEnvelopeDetector_setTCModeAnalog",1,SWIGTYPE_p_CEnvelopeDetector);
  }
...
static int _wrap_CEnvelopeDetector_setAttackTime(lua_State* L) {
  ...
  SWIG_check_num_args("CEnvelopeDetector::setAttackTime",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEnvelopeDetector::setAttackTime",1,"CEnvelopeDetector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CEnvelopeDetector::setAttackTime",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEnvelopeDetector,0))){
    SWIG_fail_ptr("CEnvelopeDetector_setAttackTime",1,SWIGTYPE_p_CEnvelopeDetector);
  }
...
static int _wrap_CEnvelopeDetector_setReleaseTime(lua_State* L) {
  ...
  SWIG_check_num_args("CEnvelopeDetector::setReleaseTime",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEnvelopeDetector::setReleaseTime",1,"CEnvelopeDetector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CEnvelopeDetector::setReleaseTime",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEnvelopeDetector,0))){
    SWIG_fail_ptr("CEnvelopeDetector_setReleaseTime",1,SWIGTYPE_p_CEnvelopeDetector);
  }
...
static int _wrap_CEnvelopeDetector_setDetectMode(lua_State* L) {
  ...
  SWIG_check_num_args("CEnvelopeDetector::setDetectMode",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEnvelopeDetector::setDetectMode",1,"CEnvelopeDetector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CEnvelopeDetector::setDetectMode",2,"UINT");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEnvelopeDetector,0))){
    SWIG_fail_ptr("CEnvelopeDetector_setDetectMode",1,SWIGTYPE_p_CEnvelopeDetector);
  }
...
static int _wrap_CEnvelopeDetector_setSampleRate(lua_State* L) {
  ...
  SWIG_check_num_args("CEnvelopeDetector::setSampleRate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEnvelopeDetector::setSampleRate",1,"CEnvelopeDetector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CEnvelopeDetector::setSampleRate",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEnvelopeDetector,0))){
    SWIG_fail_ptr("CEnvelopeDetector_setSampleRate",1,SWIGTYPE_p_CEnvelopeDetector);
  }
...
static int _wrap_CEnvelopeDetector_setLogDetect(lua_State* L) {
  ...
  SWIG_check_num_args("CEnvelopeDetector::setLogDetect",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEnvelopeDetector::setLogDetect",1,"CEnvelopeDetector *");
  if(!lua_isboolean(L,2)) SWIG_fail_arg("CEnvelopeDetector::setLogDetect",2,"bool");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEnvelopeDetector,0))){
    SWIG_fail_ptr("CEnvelopeDetector_setLogDetect",1,SWIGTYPE_p_CEnvelopeDetector);
  }
...
static int _wrap_CEnvelopeDetector_detect(lua_State* L) {
  ...
  SWIG_check_num_args("CEnvelopeDetector::detect",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEnvelopeDetector::detect",1,"CEnvelopeDetector *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CEnvelopeDetector::detect",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEnvelopeDetector,0))){
    SWIG_fail_ptr("CEnvelopeDetector_detect",1,SWIGTYPE_p_CEnvelopeDetector);
  }
  
  arg2 = (float)lua_tonumber(L, 2);
  result = (float)(arg1)->detect(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_CEnvelopeDetector_prepareForPlay(lua_State* L) {
  ...
  SWIG_check_num_args("CEnvelopeDetector::prepareForPlay",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CEnvelopeDetector::prepareForPlay",1,"CEnvelopeDetector *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CEnvelopeDetector,0))){
    SWIG_fail_ptr("CEnvelopeDetector_prepareForPlay",1,SWIGTYPE_p_CEnvelopeDetector);
  }
...
CEnvelopeDetector *arg1 = (CEnvelopeDetector *) obj;
delete arg1;
}
...
static swig_lua_class _wrap_class_CEnvelopeDetector = { "CEnvelopeDetector", "CEnvelopeDetector", &SWIGTYPE_p_CEnvelopeDetector,_proxy__wrap_new_CEnvelopeDetector, swig_delete_CEnvelopeDetector, swig_CEnvelopeDetector_methods, swig_CEnvelopeDetector_attributes, &swig_CEnvelopeDetector_Sf_SwigStatic, swig_CEnvelopeDetector_meta, swig_CEnvelopeDetector_bases, swig_CEnvelopeDetector_base_names };
...
static int _wrap_lagrpol(lua_State* L) {
  ...
  SWIG_check_num_args("lagrpol",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("lagrpol",1,"double *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("lagrpol",2,"double *");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("lagrpol",3,"int");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("lagrpol",4,"double");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_double,0))){
    SWIG_fail_ptr("lagrpol",1,SWIGTYPE_p_double);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_double,0))){
    SWIG_fail_ptr("lagrpol",2,SWIGTYPE_p_double);
  }
  
  arg3 = (int)lua_tonumber(L, 3);
  arg4 = (double)lua_tonumber(L, 4);
  result = (double)lagrpol(arg1,arg2,arg3,arg4);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static swig_type_info _swigt__p_CEnvelopeDetector = {"_p_CEnvelopeDetector", "CEnvelopeDetector *", 0, 0, (void*)&_wrap_class_CEnvelopeDetector, 0};
...
static swig_cast_info _swigc__p_CEnvelopeDetector[] = {  {&_swigt__p_CEnvelopeDetector, 0, 0, 0},{0, 0, 0, 0}};
