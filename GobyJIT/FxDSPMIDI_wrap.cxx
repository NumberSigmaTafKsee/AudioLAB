...
#define SWIGTYPE_p_DSPFX__FxMidi swig_types[1]
...
#define SWIG_name      "FxDSPMIDI"
#define SWIG_init      luaopen_FxDSPMIDI
#define SWIG_init_user luaopen_FxDSPMIDI_user

#define SWIG_LUACODE   luaopen_FxDSPMIDI_luacode
...
static int _wrap_FxMidi_midiNoteToFrequency(lua_State* L) {
  int SWIG_arg = 0;
  unsigned int arg1 ;
  float result;
  
  SWIG_check_num_args("DSPFX::FxMidi::midiNoteToFrequency",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("DSPFX::FxMidi::midiNoteToFrequency",1,"unsigned int");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative");
  arg1 = (unsigned int)lua_tonumber(L, 1);
  result = (float)DSPFX::FxMidi::midiNoteToFrequency(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_FxMidi_frequencyToMidiNote(lua_State* L) {
  int SWIG_arg = 0;
  float arg1 ;
  unsigned int result;
  
  SWIG_check_num_args("DSPFX::FxMidi::frequencyToMidiNote",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("DSPFX::FxMidi::frequencyToMidiNote",1,"float");
  arg1 = (float)lua_tonumber(L, 1);
  result = (unsigned int)DSPFX::FxMidi::frequencyToMidiNote(arg1);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_new_FxMidi(lua_State* L) {
  int SWIG_arg = 0;
  DSPFX::FxMidi *result = 0 ;
  
  SWIG_check_num_args("DSPFX::FxMidi::FxMidi",0,0)
  result = (DSPFX::FxMidi *)new DSPFX::FxMidi();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_DSPFX__FxMidi,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_FxMidi(void *obj) {
DSPFX::FxMidi *arg1 = (DSPFX::FxMidi *) obj;
delete arg1;
}
static int _proxy__wrap_new_FxMidi(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_FxMidi);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_FxMidi_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_FxMidi_methods[]= {
    {0,0}
};
static swig_lua_method swig_FxMidi_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_FxMidi_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_FxMidi_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_FxMidi_Sf_SwigStatic_methods[]= {
    { "midiNoteToFrequency", _wrap_FxMidi_midiNoteToFrequency},
    { "frequencyToMidiNote", _wrap_FxMidi_frequencyToMidiNote},
    {0,0}
};
static swig_lua_class* swig_FxMidi_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_FxMidi_Sf_SwigStatic = {
    "FxMidi",
    swig_FxMidi_Sf_SwigStatic_methods,
    swig_FxMidi_Sf_SwigStatic_attributes,
    swig_FxMidi_Sf_SwigStatic_constants,
    swig_FxMidi_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_FxMidi_bases[] = {0};
static const char *swig_FxMidi_base_names[] = {0};
static swig_lua_class _wrap_class_FxMidi = { "FxMidi", "FxMidi", &SWIGTYPE_p_DSPFX__FxMidi,_proxy__wrap_new_FxMidi, swig_delete_FxMidi, swig_FxMidi_methods, swig_FxMidi_attributes, &swig_FxMidi_Sf_SwigStatic, swig_FxMidi_meta, swig_FxMidi_bases, swig_FxMidi_base_names };
...
static swig_lua_method swig_SwigModule_methods[]= {
    ...
    { "FxMidi_midiNoteToFrequency", _wrap_FxMidi_midiNoteToFrequency},
    { "FxMidi_frequencyToMidiNote", _wrap_FxMidi_frequencyToMidiNote},
    {0,0}
};
...
static swig_type_info _swigt__p_DSPFX__FxMidi = {"_p_DSPFX__FxMidi", "DSPFX::FxMidi *", 0, 0, (void*)&_wrap_class_FxMidi, 0};
...
static swig_cast_info _swigc__p_DSPFX__FxMidi[] = {  {&_swigt__p_DSPFX__FxMidi, 0, 0, 0},{0, 0, 0, 0}};
