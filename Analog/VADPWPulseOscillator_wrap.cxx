...
#define SWIGTYPE_p_Analog__Oscillators__DPWPulse swig_types[1]
...
#define SWIG_name      "VADPWPulseOscillator"
#define SWIG_init      luaopen_VADPWPulseOscillator
#define SWIG_init_user luaopen_VADPWPulseOscillator_user

#define SWIG_LUACODE   luaopen_VADPWPulseOscillator_luacode
...
static int _wrap_DPWPulse_ProcessBlock(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::Oscillators::DPWPulse::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::Oscillators::DPWPulse::ProcessBlock",1,"Analog::Oscillators::DPWPulse *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::Oscillators::DPWPulse::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Analog::Oscillators::DPWPulse::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("Analog::Oscillators::DPWPulse::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__Oscillators__DPWPulse,0))){
    SWIG_fail_ptr("DPWPulse_ProcessBlock",1,SWIGTYPE_p_Analog__Oscillators__DPWPulse);
  }
...
static int _wrap_DPWPulse_ProcessInplace(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::Oscillators::DPWPulse::ProcessInplace",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::Oscillators::DPWPulse::ProcessInplace",1,"Analog::Oscillators::DPWPulse *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::Oscillators::DPWPulse::ProcessInplace",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Analog::Oscillators::DPWPulse::ProcessInplace",3,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__Oscillators__DPWPulse,0))){
    SWIG_fail_ptr("DPWPulse_ProcessInplace",1,SWIGTYPE_p_Analog__Oscillators__DPWPulse);
  }
