...
#define SWIGTYPE_p_p_Analog__MoogFilters__MoogFilter4__MoogFilter swig_types[49]
...
static int _wrap_MoogFilter_ProcessSIMD(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessSIMD",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessSIMD",1,"Analog::MoogFilters::MoogFilter4::MoogFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessSIMD",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessSIMD",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessSIMD",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MoogFilters__MoogFilter4__MoogFilter,0))){
    SWIG_fail_ptr("MoogFilter_ProcessSIMD",1,SWIGTYPE_p_Analog__MoogFilters__MoogFilter4__MoogFilter);
  }
...
static int _wrap_MoogFilter_ProcessInplace(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessInplace",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessInplace",1,"Analog::MoogFilters::MoogFilter4::MoogFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessInplace",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessInplace",3,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MoogFilters__MoogFilter4__MoogFilter,0))){
    SWIG_fail_ptr("MoogFilter_ProcessInplace",1,SWIGTYPE_p_Analog__MoogFilters__MoogFilter4__MoogFilter);
  }
...
static int _wrap_MoogFilter_ProcessBlock(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessBlock",4,4)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessBlock",1,"Analog::MoogFilters::MoogFilter4::MoogFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessBlock",2,"size_t");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessBlock",3,"DspFloatType *");
  if(!SWIG_isptrtype(L,4)) SWIG_fail_arg("Analog::MoogFilters::MoogFilter4::MoogFilter::ProcessBlock",4,"DspFloatType *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__MoogFilters__MoogFilter4__MoogFilter,0))){
    SWIG_fail_ptr("MoogFilter_ProcessBlock",1,SWIGTYPE_p_Analog__MoogFilters__MoogFilter4__MoogFilter);
  }
