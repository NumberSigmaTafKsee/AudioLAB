...
#define SWIGTYPE_p_Analog__KocMoc__FIRLowpass swig_types[0]
#define SWIGTYPE_p_Analog__KocMoc__IIRLowpass swig_types[1]
#define SWIGTYPE_p_Analog__KocMoc__Ladder swig_types[2]
#define SWIGTYPE_p_Analog__KocMoc__SKFilter swig_types[3]
#define SWIGTYPE_p_Analog__KocMoc__SVFilter swig_types[4]
#define SWIGTYPE_p_Random swig_types[5]
...
#define SWIGTYPE_p_std__numeric_limitsT_double_t swig_types[14]
#define SWIGTYPE_p_std__numeric_limitsT_float_t swig_types[15]
#define SWIGTYPE_p_std__numeric_limitsT_int_t swig_types[16]
#define SWIGTYPE_p_std__numeric_limitsT_long_long_t swig_types[17]
#define SWIGTYPE_p_std__numeric_limitsT_long_t swig_types[18]
#define SWIGTYPE_p_std__numeric_limitsT_short_t swig_types[19]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_int_t swig_types[20]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_long_long_t swig_types[21]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_long_t swig_types[22]
#define SWIGTYPE_p_std__numeric_limitsT_unsigned_short_t swig_types[23]
...
#define SWIGTYPE_p_std__vectorT_std__complexT_double_t_std__allocatorT_std__complexT_double_t_t_t swig_types[26]
...
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_double_t_std__allocatorT_std__complexT_double_t_t_t swig_types[30]
#define SWIGTYPE_p_std__vector_iteratorT_std__complexT_float_t_std__allocatorT_std__complexT_float_t_t_t swig_types[31]
...
#define SWIG_name      "analog_kocmoc_filters"
#define SWIG_init      luaopen_analog_kocmoc_filters
#define SWIG_init_user luaopen_analog_kocmoc_filters_user

#define SWIG_LUACODE   luaopen_analog_kocmoc_filters_luacode
...
#include "analog_kocmoc_filters.hpp"
...
static int _wrap_new_IIRLowpass__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  DspFloatType arg2 ;
  int arg3 ;
  Analog::KocMoc::IIRLowpass *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::IIRLowpass::IIRLowpass",3,3)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::IIRLowpass",1,"DspFloatType");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::IIRLowpass",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::IIRLowpass",3,"int");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  arg3 = (int)lua_tonumber(L, 3);
  result = (Analog::KocMoc::IIRLowpass *)new Analog::KocMoc::IIRLowpass(arg1,arg2,arg3);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__KocMoc__IIRLowpass,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_IIRLowpass__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::IIRLowpass *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::IIRLowpass::IIRLowpass",0,0)
  result = (Analog::KocMoc::IIRLowpass *)new Analog::KocMoc::IIRLowpass();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__KocMoc__IIRLowpass,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_IIRLowpass(lua_State* L) {
  int argc;
  int argv[4]={
    1,2,3,4
  };
  ...
  argc = lua_gettop(L);
  if (argc == 0) {
    return _wrap_new_IIRLowpass__SWIG_1(L);
  }
  if (argc == 3) {
    int _v = 0;
    {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_new_IIRLowpass__SWIG_0(L);
        }
      }
    }
  }
  
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'new_IIRLowpass'\n"
    "  Possible C/C++ prototypes are:\n"
    "    Analog::KocMoc::IIRLowpass::IIRLowpass(DspFloatType,DspFloatType,int)\n"
    "    Analog::KocMoc::IIRLowpass::IIRLowpass()\n");
  lua_error(L);return 0;
}


static int _wrap_IIRLowpass_SetFilterOrder(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::IIRLowpass *arg1 = (Analog::KocMoc::IIRLowpass *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::IIRLowpass::SetFilterOrder",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::SetFilterOrder",1,"Analog::KocMoc::IIRLowpass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::SetFilterOrder",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass,0))){
    SWIG_fail_ptr("IIRLowpass_SetFilterOrder",1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  (arg1)->SetFilterOrder(arg2);
...
static int _wrap_IIRLowpass_SetFilterSamplerate(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::IIRLowpass *arg1 = (Analog::KocMoc::IIRLowpass *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::IIRLowpass::SetFilterSamplerate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::SetFilterSamplerate",1,"Analog::KocMoc::IIRLowpass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::SetFilterSamplerate",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass,0))){
    SWIG_fail_ptr("IIRLowpass_SetFilterSamplerate",1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  (arg1)->SetFilterSamplerate(arg2);
...
static int _wrap_IIRLowpass_SetFilterCutoff(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::IIRLowpass *arg1 = (Analog::KocMoc::IIRLowpass *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::IIRLowpass::SetFilterCutoff",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::SetFilterCutoff",1,"Analog::KocMoc::IIRLowpass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::SetFilterCutoff",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass,0))){
    SWIG_fail_ptr("IIRLowpass_SetFilterCutoff",1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  (arg1)->SetFilterCutoff(arg2);
...
static int _wrap_IIRLowpass_InitializeBiquadCascade(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::IIRLowpass *arg1 = (Analog::KocMoc::IIRLowpass *) 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::IIRLowpass::InitializeBiquadCascade",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::InitializeBiquadCascade",1,"Analog::KocMoc::IIRLowpass *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass,0))){
    SWIG_fail_ptr("IIRLowpass_InitializeBiquadCascade",1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass);
  }
  
  (arg1)->InitializeBiquadCascade();
...
static int _wrap_IIRLowpass_IIRfilter(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::IIRLowpass *arg1 = (Analog::KocMoc::IIRLowpass *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::IIRLowpass::IIRfilter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::IIRfilter",1,"Analog::KocMoc::IIRLowpass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::IIRfilter",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass,0))){
    SWIG_fail_ptr("IIRLowpass_IIRfilter",1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  result = (DspFloatType)(arg1)->IIRfilter(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_IIRLowpass_GetFilterCoeffA1(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::IIRLowpass *arg1 = (Analog::KocMoc::IIRLowpass *) 0 ;
  DspFloatType *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::IIRLowpass::GetFilterCoeffA1",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::GetFilterCoeffA1",1,"Analog::KocMoc::IIRLowpass *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass,0))){
    SWIG_fail_ptr("IIRLowpass_GetFilterCoeffA1",1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass);
  }
  
  result = (DspFloatType *)(arg1)->GetFilterCoeffA1();
...
static int _wrap_IIRLowpass_GetFilterCoeffA2(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::IIRLowpass *arg1 = (Analog::KocMoc::IIRLowpass *) 0 ;
  DspFloatType *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::IIRLowpass::GetFilterCoeffA2",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::GetFilterCoeffA2",1,"Analog::KocMoc::IIRLowpass *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass,0))){
    SWIG_fail_ptr("IIRLowpass_GetFilterCoeffA2",1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass);
  }
  
  result = (DspFloatType *)(arg1)->GetFilterCoeffA2();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_float,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_IIRLowpass_GetFilterCoeffK(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::IIRLowpass *arg1 = (Analog::KocMoc::IIRLowpass *) 0 ;
  DspFloatType *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::IIRLowpass::GetFilterCoeffK",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::IIRLowpass::GetFilterCoeffK",1,"Analog::KocMoc::IIRLowpass *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass,0))){
    SWIG_fail_ptr("IIRLowpass_GetFilterCoeffK",1,SWIGTYPE_p_Analog__KocMoc__IIRLowpass);
  }
  
  result = (DspFloatType *)(arg1)->GetFilterCoeffK();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_float,0); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_IIRLowpass(void *obj) {
Analog::KocMoc::IIRLowpass *arg1 = (Analog::KocMoc::IIRLowpass *) obj;
delete arg1;
}
static int _proxy__wrap_new_IIRLowpass(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_IIRLowpass);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_IIRLowpass_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_IIRLowpass_methods[]= {
    { "SetFilterOrder", _wrap_IIRLowpass_SetFilterOrder},
    { "SetFilterSamplerate", _wrap_IIRLowpass_SetFilterSamplerate},
    { "SetFilterCutoff", _wrap_IIRLowpass_SetFilterCutoff},
    { "InitializeBiquadCascade", _wrap_IIRLowpass_InitializeBiquadCascade},
    { "IIRfilter", _wrap_IIRLowpass_IIRfilter},
    { "GetFilterCoeffA1", _wrap_IIRLowpass_GetFilterCoeffA1},
    { "GetFilterCoeffA2", _wrap_IIRLowpass_GetFilterCoeffA2},
    { "GetFilterCoeffK", _wrap_IIRLowpass_GetFilterCoeffK},
    {0,0}
};
static swig_lua_method swig_IIRLowpass_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_IIRLowpass_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_IIRLowpass_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_IIRLowpass_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_IIRLowpass_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_IIRLowpass_Sf_SwigStatic = {
    "IIRLowpass",
    swig_IIRLowpass_Sf_SwigStatic_methods,
    swig_IIRLowpass_Sf_SwigStatic_attributes,
    swig_IIRLowpass_Sf_SwigStatic_constants,
    swig_IIRLowpass_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_IIRLowpass_bases[] = {0};
static const char *swig_IIRLowpass_base_names[] = {0};
static swig_lua_class _wrap_class_IIRLowpass = { "IIRLowpass", "IIRLowpass", &SWIGTYPE_p_Analog__KocMoc__IIRLowpass,_proxy__wrap_new_IIRLowpass, swig_delete_IIRLowpass, swig_IIRLowpass_methods, swig_IIRLowpass_attributes, &swig_IIRLowpass_Sf_SwigStatic, swig_IIRLowpass_meta, swig_IIRLowpass_bases, swig_IIRLowpass_base_names };

static int _wrap_new_FIRLowpass__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  DspFloatType arg2 ;
  int arg3 ;
  Analog::KocMoc::FIRLowpass *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::FIRLowpass::FIRLowpass",3,3)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::FIRLowpass",1,"DspFloatType");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::FIRLowpass",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::FIRLowpass",3,"int");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  arg3 = (int)lua_tonumber(L, 3);
  result = (Analog::KocMoc::FIRLowpass *)new Analog::KocMoc::FIRLowpass(arg1,arg2,arg3);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__KocMoc__FIRLowpass,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_FIRLowpass__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::FIRLowpass *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::FIRLowpass::FIRLowpass",0,0)
  result = (Analog::KocMoc::FIRLowpass *)new Analog::KocMoc::FIRLowpass();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__KocMoc__FIRLowpass,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_FIRLowpass(lua_State* L) {
  int argc;
  int argv[4]={
    1,2,3,4
  };
  ...
  argc = lua_gettop(L);
  if (argc == 0) {
    return _wrap_new_FIRLowpass__SWIG_1(L);
  }
  if (argc == 3) {
    int _v = 0;
    {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_new_FIRLowpass__SWIG_0(L);
        }
      }
    }
  }
  
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'new_FIRLowpass'\n"
    "  Possible C/C++ prototypes are:\n"
    "    Analog::KocMoc::FIRLowpass::FIRLowpass(DspFloatType,DspFloatType,int)\n"
    "    Analog::KocMoc::FIRLowpass::FIRLowpass()\n");
  lua_error(L);return 0;
}


static int _wrap_FIRLowpass_SetFilterOrder(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::FIRLowpass *arg1 = (Analog::KocMoc::FIRLowpass *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::FIRLowpass::SetFilterOrder",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::SetFilterOrder",1,"Analog::KocMoc::FIRLowpass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::SetFilterOrder",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass,0))){
    SWIG_fail_ptr("FIRLowpass_SetFilterOrder",1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass);
  }
...
static int _wrap_FIRLowpass_SetFilterSamplerate(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::FIRLowpass *arg1 = (Analog::KocMoc::FIRLowpass *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::FIRLowpass::SetFilterSamplerate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::SetFilterSamplerate",1,"Analog::KocMoc::FIRLowpass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::SetFilterSamplerate",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass,0))){
    SWIG_fail_ptr("FIRLowpass_SetFilterSamplerate",1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass);
  }
...
static int _wrap_FIRLowpass_SetFilterCutoff(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::FIRLowpass *arg1 = (Analog::KocMoc::FIRLowpass *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::FIRLowpass::SetFilterCutoff",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::SetFilterCutoff",1,"Analog::KocMoc::FIRLowpass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::SetFilterCutoff",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass,0))){
    SWIG_fail_ptr("FIRLowpass_SetFilterCutoff",1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass);
  }
...
static int _wrap_FIRLowpass_FIRfilter(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::FIRLowpass *arg1 = (Analog::KocMoc::FIRLowpass *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::FIRLowpass::FIRfilter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::FIRfilter",1,"Analog::KocMoc::FIRLowpass *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::FIRfilter",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass,0))){
    SWIG_fail_ptr("FIRLowpass_FIRfilter",1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  result = (DspFloatType)(arg1)->FIRfilter(arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_FIRLowpass_GetImpulseResponse(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::FIRLowpass *arg1 = (Analog::KocMoc::FIRLowpass *) 0 ;
  DspFloatType *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::FIRLowpass::GetImpulseResponse",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::GetImpulseResponse",1,"Analog::KocMoc::FIRLowpass *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass,0))){
    SWIG_fail_ptr("FIRLowpass_GetImpulseResponse",1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass);
  }
  
  result = (DspFloatType *)(arg1)->GetImpulseResponse();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_float,0); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_FIRLowpass_InitializeRingbuffer(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::FIRLowpass *arg1 = (Analog::KocMoc::FIRLowpass *) 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::FIRLowpass::InitializeRingbuffer",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::FIRLowpass::InitializeRingbuffer",1,"Analog::KocMoc::FIRLowpass *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass,0))){
    SWIG_fail_ptr("FIRLowpass_InitializeRingbuffer",1,SWIGTYPE_p_Analog__KocMoc__FIRLowpass);
  }
  
  (arg1)->InitializeRingbuffer();
...
static void swig_delete_FIRLowpass(void *obj) {
Analog::KocMoc::FIRLowpass *arg1 = (Analog::KocMoc::FIRLowpass *) obj;
delete arg1;
}
static int _proxy__wrap_new_FIRLowpass(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_FIRLowpass);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_FIRLowpass_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_FIRLowpass_methods[]= {
    { "SetFilterOrder", _wrap_FIRLowpass_SetFilterOrder},
    { "SetFilterSamplerate", _wrap_FIRLowpass_SetFilterSamplerate},
    { "SetFilterCutoff", _wrap_FIRLowpass_SetFilterCutoff},
    { "FIRfilter", _wrap_FIRLowpass_FIRfilter},
    { "GetImpulseResponse", _wrap_FIRLowpass_GetImpulseResponse},
    { "InitializeRingbuffer", _wrap_FIRLowpass_InitializeRingbuffer},
    {0,0}
};
static swig_lua_method swig_FIRLowpass_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_FIRLowpass_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_FIRLowpass_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_FIRLowpass_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_FIRLowpass_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_FIRLowpass_Sf_SwigStatic = {
    "FIRLowpass",
    swig_FIRLowpass_Sf_SwigStatic_methods,
    swig_FIRLowpass_Sf_SwigStatic_attributes,
    swig_FIRLowpass_Sf_SwigStatic_constants,
    swig_FIRLowpass_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_FIRLowpass_bases[] = {0};
static const char *swig_FIRLowpass_base_names[] = {0};
static swig_lua_class _wrap_class_FIRLowpass = { "FIRLowpass", "FIRLowpass", &SWIGTYPE_p_Analog__KocMoc__FIRLowpass,_proxy__wrap_new_FIRLowpass, swig_delete_FIRLowpass, swig_FIRLowpass_methods, swig_FIRLowpass_attributes, &swig_FIRLowpass_Sf_SwigStatic, swig_FIRLowpass_meta, swig_FIRLowpass_bases, swig_FIRLowpass_base_names };

static int _wrap_new_Ladder__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  DspFloatType arg2 ;
  int arg3 ;
  Analog::KocMoc::LadderFilterMode arg4 ;
  DspFloatType arg5 ;
  Analog::KocMoc::LadderIntegrationMethod arg6 ;
  int arg7 ;
  Analog::KocMoc::Ladder *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::Ladder",7,7)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::Ladder",1,"DspFloatType");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::Ladder::Ladder",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Analog::KocMoc::Ladder::Ladder",3,"int");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("Analog::KocMoc::Ladder::Ladder",4,"Analog::KocMoc::LadderFilterMode");
  if(!lua_isnumber(L,5)) SWIG_fail_arg("Analog::KocMoc::Ladder::Ladder",5,"DspFloatType");
  if(!lua_isnumber(L,6)) SWIG_fail_arg("Analog::KocMoc::Ladder::Ladder",6,"Analog::KocMoc::LadderIntegrationMethod");
  if(!lua_isnumber(L,7)) SWIG_fail_arg("Analog::KocMoc::Ladder::Ladder",7,"int");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  arg3 = (int)lua_tonumber(L, 3);
  arg4 = (Analog::KocMoc::LadderFilterMode)(int)lua_tonumber(L, 4);
  arg5 = (DspFloatType)lua_tonumber(L, 5);
  arg6 = (Analog::KocMoc::LadderIntegrationMethod)(int)lua_tonumber(L, 6);
  arg7 = (int)lua_tonumber(L, 7);
  result = (Analog::KocMoc::Ladder *)new Analog::KocMoc::Ladder(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__KocMoc__Ladder,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_Ladder__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::Ladder",0,0)
  result = (Analog::KocMoc::Ladder *)new Analog::KocMoc::Ladder();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__KocMoc__Ladder,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_Ladder(lua_State* L) {
  int argc;
  int argv[8]={
    1,2,3,4,5,6,7,8
  };
  ...
  argc = lua_gettop(L);
  if (argc == 0) {
    return _wrap_new_Ladder__SWIG_1(L);
  }
  if (argc == 7) {
    int _v = 0;
    {
          ...
          if (_v) {
            ...
            if (_v) {
              ...
              if (_v) {
                ...
                if (_v) {
                  return _wrap_new_Ladder__SWIG_0(L);
                }
              }
            }
          }
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'new_Ladder'\n"
    "  Possible C/C++ prototypes are:\n"
    "    Analog::KocMoc::Ladder::Ladder(DspFloatType,DspFloatType,int,Analog::KocMoc::LadderFilterMode,DspFloatType,Analog::KocMoc::LadderIntegrationMethod,int)\n"
    "    Analog::KocMoc::Ladder::Ladder()\n");
  lua_error(L);return 0;
}


static int _wrap_Ladder_SetFilterCutoff(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::SetFilterCutoff",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterCutoff",1,"Analog::KocMoc::Ladder *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterCutoff",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_SetFilterCutoff",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
...
static int _wrap_Ladder_SetFilterResonance(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::SetFilterResonance",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterResonance",1,"Analog::KocMoc::Ladder *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterResonance",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_SetFilterResonance",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  (arg1)->SetFilterResonance(arg2);
...
static int _wrap_Ladder_SetFilterMode(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  Analog::KocMoc::LadderFilterMode arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::SetFilterMode",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterMode",1,"Analog::KocMoc::Ladder *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterMode",2,"Analog::KocMoc::LadderFilterMode");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_SetFilterMode",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  arg2 = (Analog::KocMoc::LadderFilterMode)(int)lua_tonumber(L, 2);
...
static int _wrap_Ladder_SetFilterSampleRate(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::SetFilterSampleRate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterSampleRate",1,"Analog::KocMoc::Ladder *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterSampleRate",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_SetFilterSampleRate",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
...
static int _wrap_Ladder_SetFilterIntegrationMethod(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  Analog::KocMoc::LadderIntegrationMethod arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::SetFilterIntegrationMethod",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterIntegrationMethod",1,"Analog::KocMoc::Ladder *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterIntegrationMethod",2,"Analog::KocMoc::LadderIntegrationMethod");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_SetFilterIntegrationMethod",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  arg2 = (Analog::KocMoc::LadderIntegrationMethod)(int)lua_tonumber(L, 2);
  (arg1)->SetFilterIntegrationMethod(arg2);
...
static int _wrap_Ladder_SetFilterOversamplingFactor(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::SetFilterOversamplingFactor",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterOversamplingFactor",1,"Analog::KocMoc::Ladder *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterOversamplingFactor",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_SetFilterOversamplingFactor",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  (arg1)->SetFilterOversamplingFactor(arg2);
...
static int _wrap_Ladder_SetFilterDecimatorOrder(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::SetFilterDecimatorOrder",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterDecimatorOrder",1,"Analog::KocMoc::Ladder *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::Ladder::SetFilterDecimatorOrder",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_SetFilterDecimatorOrder",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  arg2 = (int)lua_tonumber(L, 2);
  (arg1)->SetFilterDecimatorOrder(arg2);
...
static int _wrap_Ladder_GetFilterCutoff(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterCutoff",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterCutoff",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterCutoff",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (DspFloatType)(arg1)->GetFilterCutoff();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Ladder_GetFilterResonance(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterResonance",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterResonance",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterResonance",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (DspFloatType)(arg1)->GetFilterResonance();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Ladder_GetFilterMode(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  Analog::KocMoc::LadderFilterMode result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterMode",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterMode",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterMode",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (Analog::KocMoc::LadderFilterMode)(arg1)->GetFilterMode();
...
static int _wrap_Ladder_GetFilterSampleRate(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterSampleRate",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterSampleRate",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterSampleRate",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (DspFloatType)(arg1)->GetFilterSampleRate();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Ladder_GetFilterIntegrationMethod(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  Analog::KocMoc::LadderIntegrationMethod result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterIntegrationMethod",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterIntegrationMethod",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterIntegrationMethod",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (Analog::KocMoc::LadderIntegrationMethod)(arg1)->GetFilterIntegrationMethod();
  lua_pushnumber(L, (lua_Number)(int)(result)); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Ladder_GetFilterOversamplingFactor(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  int result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterOversamplingFactor",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterOversamplingFactor",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterOversamplingFactor",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (int)(arg1)->GetFilterOversamplingFactor();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Ladder_GetFilterDecimatorOrder(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  int result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterDecimatorOrder",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterDecimatorOrder",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterDecimatorOrder",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (int)(arg1)->GetFilterDecimatorOrder();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Ladder_LadderFilter(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::LadderFilter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::LadderFilter",1,"Analog::KocMoc::Ladder *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::Ladder::LadderFilter",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_LadderFilter",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  (arg1)->LadderFilter(arg2);
...
static int _wrap_Ladder_GetFilterLowpass(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterLowpass",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterLowpass",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterLowpass",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (DspFloatType)(arg1)->GetFilterLowpass();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Ladder_GetFilterBandpass(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterBandpass",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterBandpass",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterBandpass",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (DspFloatType)(arg1)->GetFilterBandpass();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Ladder_GetFilterHighpass(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterHighpass",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterHighpass",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterHighpass",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (DspFloatType)(arg1)->GetFilterHighpass();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Ladder_GetFilterOutput(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::GetFilterOutput",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::GetFilterOutput",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_GetFilterOutput",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  result = (DspFloatType)(arg1)->GetFilterOutput();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Ladder_ResetFilterState(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::Ladder::ResetFilterState",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::Ladder::ResetFilterState",1,"Analog::KocMoc::Ladder *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__Ladder,0))){
    SWIG_fail_ptr("Ladder_ResetFilterState",1,SWIGTYPE_p_Analog__KocMoc__Ladder);
  }
  
  (arg1)->ResetFilterState();
...
static void swig_delete_Ladder(void *obj) {
Analog::KocMoc::Ladder *arg1 = (Analog::KocMoc::Ladder *) obj;
delete arg1;
}
static int _proxy__wrap_new_Ladder(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_Ladder);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_Ladder_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Ladder_methods[]= {
    { "SetFilterCutoff", _wrap_Ladder_SetFilterCutoff},
    { "SetFilterResonance", _wrap_Ladder_SetFilterResonance},
    { "SetFilterMode", _wrap_Ladder_SetFilterMode},
    { "SetFilterSampleRate", _wrap_Ladder_SetFilterSampleRate},
    { "SetFilterIntegrationMethod", _wrap_Ladder_SetFilterIntegrationMethod},
    { "SetFilterOversamplingFactor", _wrap_Ladder_SetFilterOversamplingFactor},
    { "SetFilterDecimatorOrder", _wrap_Ladder_SetFilterDecimatorOrder},
    { "GetFilterCutoff", _wrap_Ladder_GetFilterCutoff},
    { "GetFilterResonance", _wrap_Ladder_GetFilterResonance},
    { "GetFilterMode", _wrap_Ladder_GetFilterMode},
    { "GetFilterSampleRate", _wrap_Ladder_GetFilterSampleRate},
    { "GetFilterIntegrationMethod", _wrap_Ladder_GetFilterIntegrationMethod},
    { "GetFilterOversamplingFactor", _wrap_Ladder_GetFilterOversamplingFactor},
    { "GetFilterDecimatorOrder", _wrap_Ladder_GetFilterDecimatorOrder},
    { "LadderFilter", _wrap_Ladder_LadderFilter},
    { "GetFilterLowpass", _wrap_Ladder_GetFilterLowpass},
    { "GetFilterBandpass", _wrap_Ladder_GetFilterBandpass},
    { "GetFilterHighpass", _wrap_Ladder_GetFilterHighpass},
    { "GetFilterOutput", _wrap_Ladder_GetFilterOutput},
    { "ResetFilterState", _wrap_Ladder_ResetFilterState},
    {0,0}
};
static swig_lua_method swig_Ladder_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_Ladder_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_Ladder_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_Ladder_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_Ladder_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_Ladder_Sf_SwigStatic = {
    "Ladder",
    swig_Ladder_Sf_SwigStatic_methods,
    swig_Ladder_Sf_SwigStatic_attributes,
    swig_Ladder_Sf_SwigStatic_constants,
    swig_Ladder_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_Ladder_bases[] = {0};
static const char *swig_Ladder_base_names[] = {0};
static swig_lua_class _wrap_class_Ladder = { "Ladder", "Ladder", &SWIGTYPE_p_Analog__KocMoc__Ladder,_proxy__wrap_new_Ladder, swig_delete_Ladder, swig_Ladder_methods, swig_Ladder_attributes, &swig_Ladder_Sf_SwigStatic, swig_Ladder_meta, swig_Ladder_bases, swig_Ladder_base_names };

static int _wrap_new_SKFilter__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  DspFloatType arg2 ;
  int arg3 ;
  Analog::KocMoc::SKFilterMode arg4 ;
  DspFloatType arg5 ;
  Analog::KocMoc::SKIntegrationMethod arg6 ;
  int arg7 ;
  Analog::KocMoc::SKFilter *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SKFilter",7,7)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SKFilter",1,"DspFloatType");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SKFilter",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SKFilter",3,"int");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SKFilter",4,"Analog::KocMoc::SKFilterMode");
  if(!lua_isnumber(L,5)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SKFilter",5,"DspFloatType");
  if(!lua_isnumber(L,6)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SKFilter",6,"Analog::KocMoc::SKIntegrationMethod");
  if(!lua_isnumber(L,7)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SKFilter",7,"int");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  arg3 = (int)lua_tonumber(L, 3);
  arg4 = (Analog::KocMoc::SKFilterMode)(int)lua_tonumber(L, 4);
  arg5 = (DspFloatType)lua_tonumber(L, 5);
  arg6 = (Analog::KocMoc::SKIntegrationMethod)(int)lua_tonumber(L, 6);
  arg7 = (int)lua_tonumber(L, 7);
  result = (Analog::KocMoc::SKFilter *)new Analog::KocMoc::SKFilter(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__KocMoc__SKFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_SKFilter__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SKFilter",0,0)
  result = (Analog::KocMoc::SKFilter *)new Analog::KocMoc::SKFilter();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__KocMoc__SKFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_SKFilter(lua_State* L) {
  int argc;
  int argv[8]={
    1,2,3,4,5,6,7,8
  };
  ...
  argc = lua_gettop(L);
  if (argc == 0) {
    return _wrap_new_SKFilter__SWIG_1(L);
  }
  if (argc == 7) {
    int _v = 0;
    {
          ...
          if (_v) {
            ...
            if (_v) {
              ...
              if (_v) {
                ...
                if (_v) {
                  return _wrap_new_SKFilter__SWIG_0(L);
                }
              }
            }
          }
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'new_SKFilter'\n"
    "  Possible C/C++ prototypes are:\n"
    "    Analog::KocMoc::SKFilter::SKFilter(DspFloatType,DspFloatType,int,Analog::KocMoc::SKFilterMode,DspFloatType,Analog::KocMoc::SKIntegrationMethod,int)\n"
    "    Analog::KocMoc::SKFilter::SKFilter()\n");
  lua_error(L);return 0;
}


static int _wrap_SKFilter_SetFilterCutoff(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SetFilterCutoff",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterCutoff",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterCutoff",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_SetFilterCutoff",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_SetFilterResonance(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SetFilterResonance",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterResonance",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterResonance",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_SetFilterResonance",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_SetFilterMode(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  Analog::KocMoc::SKFilterMode arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SetFilterMode",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterMode",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterMode",2,"Analog::KocMoc::SKFilterMode");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_SetFilterMode",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
  
  arg2 = (Analog::KocMoc::SKFilterMode)(int)lua_tonumber(L, 2);
  (arg1)->SetFilterMode(arg2);
...
static int _wrap_SKFilter_SetFilterSampleRate(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SetFilterSampleRate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterSampleRate",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterSampleRate",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_SetFilterSampleRate",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_SetFilterIntegrationMethod(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  Analog::KocMoc::SKIntegrationMethod arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SetFilterIntegrationMethod",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterIntegrationMethod",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterIntegrationMethod",2,"Analog::KocMoc::SKIntegrationMethod");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_SetFilterIntegrationMethod",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
  
  arg2 = (Analog::KocMoc::SKIntegrationMethod)(int)lua_tonumber(L, 2);
  (arg1)->SetFilterIntegrationMethod(arg2);
...
static int _wrap_SKFilter_SetFilterOversamplingFactor(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SetFilterOversamplingFactor",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterOversamplingFactor",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterOversamplingFactor",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_SetFilterOversamplingFactor",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_SetFilterDecimatorOrder(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SetFilterDecimatorOrder",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterDecimatorOrder",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterDecimatorOrder",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_SetFilterDecimatorOrder",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_GetFilterCutoff(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::GetFilterCutoff",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::GetFilterCutoff",1,"Analog::KocMoc::SKFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_GetFilterCutoff",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_GetFilterResonance(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::GetFilterResonance",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::GetFilterResonance",1,"Analog::KocMoc::SKFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_GetFilterResonance",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_GetFilterMode(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  Analog::KocMoc::SKFilterMode result;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::GetFilterMode",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::GetFilterMode",1,"Analog::KocMoc::SKFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_GetFilterMode",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
  
  result = (Analog::KocMoc::SKFilterMode)(arg1)->GetFilterMode();
  lua_pushnumber(L, (lua_Number)(int)(result)); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SKFilter_GetFilterSampleRate(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::GetFilterSampleRate",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::GetFilterSampleRate",1,"Analog::KocMoc::SKFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_GetFilterSampleRate",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_GetFilterIntegrationMethod(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  Analog::KocMoc::SKIntegrationMethod result;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::GetFilterIntegrationMethod",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::GetFilterIntegrationMethod",1,"Analog::KocMoc::SKFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_GetFilterIntegrationMethod",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
  
  result = (Analog::KocMoc::SKIntegrationMethod)(arg1)->GetFilterIntegrationMethod();
  lua_pushnumber(L, (lua_Number)(int)(result)); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SKFilter_GetFilterOversamplingFactor(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  int result;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::GetFilterOversamplingFactor",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::GetFilterOversamplingFactor",1,"Analog::KocMoc::SKFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_GetFilterOversamplingFactor",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_GetFilterDecimatorOrder(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  int result;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::GetFilterDecimatorOrder",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::GetFilterDecimatorOrder",1,"Analog::KocMoc::SKFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_GetFilterDecimatorOrder",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_filter(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::filter",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::filter",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_filter",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_SetFilterLowpassInput(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SetFilterLowpassInput",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterLowpassInput",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterLowpassInput",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_SetFilterLowpassInput",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  (arg1)->SetFilterLowpassInput(arg2);
...
static int _wrap_SKFilter_SetFilterBandpassInput(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SetFilterBandpassInput",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterBandpassInput",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterBandpassInput",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_SetFilterBandpassInput",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  (arg1)->SetFilterBandpassInput(arg2);
...
static int _wrap_SKFilter_SetFilterHighpassInput(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::SetFilterHighpassInput",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterHighpassInput",1,"Analog::KocMoc::SKFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SKFilter::SetFilterHighpassInput",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_SetFilterHighpassInput",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  (arg1)->SetFilterHighpassInput(arg2);
...
static int _wrap_SKFilter_GetFilterOutput(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::GetFilterOutput",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::GetFilterOutput",1,"Analog::KocMoc::SKFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_GetFilterOutput",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static int _wrap_SKFilter_ResetFilterState(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::SKFilter::ResetFilterState",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SKFilter::ResetFilterState",1,"Analog::KocMoc::SKFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SKFilter,0))){
    SWIG_fail_ptr("SKFilter_ResetFilterState",1,SWIGTYPE_p_Analog__KocMoc__SKFilter);
  }
...
static void swig_delete_SKFilter(void *obj) {
Analog::KocMoc::SKFilter *arg1 = (Analog::KocMoc::SKFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_SKFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_SKFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_SKFilter_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_SKFilter_methods[]= {
    { "SetFilterCutoff", _wrap_SKFilter_SetFilterCutoff},
    { "SetFilterResonance", _wrap_SKFilter_SetFilterResonance},
    { "SetFilterMode", _wrap_SKFilter_SetFilterMode},
    { "SetFilterSampleRate", _wrap_SKFilter_SetFilterSampleRate},
    { "SetFilterIntegrationMethod", _wrap_SKFilter_SetFilterIntegrationMethod},
    { "SetFilterOversamplingFactor", _wrap_SKFilter_SetFilterOversamplingFactor},
    { "SetFilterDecimatorOrder", _wrap_SKFilter_SetFilterDecimatorOrder},
    { "GetFilterCutoff", _wrap_SKFilter_GetFilterCutoff},
    { "GetFilterResonance", _wrap_SKFilter_GetFilterResonance},
    { "GetFilterMode", _wrap_SKFilter_GetFilterMode},
    { "GetFilterSampleRate", _wrap_SKFilter_GetFilterSampleRate},
    { "GetFilterIntegrationMethod", _wrap_SKFilter_GetFilterIntegrationMethod},
    { "GetFilterOversamplingFactor", _wrap_SKFilter_GetFilterOversamplingFactor},
    { "GetFilterDecimatorOrder", _wrap_SKFilter_GetFilterDecimatorOrder},
    { "filter", _wrap_SKFilter_filter},
    { "SetFilterLowpassInput", _wrap_SKFilter_SetFilterLowpassInput},
    { "SetFilterBandpassInput", _wrap_SKFilter_SetFilterBandpassInput},
    { "SetFilterHighpassInput", _wrap_SKFilter_SetFilterHighpassInput},
    { "GetFilterOutput", _wrap_SKFilter_GetFilterOutput},
    { "ResetFilterState", _wrap_SKFilter_ResetFilterState},
    {0,0}
};
static swig_lua_method swig_SKFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_SKFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_SKFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_SKFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_SKFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_SKFilter_Sf_SwigStatic = {
    "SKFilter",
    swig_SKFilter_Sf_SwigStatic_methods,
    swig_SKFilter_Sf_SwigStatic_attributes,
    swig_SKFilter_Sf_SwigStatic_constants,
    swig_SKFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_SKFilter_bases[] = {0};
static const char *swig_SKFilter_base_names[] = {0};
static swig_lua_class _wrap_class_SKFilter = { "SKFilter", "SKFilter", &SWIGTYPE_p_Analog__KocMoc__SKFilter,_proxy__wrap_new_SKFilter, swig_delete_SKFilter, swig_SKFilter_methods, swig_SKFilter_attributes, &swig_SKFilter_Sf_SwigStatic, swig_SKFilter_meta, swig_SKFilter_bases, swig_SKFilter_base_names };

static int _wrap_new_SVFilter__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  DspFloatType arg1 ;
  DspFloatType arg2 ;
  int arg3 ;
  Analog::KocMoc::SVFFilterMode arg4 ;
  DspFloatType arg5 ;
  Analog::KocMoc::SVFIntegrationMethod arg6 ;
  int arg7 ;
  Analog::KocMoc::SVFilter *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::SVFilter",7,7)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SVFilter",1,"DspFloatType");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SVFilter",2,"DspFloatType");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SVFilter",3,"int");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SVFilter",4,"Analog::KocMoc::SVFFilterMode");
  if(!lua_isnumber(L,5)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SVFilter",5,"DspFloatType");
  if(!lua_isnumber(L,6)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SVFilter",6,"Analog::KocMoc::SVFIntegrationMethod");
  if(!lua_isnumber(L,7)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SVFilter",7,"int");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  arg3 = (int)lua_tonumber(L, 3);
  arg4 = (Analog::KocMoc::SVFFilterMode)(int)lua_tonumber(L, 4);
  arg5 = (DspFloatType)lua_tonumber(L, 5);
  arg6 = (Analog::KocMoc::SVFIntegrationMethod)(int)lua_tonumber(L, 6);
  arg7 = (int)lua_tonumber(L, 7);
  result = (Analog::KocMoc::SVFilter *)new Analog::KocMoc::SVFilter(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__KocMoc__SVFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_SVFilter__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *result = 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::SVFilter",0,0)
  result = (Analog::KocMoc::SVFilter *)new Analog::KocMoc::SVFilter();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Analog__KocMoc__SVFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_SVFilter(lua_State* L) {
  int argc;
  int argv[8]={
    1,2,3,4,5,6,7,8
  };
  ...
  argc = lua_gettop(L);
  if (argc == 0) {
    return _wrap_new_SVFilter__SWIG_1(L);
  }
  if (argc == 7) {
    int _v = 0;
    {
          ...
          if (_v) {
            ...
            if (_v) {
              ...
              if (_v) {
                ...
                if (_v) {
                  return _wrap_new_SVFilter__SWIG_0(L);
                }
              }
            }
          }
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'new_SVFilter'\n"
    "  Possible C/C++ prototypes are:\n"
    "    Analog::KocMoc::SVFilter::SVFilter(DspFloatType,DspFloatType,int,Analog::KocMoc::SVFFilterMode,DspFloatType,Analog::KocMoc::SVFIntegrationMethod,int)\n"
    "    Analog::KocMoc::SVFilter::SVFilter()\n");
  lua_error(L);return 0;
}


static int _wrap_SVFilter_SetFilterCutoff(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::SetFilterCutoff",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterCutoff",1,"Analog::KocMoc::SVFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterCutoff",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_SetFilterCutoff",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_SetFilterResonance(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::SetFilterResonance",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterResonance",1,"Analog::KocMoc::SVFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterResonance",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_SetFilterResonance",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_SetFilterMode(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  Analog::KocMoc::SVFFilterMode arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::SetFilterMode",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterMode",1,"Analog::KocMoc::SVFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterMode",2,"Analog::KocMoc::SVFFilterMode");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_SetFilterMode",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
  
  arg2 = (Analog::KocMoc::SVFFilterMode)(int)lua_tonumber(L, 2);
  (arg1)->SetFilterMode(arg2);
...
static int _wrap_SVFilter_SetFilterSampleRate(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::SetFilterSampleRate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterSampleRate",1,"Analog::KocMoc::SVFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterSampleRate",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_SetFilterSampleRate",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_SetFilterIntegrationMethod(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  Analog::KocMoc::SVFIntegrationMethod arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::SetFilterIntegrationMethod",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterIntegrationMethod",1,"Analog::KocMoc::SVFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterIntegrationMethod",2,"Analog::KocMoc::SVFIntegrationMethod");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_SetFilterIntegrationMethod",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
  
  arg2 = (Analog::KocMoc::SVFIntegrationMethod)(int)lua_tonumber(L, 2);
  (arg1)->SetFilterIntegrationMethod(arg2);
...
static int _wrap_SVFilter_SetFilterOversamplingFactor(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::SetFilterOversamplingFactor",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterOversamplingFactor",1,"Analog::KocMoc::SVFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterOversamplingFactor",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_SetFilterOversamplingFactor",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_SetFilterDecimatorOrder(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  int arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::SetFilterDecimatorOrder",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterDecimatorOrder",1,"Analog::KocMoc::SVFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SVFilter::SetFilterDecimatorOrder",2,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_SetFilterDecimatorOrder",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_GetFilterCutoff(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterCutoff",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterCutoff",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterCutoff",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_GetFilterResonance(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterResonance",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterResonance",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterResonance",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_GetFilterMode(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  Analog::KocMoc::SVFFilterMode result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterMode",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterMode",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterMode",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
  
  result = (Analog::KocMoc::SVFFilterMode)(arg1)->GetFilterMode();
  lua_pushnumber(L, (lua_Number)(int)(result)); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SVFilter_GetFilterSampleRate(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterSampleRate",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterSampleRate",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterSampleRate",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_GetFilterIntegrationMethod(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  Analog::KocMoc::SVFIntegrationMethod result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterIntegrationMethod",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterIntegrationMethod",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterIntegrationMethod",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
  
  result = (Analog::KocMoc::SVFIntegrationMethod)(arg1)->GetFilterIntegrationMethod();
  lua_pushnumber(L, (lua_Number)(int)(result)); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_SVFilter_GetFilterOversamplingFactor(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  int result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterOversamplingFactor",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterOversamplingFactor",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterOversamplingFactor",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_GetFilterDecimatorOrder(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  int result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterDecimatorOrder",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterDecimatorOrder",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterDecimatorOrder",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_filter(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::filter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::filter",1,"Analog::KocMoc::SVFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::KocMoc::SVFilter::filter",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_filter",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_GetFilterLowpass(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterLowpass",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterLowpass",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterLowpass",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_GetFilterBandpass(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterBandpass",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterBandpass",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterBandpass",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_GetFilterHighpass(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterHighpass",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterHighpass",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterHighpass",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_GetFilterOutput(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::GetFilterOutput",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::GetFilterOutput",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_GetFilterOutput",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static int _wrap_SVFilter_ResetFilterState(lua_State* L) {
  int SWIG_arg = 0;
  Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) 0 ;
  
  SWIG_check_num_args("Analog::KocMoc::SVFilter::ResetFilterState",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Analog::KocMoc::SVFilter::ResetFilterState",1,"Analog::KocMoc::SVFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Analog__KocMoc__SVFilter,0))){
    SWIG_fail_ptr("SVFilter_ResetFilterState",1,SWIGTYPE_p_Analog__KocMoc__SVFilter);
  }
...
static void swig_delete_SVFilter(void *obj) {
Analog::KocMoc::SVFilter *arg1 = (Analog::KocMoc::SVFilter *) obj;
delete arg1;
}
static int _proxy__wrap_new_SVFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_SVFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_SVFilter_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_SVFilter_methods[]= {
    { "SetFilterCutoff", _wrap_SVFilter_SetFilterCutoff},
    { "SetFilterResonance", _wrap_SVFilter_SetFilterResonance},
    { "SetFilterMode", _wrap_SVFilter_SetFilterMode},
    { "SetFilterSampleRate", _wrap_SVFilter_SetFilterSampleRate},
    { "SetFilterIntegrationMethod", _wrap_SVFilter_SetFilterIntegrationMethod},
    { "SetFilterOversamplingFactor", _wrap_SVFilter_SetFilterOversamplingFactor},
    { "SetFilterDecimatorOrder", _wrap_SVFilter_SetFilterDecimatorOrder},
    { "GetFilterCutoff", _wrap_SVFilter_GetFilterCutoff},
    { "GetFilterResonance", _wrap_SVFilter_GetFilterResonance},
    { "GetFilterMode", _wrap_SVFilter_GetFilterMode},
    { "GetFilterSampleRate", _wrap_SVFilter_GetFilterSampleRate},
    { "GetFilterIntegrationMethod", _wrap_SVFilter_GetFilterIntegrationMethod},
    { "GetFilterOversamplingFactor", _wrap_SVFilter_GetFilterOversamplingFactor},
    { "GetFilterDecimatorOrder", _wrap_SVFilter_GetFilterDecimatorOrder},
    { "filter", _wrap_SVFilter_filter},
    { "GetFilterLowpass", _wrap_SVFilter_GetFilterLowpass},
    { "GetFilterBandpass", _wrap_SVFilter_GetFilterBandpass},
    { "GetFilterHighpass", _wrap_SVFilter_GetFilterHighpass},
    { "GetFilterOutput", _wrap_SVFilter_GetFilterOutput},
    { "ResetFilterState", _wrap_SVFilter_ResetFilterState},
    {0,0}
};
static swig_lua_method swig_SVFilter_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_SVFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_SVFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_SVFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_SVFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_SVFilter_Sf_SwigStatic = {
    "SVFilter",
    swig_SVFilter_Sf_SwigStatic_methods,
    swig_SVFilter_Sf_SwigStatic_attributes,
    swig_SVFilter_Sf_SwigStatic_constants,
    swig_SVFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_SVFilter_bases[] = {0};
static const char *swig_SVFilter_base_names[] = {0};
static swig_lua_class _wrap_class_SVFilter = { "SVFilter", "SVFilter", &SWIGTYPE_p_Analog__KocMoc__SVFilter,_proxy__wrap_new_SVFilter, swig_delete_SVFilter, swig_SVFilter_methods, swig_SVFilter_attributes, &swig_SVFilter_Sf_SwigStatic, swig_SVFilter_meta, swig_SVFilter_bases, swig_SVFilter_base_names };
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("LADDER_MAX_NEWTON_STEPS", 100)},
    {SWIG_LUA_CONSTTAB_INT("IIR_MAX_ORDER", 32)},
    {SWIG_LUA_CONSTTAB_INT("IIR_DOWNSAMPLE_ORDER", 16)},
    {SWIG_LUA_CONSTTAB_FLOAT("IIR_DOWNSAMPLING_BANDWIDTH", 0.9)},
    {SWIG_LUA_CONSTTAB_INT("SVF_MAX_NEWTON_STEPS", 8)},
    {SWIG_LUA_CONSTTAB_INT("SVF_NEWTON_BREAKING_LIMIT", 1)},
    {SWIG_LUA_CONSTTAB_INT("LADDER_LOWPASS_MODE", Analog::KocMoc::LADDER_LOWPASS_MODE)},
    {SWIG_LUA_CONSTTAB_INT("LADDER_BANDPASS_MODE", Analog::KocMoc::LADDER_BANDPASS_MODE)},
    {SWIG_LUA_CONSTTAB_INT("LADDER_HIGHPASS_MODE", Analog::KocMoc::LADDER_HIGHPASS_MODE)},
    {SWIG_LUA_CONSTTAB_INT("LADDER_EULER_FULL_TANH", Analog::KocMoc::LADDER_EULER_FULL_TANH)},
    {SWIG_LUA_CONSTTAB_INT("LADDER_PREDICTOR_CORRECTOR_FULL_TANH", Analog::KocMoc::LADDER_PREDICTOR_CORRECTOR_FULL_TANH)},
    {SWIG_LUA_CONSTTAB_INT("LADDER_PREDICTOR_CORRECTOR_FEEDBACK_TANH", Analog::KocMoc::LADDER_PREDICTOR_CORRECTOR_FEEDBACK_TANH)},
    {SWIG_LUA_CONSTTAB_INT("LADDER_TRAPEZOIDAL_FEEDBACK_TANH", Analog::KocMoc::LADDER_TRAPEZOIDAL_FEEDBACK_TANH)},
    {SWIG_LUA_CONSTTAB_INT("SK_LOWPASS_MODE", Analog::KocMoc::SK_LOWPASS_MODE)},
    {SWIG_LUA_CONSTTAB_INT("SK_BANDPASS_MODE", Analog::KocMoc::SK_BANDPASS_MODE)},
    {SWIG_LUA_CONSTTAB_INT("SK_HIGHPASS_MODE", Analog::KocMoc::SK_HIGHPASS_MODE)},
    {SWIG_LUA_CONSTTAB_INT("SK_SEMI_IMPLICIT_EULER", Analog::KocMoc::SK_SEMI_IMPLICIT_EULER)},
    {SWIG_LUA_CONSTTAB_INT("SK_PREDICTOR_CORRECTOR", Analog::KocMoc::SK_PREDICTOR_CORRECTOR)},
    {SWIG_LUA_CONSTTAB_INT("SK_TRAPEZOIDAL", Analog::KocMoc::SK_TRAPEZOIDAL)},
    {SWIG_LUA_CONSTTAB_INT("SVF_LOWPASS_MODE", Analog::KocMoc::SVF_LOWPASS_MODE)},
    {SWIG_LUA_CONSTTAB_INT("SVF_BANDPASS_MODE", Analog::KocMoc::SVF_BANDPASS_MODE)},
    {SWIG_LUA_CONSTTAB_INT("SVF_HIGHPASS_MODE", Analog::KocMoc::SVF_HIGHPASS_MODE)},
    {SWIG_LUA_CONSTTAB_INT("SVF_SEMI_IMPLICIT_EULER", Analog::KocMoc::SVF_SEMI_IMPLICIT_EULER)},
    {SWIG_LUA_CONSTTAB_INT("SVF_PREDICTOR_CORRECTOR", Analog::KocMoc::SVF_PREDICTOR_CORRECTOR)},
    {SWIG_LUA_CONSTTAB_INT("SVF_TRAPEZOIDAL", Analog::KocMoc::SVF_TRAPEZOIDAL)},
    {SWIG_LUA_CONSTTAB_INT("SVF_INV_TRAPEZOIDAL", Analog::KocMoc::SVF_INV_TRAPEZOIDAL)},
    {0,0,0,0,0,0}
};
...
&_wrap_class_Random,
&_wrap_class_IIRLowpass,
&_wrap_class_FIRLowpass,
&_wrap_class_Ladder,
&_wrap_class_SKFilter,
&_wrap_class_SVFilter,
...
static swig_type_info _swigt__p_Analog__KocMoc__FIRLowpass = {"_p_Analog__KocMoc__FIRLowpass", "Analog::KocMoc::FIRLowpass *", 0, 0, (void*)&_wrap_class_FIRLowpass, 0};
static swig_type_info _swigt__p_Analog__KocMoc__IIRLowpass = {"_p_Analog__KocMoc__IIRLowpass", "Analog::KocMoc::IIRLowpass *", 0, 0, (void*)&_wrap_class_IIRLowpass, 0};
static swig_type_info _swigt__p_Analog__KocMoc__Ladder = {"_p_Analog__KocMoc__Ladder", "Analog::KocMoc::Ladder *", 0, 0, (void*)&_wrap_class_Ladder, 0};
static swig_type_info _swigt__p_Analog__KocMoc__SKFilter = {"_p_Analog__KocMoc__SKFilter", "Analog::KocMoc::SKFilter *", 0, 0, (void*)&_wrap_class_SKFilter, 0};
static swig_type_info _swigt__p_Analog__KocMoc__SVFilter = {"_p_Analog__KocMoc__SVFilter", "Analog::KocMoc::SVFilter *", 0, 0, (void*)&_wrap_class_SVFilter, 0};
...
static swig_type_info *swig_type_initial[] = {
  &_swigt__p_Analog__KocMoc__FIRLowpass,
  &_swigt__p_Analog__KocMoc__IIRLowpass,
  &_swigt__p_Analog__KocMoc__Ladder,
  &_swigt__p_Analog__KocMoc__SKFilter,
  &_swigt__p_Analog__KocMoc__SVFilter,
  &_swigt__p_Random,
  &_swigt__p_double,
  &_swigt__p_float,
  &_swigt__p_int,
...
static swig_cast_info _swigc__p_Analog__KocMoc__FIRLowpass[] = {  {&_swigt__p_Analog__KocMoc__FIRLowpass, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Analog__KocMoc__IIRLowpass[] = {  {&_swigt__p_Analog__KocMoc__IIRLowpass, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Analog__KocMoc__Ladder[] = {  {&_swigt__p_Analog__KocMoc__Ladder, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Analog__KocMoc__SKFilter[] = {  {&_swigt__p_Analog__KocMoc__SKFilter, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_Analog__KocMoc__SVFilter[] = {  {&_swigt__p_Analog__KocMoc__SVFilter, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_Analog__KocMoc__FIRLowpass,
  _swigc__p_Analog__KocMoc__IIRLowpass,
  _swigc__p_Analog__KocMoc__Ladder,
  _swigc__p_Analog__KocMoc__SKFilter,
  _swigc__p_Analog__KocMoc__SVFilter,
  _swigc__p_Random,
  _swigc__p_double,
  _swigc__p_float,
  _swigc__p_int,
