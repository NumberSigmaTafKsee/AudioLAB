// the idea is simple
// sample and hold the target and filter it
// set the target and let the filter rise to it
// the filter will slow rise or fall to the target but probably never exactly reach it
