...
#define SWIGTYPE_p_Analog__Oscillators__PolyBLEPOsc__PolyBLEP swig_types[1]
...
#define SWIG_name      "VAPolyBLEPOscillator"
#define SWIG_init      luaopen_VAPolyBLEPOscillator
#define SWIG_init_user luaopen_VAPolyBLEPOscillator_user

#define SWIG_LUACODE   luaopen_VAPolyBLEPOscillator_luacode
...
static int _wrap_blep(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::Oscillators::PolyBLEPOsc::blep",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::Oscillators::PolyBLEPOsc::blep",1,"DspFloatType");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::Oscillators::PolyBLEPOsc::blep",2,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  result = (DspFloatType)Analog::Oscillators::PolyBLEPOsc::blep(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_blamp(lua_State* L) {
  ...
  SWIG_check_num_args("Analog::Oscillators::PolyBLEPOsc::blamp",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("Analog::Oscillators::PolyBLEPOsc::blamp",1,"DspFloatType");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Analog::Oscillators::PolyBLEPOsc::blamp",2,"DspFloatType");
  arg1 = (DspFloatType)lua_tonumber(L, 1);
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  result = (DspFloatType)Analog::Oscillators::PolyBLEPOsc::blamp(arg1,arg2);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
