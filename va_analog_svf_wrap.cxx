...
#define SWIGTYPE_p_p_Analog__Filters__AnalogSVF__AnalogSVF swig_types[44]
...
#define SWIG_name      "va_analog_svf"
#define SWIG_init      luaopen_va_analog_svf
#define SWIG_init_user luaopen_va_analog_svf_user

#define SWIG_LUACODE   luaopen_va_analog_svf_luacode
...
static int _wrap_AnalogSVF_ProcessBlock__SWIG_0(lua_State* L) {
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,5,(void**)&arg5,SWIGTYPE_p_double,0))){
    SWIG_fail_ptr("AnalogSVF_ProcessBlock",5,SWIGTYPE_p_double);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,6,(void**)&arg6,SWIGTYPE_p_double,0))){
    SWIG_fail_ptr("AnalogSVF_ProcessBlock",6,SWIGTYPE_p_double);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,7,(void**)&arg7,SWIGTYPE_p_double,0))){
    SWIG_fail_ptr("AnalogSVF_ProcessBlock",7,SWIGTYPE_p_double);
  }
...
static int _wrap_AnalogSVF_InplaceProcess__SWIG_0(lua_State* L) {
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_double,0))){
    SWIG_fail_ptr("AnalogSVF_InplaceProcess",3,SWIGTYPE_p_double);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_double,0))){
    SWIG_fail_ptr("AnalogSVF_InplaceProcess",4,SWIGTYPE_p_double);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,5,(void**)&arg5,SWIGTYPE_p_double,0))){
    SWIG_fail_ptr("AnalogSVF_InplaceProcess",5,SWIGTYPE_p_double);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,6,(void**)&arg6,SWIGTYPE_p_double,0))){
    SWIG_fail_ptr("AnalogSVF_InplaceProcess",6,SWIGTYPE_p_double);
  }
