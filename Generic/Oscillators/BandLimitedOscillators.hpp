...
namespace Oscillators
{
    ...
    {
        //! Class constructor.
        BlitSaw( DspFloatType sr = 44100.0, DspFloatType frequency = 220.0 ) : OscillatorProcessor()
        {
            nHarmonics_ = 0;
            sampleRate = sr;
            offset = 0;
    ...
    struct BlitSquare : public OscillatorProcessor
    {
        ...
        BlitSquare(DspFloatType sr = 44100.0) : OscillatorProcessor()
        {
            sampleRate = sr;
            block.setFc(10.0f/sampleRate);
            _out = 0;
    ...
    struct BlitTriangle : public OscillatorProcessor
    {
        ...
        BlitTriangle(DspFloatType sr = 44100.0) : OscillatorProcessor()
        {
            sampleRate = sr;
    ...
    struct DPWPulse
    {
        DspFloatType freq,fs,inc,invSampleRate;
        DspFloatType phase,lastPhase;
    ...
    struct DPWTriangle
    {
        ...
        DPWTriangle(DspFloatType sampleRate=44100.0)
        {
            freq = 440.0f;
            fs   = sampleRate;
