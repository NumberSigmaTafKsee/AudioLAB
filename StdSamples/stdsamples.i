...
%template(get_left_channelf)  AudioDSP::get_left_channel<DspFloatType>;
%template(get_right_channelf) AudioDSP::get_right_channel<DspFloatType>;
%template(get_channelf)       AudioDSP::get_channel<DspFloatType>;

%template(interleavef)     AudioDSP::interleave<DspFloatType>;
%template(deinterleavef)   AudioDSP::interleave<DspFloatType>;
%template(copy_vectorf)    AudioDSP::copy_vector<DspFloatType>;
%template(slice_vectorf)   AudioDSP::slice_vector<DspFloatType>;
%template(copy_bufferf)    AudioDSP::copy_buffer<DspFloatType>;
%template(slice_bufferf)   AudioDSP::slice_buffer<DspFloatType>;
%template(stereo_splitf)   AudioDSP::split_stereo<DspFloatType>;
//%template(insert_frontf)   AudioDSP::insert_front<DspFloatType>;
