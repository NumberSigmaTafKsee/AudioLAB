...
%template(ArrayXXf)  Eigen::Array<float,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor>;
%template(ArrayXXd)  Eigen::Array<double,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor>;
%template(ArrayXXcf) Eigen::Array<std::complex<float>,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor>;
%template(ArrayXXcd) Eigen::Array<std::complex<double>,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor>;

%template(MatrixViewXf) MatrixView<float,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor>;
%template(MatrixViewXd) MatrixView<double,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor>;

%template(ArrayViewXXf) ArrayView<float,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor>;
%template(ArrayViewXXd) ArrayView<double,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor>;
