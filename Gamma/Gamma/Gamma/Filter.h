...
public:
	...
	void ProcessBlock(size_t n, Tv * in, Tv * out) {
		#pragma omp simd
...
public:
	...
	void ProcessBlock(size_t n, Tv * in, Complex<Tv> * out) {
		#pragma omp simd
		for(size_t i = 0; i < n; i++) {
			out[i] = (*this)(in[i]);
		}
	}
	Complex<Tv> Tick(Tv I) {
		return (*this)(I);
	}
